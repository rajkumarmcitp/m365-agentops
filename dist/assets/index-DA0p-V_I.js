(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const Xi=[{id:"demo",name:"Demo Account",email:"demo@contoso.com",role:"admin",initials:"DM",color:"#00C7B7",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"],isDemoAccount:!0},{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","myaccount","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["requests","msgcenter","portal","myreqs","myaccount","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings","graphapi","sso"]}],Ws={auth:{clientId:"04d3be8d-d433-4367-893e-eccc82190a11",authority:"https://login.microsoftonline.com/b9cc8284-05ed-452f-877a-970779430dcb",redirectUri:window.location.origin+"/callback"},cache:{cacheLocation:"sessionStorage",storeAuthStateInCookie:!1},system:{allowNativeBroker:!1}},Js={scopes:["openid","profile","email","User.Read"]};let H=null;async function Ks(){try{if(!window.msal)return console.warn("MSAL not loaded yet"),null;H=new window.msal.PublicClientApplication(Ws),await H.initialize();const e=await H.handleRedirectPromise();if(e)return console.log("✓ Authenticated from redirect:",e.account.name),e.account;const t=H.getAllAccounts();return t.length>0?(console.log("✓ Already authenticated as:",t[0].name),t[0]):null}catch(e){return console.error("MSAL init error:",e.message),null}}async function Ys(){try{if(!H)return console.error("MSAL not initialized"),null;const e=await H.loginPopup(Js);return console.log("✓ Login successful:",e.account.name),e.account}catch(e){return e.errorCode==="user_cancelled"?console.log("User cancelled login"):console.error("Login error:",e.errorCode,e.errorMessage),null}}async function Zs(){try{if(!H)return null;const e=H.getAllAccounts();if(e.length===0)return null;const t={scopes:["https://graph.microsoft.com/.default"],account:e[0]};return(await H.acquireTokenSilent(t)).accessToken}catch(e){return console.error("Token error:",e.message),null}}async function Qs(){try{if(!H)return;const e={account:H.getAllAccounts()[0]};await H.logout(e),console.log("✓ Logged out")}catch(e){console.error("Logout error:",e)}}function Xs(){if(!H)return null;const e=H.getAllAccounts();return e.length>0?e[0]:null}function ea(){if(window.userEmail)return console.log("📧 getUserEmail from window.userEmail:",window.userEmail),window.userEmail;const e=Xs();if(!e)return null;const t=e.username||e.mail||e.email;return console.log("📧 getUserEmail from MSAL:",t),t}const ta={},A=typeof import.meta<"u"&&ta?"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api":window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"http://localhost:3000/api":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api",ia=A;async function M(e,t="GET",i=null){try{const s=`${ia}${e}`;console.log(`🔄 ${t} ${s}`);const a={method:t,headers:{"Content-Type":"application/json"},credentials:"include"};i&&(a.body=JSON.stringify(i));const n=await fetch(s,a);if(!n.ok)throw new Error(`HTTP ${n.status}: ${n.statusText}`);const r=await n.json();return console.log(`✓ ${t} ${e}:`,r),r}catch(s){return console.error(`✗ API error on ${t} ${e}:`,s.message),{success:!1,error:s.message,data:[],count:0}}}async function Jt(){return M("/devices")}async function sa(){return M("/device-compliance-policies")}async function aa(){return M("/config/cis-controls")}async function na(){return M("/msgcenter/messages")}async function ra(){return M("/msgcenter/health")}async function es(){return M("/security/score")}async function oa(){return M("/security/incidents")}async function la(){return M("/identity/posture")}async function da(){return M("/privileged-accounts")}async function ca(){return M("/users")}async function pa(){return M("/applications")}async function ua(){return M("/service-principals")}let si=null;function ts(){return si=setInterval(()=>{ai()},3e4),ai(),si}async function ai(){try{const e=encodeURIComponent(m.settings.sharepointSiteUrl||"root"),t=await fetch(`${A}/msgcenter/notifications?siteUrl=${e}`).then(i=>i.json());t.success&&t.data&&(va(t.unreadCount||0),t.data.filter(s=>!s.read).forEach(s=>{ga(s),fa(s.id)}))}catch(e){console.warn("Error checking notifications:",e.message)}}function va(e){const t=document.getElementById("notification-bell"),i=document.getElementById("notification-badge");t&&i&&(e>0?(i.style.display="flex",i.textContent=e>9?"9+":e):i.style.display="none")}function ga(e){const t=document.getElementById("toast-container");if(!t)return;const i=ma(e.type),s=ya(e.type);let a=e.message;e.type==="approval"?a=`"${e.title}" requires approval`:e.type==="deadline"&&(a="Deadline approaching");const n=document.createElement("div");n.style.cssText=`
    background:white;
  ...
  `,t.appendChild(n);const r=n.querySelector(".close-toast");r==null||r.addEventListener("click",()=>{n.style.animation="slideOut 300ms ease-in",setTimeout(()=>n.remove(),300)}),setTimeout(()=>{n.parentElement&&(n.style.animation="slideOut 300ms ease-in",setTimeout(()=>n.remove(),300))},5e3)}function ma(e){return{new_announcement:"📢",deadline:"⏰",task_update:"✓",approval:"👤"}[e]||"📌"}function ya(e){return{new_announcement:"#0066cc",deadline:"#ff9800",task_update:"#4caf50",approval:"#9c27b0"}[e]||"#999"}async function fa(e){try{await fetch(`${A}/msgcenter/notifications/${e}/read`,{method:"POST"})}catch(t){console.warn("Error marking notification as read:",t.message)}}async function ha(){try{const e=encodeURIComponent(m.settings.sharepointSiteUrl||"root"),t=await fetch(`${A}/msgcenter/notifications?siteUrl=${e}`).then(i=>i.json());return t.success?{success:!0,data:t.data||[],count:t.count||0,unreadCount:t.unreadCount||0}:{success:!1,data:[]}}catch(e){return console.error("Error fetching notifications:",e.message),{success:!1,data:[]}}}const is=document.createElement("style");is.textContent=`
  @keyframes slideIn {
    from {
...
`;document.head.appendChild(is);function ba(){const e=document.getElementById("app-header"),t=m.currentUser;t&&(e.innerHTML=`
  ...
  `,document.getElementById("notification-bell").addEventListener("click",async()=>{const i=await ha();i.data.length>0&&xa(i.data)}),document.getElementById("hdr-settings").addEventListener("click",async()=>{var i;(i=m.currentUser)!=null&&i.navAccess.includes("settings")&&await C("settings")}),document.getElementById("hdr-signout").addEventListener("click",async()=>{console.log("📤 Signing out..."),m.currentUser=null,await Qs(),document.getElementById("app").innerHTML="",window.location.reload()}))}function xa(e){const t=document.createElement("div");t.style.cssText=`
  ...
  `;const t=document.createElement("div");t.style.marginTop="16px",t.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading Change Intelligence...</p></div>',e.appendChild(t),Da().then(S=>{t.innerHTML=S,console.log("✓ Change Intelligence loaded")}).catch(S=>{console.error("❌ Error loading Change Intelligence:",S.message),t.innerHTML=`<div style="padding:20px;background:var(--color-background-secondary);border-radius:var(--border-radius-md)"><div style="color:var(--color-text-secondary);font-size:11px">Failed to load Change Intelligence: ${S.message}</div></div>`}),(i=e.querySelector("#dash-to-msgcenter-health"))==null||i.addEventListener("click",async()=>await C("msgcenter")),(s=e.querySelector("#dash-to-requests"))==null||s.addEventListener("click",async()=>await C("requests")),(a=e.querySelector("#dash-to-security"))==null||a.addEventListener("click",async()=>await C("security")),(n=e.querySelector("#dash-to-tenantguard"))==null||n.addEventListener("click",async()=>await C("tenantguard")),(r=e.querySelector("#dash-to-privaccts"))==null||r.addEventListener("click",async()=>await C("privaccts")),(o=e.querySelector("#dash-to-zt"))==null||o.addEventListener("click",async()=>await C("zerotrust")),(l=e.querySelector("#dash-to-m365"))==null||l.addEventListener("click",async()=>await C("m365config")),(c=e.querySelector("#dash-to-licenses"))==null||c.addEventListener("click",async()=>await C("licenses")),(d=e.querySelector("#dash-to-intune"))==null||d.addEventListener("click",async()=>await C("intune")),(p=e.querySelector("#dash-to-apps"))==null||p.addEventListener("click",async()=>await C("applications")),(v=e.querySelector("#dash-to-investigation"))==null||v.addEventListener("click",async()=>await C("user-investigation")),(f=e.querySelector("#dash-to-agents"))==null||f.addEventListener("click",async()=>await C("agents")),(b=e.querySelector("#dash-to-approvals"))==null||b.addEventListener("click",async()=>await C("approvals")),(k=e.querySelector("#dash-to-msgcenter"))==null||k.addEventListener("click",async()=>await C("msgcenter")),(y=e.querySelector("#dash-to-audit"))==null||y.addEventListener("click",async()=>await C("audit")),(w=e.querySelector("#dash-consents-view"))==null||w.addEventListener("click",async()=>await C("applications")),(P=e.querySelector("#dash-consents-dismiss"))==null||P.addEventListener("click",()=>{const S=e.querySelector("#dash-consents-section");S&&(S.style.display="none"),localStorage.setItem("dashboard_consents_dismissed",new Date().getTime())})}async function Ea(e){try{console.log("📡 Fetching dashboard data...");const[t,i,s,a]=await Promise.all([Jt().catch(n=>(console.warn("⚠️ Devices fetch failed:",n.message),{})),ca().catch(n=>(console.warn("⚠️ Users fetch failed:",n.message),{})),es().catch(n=>(console.warn("⚠️ Score fetch failed:",n.message),{})),M("/audit-logs/consents").catch(n=>(console.warn("⚠️ Consents fetch failed:",n.message),{}))]);if(Rt=t.success&&t.count?t.count:0,Dt=i.success&&i.count?i.count:0,It=s.success?s.data:null,Ca(e),Pa(e),Ma(e),Ta(e),a.success&&a.data){const n=new Date,r=new Date(n.getTime()-24*60*60*1e3);Be=a.data.filter(o=>new Date(o.activityDateTime)>=r).sort((o,l)=>new Date(l.activityDateTime)-new Date(o.activityDateTime)).slice(0,5),Be.length>0&&!Aa()?(console.log(`✅ Loaded ${Be.length} recent admin consents`),La(e)):e.querySelector("#dash-consents-section").style.display="none"}console.log(`✅ Dashboard data loaded: ${Rt} devices, ${Dt} users`)}catch(t){console.error("❌ Error loading dashboard data:",t)}}function Ca(e){const t=e.querySelector("#dash-kpi-devices");t&&(t.textContent=Rt);const i=e.querySelector("#dash-kpi-users");i&&(i.textContent=Dt);const s=e.querySelector("#dash-kpi-score");s&&It&&(s.textContent=`${It.overallScore||0}/100`),e.querySelectorAll(".kpi-tile").forEach(a=>{a.style.background="",a.style.opacity="1"})}function Pa(e){const t=e.querySelector("#dash-requests-pending"),i=e.querySelector("#dash-requests-total"),s=e.querySelector("#dash-requests-time");t&&(t.textContent="2"),i&&(i.textContent="5"),s&&(s.textContent="⏱ Oldest: 2 hours ago");const a=e.querySelector("#dash-incidents-active"),n=e.querySelector("#dash-incidents-week"),r=e.querySelector("#dash-incidents-status");a&&(a.textContent="0"),n&&(n.textContent="3"),r&&(r.textContent="✓ Status: Investigating");const o=e.querySelector("#dash-tguard-active"),l=e.querySelector("#dash-tguard-critical"),c=e.querySelector("#dash-tguard-correlations");o&&(o.textContent="5"),l&&(l.textContent="2"),c&&(c.textContent="⚠ Correlations: 2");const d=e.querySelector("#dash-priv-atrisk"),p=e.querySelector("#dash-priv-total"),v=e.querySelector("#dash-priv-nomfa");d&&(d.textContent="1"),p&&(p.textContent="5"),v&&(v.textContent="⏱ No MFA: 1");const f=e.querySelectorAll(".dash-cards-row")[0];f&&f.querySelectorAll(".card").forEach(b=>{b.style.background="",b.style.opacity="1"})}function Ma(e){var v,f;const t=e.querySelector("#dash-zt-status"),i=e.querySelector("#dash-zt-pillars");t&&(t.textContent="No Assessment"),i&&(i.textContent="Pillars: 4 • Controls: 12");const s=e.querySelector("#dash-cis-compliance"),a=e.querySelector("#dash-cis-topics"),n=e.querySelector("#dash-cis-trend");s&&(s.textContent="78%"),a&&(a.textContent="9"),n&&(n.textContent="📊 Trend: ↑ +2%");const r=e.querySelector("#dash-license-pct"),o=e.querySelector("#dash-license-count"),l=e.querySelector("#dash-license-risk");r&&(r.textContent="95%"),o&&(o.textContent="1.2K / 1.3K"),l&&(l.textContent="⚠ Risk: 50 unused");const c=e.querySelector("#dash-device-compliance"),d=e.querySelector("#dash-device-count"),p=e.querySelector("#dash-device-noncompliant");c&&(c.textContent="98%"),d&&(d.textContent="847"),p&&(p.textContent="⚠ Non-Compliant: 15"),(f=(v=e.querySelectorAll(".dash-cards-row")[1])==null?void 0:v.querySelectorAll(".card"))==null||f.forEach(b=>{b.style.background="",b.style.opacity="1"})}function Ta(e){var f,b;const t=e.querySelector("#dash-apps-expiring"),i=e.querySelector("#dash-apps-total"),s=e.querySelector("#dash-apps-status");t&&(t.textContent="3"),i&&(i.textContent="5"),s&&(s.textContent="⚠ Secrets expiring soon");const a=e.querySelector("#dash-risk-high"),n=e.querySelector("#dash-risk-users"),r=e.querySelector("#dash-risk-score");a&&(a.textContent="3"),n&&(n.textContent="15"),r&&(r.textContent="📊 Risk Score: 42");const o=e.querySelector("#dash-agents-active"),l=e.querySelector("#dash-agents-healthy"),c=e.querySelector("#dash-agents-uptime");o&&(o.textContent="6"),l&&(l.textContent="4"),c&&(c.textContent="📊 Uptime: 99.8%");const d=e.querySelector("#dash-approvals-pending"),p=e.querySelector("#dash-approvals-total"),v=e.querySelector("#dash-approvals-time");d&&(d.textContent="3"),p&&(p.textContent="7"),v&&(v.textContent="⏱ Oldest: 5 hours"),(b=(f=e.querySelectorAll(".dash-cards-row")[2])==null?void 0:f.querySelectorAll(".card"))==null||b.forEach(k=>{k.style.background="",k.style.opacity="1"})}function La(e){const t=e.querySelector("#dash-consents-section"),i=e.querySelector("#dash-consents-count"),s=e.querySelector("#dash-consents-tbody");!t||!s||(i.textContent=Be.length,s.innerHTML=Be.map(a=>`
  ...
  `).join(""),t.style.display="block")}function Ra(e){var t,i,s,a,n,r,o,l,c,d,p,v,f,b,k;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-layout-dashboard"></i> Dashboard</div>
        <div class="page-subtitle">${m.tenantDomain} — last updated just now</div>
    ...
    <div class="dash-cards-row">
      ...
      <div class="card" style="grid-column: span 2;">
        ...
        <div style="margin-bottom:10px">
          ${n.map(d=>{const p=St[d.service]||{icon:"ti-apps",color:"#185FA5",bg:"#E6F1FB"};return`<div style="display:flex;align-items:flex-start;gap:8px;padding:7px 0;border-bottom:0.5px solid var(--color-border-tertiary)">
      ...
      <div class="card" style="grid-column: span 2;">
        ...
        `).join(""):`
          <div style="font-size:11px;color:var(--clr-success-text);display:flex;align-items:center;gap:6px">
            <i class="ti ti-circle-check"></i> All ${Object.keys(St).length} monitored services operational.
          </div>
        `}
    ...
    <div class="card mb-3">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${["ALL","PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].map(s=>`
          <button class="demo-filter-btn ${ie===s?"btn-primary":""}" data-status="${s}" style="padding:6px 12px;font-size:11px;border:0.5px solid var(--color-border-secondary);background:${ie===s?"var(--clr-info-bg)":"transparent"};color:${ie===s?"var(--clr-info-text)":"var(--color-text-secondary)"};border-radius:var(--border-radius-sm);cursor:pointer;transition:all 200ms">
            ${s}
          </button>
        `).join("")}
      </div>
              ...
              ${t.map(s=>{var a,n;return`
                <tr style="border-bottom:0.5px solid var(--color-border-tertiary);cursor:pointer" class="demo-req-row" data-id="${s.id}">
                  ...
                  <td style="padding:10px 12px">
                    <span style="padding:2px 6px;border-radius:3px;font-size:10px;background:${wt((a=s.validation)==null?void 0:a.riskLevel)};color:white">
                      ${((n=s.validation)==null?void 0:n.riskLevel)||"MEDIUM"}
                    </span>
                  </td>
                  <td style="padding:10px 12px">${xt(s.status)}</td>
  ...
  `,e.querySelectorAll(".demo-filter-btn").forEach(s=>{s.addEventListener("click",()=>{ie=s.dataset.status,Kt(e)})}),e.querySelectorAll(".demo-req-row").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;te=I.find(n=>n.id===a),te&&(Ae="details",ri(e))})}),e.querySelectorAll(".demo-req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;te=I.find(r=>r.id===n),te&&(Ae="details",ri(e))})})}function ri(e){var i,s,a,n,r,o;if(!e||!e.querySelector||!te)return;const t=te;e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div>
          ...
          <div class="page-subtitle">${t.operationId} • ${xt(t.status)}</div>
        </div>
      </div>
    </div>
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
              <div style="font-size:28px;font-weight:600;color:${wt((i=t.validation)==null?void 0:i.riskLevel)}">${((s=t.validation)==null?void 0:s.riskScore)||0}</div>
              <div>
  ...
  `,(o=e.querySelector(".demo-back-btn"))==null||o.addEventListener("click",()=>{Ae="list",Kt(e)})}async function as(e){try{const i=await(await fetch(`${A}/requests?limit=100`)).json();I=Array.isArray(i.data)?i.data:[],console.log(`📋 Loaded ${I.length} requests`)}catch(t){console.error("Error loading requests:",t),u("Failed to load requests","error")}}function bt(e){if(!e||!e.querySelector){console.error("❌ Page element not found or invalid");return}const t=ie==="ALL"?I:I.filter(s=>s.status===ie),i={total:I.length,pending:I.filter(s=>s.status==="PENDING_APPROVAL").length,approved:I.filter(s=>s.status==="APPROVED").length,rejected:I.filter(s=>s.status==="REJECTED").length,completed:I.filter(s=>s.status==="COMPLETED").length};e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-inbox"></i> Service Requests</div>
        <div class="page-subtitle">Manage and approve all service requests in the system</div>
    ...
    <div class="card mb-3">
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${["ALL","PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].map(s=>`
          <button class="btn ${ie===s?"btn-primary":""}" id="filter-${s}" style="padding:6px 12px;font-size:11px">
            ${s}
          </button>
        `).join("")}
      </div>
  ...
  `,e&&e.querySelector&&["ALL","PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].forEach(s=>{const a=e.querySelector(`#filter-${s}`);a&&a.addEventListener("click",()=>{ie=s,bt(e)})}),e&&e.querySelectorAll&&(e.querySelectorAll("tr[data-id]").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;te=I.find(n=>n.id===a),te&&(Ae="details",oi(e))})}),e.querySelectorAll(".req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;te=I.find(r=>r.id===n),te&&(Ae="details",oi(e))})}))}function oi(e){var a,n,r,o,l;if(!e||!e.querySelector||!te)return;const t=te,i=za(t);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
    ...
    <div class="grid-2" style="gap:16px">
      ...
      <div>
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
              <div style="font-size:28px;font-weight:600;color:${wt((a=t.validation)==null?void 0:a.riskLevel)}">${((n=t.validation)==null?void 0:n.riskScore)||0}</div>
              <div>
...
**Graph API:** GET /beta/identity/conditionalAccess/policies`}];let pt=null,G=[],D=R,De="executive",z={priority:"all",category:"all",status:"all"},dt="7d",He=[],ci=!1;const Va=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"},{id:"apiref",label:"API Reference",icon:"ti-api"}];async function Wa(){const e=document.getElementById("page-security");if(e){if(K()){console.log("🎭 Demo account detected - showing demo security data"),vn(e);return}try{console.log("📡 Fetching real security data from backend...");const t=await es();t.success&&t.data?(pt=t.data,console.log("✅ Loaded real secure score from API")):(console.warn("⚠️ No secure score data available from API"),pt=null);let i=[];try{const r=await Jt();r.success&&r.data&&(i=r.data,console.log(`✅ Loaded ${i.length} real devices from Intune`))}catch(r){console.warn("⚠️ Could not fetch device data:",r.message)}const s=r=>r.map(o=>{var c,d,p,v,f,b;const l=o.deviceName||((d=(c=o.description)==null?void 0:c.match(/Device ([A-Z0-9-]+)/))==null?void 0:d[1])||((v=(p=o.title)==null?void 0:p.match(/([A-Z0-9-]+)/))==null?void 0:v[1])||((b=(f=o.description)==null?void 0:f.match(/([A-Z0-9]{3,})/))==null?void 0:b[1]);if(l&&i.length>0){const k=i.find(y=>{var w,P;return((w=y.deviceName)==null?void 0:w.toUpperCase().includes(l.toUpperCase()))||((P=y.deviceName)==null?void 0:P.includes(l))||y.id===l});if(k)return{...o,deviceId:k.id,deviceName:k.deviceName,deviceOS:k.operatingSystem,compliant:k.complianceState==="Compliant",managed:!0,owner:k.userDisplayName}}return o}),a=await oa();a.success&&Array.isArray(a.data)&&a.data.length>0?(G=s(a.data),console.log(`✅ Loaded ${G.length} real incidents from alerts (enriched with device data)`)):(console.warn("⚠️ No active incidents found"),G=[]);const n=await la();n.success&&n.data&&(D={totalUsers:n.data.totalUsers||R.totalUsers,privAccounts:n.data.privilegedAccounts||R.privAccounts,globalAdmins:n.data.globalAdmins||R.globalAdmins,serviceAccounts:n.data.serviceAccounts||R.serviceAccounts,breakGlass:n.data.breakGlassAccounts||R.breakGlass,identitySecureScore:n.data.identitySecureScore||R.identitySecureScore,mfaEnabled:n.data.mfaEnabled||R.mfaEnabled,mfaExcluded:n.data.mfaExcluded||R.mfaExcluded,passwordlessAdoption:n.data.passwordlessAdoption||R.passwordlessAdoption,fido2Adoption:n.data.fido2Adoption||R.fido2Adoption,legacyAuthConnections:n.data.legacyAuthConnections||R.legacyAuthConnections,highRiskUsers:n.data.highRiskUsers||R.highRiskUsers,riskySignIns30d:n.data.riskySignIns30d||R.riskySignIns30d,impossibleTravel30d:R.impossibleTravel30d,anonymousIP30d:R.anonymousIP30d,passwordSpray30d:R.passwordSpray30d,caPoliciesEnabled:n.data.caPoliciesEnabled||R.caPoliciesEnabled,caPoliciesDisabled:n.data.caPoliciesDisabled||R.caPoliciesDisabled,caPoliciesReportOnly:n.data.caPoliciesReportOnly||R.caPoliciesReportOnly,caUsersExcluded:n.data.caUsersExcluded||R.caUsersExcluded},console.log("✅ Loaded real identity posture data from Azure AD"))}catch(t){console.error("❌ Error loading security data:",t.message)}ce(e)}}function ce(e){var a,n;const t=Array.isArray(G)?G:[],i=t.filter(r=>r.severity==="critical").length;t.filter(r=>r.severity==="high"&&r.status!=="resolved").length;const s=xe.filter(r=>r.priority==="critical"||r.priority==="high").length;e.innerHTML=`
    ...
    <div class="tabs" id="sec-subnav">
      ${Va.map(r=>`
        <button class="tab-btn ${De===r.id?"active":""}" data-sec="${r.id}">
    ...
    <!-- Section content -->
    <div id="sec-content" style="margin-top:16px">${Za()}</div>
  `,e.querySelectorAll("#sec-subnav .tab-btn").forEach(r=>{r.addEventListener("click",()=>{var o;De=r.dataset.sec,ce(e),(o=e.querySelector("#sec-subnav"))==null||o.scrollIntoView({behavior:"smooth",block:"nearest"})})}),(a=e.querySelector("#sec-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#sec-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u("Security posture refreshed — all 15 data sources updated.","success")},2200)}),(n=e.querySelector("#sec-report"))==null||n.addEventListener("click",()=>u("Security report exported as PDF.","success")),un(e)}function Ja(){const e=pt||Yt,t=e.percentOf100,i=t>=80?"success":t>=60?"warning":"danger",s=Array.isArray(G)?G:[],a=s.filter(n=>n.severity==="critical"&&n.status!=="resolved").length;return`
    <div class="kpi-tile sec-kpi-primary" style="min-width:160px">
      <div style="display:flex;align-items:center;gap:12px">
        ${ut(e.current,e.max,52)}
        <div>
  ...
  `}function ut(e,t,i=80){const s=e/t,a=i/2*.82,n=i/2,r=i/2,o=2*Math.PI*a,l=o*s,c=s>=.8?"#3B6D11":s>=.6?"#854F0B":"#A32D2D",d=i<60?11:14;return`<svg width="${i}" height="${i}" viewBox="0 0 ${i} ${i}" style="flex-shrink:0">
  ...
  </svg>`}function Ka(e,t=24){const i=Math.max(...e),s=Math.min(...e),a=i-s||1;return`<div style="display:flex;align-items:flex-end;gap:2px;height:${t}px">
  ...
  </div>`}function Ya(e,t){return e==="pass"||e===!0?`<span style="color:var(--clr-success-text)"><i class="ti ti-circle-check"></i> ${t}</span>`:e==="partial"||e==="warn"?`<span style="color:var(--clr-warning-text)"><i class="ti ti-alert-triangle"></i> ${t}</span>`:`<span style="color:var(--clr-danger-text)"><i class="ti ti-circle-x"></i> ${t}</span>`}function Za(){return({executive:pi,securescore:Qa,identity:Xa,email:en,endpoint:tn,teams:sn,sharepoint:an,dataprotection:nn,privaccess:rn,guests:on,incidents:ln,recommendations:dn,copilot:cn,apiref:pn}[De]||pi)()}function pi(){const e=pt||Yt,t=Array.isArray(G)?G:[];return`
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div style="display:flex;gap:4px">
            <button class="btn btn-xs ${dt==="7d"?"btn-primary":""}" data-trend="7d">7d</button>
            <button class="btn btn-xs ${dt==="30d"?"btn-primary":""}" data-trend="30d">30d</button>
          </div>
        </div>
        <div style="display:flex;align-items:flex-end;gap:16px;margin-bottom:16px">
          ${ut(e.current,e.max,80)}
          <div>
        ...
        <div style="margin-bottom:12px" id="exec-trend-chart">
          ${Ka((dt==="30d"?e.trend30d:e.trend7d)||[72,73,74,75,76,77,78],32)}
        </div>
  ...
  `}function Xa(){const e=D;return`
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        ...
        ${se([{label:"High-Risk Users",val:e.highRiskUsers,cls:e.highRiskUsers===0?"success":"danger"},{label:"Risky Sign-ins",val:e.riskySignIns30d,cls:"warning"},{label:"Impossible Travel",val:e.impossibleTravel30d,cls:e.impossibleTravel30d===0?"success":"danger"},{label:"Anonymous IP Sign-ins",val:e.anonymousIP30d,cls:e.anonymousIP30d===0?"success":"warning"},{label:"Password Spray Attacks",val:e.passwordSpray30d,cls:"success"}])}
      ...
      <div class="card">
        ...
        ${se([{label:"Policies Enabled",val:e.caPoliciesEnabled,cls:"success"},{label:"Policies Disabled",val:e.caPoliciesDisabled,cls:e.caPoliciesDisabled===0?"success":"warning"},{label:"Report-Only Mode",val:e.caPoliciesReportOnly,cls:"warning"},{label:"Users Excluded",val:e.caUsersExcluded,cls:e.caUsersExcluded>10?"warning":"success"}])}
  ...
  `}function en(){const e=Na;return`
    ...
    <div class="grid-2 mb-3" style="gap:16px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          ${[{label:"SPF Record",ok:e.spf==="pass",note:"Configured — v=spf1 include:protection.outlook.com -all"},{label:"DKIM Signing",ok:e.dkim==="pass",note:"Enabled for contoso.com"},{label:"DMARC Policy",ok:"warn",note:`Policy: ${e.dmarc} — upgrade to reject for full protection`},{label:"Safe Links",ok:e.safeLinks==="enabled",note:"Active for all users"},{label:"Safe Attachments",ok:"warn",note:"Partial — not all users covered"},{label:"Anti-spam Policy",ok:"warn",note:`Level: ${e.antiSpamPolicy} — recommend strict`}].map(t=>`
            <div style="padding:10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:0.5px solid var(--color-border-tertiary)">
              ...
              <div style="font-size:12px;font-weight:600;margin-bottom:3px">${Ya(t.ok,t.ok==="pass"||t.ok===!0?"Pass":t.ok==="warn"?"Warning":"Fail")}</div>
      ...
      <div class="card">
        ...
        ${se([{label:"External Forwarding Rules",val:e.externalForwardingRules,cls:"danger"},{label:"Suspicious Inbox Rules",val:e.suspiciousInboxRules,cls:"danger"},{label:"Shared Mailboxes",val:e.sharedMailboxExposed,cls:"info"}])}
  ...
  `}function tn(){const e=Ga;return`
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        ${se([{label:"Active Threats",val:e.activeThreats,cls:"danger"},{label:"High Severity Alerts",val:e.highSeverityAlerts,cls:"danger"},{label:"Windows 11 (%)",val:e.windows11Pct+"%",cls:"success"},{label:"Windows 10 (%)",val:e.windows10Pct+"%",cls:"warning"}])}
  ...
  `}function sn(){const e=Oa;return`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${se([{label:"Teams with External Sharing",val:e.teamsWithExternalSharing,cls:"warning"},{label:"Unowned Teams",val:e.unownedTeams,cls:"warning"},{label:"Guests Added (30d)",val:e.guestsAdded30d,cls:"info"},{label:"External Domains Allowed",val:e.externalDomainsAllowed,cls:"warning"}])}
  ...
  `}function an(){const e=Ua;return`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${se([{label:"Public Content",val:e.publicContent,cls:"danger"},{label:"Large Downloads (30d)",val:e.largeDownloads30d,cls:"warning"},{label:"DLP Coverage",val:e.dlpCoveragePct+"%",cls:"warning"},{label:"Ext. Sharing Restricted",val:"Yes",cls:"success"}])}
  ...
  `}function nn(){const e=ja;return`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${se([{label:"Files Without Labels",val:e.filesWithoutLabels.toLocaleString(),cls:"danger"},{label:"Retention Policies",val:e.retentionPoliciesActive,cls:"info"},{label:"Insider Risk Policies",val:e.insiderRiskPolicies,cls:"info"},{label:"Unusual Downloads (30d)",val:e.unusualDownloads30d,cls:"warning"}])}
  ...
  `}function rn(){const e=Fa;return`
    ...
    <div class="grid-2" style="gap:16px">
      ...
      <div class="card">
        ...
        ${se([{label:"New Admin Created",val:e.newAdmins30d,cls:"warning"},{label:"Priv. Role Assignments",val:e.privRoleAssignments30d,cls:"info"},{label:"Emergency Access Used",val:e.emergencyAccess30d,cls:"success"},{label:"PIM Eligible Roles",val:e.pimEligibleRoles,cls:"success"}])}
  ...
  `}function on(){const e=Ba;return`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${se([{label:"Added (30d)",val:e.guestsAddedLast30d,cls:"info"},{label:"Removed (30d)",val:e.guestsRemovedLast30d,cls:"success"},{label:"Avg Account Age",val:e.avgGuestAgeDays+"d",cls:"warning"}])}
        <div class="alert-banner danger mt-3" style="margin-bottom:0">
  ...
  `}function ln(){const e=G.filter(r=>r.status!=="resolved"),t=G.filter(r=>r.status==="resolved"),i=G.filter(r=>r.severity==="critical").length,s=G.filter(r=>r.severity==="high").length,a=G.filter(r=>r.severity==="medium").length,n=G.filter(r=>r.severity==="low").length;return`
    <div class="kpi-row mb-3">
    ...
    ${t.length>0?`
      ...
      `).join("")}
    `:""}
  `}function dn(){const e=xe.filter(s=>!(z.priority!=="all"&&s.priority!==z.priority||z.category!=="all"&&s.category!==z.category||z.status!=="all"&&s.status!==z.status)),t=e.reduce((s,a)=>s+a.scoreGain,0),i=[...new Set(xe.map(s=>s.category))];return`
  ...
  `}function cn(){(!ci||He.length===0)&&(He=[{role:"ai",text:`**M365 Security Copilot** — I have full context of your security posture across all 15 data sources.

Current tenant: **${m.tenantDomain}** · Secure Score: **64/95** · ${G.filter(t=>t.status!=="resolved").length} active incidents

Ask me anything about your security posture, specific risks, or recommended actions.`}],ci=!0);const e=["Show me all high-risk users","Why did Secure Score drop this week?","Which Teams have external guests?","Top 10 security improvements","Which devices are vulnerable to ransomware?","Summarize today's security posture","Email security status","MFA coverage and gaps","Conditional Access coverage","Guest user governance"];return`
  ...
  `}function pn(){return`
    ...
    ${[...new Set(di.map(t=>t.category))].map(t=>`
      <div class="card mb-3" style="padding:0;overflow:hidden">
        ...
        <table>
          ...
          <tbody>
            ${di.filter(i=>i.category===t).map(i=>`
              <tr>
  ...
  `}function un(e){var a,n,r,o,l;const t=e.querySelector("#sec-content");if(!t)return;t.querySelectorAll("[data-trend]").forEach(c=>{c.addEventListener("click",()=>{dt=c.dataset.trend,ce(e)})}),t.querySelectorAll("[data-goto]").forEach(c=>{c.addEventListener("click",()=>{const p={identity:"identity",email:"email",endpoint:"endpoint",teams:"teams",sharepoint:"sharepoint",data:"dataprotection",privaccess:"privaccess",guests:"guests"}[c.dataset.goto];p&&(De=p,ce(e))})}),(a=t.querySelector("#exec-view-incidents"))==null||a.addEventListener("click",()=>{De="incidents",ce(e)}),(n=t.querySelector("#exec-view-recs"))==null||n.addEventListener("click",()=>{De="recommendations",ce(e)}),(r=t.querySelector("#rec-priority"))==null||r.addEventListener("change",c=>{z.priority=c.target.value,ce(e)}),(o=t.querySelector("#rec-category"))==null||o.addEventListener("change",c=>{z.category=c.target.value,ce(e)}),(l=t.querySelector("#rec-status"))==null||l.addEventListener("change",c=>{z.status=c.target.value,ce(e)});const i=t.querySelector("#sec-cop-send"),s=t.querySelector("#sec-cop-input");i&&s&&(i.addEventListener("click",()=>$t(e,s)),s.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),$t(e,s))})),t.querySelectorAll(".sec-cop-pill").forEach(c=>{c.addEventListener("click",()=>{const d=t.querySelector("#sec-cop-input");d&&(d.value=c.dataset.q,$t(e,d))})}),t.querySelectorAll(".api-copy").forEach(c=>{c.addEventListener("click",()=>{navigator.clipboard.writeText(c.dataset.code),u("Endpoint copied to clipboard.","success")})})}function $t(e,t){const i=t.value.trim();if(!i)return;He.push({role:"user",text:i}),t.value="";const s=e.querySelector("#sec-copilot-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,s.scrollTop=s.scrollHeight),setTimeout(()=>{const a=i.toLowerCase(),n=_a.find(o=>o.keywords.some(l=>a.includes(l))),r=(n==null?void 0:n.response)||`Analysing your query across all 15 security data sources...
...
Current status: Secure Score 64/95 · ${G.filter(o=>o.status!=="resolved").length} active incidents · ${R.highRiskUsers} high-risk users.`;He.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        <div class="chat-sender"><i class="ti ti-shield-check" style="color:var(--clr-info-text)"></i> Security Copilot</div>
        <div class="chat-bubble">${ns(r)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function ns(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"<br><br>").replace(/\n/g,"<br>").replace(/\|(.+)\|\n\|[-|: ]+\|\n/g,"").replace(/\|(.+)\|/g,t=>`<span style="display:flex;gap:16px;font-size:11px;padding:2px 0">${t.split("|").filter(s=>s.trim()).map(s=>`<span>${s.trim()}</span>`).join("")}</span>`)}function vn(e){const t={overallScore:78,categoryScores:{identity:82,data:75,devices:72,apps:76,infrastructure:79}},i=Ha.slice(0,5);e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#security-content");ui(s,t,i),e.querySelectorAll("#sec-tabs .tab-btn").forEach(a=>{a.addEventListener("click",()=>{e.querySelectorAll("#sec-tabs .tab-btn").forEach(r=>r.classList.remove("active")),a.classList.add("active");const n=a.dataset.section;n==="executive"?ui(s,t,i):n==="securescore"?gn(s,t):n==="identity"?mn(s):n==="incidents"&&yn(s,i)})})}function ui(e,t,i){e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function se(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
  ...
  `;const r=e.querySelector("#demo-content");vi(r),e.querySelectorAll(".tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".tabs .tab-btn").forEach(d=>d.classList.remove("active")),l.classList.add("active");const c=l.dataset.section;c==="alerts"?vi(r):c==="correlations"&&Mn(r)})}),(o=e.querySelector("#tg-refresh"))==null||o.addEventListener("click",()=>{const l=e.querySelector("#tg-refresh");l.innerHTML='<span class="spinner dark"></span> Refreshing...',l.disabled=!0,setTimeout(()=>{l.innerHTML='<i class="ti ti-refresh"></i> Refresh',l.disabled=!1},2e3)})}function vi(e){e.innerHTML=`
    <div class="card">
      <div class="card-header">
        <span class="card-title">Security Alerts</span>
        <span class="badge danger">${le.length} alerts</span>
      </div>
      <table style="width:100%">
        <thead style="background:var(--color-background-secondary)">
          <tr>
        ...
        <tbody>
          ${le.map((t,i)=>`
            <tr style="border-bottom:${i<le.length-1?"0.5px solid var(--color-border-tertiary)":"none"}">
  ...
  `}function Tn(e){var r;const t=document.getElementById("page-tenantguard");if(!t)return;const i=e.critical||0,s=e.high||0;e.medium;const a=e.total||0,n=ue.length;t.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-alert-triangle"></i> TenantGuard Alert Center</div>
        <div class="page-subtitle">Real-time alerts, correlations & attack pattern detection · ${a} alerts · ${n} correlations</div>
    ...
    <div class="tabs" id="tg-main-tabs">
      ${$n.map(o=>`
        <button class="tab-btn ${Q===o.id?"active":""}" data-section="${o.id}">
    ...
    <div id="tg-content" style="margin-top:16px">
      ${Q==="alerts"?qt():Q==="correlations"?gi():Q==="patterns"?mi():Ln()}
    </div>
  `,t.querySelectorAll("[data-section]").forEach(o=>{o.addEventListener("click",()=>{Q=o.dataset.section,oe="all";const l=t.querySelector("#tg-content");l&&(l.innerHTML=Q==="alerts"?qt():Q==="correlations"?gi():mi(),Q==="alerts"&&zt(t)),t.querySelectorAll("[data-section]").forEach(c=>c.classList.remove("active")),o.classList.add("active")})}),(r=t.querySelector("#tg-refresh"))==null||r.addEventListener("click",async()=>{const o=t.querySelector("#tg-refresh"),l=o.innerHTML;o.innerHTML='<span class="spinner dark"></span> Scanning...',o.disabled=!0,await Ze(),o.innerHTML=l,o.disabled=!1}),Q==="alerts"&&zt(t)}function qt(){return`
    <!-- Severity Tabs -->
    <div class="tabs" id="tg-severity-tabs">
      ${Sn.map(e=>`
        <button class="tab-btn ${oe===e.id?"active":""}" data-severity="${e.id}">
          <i class="ti ${e.icon}"></i><span>${e.label}</span>
        </button>
      `).join("")}
    </div>
    <div id="tg-alerts-list" style="margin-top:12px">${ls()}</div>
  `}function gi(){return ue.length===0?`
  ...
  `).join("")}function mi(){return'<div style="padding:20px;text-align:center"><div class="spinner"></div><p style="color:var(--color-text-secondary)">Loading patterns...</p></div>'}function Ln(){return Me?os():`
    <div class="card mb-3">
      <div class="card-header">
      ...
      <div style="padding:16px;color:var(--color-text-secondary);text-align:center">
        ...
        <div style="margin-top:20px;border-top:0.5px solid var(--color-border-tertiary);padding-top:16px">
          ...
          ${ue.slice(0,3).map(e=>`
            <button class="btn" style="width:100%;margin-bottom:8px;justify-content:flex-start" onclick="startCorrInvestigation('${e.id}', '${_(e.description)}')">
              <i class="ti ti-link"></i>
              <span style="text-align:left;flex:1">${_(e.description.substring(0,50))}...</span>
              <span class="badge ${Qe(e.risk_level)}">${e.risk_level}</span>
            </button>
          `).join("")}
        </div>
  ...
  `}function os(){return`
    <div class="card mb-3">
      <div class="card-header">
        <span class="card-title"><i class="ti ti-robot"></i> ${_(Me.title)}</span>
  ...
  `}function ls(){const e=oe==="all"?le:le.filter(t=>t.severity===oe);return e.length===0?`
      <div style="text-align:center;padding:40px 20px;color:var(--color-text-secondary)">
        <div style="font-size:48px;margin-bottom:12px;opacity:0.5">✓</div>
        <div style="font-weight:600;font-size:14px;margin-bottom:4px">All clear</div>
        <div style="font-size:12px">
          ${oe==="all"?"No active alerts. Your tenant is secure.":`No ${oe.toLowerCase()} severity alerts.`}
        </div>
      </div>
    `:e.map(t=>`
    <div class="tenantguard-alert-card ${t.severity.toLowerCase()}" data-alert-id="${t.id}">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px">
        <div style="flex:1">
          ...
          <div style="font-size:10px;color:var(--color-text-tertiary);display:flex;gap:12px;flex-wrap:wrap">
            <span><i class="ti ti-user" style="font-size:10px;vertical-align:baseline"></i> ${_(t.actor||"System")}</span>
            <span><i class="ti ti-clock" style="font-size:10px;vertical-align:baseline"></i> ${Nt(t.action_timestamp)}</span>
  ...
  `).join("")}function zt(e){const t=e.querySelector("#tg-severity-tabs");t&&t.querySelectorAll(".tab-btn").forEach(i=>{i.addEventListener("click",()=>{oe=i.dataset.severity,t.querySelectorAll(".tab-btn").forEach(a=>a.classList.remove("active")),i.classList.add("active");const s=e.querySelector("#tg-alerts-list");s&&(s.innerHTML=ls()),yi(e)})}),yi(e)}function yi(e){e.querySelectorAll(".tg-details-btn").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation(),ds(i.target.closest("button").dataset.alertId)})}),e.querySelectorAll(".tg-dismiss-btn").forEach(t=>{t.addEventListener("click",async i=>{i.stopPropagation();const s=i.target.closest("button").dataset.alertId;try{await rs(s,"Dismissed from dashboard"),u("Alert dismissed","success"),await Ze()}catch{u("Failed to dismiss alert","error")}})})}function ds(e){const t=le.find(r=>r.id===e);if(!t)return;const i=document.getElementById("tg-content");if(!i)return;let s=[],a={};try{s=JSON.parse(t.recommendations||"[]"),a=JSON.parse(t.risk_assessment||"{}")}catch{}i.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
        <div>
          <div class="card-title">${_(t.headline)}</div>
          <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">
            Score: ${t.score}/100 · ${Nt(t.action_timestamp)}
          </div>
        </div>
      ...
      <div style="margin-bottom:16px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;font-size:11px">
          <div>
            ...
            <div style="font-weight:700;font-size:14px;color:${qn(a.severity||t.severity)}">${a.score||t.score}/100</div>
          </div>
          <div>
          ...
          ${Object.entries(a.levels||{}).map(([r,o])=>`
            <div>
              <div style="color:var(--color-text-tertiary)">${In(r)}</div>
  ...
  `;const n=oe==="all"?le.filter(r=>r.id!==e):le.filter(r=>r.severity===oe&&r.id!==e);if(n.length>0){const r=`
        ...
        ${n.map(l=>`
          <div class="tenantguard-alert-card ${l.severity.toLowerCase()}" style="cursor:pointer" onclick="showAlertDetailsFromDetail('${l.id}')">
            <div style="display:flex;justify-content:space-between;align-items:flex-start">
              <div style="flex:1">
                <div style="font-weight:600;font-size:12px">${_(l.headline)}</div>
                <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">${Nt(l.action_timestamp)}</div>
              </div>
              <span class="badge ${Qe(l.severity)}">${l.severity}</span>
            </div>
          </div>
        `).join("")}
      </div>
    `,o=i.querySelector("#other-alerts");o&&(o.innerHTML=r)}else{const r=i.querySelector("#other-alerts");r&&(r.style.display="none")}}window.dismissAndRefreshDetail=async function(e){try{await rs(e),u("Alert dismissed","success"),await Ze()}catch{u("Failed to dismiss alert","error")}};window.showAlertDetailsFromDetail=function(e){ds(e)};window.startCorrInvestigation=async function(e,t){try{Q="investigation",Me=await xn(null,e,t);const i=document.getElementById("page-tenantguard");if(i){const s=i.querySelector("#tg-content");s&&(s.innerHTML=os(),Rn(i),Dn())}}catch(i){u("Failed to start investigation: "+i.message,"error")}};window.closeInvestigation=function(){Me=null,Q="alerts";const e=document.getElementById("page-tenantguard");if(e){const t=e.querySelector("#tg-content");t&&(t.innerHTML=qt(),zt(e))}};async function Rn(e){const t=e.querySelector("#investigation-send"),i=e.querySelector("#investigation-input"),s=e.querySelector("#investigation-report");t&&i&&(t.addEventListener("click",fi),i.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),fi())})),s&&s.addEventListener("click",async()=>{try{s.disabled=!0,s.innerHTML='<span class="spinner dark"></span>';const a=await An(Me.id);u("Report generated! Downloading...","success"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}catch(a){u("Failed to generate report: "+a.message,"error"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}})}async function fi(){const e=document.getElementById("page-tenantguard"),t=e==null?void 0:e.querySelector("#investigation-input");if(!t)return;const i=t.value.trim();if(i)try{t.value="",t.disabled=!0;const s=e.querySelector("#investigation-messages");s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight);const a=await kn(Me.id,i);s&&(s.innerHTML+=`
        <div style="margin-bottom:8px">
          <div style="display:inline-block;max-width:70%;background:var(--color-background-secondary);padding:8px 12px;border-radius:4px;font-size:12px;border:0.5px solid var(--color-border-secondary);color:var(--color-text-secondary)">
            ${_(a.response).replace(/\n/g,"<br>")}
          </div>
        </div>
      `,s.scrollTop=s.scrollHeight),t.disabled=!1,t.focus()}catch(s){u("Failed to send message: "+s.message,"error");const a=e==null?void 0:e.querySelector("#investigation-input");a&&(a.disabled=!1)}}async function Dn(){try{const e=await wn(Me.id),t=document.querySelector("#investigation-messages");t&&e.messages&&(t.innerHTML=e.messages.map(i=>`
  ...
  `;let t=[],i=null;const s=e.querySelector("#user-search"),a=e.querySelector("#user-dropdown"),n=e.querySelector("#days-back");e.querySelector("#custom-date");const r=e.querySelector("#investigate-btn");o();async function o(){try{t=(await Nn()).data||[]}catch(l){console.error("Failed to load users:",l),u("Failed to load user list","error")}}s.addEventListener("input",l=>{const c=l.target.value.toLowerCase();if(!c){a.style.display="none";return}const d=t.filter(p=>p.displayName.toLowerCase().includes(c)||p.mail.toLowerCase().includes(c));a.innerHTML=d.map(p=>`
    ...
    `).join(""),d.forEach(p=>{const v=a.querySelector(`[data-id="${p.id}"]`);v==null||v.addEventListener("click",()=>{i=p.id,s.value=p.displayName,a.style.display="none",r.disabled=!1})}),a.style.display=d.length>0?"block":"none"}),r.addEventListener("click",async()=>{if(!i){u("Please select a user","warning");return}const l=parseInt(n.value),c=new Date,d=new Date(c);d.setDate(d.getDate()-l),Ct(e,!0);try{const p=await Gn(i,d.toISOString().split("T")[0],c.toISOString().split("T")[0]);Fn(e,p.data),Ct(e,!1)}catch(p){console.error("Investigation error:",p),u("Failed to load investigation data","error"),Ct(e,!1)}}),document.addEventListener("click",l=>{!s.contains(l.target)&&!a.contains(l.target)&&(a.style.display="none")})}function Ct(e,t){e.querySelector("#loading-state").style.display=t?"block":"none",e.querySelector("#investigation-results").style.display=t?"none":"block",e.querySelector("#empty-state").style.display="none"}function Fn(e,t){const{user:i,applicationAccess:s,signInLogs:a,auditLogs:n,actionsOnOtherAccounts:r,timeline:o,summary:l}=t,c=`
    <div class="info-card">
    ...
    <div class="info-card">
      ...
      <div style="display:flex;align-items:center;gap:8px">
        ...
        <div style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${hi(i.riskLevel).bg};color:${hi(i.riskLevel).text}">${i.riskLevel}</div>
      </div>
    </div>
    ...
    <div class="info-card">
      ...
      <div style="color:var(--color-text-secondary);font-size:11px;margin-top:4px">${Bn(i.lastActive)}</div>
    </div>
        ...
        <tbody>
          ${s.map(y=>`
            <tr>
              ...
              <td>
                <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${bi(y.status).bg};color:${bi(y.status).text}">
                  ${y.status}
                </span>
              </td>
        ...
        <tbody>
          ${n.map(y=>`
            <tr>
              ...
              <td>
                <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${de(y.severity).bg};color:${de(y.severity).text}">
                  ${y.severity}
                </span>
              </td>
            </tr>
  ...
  `;e.querySelector("#audit-logs-section").innerHTML=f;const b=`
    <div style="display:flex;flex-direction:column;gap:8px">
      ${r.map(y=>`
        <div style="padding:12px;background:var(--color-background-secondary);border-radius:6px;border-left:3px solid ${de(y.severity).border}">
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${de(y.severity).bg};color:${de(y.severity).text};margin-left:12px">
              ${y.severity}
            </span>
          </div>
        </div>
      ...
      ${o.map((y,w)=>`
        <div style="display:flex;gap:16px;margin-bottom:24px;position:relative">
          <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
            <div style="width:12px;height:12px;border-radius:50%;background:${de(y.severity).bg};border:2px solid ${de(y.severity).border}"></div>
          ...
          <div style="flex:1;padding-top:2px">
            <div style="display:flex;justify-content:space-between;align-items:start;gap:12px">
              ...
              <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${de(y.severity).bg};color:${de(y.severity).text};white-space:nowrap">
                ${y.severity}
              </span>
            </div>
          </div>
  ...
  `}function xi(e,t){let i=t.flatMap(d=>d.controls),s=i.filter(d=>d.status==="pass").length,a=i.filter(d=>d.status==="warn").length,n=i.filter(d=>d.status==="fail").length;const r=i.length,o=(s/r*100).toFixed(0),l=(a/r*100).toFixed(0),c=(n/r*100).toFixed(0);e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-lock-check"></i> Zero Trust Compliance</div>
  ...
  `;const s=e.querySelector("#cfg-topic-grid");Zt.forEach(a=>{const n=Qt(a),r=Xe(n.score),o=document.createElement("div");o.className="cfg-topic-card";const l=ps[a.id]||{bg:"#f0f0f0",color:"#555"};o.innerHTML=`
    ...
    `,o.addEventListener("click",()=>{At=a,kt="topic",gs(e,a)}),s.appendChild(o)}),e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const a=e.querySelector("#cfg-scan-now");a.innerHTML='<span class="spinner dark"></span> Scanning...',a.disabled=!0,setTimeout(()=>{a.innerHTML='<i class="ti ti-refresh"></i> Run scan now',a.disabled=!1,u("CIS Benchmark scan complete — see results above","success")},2e3)})}function gs(e,t){const i=Qt(t),s=Xe(i.score);e.innerHTML=`
    <div class="page-header">
      <div>
        ...
        <tbody>
          ${n.controls.map(o=>`
            <tr style="border-bottom:0.5px solid var(--color-border-tertiary)">
              ...
              <td style="padding:10px 12px;font-size:10px">${Yn(Xt(o))}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,a.appendChild(r)}),e.querySelector("#cfg-back").addEventListener("click",()=>{kt="main",At=null,vs()})}async function ei(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const s=await aa();if(!s.success||!s.data||s.data.length===0){wi(e);return}const a=us(),n=Xe(a.score);e.innerHTML=`
      <div class="page-header">
        <div>
          <div class="page-title"><i class="ti ti-settings-2"></i> M365 Config — CIS Benchmark v7.0.0</div>
      ...
      <div style="font-size:11px;font-weight:600;color:var(--color-text-secondary);margin-bottom:10px;text-transform:uppercase;letter-spacing:0.5px">Topics</div>
      <div class="cfg-topic-grid" id="cfg-topic-grid"></div>
    `;const r=e.querySelector("#cfg-topic-grid");Zt.forEach(o=>{const l=Qt(o),c=Xe(l.score),d=document.createElement("div");d.className="cfg-topic-card";const p=ps[o.id]||{bg:"#f0f0f0",color:"#555"};d.innerHTML=`
      ...
      `,d.addEventListener("click",()=>{At=o,kt="topic",gs(e,o)}),r.appendChild(d)}),(t=e.querySelector("#cfg-scan-now"))==null||t.addEventListener("click",async()=>{const o=e.querySelector("#cfg-scan-now");o.innerHTML='<span class="spinner dark"></span> Scanning...',o.disabled=!0,setTimeout(async()=>{o.innerHTML='<i class="ti ti-refresh"></i> Re-scan',o.disabled=!1,await ei(e),u("Configuration scan completed","success")},2e3)}),(i=e.querySelector("#cfg-agent-btn"))==null||i.addEventListener("click",()=>{u("Configuration Agent will help remediate failed controls","info")})}catch(s){console.error("Error loading CIS controls:",s),wi(e)}}function wi(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-settings-2"></i> M365 Config — CIS Benchmark</div>
  ...
  `,e.querySelector("#cfg-scan-now").addEventListener("click",async()=>{const t=e.querySelector("#cfg-scan-now");t.innerHTML='<span class="spinner dark"></span> Scanning...',t.disabled=!0,setTimeout(async()=>{t.innerHTML='<i class="ti ti-refresh"></i> Run scan',t.disabled=!1,await ei(e)},2e3)})}const Gt=[{id:"pg1",name:"Global Administrators",roles:["Global Admin"],members:2,pim:!0,pimType:"Eligible",lastActivity:"2 hours ago",ml:["aisha.raza@contoso.com","chen.wei@contoso.com"]},{id:"pg2",name:"Security Admins",roles:["Security Admin"],members:2,pim:!0,pimType:"Eligible",lastActivity:"1 day ago",ml:["aisha.raza@contoso.com","sam.torres@contoso.com"]},{id:"pg3",name:"Exchange Admins",roles:["Exchange Admin"],members:2,pim:!0,pimType:"Active",lastActivity:"3 days ago",ml:["chen.wei@contoso.com","kevin.osei@contoso.com"]},{id:"pg4",name:"SharePoint Admins",roles:["SharePoint Admin"],members:1,pim:!1,pimType:null,lastActivity:"5 days ago",ml:["james.liu@contoso.com"]},{id:"pg5",name:"Teams Admins",roles:["Teams Admin"],members:1,pim:!1,pimType:null,lastActivity:"1 week ago",ml:["nina.patel@contoso.com"]},{id:"pg6",name:"Helpdesk Admins",roles:["Helpdesk Admin","User Admin"],members:2,pim:!1,pimType:null,lastActivity:"1 day ago",ml:["raj.mehta@contoso.com","sara.ogden@contoso.com"]},{id:"pg7",name:"Compliance Admins",roles:["Compliance Admin"],members:1,pim:!0,pimType:"Eligible",lastActivity:"4 days ago",ml:["sam.torres@contoso.com"]},{id:"pg8",name:"Break Glass Accounts",roles:["Global Admin"],members:2,pim:!0,pimType:"Active",lastActivity:"30 days ago",ml:["aisha.raza@contoso.com","backup.admin@contoso.com"]}];let ms=[],Te=[],Z={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0};async function Qn(){var t;const e=document.getElementById("page-privaccts");if(e){if(K()){console.log("🎭 Demo account detected - showing demo privileged accounts"),Xn(e);return}try{console.log("📡 Fetching real privileged accounts from Azure AD...");const i=await da();i.success&&((t=i.data)!=null&&t.accounts)?(Te=i.data.accounts,Z=i.data.summary,console.log(`✅ Loaded ${Te.length} real privileged accounts`)):(console.warn("⚠️ No privileged account data available from API"),Te=[],Z={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0})}catch(i){console.error("❌ Error loading privileged accounts:",i.message),Te=[],Z={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0}}e.innerHTML=`
    ...
    ${Z.atRisk>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
        ${Z.atRisk} privileged account${Z.atRisk>1?"s":""} have active risk detection${Z.atRisk>1?"s":""}.
      </div>
    `:""}

    <div class="kpi-row">
      <div class="kpi-tile"><div class="kpi-value info">${Z.totalAccounts}</div><div class="kpi-label">Accounts</div></div>
      <div class="kpi-tile"><div class="kpi-value ${Z.atRisk>0?"danger":"success"}">${Z.atRisk}</div><div class="kpi-label">At Risk</div></div>
      <div class="kpi-tile"><div class="kpi-value info">${Z.noMFA}</div><div class="kpi-label">No MFA</div></div>
      <div class="kpi-tile"><div class="kpi-value info">0</div><div class="kpi-label">Groups</div></div>
      <div class="kpi-tile"><div class="kpi-value warning">${Z.permanentRoles}</div><div class="kpi-label">Permanent</div></div>
    </div>
        ...
        <tbody>
          ${t.map((s,a)=>`
            <tr style="border-bottom:${a<t.length-1?"0.5px solid var(--color-border-tertiary)":"none"}">
              ...
              <td style="padding:10px 12px;font-size:10px">${fs(s.role)}</td>
              <td style="padding:10px 12px;font-size:10px">${ys(s.mfa)}</td>
  ...
  `}function sr(e){var a,n;const t=e.querySelector("#pa-tab-accounts"),i="pa-acct-search";let s=`
  ...
  `;t.innerHTML=s,bs(t),(a=t.querySelector(`#${i}`))==null||a.addEventListener("input",r=>{var c;const o=r.target.value.toLowerCase(),l=((c=t.querySelector("#pa-risk-filter"))==null?void 0:c.value)||"all";Ai(t,o,l)}),(n=t.querySelector("#pa-risk-filter"))==null||n.addEventListener("change",r=>{var l;const o=((l=t.querySelector(`#${i}`))==null?void 0:l.value.toLowerCase())||"";Ai(t,o,r.target.value)})}function Ai(e,t,i){const s=e.querySelector("#pa-acct-tbody");s&&(s.innerHTML=Te.filter(a=>{const n=!t||a.upn.toLowerCase().includes(t)||a.name.toLowerCase().includes(t),r=i==="all"||a.risk===i;return n&&r}).map(a=>hs(a)).join(""),bs(e))}function hs(e){return`
    <tr class="pa-acct-row" data-id="${e.id}">
      ...
      <td><div class="pill-group">${e.roles.map(fs).join("")}</div></td>
      <td><div class="pill-group">${ys(e.mfa)}</div></td>
      <td>${ki(e.risk)}</td>
        ...
        <div class="pa-expand-panel" style="display:block">
          <div class="grid-2" style="gap:16px">
            ...
            <div>
              ...
              <div style="margin-top:8px">Risk level: ${ki(e.risk)}</div>
            </div>
          </div>
  ...
  `}function bs(e){e.querySelectorAll(".pa-acct-expand").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const a=t.closest(".pa-acct-row").dataset.id,n=e.querySelector(`.pa-acct-expand-row[data-id="${a}"]`),r=n.style.display!=="none";n.style.display=r?"none":"table-row",t.classList.toggle("open",!r)})}),e.querySelectorAll(".pa-action").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const{action:s,id:a}=t.dataset,n=PA_ACCOUNTS.find(r=>r.id===a);s==="pwd-reset"?(u(`Password reset initiated for ${n==null?void 0:n.name}.`,"warning"),Le("risk",`Password reset forced for ${n==null?void 0:n.upn}`,"Admin")):s==="convert-pim"?(u(`${n==null?void 0:n.name} converted to PIM eligible assignment.`,"success"),Le("add",`${n==null?void 0:n.upn} converted to PIM eligible`,"Admin")):s==="mfa-enroll"?(u(`MFA enrollment triggered for ${n==null?void 0:n.name}.`,"info"),Le("mfa",`MFA enrollment triggered for ${n==null?void 0:n.upn}`,"Admin")):s==="remove"&&(u(`${n==null?void 0:n.name} removed from privileged role.`,"danger"),Le("remove",`${n==null?void 0:n.upn} removed from privileged role`,"Admin"))})})}function ar(e){const t=e.querySelector("#pa-tab-groups");t.innerHTML=`
    <div class="filter-bar" style="margin-bottom:12px">
  ...
  `,$i(t),t.querySelector("#pa-grp-search").addEventListener("input",i=>{const s=i.target.value.toLowerCase();t.querySelector("#pa-grp-tbody").innerHTML=Gt.filter(a=>!s||a.name.toLowerCase().includes(s)).map(a=>Si(a)).join(""),$i(t)})}function Si(e){return`
  ...
  `}function $i(e){e.querySelectorAll(".pa-grp-expand").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,s=e.querySelector(`.pa-grp-expand-row[data-id="${i}"]`);s.style.display=s.style.display==="none"?"table-row":"none"})}),e.querySelectorAll(".pa-grp-untag").forEach(t=>{t.addEventListener("click",()=>{const i=Gt.find(s=>s.id===t.dataset.id);u(`${i==null?void 0:i.name} untagged as privileged group.`,"warning"),Le("remove",`Group "${i==null?void 0:i.name}" untagged`,"Admin")})}),e.querySelectorAll(".pa-grp-remove-member").forEach(t=>{t.addEventListener("click",()=>{u(`${t.dataset.upn} removed from group.`,"success"),Le("remove",`${t.dataset.upn} removed from group`,"Admin")})})}function nr(e){const t=e.querySelector("#pa-tab-log");xs(t)}function xs(e){e.innerHTML=`
  ...
  `}function Le(e,t,i){const s={add:"ti-user-plus",remove:"ti-user-minus",risk:"ti-alert-triangle",mfa:"ti-shield",tag:"ti-tag",review:"ti-clipboard-check"},a={add:"var(--clr-info-text)",remove:"var(--clr-warning-text)",risk:"var(--clr-danger-text)",mfa:"var(--clr-success-text)",tag:"var(--clr-info-text)",review:"var(--clr-success-text)"},n={add:"var(--clr-info-bg)",remove:"var(--clr-warning-bg)",risk:"var(--clr-danger-bg)",mfa:"var(--clr-success-bg)",tag:"var(--clr-info-bg)",review:"var(--clr-success-bg)"};ms.unshift({id:Date.now(),type:e,icls:s[e]||"ti-info-circle",ic:a[e]||"var(--clr-info-text)",bg:n[e]||"var(--clr-info-bg)",title:t,detail:t,by:i,time:"Just now"});const r=document.querySelector("#pa-tab-log");r&&xs(r)}let X=[],Ge={total:0,consumed:0,available:0,utilizationPct:0},Oe=[],Ot=[],ct={},lt="summary";const ws=[{id:"summary",label:"Executive Summary",icon:"ti-layout-dashboard"},{id:"inventory",label:"License Inventory",icon:"ti-box"},{id:"services",label:"Service Plans",icon:"ti-list-check"},{id:"assignments",label:"User Assignments",icon:"ti-users"},{id:"groups",label:"Group Licensing",icon:"ti-users-group"},{id:"compliance",label:"Compliance",icon:"ti-shield-check"}];async function ks(){const e=document.getElementById("page-licenses");if(e){if(K()){console.log("🎭 Demo account detected - showing demo license data"),rr(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading comprehensive license data...</p></div>';try{console.log("📡 Fetching comprehensive license data...");const[t,i,s,a]=await Promise.all([M("/licenses"),M("/licenses/assignments"),M("/licenses/groups"),M("/licenses/compliance")]);t.success&&t.data&&(X=t.data,Ge=t.summary||{total:0,consumed:0,available:0,utilizationPct:0}),i.success&&i.data&&(Oe=i.data),s.success&&s.data&&(Ot=s.data),a.success&&a.data&&(ct=a.data),console.log("✅ Loaded all license data")}catch(t){console.error("❌ Error loading license data:",t)}As(e)}}function rr(e){var o;const t=[{sku:"Microsoft 365 E5",total:300,consumed:285,available:15,utilizationPct:95,price:180},{sku:"Microsoft 365 E3",total:500,consumed:478,available:22,utilizationPct:95,price:20},{sku:"Microsoft 365 F1",total:150,consumed:145,available:5,utilizationPct:96,price:6},{sku:"Enterprise Mobility + Security E5",total:200,consumed:198,available:2,utilizationPct:99,price:22},{sku:"Office 365 E1",total:100,consumed:87,available:13,utilizationPct:87,price:8}],i={total:1250,consumed:1193,available:57,utilizationPct:95},s=[{name:"Priya Kumar",email:"priya@contoso.com",licenses:["Microsoft 365 E5","Enterprise Mobility + Security E5"]},{name:"Chen Wei",email:"chen@contoso.com",licenses:["Microsoft 365 E5"]},{name:"Aisha Raza",email:"aisha@contoso.com",licenses:["Microsoft 365 E5","Enterprise Mobility + Security E5"]},{name:"Sanjay Kumar",email:"sanjay@contoso.com",licenses:["Microsoft 365 E3","Office 365 E1"]},{name:"Sarah Johnson",email:"sarah@contoso.com",licenses:["Microsoft 365 E3"]}],a=[{name:"Executive Team",licenses:["Microsoft 365 E5"],users:12,utilizationPct:92},{name:"Engineering Department",licenses:["Microsoft 365 E3"],users:45,utilizationPct:98},{name:"Support Team",licenses:["Microsoft 365 F1"],users:60,utilizationPct:96}],n=[{service:"Exchange Online",status:"Licensed",users:847,entitlement:1250,compliance:"100%"},{service:"SharePoint Online",status:"Licensed",users:823,entitlement:1250,compliance:"100%"},{service:"Teams",status:"Licensed",users:812,entitlement:1250,compliance:"99%"},{service:"Microsoft Forms",status:"Licensed",users:1100,entitlement:1250,compliance:"88%"}];e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const r=e.querySelector("#tab-content");Ei(r,i,t),e.querySelectorAll(".tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".tabs .tab-btn").forEach(d=>d.classList.remove("active")),l.classList.add("active");const c=l.dataset.tab;c==="summary"?Ei(r,i,t):c==="inventory"?or(r,t):c==="services"?lr(r,n):c==="assignments"?dr(r,s):c==="groups"?cr(r,a):c==="compliance"&&pr(r,i)})}),(o=e.querySelector("#license-refresh"))==null||o.addEventListener("click",()=>{const l=e.querySelector("#license-refresh");l.innerHTML='<span class="spinner dark"></span> Syncing...',l.disabled=!0,setTimeout(()=>{l.innerHTML='<i class="ti ti-refresh"></i> Refresh',l.disabled=!1},2e3)})}function Ei(e,t,i){e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function As(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-license"></i> License Management Dashboard</div>
        <div class="page-subtitle">Enterprise-wide licensing health, utilization, and compliance</div>
    ...
    <div style="display:flex;gap:0;border-bottom:1px solid var(--color-border-secondary);margin-bottom:16px;overflow-x:auto">
      ${ws.map(s=>`
        <button class="license-tab-btn ${lt===s.id?"active":""}" data-tab="${s.id}" style="padding:12px 16px;border:none;background:none;cursor:pointer;font-size:11px;font-weight:600;color:var(--color-text-secondary);border-bottom:2px solid transparent;white-space:nowrap;${lt===s.id?"color:var(--color-text-primary);border-bottom-color:var(--clr-info-text)":""}">
  ...
  `,e.querySelectorAll(".license-tab-btn").forEach(s=>{s.addEventListener("click",()=>{lt=s.dataset.tab,As(e)})}),(t=e.querySelector("#license-refresh"))==null||t.addEventListener("click",()=>{ks()}),(i=e.querySelector("#license-export"))==null||i.addEventListener("click",()=>{alert("Export functionality coming soon")})}function ur(e){switch(e){case"summary":return vr();case"inventory":return gr();case"services":return mr();case"assignments":return yr();case"groups":return fr();case"compliance":return hr();default:return""}}function vr(){return`
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:12px;margin-bottom:24px">
      <div class="card" style="padding:16px">
        ...
        <div style="font-size:24px;font-weight:700;color:var(--clr-info-text)">${Ge.total.toLocaleString()}</div>
      </div>
      <div class="card" style="padding:16px">
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:6px">Assigned Licenses</div>
        <div style="font-size:24px;font-weight:700;color:var(--clr-warning-text)">${Ge.consumed.toLocaleString()}</div>
      </div>
      <div class="card" style="padding:16px">
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:6px">Available Licenses</div>
        <div style="font-size:24px;font-weight:700;color:var(--clr-success-text)">${Ge.available.toLocaleString()}</div>
      </div>
      <div class="card" style="padding:16px">
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:6px">Utilization Rate</div>
        <div style="font-size:24px;font-weight:700;color:var(--clr-warning-text)">${Ge.utilizationPct}%</div>
      </div>
    </div>
    ...
    <!-- Critical Alerts -->
    ${X.some(e=>e.status==="critical")?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
        <strong>${X.filter(e=>e.status==="critical").length} license(s) at CRITICAL capacity</strong> — Immediate action required
      </div>
    `:""}
    ${X.some(e=>e.status==="monitor")?`
      <div class="alert-banner warning">
        <i class="ti ti-alert-circle"></i>
        <strong>${X.filter(e=>e.status==="monitor").length} license(s) require monitoring</strong> — Plan additional purchases
      </div>
    `:""}
  `}function gr(){return`
    <div class="card" style="padding:0;overflow:hidden">
    ...
    <div class="card" style="padding:0;overflow:hidden">
      ...
      `:`
        <table style="width:100%">
          ...
          <tbody>
            ${Ot.map((t,i)=>(console.log(`📊 Group ${i}: ${t.displayName}, memberCount=${t.memberCount}, type=${typeof t.memberCount}`),`
              <tr style="border-bottom:0.5px solid var(--color-border-tertiary)">
                <td style="padding:12px">
  ...
  `}function hr(){const e=ct.scores||{utilization:0,costOptimization:0,securityCoverage:0,compliance:0};return`
      ...
      <div style="padding:12px">
        <div style="display:grid;gap:12px">
          <div style="padding:12px;background:rgba(239, 68, 68, 0.05);border-radius:6px;border-left:3px solid var(--clr-danger-text)">
            ...
            <div style="font-size:10px;color:var(--color-text-secondary);margin-top:4px">${ct.disabledUsersWithLicenses||0} users</div>
          </div>
          <div style="padding:12px;background:rgba(250, 190, 88, 0.05);border-radius:6px;border-left:3px solid var(--clr-warning-text)">
            ...
            <div style="font-size:10px;color:var(--color-text-secondary);margin-top:4px">${ct.inactiveUsers||0} users consuming licenses</div>
          </div>
  ...
  `;const t=e.querySelector("#agents-grid");Ci.forEach(i=>{const s=i.status==="active"?"active pulse":i.status==="alert"?"alert pulse":"idle",a=i.status==="active"?"var(--clr-success-text)":i.status==="alert"?"var(--clr-danger-text)":"var(--color-text-tertiary)",n=document.createElement("div");n.className="agent-card",n.innerHTML=`
  ...
  `}let Se="queue",Ut=null,we=[],vt=[],U="Submitted";async function kr(){const e=document.getElementById("page-approvals");e&&(Se="queue",U="Submitted",await et(e))}async function et(e){Se==="queue"?await Re(e):Se==="detail"&&await Ss(e)}async function Re(e){var t;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const i=await M("/self-service/requests");if(i.success)we=i.data||[],Ue(),Ar(e,i.stats||{});else throw new Error(i.error||"Failed to load requests")}catch(i){console.error("Error loading approvals:",i),u("Failed to load requests: "+i.message,"error"),e.querySelector('[class="page-header"]').insertAdjacentHTML("afterend",`
      <div class="alert-banner danger" style="margin:16px">
        <i class="ti ti-alert-triangle"></i>
        <span>${i.message}</span>
      </div>
    `)}(t=e.querySelector("#queue-refresh"))==null||t.addEventListener("click",async()=>{await Re(e)})}function Ue(){U==="all"?vt=we:vt=we.filter(e=>e.status===U)}function Ar(e,t){var n,r,o,l;const i=e.querySelector(".page-header"),s=`
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;margin:16px">
      <div class="card ${U==="Submitted"?"active":""}" style="padding:12px;text-align:center;cursor:pointer;border:1px solid ${U==="Submitted"?"var(--clr-warning-text)":"transparent"}" id="filter-submitted">
        <div style="font-size:28px;font-weight:700;color:var(--clr-warning-text)">${we.filter(c=>c.status==="Submitted").length}</div>
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">Pending</div>
      </div>
      <div class="card ${U==="Approved"?"active":""}" style="padding:12px;text-align:center;cursor:pointer;border:1px solid ${U==="Approved"?"var(--clr-success-text)":"transparent"}" id="filter-approved">
        <div style="font-size:28px;font-weight:700;color:var(--clr-success-text)">${we.filter(c=>c.status==="Approved").length}</div>
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">Approved</div>
      </div>
      <div class="card ${U==="Rejected"?"active":""}" style="padding:12px;text-align:center;cursor:pointer;border:1px solid ${U==="Rejected"?"var(--clr-danger-text)":"transparent"}" id="filter-rejected">
        <div style="font-size:28px;font-weight:700;color:var(--clr-danger-text)">${we.filter(c=>c.status==="Rejected").length}</div>
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">Rejected</div>
      </div>
      <div class="card ${U==="Completed"?"active":""}" style="padding:12px;text-align:center;cursor:pointer;border:1px solid ${U==="Completed"?"var(--clr-info-text)":"transparent"}" id="filter-completed">
        <div style="font-size:28px;font-weight:700;color:var(--clr-info-text)">${we.filter(c=>c.status==="Completed").length}</div>
    ...
    <div style="margin:16px">
      ${vt.length===0?`
        <div class="empty-state" style="padding:40px;text-align:center">
          ...
          <h3 style="color:var(--color-text-secondary)">No ${U.toLowerCase()} requests</h3>
        </div>
      `:`
        <div class="card" style="padding:0;overflow:hidden">
          <table style="width:100%">
            ...
            <tbody>
              ${vt.map(c=>{const d=c.status==="Submitted"?"var(--clr-warning-text)":c.status==="Approved"?"var(--clr-success-text)":c.status==="Rejected"?"var(--clr-danger-text)":"var(--clr-info-text)",p=new Date(c.createdDate).toLocaleString("en-GB",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"});return`
  ...
  `;i.insertAdjacentHTML("afterend",a),e.querySelectorAll(".req-row").forEach(c=>{c.addEventListener("click",async()=>{Ut=c.dataset.id,Se="detail",await et(e)})}),(n=e.querySelector("#filter-submitted"))==null||n.addEventListener("click",async()=>{U="Submitted",Ue(),await Re(e)}),(r=e.querySelector("#filter-approved"))==null||r.addEventListener("click",async()=>{U="Approved",Ue(),await Re(e)}),(o=e.querySelector("#filter-rejected"))==null||o.addEventListener("click",async()=>{U="Rejected",Ue(),await Re(e)}),(l=e.querySelector("#filter-completed"))==null||l.addEventListener("click",async()=>{U="Completed",Ue(),await Re(e)})}async function Ss(e){var t;if(!Ut){Se="queue",await et(e);return}e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const i=await M(`/self-service/requests/${Ut}`);if(i.success&&i.data)Sr(e,i.data);else throw new Error("Request not found")}catch(i){console.error("Error loading request:",i),e.querySelector('[class="page-header"]').insertAdjacentHTML("afterend",`
      <div class="alert-banner danger" style="margin:16px">
        <i class="ti ti-alert-triangle"></i>
        <span>Error: ${i.message}</span>
      </div>
    `)}(t=e.querySelector("#detail-back"))==null||t.addEventListener("click",async()=>{Se="queue",await et(e)})}function Sr(e,t){var r,o,l;const i=e.querySelector(".page-header .page-subtitle");i&&(i.textContent=`${t.requestId} • ${t.status}`);const s=t.status==="Submitted"?"var(--clr-warning-text)":t.status==="Approved"?"var(--clr-success-text)":t.status==="Rejected"?"var(--clr-danger-text)":"var(--clr-info-text)",a=new Date(t.createdDate).toLocaleString();e.querySelector(".page-header").insertAdjacentHTML("afterend",`
    <div style="margin:16px">
      <!-- Status Banner -->
  ...
  `),(r=e.querySelector("#btn-approve"))==null||r.addEventListener("click",()=>{Pi(e,t,"approve")}),(o=e.querySelector("#btn-reject"))==null||o.addEventListener("click",()=>{Pi(e,t,"reject")}),(l=e.querySelector("#detail-back"))==null||l.addEventListener("click",async()=>{Se="queue",await et(e)})}function Pi(e,t,i){const s=i==="approve",a=document.createElement("div");a.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;z-index:1000;padding:20px";const n=document.createElement("div");n.style.cssText="background:white;border-radius:8px;max-width:450px;padding:20px;box-shadow:0 10px 40px rgba(0,0,0,0.3)",n.innerHTML=`
  ...
  `,a.appendChild(n),document.body.appendChild(a),document.getElementById("modal-cancel").addEventListener("click",()=>{a.remove()}),document.getElementById("modal-confirm").addEventListener("click",async()=>{var l,c;const r=document.getElementById("modal-comment").value.trim();if(!s&&!r){u("Please provide a rejection reason","warning");return}const o=document.getElementById("modal-confirm");o.disabled=!0,o.innerHTML='<span class="spinner" style="display:inline-block;width:12px;height:12px;border:2px solid currentColor;border-radius:50%;border-right-color:transparent;animation:spin 0.6s linear infinite"></span> Processing...';try{const d=s?`/self-service/requests/${t.requestId}/approve`:`/self-service/requests/${t.requestId}/reject`,p=s?{approverId:(l=m.currentUser)==null?void 0:l.email,comment:r}:{rejectedBy:(c=m.currentUser)==null?void 0:c.email,reason:r},v=await M(d,"PUT",p);if(v.success)u(`Request ${s?"approved":"rejected"} successfully`,"success"),a.remove(),setTimeout(async()=>{await Ss(e)},500);else throw new Error(v.error||"Failed to update request")}catch(d){u("Error: "+d.message,"error"),o.disabled=!1,o.innerHTML=s?"✓ Approve":"✗ Reject"}}),setTimeout(()=>document.getElementById("modal-comment").focus(),100)}let $e="queue",re=null,je=[];async function $r(){const e=document.getElementById("page-agent");e&&($e="queue",re=null,await rt(e))}async function rt(e){$e==="queue"?await $s(e):$e==="processing"&&await Es(e)}async function $s(e){var t;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const i=await M("/self-service/requests/pending-processing");if(i.success)je=i.data||[],Er(e);else throw new Error(i.error||"Failed to load requests")}catch(i){console.error("Error loading queue:",i),u("Failed to load requests: "+i.message,"error"),e.querySelector('[class="page-header"]').insertAdjacentHTML("afterend",`
      <div class="alert-banner danger" style="margin:16px">
        <i class="ti ti-alert-triangle"></i>
        <span>${i.message}</span>
      </div>
    `)}(t=e.querySelector("#queue-refresh"))==null||t.addEventListener("click",async()=>{await $s(e)})}function Er(e){const t=e.querySelector(".page-header"),i=`
    <!-- Stats -->
  ...
  `;t.insertAdjacentHTML("afterend",i),e.querySelectorAll(".queue-row").forEach(s=>{var a;(a=s.querySelector(".process-btn"))==null||a.addEventListener("click",async n=>{n.stopPropagation(),re=s.dataset.id,je.find(r=>r.requestId===re),$e="processing",await rt(e)})})}async function Es(e){var t;if(!re){$e="queue",await rt(e);return}e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const i=await M(`/self-service/requests/${re}`);if(!i.success||!i.data)throw new Error("Request details not found");const s=i.data,a=e.querySelector("#proc-subtitle");a&&(a.textContent=`${s.requestId} • ${s.service} / ${s.operation}`);const n=[{step:"Validating request...",delay:1e3},{step:"Connecting to Graph API...",delay:2e3},{step:`Creating ${s.service} resource...`,delay:3e3},{step:"Configuring permissions...",delay:2e3},{step:"Finalizing provisioning...",delay:1e3}];let r=0;for(const{step:l,delay:c}of n)await new Promise(d=>setTimeout(()=>{const p=e.querySelector("#proc-message");p&&(p.textContent=l),d()},r)),r+=c;const o=await M(`/self-service/requests/${re}/process`,"POST",{agentId:((t=m.currentUser)==null?void 0:t.email)||"agent@system"});o.success?Cr(e,o.data):Mi(e,o.error,re)}catch(i){console.error("Processing error:",i),Mi(e,i.message,re)}}function Cr(e,t){var s,a,n;const i=t.resource||{};e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,(s=e.querySelector("#proc-back-btn"))==null||s.addEventListener("click",gt),(a=e.querySelector("#proc-back-btn2"))==null||a.addEventListener("click",gt),(n=e.querySelector("#proc-continue"))==null||n.addEventListener("click",async()=>{$e="queue",re=null,await rt(e)}),u("Request processed successfully!","success")}function Mi(e,t,i){var s,a,n;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,(s=e.querySelector("#proc-back-btn"))==null||s.addEventListener("click",gt),(a=e.querySelector("#proc-back-btn2"))==null||a.addEventListener("click",gt),(n=e.querySelector("#proc-retry"))==null||n.addEventListener("click",async()=>{await Es(e)}),u("Provisioning failed: "+t,"error")}function gt(){const e=document.getElementById("page-agent");$e="queue",re=null,rt(e)}const jt=[{id:"submit",label:"Request Submitted",icon:"ti-send",color:"info"},{id:"manager",label:"Manager Approval",icon:"ti-user-check",color:"warning"},{id:"dataowner",label:"Data Owner Approval",icon:"ti-shield-check",color:"purple"},{id:"it",label:"IT Review",icon:"ti-settings",color:"warning"},{id:"agent",label:"AI Agent Validation",icon:"ti-robot",color:"teal"},{id:"action",label:"System Provisioning",icon:"ti-api",color:"info"},{id:"done",label:"Completion",icon:"ti-circle-check",color:"success"}],mt=[{id:"exchange",name:"Exchange Online",icon:"ti-mail",color:"#854F0B",bg:"#FAEEDA",desc:"Groups, shared mailboxes, room resources, and email settings",badge:"4 services"},{id:"teams",name:"Microsoft Teams",icon:"ti-brand-teams",color:"#3C3489",bg:"#EEEDFE",desc:"Create teams, manage members, channels, and guest access",badge:"5 actions"},{id:"sharepoint",name:"SharePoint Services",icon:"ti-brand-sharepoint",color:"#3B6D11",bg:"#EAF3DE",desc:"Sites, permissions, external sharing, and storage management",badge:"6 actions"},{id:"onedrive",name:"OneDrive Administration",icon:"ti-cloud",color:"#0C447C",bg:"#E6F1FB",desc:"Storage increases and former employee OneDrive access",badge:"2 actions"},{id:"ext-sharing",name:"External Sharing",icon:"ti-world",color:"#791F1F",bg:"#FCEBEB",desc:"Invite, extend, or remove external guest access",badge:"4 actions"},{id:"user-access",name:"User Access Management",icon:"ti-lock-access",color:"#185FA5",bg:"#E6F1FB",desc:"Request access to mailboxes, Teams, SharePoint and groups",badge:"5 actions"},{id:"licenses",name:"License Management",icon:"ti-license",color:"#854F0B",bg:"#FAEEDA",desc:"Request Microsoft 365, Power BI, Visio, Project licenses",badge:"6 licenses"},{id:"copilot",name:"Microsoft Copilot",icon:"ti-sparkles",color:"#3C3489",bg:"#EEEDFE",desc:"Request or remove Microsoft 365 Copilot licenses",badge:"2 actions"},{id:"power-platform",name:"Power Platform",icon:"ti-bolt",color:"#3B6D11",bg:"#EAF3DE",desc:"Environments, premium connectors, DLP exceptions",badge:"4 actions"},{id:"intune",name:"Intune Services",icon:"ti-device-laptop",color:"#0C447C",bg:"#E6F1FB",desc:"Device retirement, wipe, and compliance exceptions",badge:"3 actions"},{id:"guest-lifecycle",name:"Guest User Lifecycle",icon:"ti-user-plus",color:"#633806",bg:"#FAEEDA",desc:"Invite guests, extend or remove access, quarterly reviews",badge:"4 actions"}],Ie=[{id:"exchange-groups",name:"Distribution & Security Groups",icon:"ti-users-group",desc:"M365 Groups, Distribution Groups, Security Groups"},{id:"shared-mailbox",name:"Shared Mailboxes",icon:"ti-mailbox",desc:"Create, delete, and manage shared mailbox permissions"},{id:"room-equipment",name:"Room & Equipment Mailboxes",icon:"ti-building",desc:"Meeting rooms, equipment resources, booking policies"},{id:"email-services",name:"Email Services",icon:"ti-mail-forward",desc:"SMTP addresses, mail forwarding, auto-reply configuration"}],Pr={"exchange-groups":{parentGroup:"exchange",operations:[{id:"create-m365-group",group:"Microsoft 365 Groups",label:"Create M365 Group",approvalPath:["manager","it"],agentChecks:["Check for duplicate group names","Suggest existing groups with similar purpose","Validate naming convention","Verify requestor eligibility"],systemAction:"POST /v1.0/groups (groupTypes: Unified)",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. Marketing EMEA"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"marketing-emea",hint:"@contoso.com appended automatically"},{id:"privacy",label:"Privacy",type:"select",required:!0,options:["Private","Public"]},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"user1@contoso.com, user2@contoso.com",hint:"Comma-separated UPNs"},{id:"description",label:"Group Description",type:"textarea",required:!1,placeholder:"Purpose of this group..."},{id:"justification",label:"Business Justification",type:"textarea",required:!0,placeholder:"Why is this group needed?"}]},{id:"add-m365-members",group:"Microsoft 365 Groups",label:"Add Members to M365 Group",approvalPath:["manager"],agentChecks:["Verify group exists","Check member licensing","Validate UPNs"],systemAction:"POST /v1.0/groups/{id}/members/$ref",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0,placeholder:"marketing-emea@contoso.com"},{id:"members",label:"Members to Add",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0,placeholder:"Why do these users need to join?"}]},{id:"remove-m365-members",group:"Microsoft 365 Groups",label:"Remove Members from M365 Group",approvalPath:["manager"],agentChecks:["Verify group membership","Check if member is owner"],systemAction:"DELETE /v1.0/groups/{id}/members/{userId}/$ref",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0,placeholder:"marketing-emea@contoso.com"},{id:"members",label:"Members to Remove",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"archive-m365-group",group:"Microsoft 365 Groups",label:"Archive M365 Group",approvalPath:["manager","it"],agentChecks:["Check last activity date","Identify active owners","Verify no active workflows depend on group"],systemAction:"PATCH /v1.0/groups/{id} (visibility: archived)",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0},{id:"archiveDate",label:"Archive By Date",type:"date",required:!1},{id:"dataRetention",label:"Data Retention Period",type:"select",required:!0,options:["30 days","90 days","180 days","1 year","Indefinite"]},{id:"justification",label:"Reason for Archiving",type:"textarea",required:!0}]},{id:"create-dg",group:"Distribution Groups",label:"Create Distribution Group",approvalPath:["manager"],agentChecks:["Duplicate DG check","Naming convention validation","Suggest existing DGs"],systemAction:"New-DistributionGroup via Exchange PowerShell",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. All Staff UK"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"all-staff-uk"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"managedBy",label:"Managed By (Owner)",type:"text",required:!1,placeholder:"UPN of owner"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"modify-dg",group:"Distribution Groups",label:"Rename / Modify Distribution Group",approvalPath:["manager"],agentChecks:["Verify group ownership","Check for email references to current name"],systemAction:"Set-DistributionGroup via Exchange PowerShell",fields:[{id:"currentName",label:"Current Group Name",type:"text",required:!0},{id:"newName",label:"New Display Name",type:"text",required:!1,placeholder:"Leave blank if not changing"},{id:"newAlias",label:"New Email Alias",type:"text",required:!1,placeholder:"Leave blank if not changing"},{id:"changeOwner",label:"New Owner UPN",type:"text",required:!1},{id:"justification",label:"Reason for Change",type:"textarea",required:!0}]},{id:"delete-dg",group:"Distribution Groups",label:"Delete Distribution Group",approvalPath:["manager","it"],agentChecks:["Check group usage in mail flow rules","Identify group members","Check email references in other systems"],systemAction:"Remove-DistributionGroup via Exchange PowerShell",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0},{id:"confirmation",label:"Type group name to confirm deletion",type:"text",required:!0,placeholder:"Must match exactly"},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]},{id:"create-sg",group:"Security Groups",label:"Create Security Group",approvalPath:["manager","it"],agentChecks:["Duplicate check","Naming convention","Suggest existing groups","Review intended resource access"],systemAction:"POST /v1.0/groups (securityEnabled: true)",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. SG-Finance-ReadOnly"},{id:"purpose",label:"Purpose / Resource",type:"text",required:!0,placeholder:"What resource will this secure?"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"manage-sg-members",group:"Security Groups",label:"Add / Remove Security Group Members",approvalPath:["manager","it"],agentChecks:["Verify requester is group owner","Check member eligibility","Validate access to secured resource"],systemAction:"POST/DELETE /v1.0/groups/{id}/members/$ref",fields:[{id:"groupName",label:"Security Group Name",type:"text",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Add members","Remove members"]},{id:"members",label:"Members (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"shared-mailbox":{parentGroup:"exchange",operations:[{id:"create-shared-mb",group:"Create / Delete",label:"Create Shared Mailbox",approvalPath:["manager","it"],agentChecks:["Duplicate mailbox check","License availability","Naming convention","Verify owner details"],systemAction:"New-Mailbox -Shared via Exchange PowerShell",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. HR Department"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"hr@contoso.com"},{id:"fullAccess",label:"Full Access Users",type:"text",required:!1,placeholder:"UPNs comma-separated"},{id:"sendAs",label:"Send As Users",type:"text",required:!1,placeholder:"UPNs comma-separated"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-shared-mb",group:"Create / Delete",label:"Delete Shared Mailbox",approvalPath:["manager","it"],agentChecks:["Check mailbox usage in last 90 days","Identify users with permissions","Check mail flow dependencies"],systemAction:"Remove-Mailbox via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Mailbox Email Address",type:"email",required:!0},{id:"dataAction",label:"Data Disposition",type:"select",required:!0,options:["Export then delete","Retain for 90 days","Immediate deletion"]},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]},{id:"mb-permissions",group:"Permissions",label:"Modify Mailbox Permissions",approvalPath:["manager"],agentChecks:["Verify mailbox exists","Validate user licensing","Check current permission state"],systemAction:"Add/Remove-MailboxPermission via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Mailbox Email Address",type:"email",required:!0},{id:"permType",label:"Permission Type",type:"select",required:!0,options:["Full Access","Send As","Send on Behalf"]},{id:"action",label:"Action",type:"select",required:!0,options:["Add permission","Remove permission"]},{id:"users",label:"Users (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"room-equipment":{parentGroup:"exchange",operations:[{id:"create-room",group:"Create",label:"Create Room Mailbox",approvalPath:["manager","it"],agentChecks:["Check for duplicate room names","Validate capacity settings","Verify location exists in directory"],systemAction:"New-Mailbox -Room via Exchange PowerShell",fields:[{id:"displayName",label:"Room Name",type:"text",required:!0,placeholder:"e.g. London — Boardroom A"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"london-boardroom-a"},{id:"capacity",label:"Capacity (persons)",type:"text",required:!0,placeholder:"12"},{id:"location",label:"Building / Floor",type:"text",required:!1,placeholder:"e.g. 1 Canada Square, Floor 4"},{id:"autoAccept",label:"Auto-accept bookings",type:"select",required:!0,options:["Auto-accept all","Require approval","Manual only"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"create-equipment",group:"Create",label:"Create Equipment Mailbox",approvalPath:["manager","it"],agentChecks:["Duplicate equipment name check","Validate equipment type"],systemAction:"New-Mailbox -Equipment via Exchange PowerShell",fields:[{id:"displayName",label:"Equipment Name",type:"text",required:!0,placeholder:"e.g. Projector — Floor 3"},{id:"alias",label:"Email Alias",type:"text",required:!0},{id:"equipType",label:"Equipment Type",type:"select",required:!0,options:["Projector","Video conferencing unit","Laptop pool","Car/Fleet","Other"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"modify-booking",group:"Modify",label:"Modify Booking Policy",approvalPath:["manager"],agentChecks:["Verify resource exists","Check current booking conflicts"],systemAction:"Set-CalendarProcessing via Exchange PowerShell",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"autoAccept",label:"Auto-accept policy",type:"select",required:!1,options:["Auto-accept all","Require approval","Manual only"]},{id:"maxDuration",label:"Max booking duration",type:"select",required:!1,options:["1 hour","2 hours","4 hours","8 hours","1 day","Unlimited"]},{id:"bookingWindow",label:"Advance booking window",type:"select",required:!1,options:["1 week","2 weeks","1 month","3 months","6 months"]},{id:"justification",label:"Reason for Change",type:"textarea",required:!0}]},{id:"add-delegate",group:"Modify",label:"Add Room/Equipment Delegate",approvalPath:["manager"],agentChecks:["Verify resource exists","Verify delegate licensing"],systemAction:"Set-CalendarProcessing -ResourceDelegates",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"delegates",label:"Delegate UPNs",type:"text",required:!0,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-resource",group:"Delete",label:"Remove Room / Equipment Mailbox",approvalPath:["manager","it"],agentChecks:["Check for future bookings","Identify delegates","Cancel existing calendar entries"],systemAction:"Remove-Mailbox via Exchange PowerShell",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"deleteDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"justification",label:"Reason for Removal",type:"textarea",required:!0}]}]},"email-services":{parentGroup:"exchange",operations:[{id:"smtp-change",group:"Email Configuration",label:"SMTP Address Change",approvalPath:["manager","it"],agentChecks:["Verify mailbox ownership","Check SMTP address availability","Check for email references in other systems"],systemAction:"Set-Mailbox -EmailAddresses via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"newSmtp",label:"New Primary SMTP",type:"email",required:!0,hint:"New primary email address"},{id:"keepOld",label:"Retain old address as alias",type:"select",required:!0,options:["Yes — keep as alias","No — remove old address"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"mail-forwarding",group:"Email Configuration",label:"Configure Mail Forwarding",approvalPath:["manager","it"],agentChecks:["Check for external forwarding policy","Verify destination address","Flag if forwarding to external domain"],systemAction:"Set-Mailbox -ForwardingSmtpAddress via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"forwardTo",label:"Forward To",type:"email",required:!0},{id:"keepCopy",label:"Keep a copy in mailbox",type:"select",required:!0,options:["Yes","No"]},{id:"duration",label:"Forwarding Duration",type:"select",required:!1,options:["Indefinite","30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"auto-reply",group:"Email Configuration",label:"Auto Reply Configuration",approvalPath:["manager"],agentChecks:["Validate mailbox ownership","Check message content for compliance"],systemAction:"Set-MailboxAutoReplyConfiguration via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"scope",label:"Reply Scope",type:"select",required:!0,options:["Internal only","Internal and external"]},{id:"startDate",label:"Start Date",type:"date",required:!1},{id:"endDate",label:"End Date",type:"date",required:!1},{id:"message",label:"Auto Reply Message",type:"textarea",required:!0,placeholder:"Out of office message..."}]}]},teams:{parentGroup:null,operations:[{id:"create-team",group:"Team Management",label:"Create Team",approvalPath:["manager"],agentChecks:["Duplicate team name check","Suggest existing teams","Validate naming convention","Check M365 group quota"],systemAction:"POST /v1.0/teams",fields:[{id:"displayName",label:"Team Name",type:"text",required:!0,placeholder:"e.g. Project Phoenix"},{id:"description",label:"Description",type:"textarea",required:!1},{id:"privacy",label:"Privacy",type:"select",required:!0,options:["Private (invite only)","Public (open to all)"]},{id:"template",label:"Team Template",type:"select",required:!1,options:["Standard","Project","Retail","Healthcare","Education"]},{id:"owners",label:"Team Owners",type:"text",required:!0,placeholder:"Comma-separated UPNs (at least 1)"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"add-team-members",group:"Team Management",label:"Add / Remove Team Members",approvalPath:["manager"],agentChecks:["Verify team exists","Check user licensing","Validate requester is owner"],systemAction:"POST/DELETE /v1.0/teams/{id}/members",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Add members","Remove members","Promote to owner","Demote from owner"]},{id:"users",label:"Users (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"create-channel",group:"Channel Management",label:"Create Channel",approvalPath:["manager"],agentChecks:["Verify team exists","Check for duplicate channel names","Validate channel type eligibility"],systemAction:"POST /v1.0/teams/{id}/channels",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"channelName",label:"Channel Name",type:"text",required:!0,placeholder:"e.g. Project Updates"},{id:"channelType",label:"Channel Type",type:"select",required:!0,options:["Standard","Private","Shared"]},{id:"description",label:"Description",type:"textarea",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"team-guest-access",group:"Guest Access",label:"Request Guest Access to Team",approvalPath:["manager","it"],agentChecks:["Verify guest policy allows external access","Check guest domain restrictions","Validate team guest access setting"],systemAction:"POST /v1.0/teams/{id}/members (guest)",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"guestEmails",label:"Guest Email Addresses",type:"textarea",required:!0,placeholder:"One email per line (external addresses)"},{id:"guestOrg",label:"Guest Organisation",type:"text",required:!0,placeholder:"External company name"},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},sharepoint:{parentGroup:null,operations:[{id:"new-site",group:"Site Management",label:"Request New SharePoint Site",approvalPath:["manager","it"],agentChecks:["Check for similar existing sites","Validate site URL availability","Check storage quota","Verify naming convention"],systemAction:"POST /v1.0/sites — Invoke-RestMethod SharePoint REST API",fields:[{id:"siteTitle",label:"Site Title",type:"text",required:!0,placeholder:"e.g. Finance Department Hub"},{id:"siteUrl",label:"Site URL",type:"text",required:!0,placeholder:"finance-hub",hint:"contoso.sharepoint.com/sites/ prefix appended"},{id:"siteTemplate",label:"Template",type:"select",required:!0,options:["Team site","Communication site","Hub site","Document center"]},{id:"owners",label:"Site Owners",type:"text",required:!0,placeholder:"Comma-separated UPNs"},{id:"storageQuota",label:"Initial Storage Quota",type:"select",required:!1,options:["1 GB (default)","5 GB","10 GB","25 GB","100 GB"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"add-site-members",group:"Site Permissions",label:"Add Site Members / Owners",approvalPath:["manager"],agentChecks:["Verify site exists","Check user eligibility","Validate permission level request"],systemAction:"SharePoint REST API — /_api/web/roleassignments",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0,placeholder:"contoso.sharepoint.com/sites/..."},{id:"role",label:"Permission Level",type:"select",required:!0,options:["Read","Contribute","Edit","Full Control","Site Owner"]},{id:"users",label:"Users / Groups (UPNs)",type:"textarea",required:!0,placeholder:"One UPN or group name per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"external-sharing",group:"External Sharing",label:"Request External Sharing",approvalPath:["manager","dataowner","it"],agentChecks:["Check tenant external sharing policy","Verify domain not blocked","Classify data sensitivity","Check DLP policy applicability"],systemAction:"Set-SPOSite -SharingCapability via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"sharingLevel",label:"Sharing Level",type:"select",required:!0,options:["Specific people (authenticated)","Anyone with link (no sign-in)","Existing guests only"]},{id:"externalOrg",label:"External Organisation",type:"text",required:!0},{id:"duration",label:"Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year","Ongoing (reviewed annually)"]},{id:"dataSensitivity",label:"Data Sensitivity",type:"select",required:!0,options:["Public","Internal","Confidential","Highly Confidential"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"storage-increase",group:"Site Management",label:"Request Storage Increase",approvalPath:["manager","it"],agentChecks:["Check current usage vs quota","Validate increase request is proportionate","Check tenant storage pool"],systemAction:"Set-SPOSite -StorageQuota via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"currentSize",label:"Current Storage Used",type:"text",required:!1,placeholder:"Approx. current usage (e.g. 4.5 GB)"},{id:"requestedGB",label:"Additional Storage (GB)",type:"text",required:!0,placeholder:"e.g. 10"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-site",group:"Site Management",label:"Request Site Deletion",approvalPath:["manager","it"],agentChecks:["Check last site activity","Identify site owners","Check for active flows or apps referencing site","Verify data retention requirements"],systemAction:"Remove-SPOSite via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"contentAction",label:"Content Action",type:"select",required:!0,options:["Export content then delete","Move to archive library","Immediate deletion"]},{id:"confirmation",label:"Type site name to confirm",type:"text",required:!0},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]}]},onedrive:{parentGroup:null,operations:[{id:"onedrive-storage",group:"Storage",label:"Request OneDrive Storage Increase",approvalPath:["manager","it"],agentChecks:["Check current OneDrive usage","Verify user licensing tier","Check tenant storage pool"],systemAction:"Set-SPOSite (OneDrive) -StorageQuota via PnP PowerShell",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0,placeholder:"user@contoso.com"},{id:"currentUsage",label:"Current Usage (approx)",type:"text",required:!1,placeholder:"e.g. 800 GB"},{id:"requestedQuota",label:"Requested Quota (GB)",type:"select",required:!0,options:["1 TB (default)","2 TB","5 TB","10 TB","25 TB (requires approval)"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"former-employee-od",group:"Access",label:"Access Former Employee OneDrive",approvalPath:["manager","it"],agentChecks:["Verify employee account status","Check data retention policy","Validate manager relationship","Check GDPR/legal hold status"],systemAction:"Set-SPOUser -Site (OneDrive URL) -LoginName via PnP PowerShell",fields:[{id:"formerEmployee",label:"Former Employee UPN",type:"email",required:!0},{id:"requestorUpn",label:"Requestor UPN",type:"email",required:!0,hint:"Your UPN — will be granted access"},{id:"reason",label:"Reason for Access",type:"select",required:!0,options:["Business continuity","Legal / compliance","Data recovery","Project handover","GDPR subject access request"]},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["7 days","30 days","90 days"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"ext-sharing":{parentGroup:null,operations:[{id:"invite-guest",group:"Guest Invitations",label:"Invite External Guest",approvalPath:["manager","it"],agentChecks:["Check domain against block list","Verify guest invitation policy","Check existing guest account","Validate business relationship"],systemAction:"POST /v1.0/invitations",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"guestName",label:"Guest Full Name",type:"text",required:!0},{id:"guestOrg",label:"Guest Organisation",type:"text",required:!0},{id:"accessNeeded",label:"Access Required",type:"text",required:!0,placeholder:"Teams, SharePoint site, etc."},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"extend-guest",group:"Guest Lifecycle",label:"Extend Guest Access",approvalPath:["manager","dataowner"],agentChecks:["Verify current expiry date","Check if guest is still active","Validate business relationship still active"],systemAction:"PATCH /v1.0/users/{guestId} — update account expiry",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"extension",label:"Extend By",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"reviewDate",label:"Next Review Date",type:"date",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-guest",group:"Guest Lifecycle",label:"Remove Guest Access",approvalPath:["manager"],agentChecks:["Enumerate all resources guest has access to","Check for owned content","Schedule account removal"],systemAction:"DELETE /v1.0/users/{guestId}",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"removeDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"reassignContent",label:"Reassign owned content to",type:"text",required:!1,placeholder:"UPN of new owner (optional)"},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"enable-ext-sharing",group:"Sharing Policy",label:"Request External Sharing Enablement",approvalPath:["manager","dataowner","it"],agentChecks:["Verify DLP policies cover new sharing scope","Check Conditional Access for guest sign-in","Review tenant sharing policy settings"],systemAction:"Set-SPOTenant -SharingCapability via PnP PowerShell",fields:[{id:"scope",label:"Sharing Scope",type:"select",required:!0,options:["Specific SharePoint sites","All SharePoint sites","OneDrive","All workloads"]},{id:"sharingLevel",label:"Sharing Level",type:"select",required:!0,options:["New and existing guests","Existing guests only","Anyone (anonymous links)"]},{id:"domains",label:"Allowed External Domains",type:"text",required:!1,placeholder:"partner1.com, partner2.com"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"user-access":{parentGroup:null,operations:[{id:"access-mailbox",group:"Access Requests",label:"Access to Shared Mailbox",approvalPath:["manager"],agentChecks:["Verify mailbox exists","Check existing permissions","Validate requester eligibility"],systemAction:"Add-MailboxPermission via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Shared Mailbox Email",type:"email",required:!0},{id:"permLevel",label:"Permission Level",type:"select",required:!0,options:["Full Access","Send As","Send on Behalf"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-teams",group:"Access Requests",label:"Access to Teams Team or Channel",approvalPath:["manager"],agentChecks:["Verify team exists","Check if team is private/public","Check channel accessibility"],systemAction:"POST /v1.0/teams/{id}/members",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"channelName",label:"Channel Name",type:"text",required:!1,placeholder:"Leave blank for general access"},{id:"role",label:"Role",type:"select",required:!0,options:["Member","Owner"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-sharepoint",group:"Access Requests",label:"Access to SharePoint Site",approvalPath:["manager"],agentChecks:["Verify site exists","Check current permissions","Classify data sensitivity"],systemAction:"SharePoint REST API — /_api/web/roleassignments",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"permLevel",label:"Permission Level",type:"select",required:!0,options:["Read","Contribute","Edit"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-dl",group:"Access Requests",label:"Access to Distribution List",approvalPath:["manager"],agentChecks:["Verify DL exists","Check for closed membership","Check for similar groups"],systemAction:"Add-DistributionGroupMember via Exchange PowerShell",fields:[{id:"dlEmail",label:"Distribution List Email",type:"email",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Subscribe (add)","Unsubscribe (remove)"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-sg",group:"Access Requests",label:"Access to Security Group",approvalPath:["manager","it"],agentChecks:["Verify SG exists","Identify what resources are secured","Validate eligibility based on role/department"],systemAction:"POST /v1.0/groups/{id}/members/$ref",fields:[{id:"sgName",label:"Security Group Name",type:"text",required:!0},{id:"resourceAccess",label:"Resource you need to access",type:"text",required:!0,placeholder:"What will this SG membership unlock?"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},licenses:{parentGroup:null,operations:[{id:"req-e3",group:"Microsoft 365",label:"Request Microsoft 365 E3 License",approvalPath:["manager","it"],agentChecks:["Check E3 license availability","Verify current license assignment","Validate user eligibility"],systemAction:"POST /v1.0/users/{id}/assignLicense",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"startDate",label:"Required From Date",type:"date",required:!1},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-e5",group:"Microsoft 365",label:"Request Microsoft 365 E5 License",approvalPath:["manager","it"],agentChecks:["Check E5 license availability (CRITICAL — low stock)","Verify E5 features needed vs E3","Validate cost center approval"],systemAction:"POST /v1.0/users/{id}/assignLicense",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"featuresNeeded",label:"E5 Features Required",type:"select",required:!0,options:["Defender for Endpoint P2","Purview compliance","Advanced analytics","All E5 features"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"startDate",label:"Required From Date",type:"date",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-powerbi",group:"Add-on Licenses",label:"Request Power BI Pro License",approvalPath:["manager"],agentChecks:["Check Power BI Pro availability","Verify user not already licensed","Check for Power BI Free upgrade path"],systemAction:"POST /v1.0/users/{id}/assignLicense (PBIPREMIUM)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"useCase",label:"Use Case",type:"textarea",required:!0,placeholder:"How will Power BI Pro be used?"},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-visio",group:"Add-on Licenses",label:"Request Visio Plan License",approvalPath:["manager"],agentChecks:["Check Visio license availability","Verify Visio Plan 1 vs Plan 2 need"],systemAction:"POST /v1.0/users/{id}/assignLicense (VISIO_PLAN2)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"visioTier",label:"Visio Plan",type:"select",required:!0,options:["Visio Plan 1 (web only)","Visio Plan 2 (desktop + web)"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-project",group:"Add-on Licenses",label:"Request Project Plan License",approvalPath:["manager"],agentChecks:["Check Project Plan availability","Validate PM role or equivalent"],systemAction:"POST /v1.0/users/{id}/assignLicense (PROJECT_PLAN3)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"projectTier",label:"Project Plan",type:"select",required:!0,options:["Project Plan 1 (web only)","Project Plan 3 (full)","Project Plan 5 (enterprise)"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},copilot:{parentGroup:null,operations:[{id:"req-copilot",group:"Copilot License",label:"Request Microsoft 365 Copilot License",approvalPath:["manager","it"],agentChecks:["Check Copilot license availability","Verify M365 E3/E5 prerequisite","Validate cost center budget"],systemAction:"POST /v1.0/users/{id}/assignLicense (COPILOT_M365)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"useCase",label:"Intended Use Case",type:"textarea",required:!0,placeholder:"How will Copilot improve your productivity?"},{id:"pilotGroup",label:"Pilot / rollout group",type:"text",required:!1,placeholder:"Team or department (optional)"},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-copilot",group:"Copilot License",label:"Remove Microsoft 365 Copilot License",approvalPath:["manager"],agentChecks:["Verify current Copilot assignment","Check active Copilot usage metrics"],systemAction:"POST /v1.0/users/{id}/assignLicense (removeLicenses)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"reason",label:"Reason for Removal",type:"select",required:!0,options:["User departure","Cost reduction","Low utilisation","Role change","Other"]},{id:"justification",label:"Additional Details",type:"textarea",required:!1}]}]},"power-platform":{parentGroup:null,operations:[{id:"create-env",group:"Environments",label:"Create Power Platform Environment",approvalPath:["manager","it"],agentChecks:["Check environment quota","Validate environment type eligibility","Check DLP policy coverage for new environment"],systemAction:"Power Platform Admin API — POST /environments",fields:[{id:"envName",label:"Environment Name",type:"text",required:!0,placeholder:"e.g. Finance-Production"},{id:"envType",label:"Environment Type",type:"select",required:!0,options:["Sandbox","Production","Developer","Trial"]},{id:"region",label:"Region",type:"select",required:!0,options:["United Kingdom","Europe","United States","Australia"]},{id:"purpose",label:"Purpose",type:"textarea",required:!0},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"premium-connector",group:"Connectors",label:"Request Premium Connector Access",approvalPath:["manager","it"],agentChecks:["Check DLP policy for requested connector","Verify Power Automate license","Assess data exposure risk"],systemAction:"Power Platform DLP API — update connector classification",fields:[{id:"connector",label:"Premium Connector",type:"text",required:!0,placeholder:"e.g. Salesforce, SAP, ServiceNow"},{id:"environment",label:"Environment Name",type:"text",required:!0},{id:"useCase",label:"Use Case",type:"textarea",required:!0},{id:"dataFlow",label:"Data Flow Description",type:"textarea",required:!0,placeholder:"What data will flow through this connector?"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"dlp-exception",group:"Policies",label:"Request DLP Policy Exception",approvalPath:["manager","dataowner","it"],agentChecks:["Validate exception scope","Assess compliance risk","Check for alternative compliant approach","Flag sensitive connectors"],systemAction:"Power Platform DLP API — environment-level policy override",fields:[{id:"environment",label:"Environment",type:"text",required:!0},{id:"dlpPolicy",label:"DLP Policy Name",type:"text",required:!0},{id:"connector",label:"Connector(s) Affected",type:"text",required:!0},{id:"riskMitigation",label:"Risk Mitigation Plan",type:"textarea",required:!0},{id:"duration",label:"Exception Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"pa-license",group:"Licensing",label:"Request Power Automate License",approvalPath:["manager"],agentChecks:["Check Power Automate license availability","Verify M365 base license","Determine if Premium or per-flow license needed"],systemAction:"POST /v1.0/users/{id}/assignLicense (FLOW_PER_USER)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"licenseType",label:"License Type",type:"select",required:!0,options:["Power Automate Premium (per user)","Power Automate per flow","Power Automate Process"]},{id:"useCase",label:"Use Case",type:"textarea",required:!0},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},intune:{parentGroup:null,operations:[{id:"retire-device",group:"Device Actions",label:"Retire Device",approvalPath:["manager","it"],agentChecks:["Verify device ownership","Check for company data on device","Confirm MFA device registration","Check for pending updates"],systemAction:"POST /beta/deviceManagement/managedDevices/{id}/retire",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0,placeholder:"Device display name from Intune"},{id:"userUpn",label:"Device User UPN",type:"email",required:!0},{id:"reason",label:"Reason for Retirement",type:"select",required:!0,options:["Device being replaced","User departure","Device lost/stolen","End of lifecycle","Other"]},{id:"returnDate",label:"Device Return / Disposal Date",type:"date",required:!1},{id:"justification",label:"Additional Details",type:"textarea",required:!1}]},{id:"wipe-device",group:"Device Actions",label:"Wipe Device",approvalPath:["it"],agentChecks:["Verify device ownership","Check for unsynced data","CRITICAL: Confirm user awareness — device wipe is irreversible"],systemAction:"POST /beta/deviceManagement/managedDevices/{id}/wipe",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0},{id:"userUpn",label:"Device User UPN",type:"email",required:!0},{id:"wipeType",label:"Wipe Type",type:"select",required:!0,options:["Full wipe (factory reset)","Selective wipe (remove corporate data only)"]},{id:"reason",label:"Reason",type:"select",required:!0,options:["Device lost","Device stolen","Security incident","User departure","Other"]},{id:"confirmation",label:"Type CONFIRM to proceed",type:"text",required:!0,hint:"This action is irreversible"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"compliance-exception",group:"Compliance",label:"Request Compliance Exception",approvalPath:["manager","it"],agentChecks:["Assess compliance gap","Check for compensating controls","Review exception policy limits","Flag if exception creates Zero Trust gap"],systemAction:"Update device compliance policy exclusion group via Intune API",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0},{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"nonCompliantItem",label:"Non-Compliant Item",type:"select",required:!0,options:["OS version","Encryption","Screen lock","Jailbreak/Root detection","Threat level","Other"]},{id:"compensatingControls",label:"Compensating Controls",type:"textarea",required:!0,placeholder:"What security controls mitigate the compliance gap?"},{id:"duration",label:"Exception Duration",type:"select",required:!0,options:["7 days","30 days","90 days"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"guest-lifecycle":{parentGroup:null,operations:[{id:"invite-guest-user",group:"Guest Management",label:"Invite Guest User",approvalPath:["manager","it"],agentChecks:["Check domain against block list","Check for existing guest account","Verify guest invitation policy","Check Conditional Access guest policy"],systemAction:"POST /v1.0/invitations",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"guestName",label:"Guest Full Name",type:"text",required:!0},{id:"guestOrg",label:"Organisation",type:"text",required:!0},{id:"accessScope",label:"Access Scope",type:"text",required:!0,placeholder:"Teams, SharePoint sites, etc."},{id:"sponsor",label:"Internal Sponsor UPN",type:"email",required:!0,hint:"Accountable internal contact for this guest"},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"extend-guest-access",group:"Guest Management",label:"Extend Guest Access",approvalPath:["manager","dataowner"],agentChecks:["Verify guest activity (last 30 days)","Check access scope still appropriate","Validate sponsor still in organisation"],systemAction:"PATCH /v1.0/users/{guestId} — update account expiry",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"extension",label:"Extend Access By",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"accessReview",label:"Access Still Required For",type:"textarea",required:!0,placeholder:"Confirm ongoing business need..."},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-guest-user",group:"Guest Management",label:"Remove Guest User",approvalPath:["manager"],agentChecks:["Enumerate guest resource access","Check for owned content","Check active collaborations","Flag any open items"],systemAction:"DELETE /v1.0/users/{guestId}",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"removeDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"contentAction",label:"Owned Content Action",type:"select",required:!0,options:["Reassign to sponsor","Export then delete","No action needed"]},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"quarterly-review",group:"Access Review",label:"Request Quarterly Access Review",approvalPath:["it"],agentChecks:["Enumerate all active guest accounts","Identify guests inactive >60 days","Check expiry dates","Identify guests without sponsors"],systemAction:'GET /v1.0/users?$filter=userType eq "Guest" — generate review report',fields:[{id:"scope",label:"Review Scope",type:"select",required:!0,options:["All guest users","Specific department guests","Guests expiring in 30 days","Inactive guests only"]},{id:"reviewerUpn",label:"Reviewer UPN",type:"email",required:!0,hint:"Who should receive the review report"},{id:"justification",label:"Additional Notes",type:"textarea",required:!1}]}]}};let q="landing",V=null,J=null,j=null,ae={},Cs=100,Ee=null;function Mr(){const e=document.getElementById("page-portal");e&&(q="landing",V=null,J=null,j=null,ae={},Ee=null,W(e))}function W(e){q==="landing"?Lr(e):q==="service"?Rr(e):q==="form"?Ir(e):q==="submitted"?Or(e):q==="my-requests"&&Ts(e)}function yt(e){const t=m.settings;return t.portalEnabled?t[e]!==!1:!1}function Ti(e){return"portal_"+e.replace(/-/g,"_")}function qe(e){return Pr[e]||null}function ti(e){return mt.find(t=>t.id===e)}function Ps(e,t){const i=qe(e);return i?i.operations.find(s=>s.id===t):null}function tt(e){return e==="exchange"}function Tr(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};for(const t of Ie)if(yt(e[t.id]))return t.id;return Ie[0].id}function ot(){return tt(V)?J:V}function it(e){if(!e)return[];const t=["submit",...e.approvalPath,"agent","action","done"];return jt.filter(i=>t.includes(i.id))}function Lr(e){const t=m.currentUser;if(!m.settings.portalEnabled){e.innerHTML=`
      ...
      </div>`;return}const i={user:"Standard user",manager:"Manager",admin:"Administrator",super:"Super Admin"},s=mt.filter(n=>yt(Ti(n.id)));e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="portal-workflow-banner mb-3">
      ${jt.map((n,r)=>`
        ...
        ${r<jt.length-1?'<div class="pwf-arrow"><i class="ti ti-arrow-right"></i></div>':""}
      `).join("")}
    </div>
  ...
  `;const a=e.querySelector("#portal-service-grid");mt.forEach(n=>{var c,d;const r=yt(Ti(n.id)),o=tt(n.id)?Ie.reduce((p,v)=>{var f,b;return p+(((b=(f=qe(v.id))==null?void 0:f.operations)==null?void 0:b.length)||0)},0):((d=(c=qe(n.id))==null?void 0:c.operations)==null?void 0:d.length)||0,l=document.createElement("div");l.className=`portal-svc-card ${r?"":"disabled"}`,l.innerHTML=`
    ...
    `,r||(l.title="This service has been disabled by your administrator."),a.appendChild(l)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(n=>{n.addEventListener("click",()=>{V=n.dataset.gid,tt(V)&&(J=Tr()),j=null,ae={},q="service",W(e)})})}function Rr(e){const t=ti(V);if(!t){q="landing",W(e);return}const i=ot(),s=qe(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{q="landing",W(e)}),tt(V)&&e.querySelectorAll(".ex-sub-tab").forEach(a=>{a.addEventListener("click",()=>{J=a.dataset.sub,j=null,Li(e,qe(J)),e.querySelectorAll(".ex-sub-tab").forEach(n=>n.classList.toggle("active",n.dataset.sub===J))})}),Li(e,s)}function Dr(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
    <div class="tabs mb-3" style="margin-bottom:16px">
      ${Ie.map(t=>{const i=yt(e[t.id]);return`<button class="tab-btn ex-sub-tab ${t.id===J?"active":""} ${i?"":"disabled-tab"}"
  ...
  `}function Li(e,t){const i=e.querySelector("#svc-ops-area");if(!i)return;if(!t){i.innerHTML='<div class="empty-state">No operations available for this service.</div>';return}const s={};if(t.operations.forEach(a=>{s[a.group]||(s[a.group]=[]),s[a.group].push(a)}),i.innerHTML=`
    <div class="card">
            ...
            ${n.map(r=>`
              <div class="op-card ${j===r.id?"selected":""}" data-op="${r.id}">
                ...
                <div class="op-card-steps">
                  ${it(r).map(o=>`<span class="op-step-dot op-step-${o.color}" title="${o.label}"></span>`).join("")}
                </div>
                <div class="op-card-approval">
                  <i class="ti ti-route" style="font-size:10px"></i>
                  ${it(r).map(o=>o.label).join(" → ")}
                </div>
              </div>
            `).join("")}
          </div>
  ...
  `,i.querySelectorAll(".op-card").forEach(a=>{a.addEventListener("click",()=>{i.querySelectorAll(".op-card").forEach(n=>n.classList.remove("selected")),a.classList.add("selected"),j=a.dataset.op,Ri(i,qe(ot()),j)})}),j){const a=i.querySelector(`.op-card[data-op="${j}"]`);a&&a.classList.add("selected"),Ri(i,t,j)}}function Ri(e,t,i){var r;const s=e.querySelector("#svc-form-preview");if(!s)return;const a=(r=t==null?void 0:t.operations)==null?void 0:r.find(o=>o.id===i);if(!a)return;const n=it(a);s.innerHTML=`
    <div class="card mt-3">
      <div class="card-header">
  ...
  `,s.querySelector("#svc-start-form").addEventListener("click",()=>{q="form",ae={};const o=document.getElementById("page-portal");W(o)})}function Ir(e){var n;const t=ti(V),i=ot(),s=Ps(i,j);if(!s||!t){q="service",W(e);return}const a=it(s);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div>
          ...
          <div class="page-subtitle">${t.name}${J?" — "+(((n=Ie.find(r=>r.id===J))==null?void 0:n.name)||""):""}</div>
        </div>
      </div>
    </div>
            ...
            ${a.map((r,o)=>`
              <div class="wfv-step">
                ...
                <div class="wfv-content">
                  ...
                  ${Di(r.id,s)?`<div class="wfv-desc">${Di(r.id,s)}</div>`:""}
                </div>
              </div>
            `).join("")}
          </div>
  ...
  `,e.querySelector("#form-back").addEventListener("click",()=>{q="service",W(e)}),e.querySelector("#form-submit").addEventListener("click",()=>zr(e,s))}function qr(e){const t=e.required?" *":"",i=e.hint?`<div style="font-size:10px;color:var(--color-text-tertiary);margin-top:3px">${e.hint}</div>`:"";return e.type==="text"||e.type==="email"?`<div class="form-group" data-field="${e.id}">
      ...
      ${i}
    </div>`:""}function Di(e,t){return t.approvalPath,e==="submit"?"Request submitted with required details":e==="manager"?"Your direct manager reviews and approves":e==="it"?"IT team validates technical feasibility and security":e==="dataowner"?"Data/resource owner confirms access appropriateness":e==="agent"?`AI Agent validates: ${t.agentChecks[0]}, and ${t.agentChecks.length-1} more checks`:e==="action"?`Provisioning via: ${t.systemAction}`:e==="done"?"Email notification sent. Request available in My Requests.":""}function zr(e,t){const i=e.querySelector("#dynamic-form");let s=!0;const a=[];if(t.fields.filter(r=>r.required).forEach(r=>{const o=i.querySelector(`#ff-${r.id}`);if(!o)return;(o.type==="checkbox"?o.checked:o.value.trim())||(s=!1,a.push(r.label),o.style.borderColor="var(--clr-danger-text)",o.addEventListener("input",()=>{o.style.borderColor=""},{once:!0}))}),t.fields.find(r=>r.id==="confirmation")){const r=i.querySelector("#ff-confirmation"),o=i.querySelector("#ff-groupName, #ff-siteUrl, #ff-currentName");if(r&&r.value.toUpperCase()!=="CONFIRM"&&!o&&r.value!=="CONFIRM"){s=!1,u("Type CONFIRM in the confirmation field to proceed.","error");return}}if(!s){u(`Please fill in required fields: ${a.slice(0,3).join(", ")}`,"error");return}t.fields.forEach(r=>{const o=i.querySelector(`#ff-${r.id}`);o&&(ae[r.id]=o.type==="checkbox"?o.checked:o.value)}),Nr(e,t)}async function Nr(e,t){const i=e.querySelector("#form-submit");e.querySelector(".card"),i.disabled=!0,i.innerHTML='<span class="spinner"></span> Validating with AI Agent...';try{const n=(await(await fetch(`${A}/agent/validate-request`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request:{operationId:t.id,fields:ae},userEmail:window.userEmail})})).json()).data;console.log("🤖 Agent validation result:",n),Gr(e,t,n,ae)}catch(s){console.error("⚠️ Validation error:",s),u("Agent validation failed. Proceeding with manual review.","warning"),Ms(e,t)}finally{i.disabled=!1,i.innerHTML='<i class="ti ti-send"></i> Submit Request'}}function Gr(e,t,i,s){const{riskLevel:a,riskScore:n,checks:r,recommendations:o,autoApprove:l,approvalPath:c,status:d}=i,v={LOW:{bg:"var(--clr-success-bg)",text:"var(--clr-success-text)",icon:"ti-circle-check"},MEDIUM:{bg:"var(--clr-warning-bg)",text:"var(--clr-warning-text)",icon:"ti-alert-circle"},HIGH:{bg:"var(--clr-danger-bg)",text:"var(--clr-danger-text)",icon:"ti-alert-octagon"},CRITICAL:{bg:"var(--clr-danger-bg)",text:"var(--clr-danger-text)",icon:"ti-alert-triangle"}}[a],f=document.createElement("div");f.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;z-index:1000;padding:20px";const b=document.createElement("div");b.style.cssText="background:white;border-radius:8px;max-width:600px;max-height:80vh;overflow-y:auto;padding:24px;box-shadow:0 10px 40px rgba(0,0,0,0.3)",b.innerHTML=`
  ...
  `,f.appendChild(b),document.body.appendChild(f),document.getElementById("val-cancel").addEventListener("click",()=>{f.remove()}),document.getElementById("val-submit").addEventListener("click",()=>{f.remove(),Ms(e,t)})}async function Ms(e,t,i){var s;Cs++;try{const a=e.querySelector("#val-submit");a&&(a.disabled=!0,a.innerHTML='<span class="spinner"></span> Submitting...');const n=ot(),o=await(await fetch(`${A}/self-service/requests/submit`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({serviceId:n,operationId:t.id,formData:ae,requesterId:((s=m.currentUser)==null?void 0:s.email)||window.userEmail,description:t.label})})).json();o.success?(console.log("✓ Request submitted:",o.requestId),Ee=o.requestId,u("Request submitted successfully","success"),q="submitted",W(e)):(u("Failed to submit request: "+o.error,"error"),a&&(a.disabled=!1,a.innerHTML='<i class="ti ti-send"></i> Confirm & Submit'))}catch(a){console.error("Submission error:",a),u("Error submitting request. Please try again.","error")}}function Or(e){var r;const t=ti(V),i=ot(),s=Ps(i,j);if(!s||!t){q="landing",W(e);return}const a=it(s),n=Ee||`REQ-${String(Cs).padStart(4,"0")}`;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{q="landing",V=null,J=null,j=null,ae={},Ee=null,W(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{q="my-requests",W(e)})}async function Ts(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;try{const s=((t=m.currentUser)==null?void 0:t.email)||window.userEmail,n=await(await fetch(`${A}/self-service/requests/my-requests?email=${encodeURIComponent(s)}`,{headers:{"Content-Type":"application/json"}})).json();n.success&&n.data.length>0?Ur(e,n.data):(e.querySelector('[class="page-header"]').insertAdjacentHTML("afterend",`
      ...
      `),e.querySelector("#myreq-submit-new").addEventListener("click",()=>{q="landing",V=null,J=null,j=null,ae={},Ee=null,W(e)}))}catch(s){console.error("Error fetching requests:",s),e.querySelector('[class="page-header"]').insertAdjacentHTML("afterend",`
      <div class="alert-banner danger" style="margin:16px">
        <i class="ti ti-alert-triangle"></i>
        <span>Failed to load requests. <button class="btn btn-sm" id="myreq-retry" style="margin-left:8px">Retry</button></span>
      </div>
    `),e.querySelector("#myreq-retry").addEventListener("click",()=>{Ts(e)})}(i=e.querySelector("#myreq-back"))==null||i.addEventListener("click",()=>{q="landing",V=null,J=null,j=null,ae={},Ee=null,W(e)})}function Ur(e,t){var n;const i={Submitted:{bg:"var(--clr-info-bg)",text:"var(--clr-info-text)",icon:"ti-send"},Approved:{bg:"var(--clr-success-bg)",text:"var(--clr-success-text)",icon:"ti-circle-check"},Rejected:{bg:"var(--clr-danger-bg)",text:"var(--clr-danger-text)",icon:"ti-circle-x"},Completed:{bg:"var(--clr-success-bg)",text:"var(--clr-success-text)",icon:"ti-badge-check"}};e.querySelector(".page-header").insertAdjacentHTML("afterend",`
    <div style="margin-bottom:16px">
  ...
  `,(n=e.querySelector("#myreq-back"))==null||n.addEventListener("click",()=>{q="landing",V=null,J=null,j=null,ae={},Ee=null,W(e)})}function jr(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
      <div class="page-title"><i class="ti ti-list-check"></i> My Requests</div>
...
Full details available in **Graph API** page (super admin only).`}],Br=`I'm your **M365 AgentOps AI Copilot**. I can help you with:
...
- "What are the M365 Config failures?"`;let ft=[],qi=!1;function Hr(){const e=document.getElementById("page-chat");if(!e)return;const t=m.currentUser,i=Ii[t==null?void 0:t.role]||Ii.user;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#chat-messages"),a=e.querySelector("#chat-input");!qi||ft.length===0?(ft=[],Ft("ai",Br),qi=!0):Bt(s),e.querySelector("#chat-send").addEventListener("click",()=>Pt(e)),a.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),Pt(e))}),a.addEventListener("input",()=>{a.style.height="auto",a.style.height=Math.min(a.scrollHeight,120)+"px"}),e.querySelectorAll(".suggestion-pill").forEach(n=>{n.addEventListener("click",()=>{a.value=n.dataset.text,Pt(e)})})}function Ft(e,t){ft.push({role:e,text:t,ts:new Date().toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"})})}function Bt(e){e.innerHTML=ft.map(t=>{var a;const i=t.role==="ai",s=_r(t.text);return`
...
Try rephrasing your question or ask about a specific service name.`}function Wr(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=m.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,(i=e.querySelector("#sso-save"))==null||i.addEventListener("click",()=>u("SSO configuration saved.","success")),(s=e.querySelector("#sso-test"))==null||s.addEventListener("click",()=>{u("SSO test initiated — check your browser for the Entra ID sign-in prompt.","info")})}}function Kr(){const e=document.getElementById("page-audit");if(!e)return;const t=[{time:"Today 08:47",event:"Config Agent scan completed",user:"M365 Config Agent",category:"Compliance",severity:"info",sevCls:"info"},{time:"Today 08:15",event:"High-risk sign-in detected",user:"kevin.osei@contoso.com",category:"Security",severity:"high",sevCls:"danger"},{time:"Yesterday 16:30",event:"Access request approved (REQ-005)",user:"Sanjay Kumar",category:"Access",severity:"low",sevCls:"success"},{time:"Yesterday 14:12",event:"PIM role activated — Compliance Admin",user:"sam.torres@contoso.com",category:"Identity",severity:"medium",sevCls:"warning"}];e.innerHTML=`
    <div class="page-header">
  ...
  `}function ne({id:e,checked:t,label:i,sublabel:s,onChange:a}){const n=document.createElement("div");n.className="toggle-wrap",n.innerHTML=`
    <label class="toggle-switch">
  ...
  `;const r=n.querySelector("input");return r.addEventListener("change",()=>a(r.checked)),n}const Yr=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ii=Yr?"http://localhost:3000/api/tenantguard":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api/tenantguard";async function Zr(){try{return(await(await fetch(`${ii}/settings/claude-status`)).json()).data}catch(e){return console.error("Error getting Claude status:",e),null}}async function Qr(e){try{return await(await fetch(`${ii}/settings/claude-api-key`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:e})})).json()}catch(t){return console.error("Error setting Claude API key:",t),{success:!1,error:t.message}}}async function Xr(){try{return await(await fetch(`${ii}/settings/claude-api-key`,{method:"DELETE"})).json()}catch(e){return console.error("Error removing Claude API key:",e),{success:!1,error:e.message}}}function eo(){const e=document.getElementById("page-settings");e&&Ls(e)}function Ls(e){const t=m.settings;e.innerHTML=`
    <div class="page-header">
...
<!-- Self-Service Portal Management -->
  ...
  `;const i=ne({id:"toggle-ps",checked:t.showPSCommands,label:"Show PowerShell validation commands",sublabel:"Displays the PowerShell command used for each control in the M365 Config topic view.",onChange:h=>{m.settings.showPSCommands=h,O()}});e.querySelector("#settings-ps-wrap").appendChild(i);const s=ne({id:"toggle-result",checked:t.showTenantResult,label:"Show simulated tenant result",sublabel:"Displays the simulated tenant scan result for each control.",onChange:h=>{m.settings.showTenantResult=h,O()}});e.querySelector("#settings-result-wrap").appendChild(s);const a=ne({id:"toggle-expand",checked:t.autoExpandFailed,label:"Auto-expand failed controls",sublabel:"Automatically opens the details panel for failed controls on topic load.",onChange:h=>{m.settings.autoExpandFailed=h,O()}});e.querySelector("#settings-expand-wrap").appendChild(a);const n=ne({id:"toggle-alert-fail",checked:t.agentAlertOnFail,label:"Alert on new failures",sublabel:"Send email notification when agent detects new failed controls.",onChange:h=>{m.settings.agentAlertOnFail=h,O()}});e.querySelector("#settings-alert-fail-wrap").appendChild(n);const r=ne({id:"toggle-graph-health",checked:t.showGraphHealth,label:"Show Graph API health on dashboard",onChange:h=>{m.settings.showGraphHealth=h,O()}});e.querySelector("#settings-graph-health-wrap").appendChild(r);const o=ne({id:"toggle-zt-score",checked:t.showZeroTrustScore,label:"Show Zero Trust score on dashboard",onChange:h=>{m.settings.showZeroTrustScore=h,O()}});e.querySelector("#settings-zt-score-wrap").appendChild(o);const l=ne({id:"toggle-cfg-score",checked:t.showM365ConfigScore,label:"Show M365 Config score on dashboard",onChange:h=>{m.settings.showM365ConfigScore=h,O()}});e.querySelector("#settings-cfg-score-wrap").appendChild(l);const c=e.querySelector("#settings-sync-days");c&&(c.value=t.announcementSyncDays||7,c.addEventListener("change",h=>{m.settings.announcementSyncDays=parseInt(h.target.value),O(),u(`Sync period set to last ${h.target.value} days`,"success")}));const d=e.querySelector("#settings-sharepoint-site"),p=e.querySelector("#settings-sharepoint-test"),v=e.querySelector("#settings-sharepoint-status");d.value=t.sharepointSiteUrl||"root",p.addEventListener("click",async()=>{const h=d.value.trim()||"root";p.disabled=!0,p.innerHTML='<span class="spinner dark" style="width:14px;height:14px"></span> Testing...',v.style.display="block",v.textContent="Testing connection...";try{const g=await fetch(`${A}/msgcenter/validate-sharepoint`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteUrl:h})}),x=await g.json();g.ok&&x.success?(v.style.background="#e8f5e9",v.style.color="#2e7d32",v.textContent=`✓ Connected! Site: ${x.siteName||h}`,m.settings.sharepointSiteUrl=h,m.settings.sharepointSiteId=x.siteId,O(),u("SharePoint site configured successfully","success")):(v.style.background="#ffebee",v.style.color="#c62828",v.textContent=`✗ Error: ${x.error||"Could not connect to site"}`,u("SharePoint connection failed","error"))}catch(g){v.style.background="#ffebee",v.style.color="#c62828",v.textContent=`✗ Error: ${g.message}`,u("SharePoint connection error","error")}finally{p.disabled=!1,p.innerHTML='<i class="ti ti-check"></i> Test'}});const f=e.querySelector("#settings-primary-approver"),b=e.querySelector("#settings-secondary-approver");f&&f.addEventListener("change",h=>{const g=h.target.value.trim();if(g&&!g.includes("@")){u("Please enter a valid email address","warning");return}m.settings.primaryApprover=g||null,O(),u(g?`Primary approver set to ${g}`:"Primary approver cleared","success")}),b&&b.addEventListener("change",h=>{const g=h.target.value.trim();if(g&&!g.includes("@")){u("Please enter a valid email address","warning");return}m.settings.secondaryApprover=g||null,O(),u(g?`Secondary approver set to ${g}`:"Secondary approver cleared","success")});const k=ne({id:"toggle-portal-master",checked:t.portalEnabled!==!1,label:"Self-Service Portal — Master Switch",sublabel:"Disable to prevent all users from accessing the portal globally.",onChange:h=>{m.settings.portalEnabled=h,O();const g=e.querySelector("#portal-services-section");g&&(g.style.opacity=h?"1":"0.4"),u(h?"Self-Service Portal enabled.":"Self-Service Portal disabled globally.",h?"success":"warning")}});e.querySelector("#settings-portal-master-wrap").appendChild(k);const y=e.querySelector("#portal-services-section");y&&(y.style.opacity=t.portalEnabled!==!1?"1":"0.4");const w=e.querySelector("#portal-main-toggles");mt.forEach(h=>{const g="portal_"+h.id.replace(/-/g,"_"),x=document.createElement("div");x.className="portal-svc-setting-row",x.innerHTML=`
    ...
    `,w.appendChild(x);const N=ne({id:`chk-${g}`,checked:t[g]!==!1,label:"",onChange:T=>{m.settings[g]=T,O()}});x.querySelector(`#portal-toggle-${g}`).appendChild(N)});const P=e.querySelector("#portal-exchange-toggles"),S={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};Ie.forEach(h=>{const g=S[h.id],x=document.createElement("div");x.className="portal-svc-setting-row",x.innerHTML=`
      <i class="ti ${h.icon}" style="color:var(--color-text-secondary)"></i>
      <span style="flex:1;font-size:11px;font-weight:500">${h.name}</span>
      <div id="portal-toggle-${g}"></div>
    `,P.appendChild(x);const N=ne({id:`chk-${g}`,checked:t[g]!==!1,label:"",onChange:T=>{m.settings[g]=T,O()}});x.querySelector(`#portal-toggle-${g}`).appendChild(N)}),e.querySelector("#settings-save").addEventListener("click",()=>{m.settings.agentSchedule=e.querySelector("#settings-schedule").value,m.settings.agentAlertEmail=e.querySelector("#settings-alert-email").value,O(),u("Settings saved successfully.","success")}),e.querySelector("#settings-reset").addEventListener("click",()=>{wl(),Ls(e),u("Settings reset to defaults.","info")}),Mt(e),e.querySelector("#claude-save-btn").addEventListener("click",async()=>{const h=e.querySelector("#settings-claude-key").value;if(!h||h.trim()===""){u("Please enter a Claude API key","warning");return}const g=e.querySelector("#claude-save-btn");g.disabled=!0,g.innerHTML='<span class="spinner dark"></span> Saving...';try{const x=await Qr(h);x.success?(u("Claude API key configured successfully!","success"),e.querySelector("#settings-claude-key").value="",Mt(e)):u("Failed to save: "+x.error,"error")}catch(x){u("Error saving API key: "+x.message,"error")}g.disabled=!1,g.innerHTML='<i class="ti ti-device-floppy"></i> Save API Key'}),e.querySelector("#claude-remove-btn").addEventListener("click",async()=>{const h=e.querySelector("#claude-remove-btn");h.disabled=!0,h.innerHTML='<span class="spinner dark"></span> Removing...';try{const g=await Xr();g.success?(u("Claude API key removed","success"),Mt(e)):u("Failed to remove: "+g.error,"error")}catch(g){u("Error removing API key: "+g.message,"error")}h.disabled=!1,h.innerHTML='<i class="ti ti-trash"></i> Remove API Key'})}async function Mt(e){try{const t=await Zr();if(t){const i=e.querySelector("#claude-status-badge"),s=e.querySelector("#claude-mode-text"),a=e.querySelector("#claude-remove-btn");t.available?(i.innerHTML='<span style="background:var(--clr-success-bg);color:var(--clr-success-text);padding:2px 8px;border-radius:3px;font-size:9px;font-weight:600">ACTIVE</span>',s.innerHTML='<strong style="color:var(--clr-success-text)">✓ Claude API Active</strong> - Real AI investigations enabled',a.style.display="inline-flex"):(i.innerHTML='<span style="background:var(--clr-info-bg);color:var(--clr-info-text);padding:2px 8px;border-radius:3px;font-size:9px;font-weight:600">MOCK MODE</span>',s.innerHTML='<strong style="color:var(--clr-info-text)">✓ Mock Mode</strong> - Using intelligent fallback responses (fully functional for testing)',a.style.display="none")}}catch(t){console.error("Failed to load Claude status:",t)}}function to(e){let t='<div style="padding:16px;background:#f5f5f5;border-top:1px solid #ddd;min-width:0">';if(e.description&&typeof e.description=="string"){const i=e.description.replace(/\n/g,"<br>").replace(/\[([^\]]+:)\]/g,'<strong style="color:#333">[$1]</strong>');t+=`
      <div style="margin-bottom:16px">
    ...
    `}return t+="</div>",t}function Ht(e){return{"Not Reviewed":"info",Reviewed:"success","In Progress":"warning",Resolved:"success","Not Started":"neutral"}[e]||"neutral"}function zi(e){return{"Not Started":"neutral","In Progress":"warning",Review:"info",Resolved:"success",Pending:"warning",Approved:"success",Rejected:"danger"}[e]||"neutral"}function io(e){if(!e)return"";try{const t=new Date(e),i=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${i}-${s}-${a}`}catch{return e}}function Ce(e,t=[]){var b,k,y,w,P,S,h;const i=document.getElementById("admin-actions-tbody"),s=document.getElementById("admin-actions-count"),a=document.getElementById("my-tasks-tbody"),n=document.getElementById("my-tasks-count");if(!i||!s){console.warn("Admin actions table elements not found");return}const r=((k=(b=m.currentUser)==null?void 0:b.email)==null?void 0:k.toLowerCase())||"",o=t.filter(g=>{var x;return((x=g.assignedTo)==null?void 0:x.toLowerCase())===r});if(a&&n&&(n.textContent=`${o.length} tasks`,o.length===0?a.innerHTML='<tr><td colspan="5" style="padding:20px;text-align:center;color:#999">No tasks assigned to you</td></tr>':(a.innerHTML=o.map(g=>{var x;return`
        <tr style="border-bottom:0.5px solid #ddd">
          ...
          <td style="padding:10px">
            <span class="badge ${zi(g.taskStatus)}" style="font-size:9px">${g.taskStatus}</span>
          </td>
          <td style="padding:10px">
      ...
      `}).join(""),a.querySelectorAll(".update-assignee-task").forEach(g=>{g.addEventListener("click",async x=>{const N=x.target.closest("button").dataset.taskId,T=o.find(L=>L.id===N);T&&oo(T)})}))),!e||e.length===0){s.textContent="0 tasks created",i.innerHTML='<tr><td colspan="7" style="padding:20px;text-align:center;color:#999">No tasks created yet</td></tr>';return}new Map(t.map(g=>[g.announcementId,g]));const l=t.length>0?t:e.filter(g=>{const x=g.reviewStatus&&g.reviewStatus!=="Not Reviewed",N=g.taskStatus&&g.taskStatus!=="Not Started",T=!!g.actionDeadline,L=!!g.notes;return x||N||T||L});if(console.log(`📊 Tasks Tracking: ${l.length} tasks`),s.textContent=`${l.length} tasks`,l.length===0){i.innerHTML='<tr><td colspan="7" style="padding:20px;text-align:center;color:#999">No tasks created yet</td></tr>';return}const c=((w=(y=m.currentUser)==null?void 0:y.email)==null?void 0:w.toLowerCase())||"",d=((P=m.currentUser)==null?void 0:P.role)||"user",p=((S=m.settings.primaryApprover)==null?void 0:S.toLowerCase())||"",v=((h=m.settings.secondaryApprover)==null?void 0:h.toLowerCase())||"",f=["super","admin"].includes(d)||c===p||c===v;i.innerHTML=l.map(g=>{const x=g.announcementId&&g.announcementId!==g.id?g.announcementId:g.id||"N/A",N=g.taskStatus==="Resolved"&&g.approvalStatus==="Pending"&&f,T=g.assignedTo?`Assigned: ${g.assignedTo}`:"",L=g.dueDate?`Due: ${g.dueDate.split("T")[0]}`:"",Y=[T,L].filter(Boolean).join(" | ")||"—";return`
      <tr style="border-bottom:0.5px solid #ddd">
        ...
        <td style="padding:10px">
          <span class="badge ${Ht(g.taskStatus)}" style="font-size:9px">${g.taskStatus||"—"}</span>
        </td>
        <td style="padding:10px">
          <span class="badge ${zi(g.approvalStatus||"Pending")}" style="font-size:9px">${g.approvalStatus||"Pending"}</span>
        </td>
        <td style="padding:10px">
        ...
        <td style="padding:10px;color:#666;font-size:10px">${Y}</td>
    ...
    `}).join(""),document.querySelectorAll(".approve-resolution-btn").forEach(g=>{g.addEventListener("click",async x=>{const N=x.target.closest("button").dataset.taskId,T=x.target.closest("button");T.disabled=!0,T.innerHTML='<span class="spinner dark"></span>';try{const L=await fetch(`${A}/msgcenter/tasks/${N}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({approvalStatus:"Approved",siteUrl:m.settings.sharepointSiteUrl||"root"})}),Y=await L.json();if(L.ok&&Y.success){u("✓ Resolution approved successfully","success");const me=encodeURIComponent(m.settings.sharepointSiteUrl||"root");Promise.all([fetch(`${A}/msgcenter/announcements?siteUrl=${me}`).then(ye=>ye.json()),fetch(`${A}/msgcenter/tasks?siteUrl=${me}`).then(ye=>ye.json())]).then(([ye,Vs])=>{ye.success&&ye.data&&Ce(ye.data,Vs.data||[])})}else u(`Error: ${Y.error}`,"error"),T.disabled=!1,T.innerHTML='<i class="ti ti-check"></i> Approve'}catch(L){u(`Error: ${L.message}`,"error"),T.disabled=!1,T.innerHTML='<i class="ti ti-check"></i> Approve'}})}),document.querySelectorAll(".edit-admin-action-btn").forEach(g=>{g.addEventListener("click",async x=>{const N=x.target.closest("button").dataset.taskId;try{const T=encodeURIComponent(m.settings.sharepointSiteUrl||"root"),L=await fetch(`${A}/msgcenter/tasks?siteUrl=${T}`).then(Y=>Y.json());if(L.success&&L.data){const Y=L.data.find(me=>me.id===N);Y&&lo(Y)}}catch(T){u(`Error: ${T.message}`,"error")}})})}async function so(){const e=document.getElementById("page-msgcenter");e&&(K()?ao(e):await _t(e))}function ao(e){he.filter(t=>t.actionRequired).length,e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const t=e.querySelector("#mc-sync");t.innerHTML='<span class="spinner dark"></span> Syncing...',t.disabled=!0,setTimeout(()=>{t.innerHTML='<i class="ti ti-refresh"></i> Sync announcements',t.disabled=!1,u(`Synced ${he.length} announcements`,"success")},2e3)})}async function _t(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `;try{console.log("📡 Fetching announcements from SharePoint...");const t=encodeURIComponent(m.settings.sharepointSiteUrl||"root"),i=await fetch(`${A}/msgcenter/announcements?siteUrl=${t}`).then(d=>d.json());if(!i.success||!i.data||i.data.length===0){e.innerHTML=`
      ...
      `,e.querySelector("#mc-sync").addEventListener("click",async()=>{const d=e.querySelector("#mc-sync");d.disabled=!0,d.innerHTML='<span class="spinner dark"></span> Syncing...',await _t(e)});return}const s=i.data,a=s.filter(d=>d.reviewStatus==="Not Reviewed").length,n=s.filter(d=>d.taskStatus!=="Not Started").length;e.innerHTML=`
      <div class="page-header">
        <div>
          <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
    ...
    `;const r=[...new Set(s.map(d=>d.service))].sort(),o=e.querySelector("#filter-service");o&&r.forEach(d=>{const p=document.createElement("option");p.value=d,p.textContent=d,o.appendChild(p)});const l=()=>{var y,w,P,S;const d=((y=e.querySelector("#filter-service"))==null?void 0:y.value)||"",p=((w=e.querySelector("#filter-severity"))==null?void 0:w.value)||"",v=((P=e.querySelector("#filter-review-status"))==null?void 0:P.value)||"",f=((S=e.querySelector("#filter-task-status"))==null?void 0:S.value)||"";let b=0;e.querySelectorAll(".mc-announcement-item").forEach(h=>{const g=h.dataset.service,x=h.dataset.severity,N=h.dataset.reviewStatus,T=h.dataset.taskStatus,L=(!d||g===d)&&(!p||x===p)&&(!v||N===v)&&(!f||T===f);h.style.display=L?"block":"none",L&&b++}),e.querySelectorAll(".badge.info").forEach(h=>{h.textContent.includes("total")&&(h.textContent=`${b} total`)})};e.querySelectorAll("#filter-service, #filter-severity, #filter-review-status, #filter-task-status").forEach(d=>{d==null||d.addEventListener("change",l)});const c=e.querySelector("#announcements-container");s.forEach((d,p)=>{const v=Ht(d.reviewStatus),f=Ht(d.taskStatus),b=`
            ...
            <div style="display:flex;gap:16px;align-items:flex-start">
              ...
              <div style="flex:1;min-width:250px;padding:12px;background:#fff;border-radius:6px;border:1px solid #ddd">
                ...
                <div style="margin-bottom:12px">
                  ...
                  <input type="date" class="form-input deadline-input" data-item-id="${d.id}" value="${io(d.actionDeadline)}" style="width:100%;padding:6px;font-size:10px;border:0.5px solid #ccc;border-radius:4px">
                </div>
  ...
  `;try{const r=encodeURIComponent(m.settings.sharepointSiteUrl||"root"),o=await fetch(`${A}/msgcenter/tasks?siteUrl=${r}`).then(S=>S.json());if(!o.success||!o.data){e.querySelector("#tasks-tbody").innerHTML='<tr><td colspan="8" style="padding:20px;text-align:center;color:#999">No tasks found</td></tr>';return}const l=o.data,c=l.length,d=l.filter(S=>S.approvalStatus==="Pending").length,p=l.filter(S=>S.taskStatus==="In Progress").length,v=l.filter(S=>S.taskStatus==="Resolved").length;e.querySelector("#total-tasks").textContent=c,e.querySelector("#pending-tasks").textContent=d,e.querySelector("#in-progress-tasks").textContent=p,e.querySelector("#resolved-tasks").textContent=v,e.querySelector("#task-count").textContent=`${c} tasks`;const f=e.querySelector("#tasks-tbody"),b=((i=(t=m.currentUser)==null?void 0:t.email)==null?void 0:i.toLowerCase())||"",k=((s=m.currentUser)==null?void 0:s.role)||"user",y=((a=m.settings.primaryApprover)==null?void 0:a.toLowerCase())||"",w=((n=m.settings.secondaryApprover)==null?void 0:n.toLowerCase())||"",P=["super","admin"].includes(k)||b===y||b===w;f.innerHTML=l.map(S=>{var x;const h=S.taskStatus==="Resolved",g=S.approvalStatus==="Pending"&&h&&P;return`
        <tr style="border-bottom:0.5px solid #ddd;hover:background:#f9f9f9;${h&&!g?"opacity:0.7":""}">
          ...
          <td style="padding:10px">
            <span class="badge ${Gi(S.taskStatus)}" style="font-size:9px">${S.taskStatus}</span>
          </td>
          <td style="padding:10px">
            <span class="badge ${Gi(S.approvalStatus)}" style="font-size:9px">${S.approvalStatus}</span>
          </td>
          <td style="padding:10px">
      ...
      `}).join(""),po(e,l),e.querySelector("#tasks-refresh").addEventListener("click",async()=>{const S=e.querySelector("#tasks-refresh");S.disabled=!0,S.innerHTML='<span class="spinner dark"></span> Refreshing...',await ze(e)})}catch(r){console.error("Error rendering tasks:",r),u(`Error: ${r.message}`,"error")}}function po(e,t){e.querySelectorAll(".edit-task-btn").forEach(i=>{i.addEventListener("click",s=>{const a=s.target.closest("button").dataset.taskId,n=t.find(r=>r.id===a);n&&mo(e,n)})}),e.querySelectorAll(".approve-task-btn").forEach(i=>{i.addEventListener("click",s=>{const a=s.target.closest("button").dataset.taskId,n=t.find(r=>r.id===a);n&&go(e,n)})})}function uo(e,t,i){var f,b,k,y,w,P;const s=document.createElement("div");s.style.cssText=`
    position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);
    display:flex;align-items:center;justify-content:center;z-index:1000
  ...
  `,document.body.appendChild(s),s.querySelector(".cancel-resolution").addEventListener("click",()=>s.remove()),l&&s.querySelector(".confirm-resolution").addEventListener("click",async S=>{const h=S.target,g=h.dataset.progress,x=h.dataset.assignedTo,N=h.dataset.adminOverride==="true",T=s.querySelector("#approval-notes").value;h.disabled=!0,h.innerHTML='<span class="spinner dark"></span> Approving...';try{const L=await fetch(`${A}/msgcenter/tasks/${e}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({taskStatus:"Resolved",approvalStatus:"Approved",progress:g,assignedTo:x,notes:T?`[Admin: ${T}]`:N?"[Admin Override]":"",siteUrl:m.settings.sharepointSiteUrl||"root"})}),Y=await L.json();if(L.ok&&Y.success){u("✓ Task resolved and approved successfully","success"),s.remove();const me=document.getElementById("page-tasks");me&&await ze(me)}else u(`Error: ${Y.error}`,"error")}catch(L){u(`Error: ${L.message}`,"error")}finally{h.disabled=!1,h.innerHTML="✓ Approve & Resolve Task"}})}function vo(e,t){const i=document.createElement("div");i.style.cssText=`
    position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);
    display:flex;align-items:center;justify-content:center;z-index:1000
  `,i.innerHTML=`
...
→ **Applications → Secret & Certificate Expiry** for rotation roadmap.`}];let st="executive",B={type:"all",status:"all",search:""},_e=[],Oi=!1,F=[],pe=[],ee=[],at=[],Vt=[],Ve=[],Ui=[],ke=[],Pe=[],nt=[];const Rs=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"appregistrations",label:"App Registrations",icon:"ti-app-window"},{id:"enterprise",label:"Enterprise Apps",icon:"ti-grid-dots"},{id:"secrets",label:"Secrets & Certs",icon:"ti-lock"},{id:"permissions",label:"Permissions",icon:"ti-shield-check"},{id:"auditconsents",label:"Audit Consents",icon:"ti-history"},{id:"owners",label:"Owners",icon:"ti-users"},{id:"usage",label:"Usage Analytics",icon:"ti-chart-line"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"lifecycle",label:"Lifecycle",icon:"ti-timeline"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"App Copilot",icon:"ti-robot"}];async function ho(){const e=document.getElementById("page-applications");if(!e)return;if(K()){console.log("🎭 Demo account detected - showing demo applications data"),bo(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading real M365 application data...</p></div>',console.log("📡 Fetching real application data from backend...");const t=await pa();t!=null&&t.success&&t.data?(F=t.data,console.log(`✅ Apps: ${F.length}`)):(console.warn("⚠️ No application data available from API"),F=[]);const i=await ua();i!=null&&i.success&&i.data?(pe=i.data,console.log(`✅ SPs: ${pe.length}`)):(console.warn("⚠️ No service principal data available from API"),pe=[]);try{const a=await(await fetch(`${A}/secrets-certificates`)).json();a!=null&&a.success&&(ee=a.data||[],console.log(`✅ Secrets: ${ee.length}`))}catch(s){console.warn("⚠️ Secrets error:",s.message)}try{console.log(`🔄 Fetching permissions from ${A}/permissions`);const s=await fetch(`${A}/permissions`);console.log(`📦 Permissions response status: ${s.status}`);const a=await s.json();console.log("📊 Permissions response:",a),a!=null&&a.success?(at=a.data||[],console.log(`✅ Permissions: ${at.length} items`)):console.warn("⚠️ Permissions endpoint returned success=false")}catch(s){console.warn("⚠️ Permissions error:",s.message,s.stack)}try{const a=await(await fetch(`${A}/admin-consents`)).json();a!=null&&a.success&&(Vt=a.data||[],console.log(`✅ Consents: ${Vt.length}`))}catch(s){console.warn("⚠️ Consents error:",s.message)}try{const a=await(await fetch(`${A}/recent-consents`)).json();a!=null&&a.success&&(Ui=a.data||[],console.log(`✅ Recent Consents: ${Ui.length}`))}catch(s){console.warn("⚠️ Recent Consents error:",s.message)}try{const a=await(await fetch(`${A}/audit-logs/consents`)).json();a!=null&&a.success&&(Ve=a.data||[],console.log(`✅ Audit Consents: ${Ve.length}`))}catch(s){console.warn("⚠️ Audit Consents error:",s.message)}try{const a=await(await fetch(`${A}/usage-analytics`)).json();a!=null&&a.success&&(ke=a.data||[],console.log(`✅ Usage: ${ke.length}`))}catch(s){console.warn("⚠️ Usage error:",s.message)}try{const a=await(await fetch(`${A}/risk-assessment`)).json();a!=null&&a.success&&(Pe=a.data||[],console.log(`✅ Risks: ${Pe.length}`))}catch(s){console.warn("⚠️ Risk error:",s.message)}try{const a=await(await fetch(`${A}/recommendations`)).json();a!=null&&a.success&&(nt=a.data||[],console.log(`✅ Recs: ${nt.length}`))}catch(s){console.warn("⚠️ Recs error:",s.message)}be(e)}function bo(e){const t=[{id:"app-001",name:"Power BI Service",owners:["Chen Wei","Priya Kumar"],lastUsed:"2026-06-01",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-002",name:"Salesforce Integration",owners:["Aisha Raza"],lastUsed:"2026-06-01",status:"active",riskLevel:"medium",secretsExpiring:1},{id:"app-003",name:"ServiceNow Connector",owners:["Chen Wei","Sanjay Kumar"],lastUsed:"2026-05-31",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-004",name:"Slack Integration",owners:["Priya Kumar"],lastUsed:"2026-05-30",status:"inactive",riskLevel:"low",secretsExpiring:0},{id:"app-005",name:"Azure DevOps Extension",owners:["Chen Wei"],lastUsed:"2026-06-01",status:"active",riskLevel:"high",secretsExpiring:2}],i={totalApps:t.length,activeApps:4,secretsExpiring:3},s=[{appName:"Salesforce Integration",type:"Client Secret",expiresAt:"2026-06-15",status:"Expiring soon",daysLeft:14},{appName:"Azure DevOps Extension",type:"Client Secret",expiresAt:"2026-06-10",status:"Expiring soon",daysLeft:9},{appName:"Azure DevOps Extension",type:"Certificate",expiresAt:"2026-06-08",status:"Critical",daysLeft:7}];e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const a=e.querySelector("#app-content");ji(a,i,t),e.querySelectorAll("#app-tabs .tab-btn").forEach(n=>{n.addEventListener("click",()=>{e.querySelectorAll("#app-tabs .tab-btn").forEach(o=>o.classList.remove("active")),n.classList.add("active");const r=n.dataset.tab;r==="executive"?ji(a,i,t):r==="appregistrations"?xo(a,t):r==="enterprise"?wo(a,t):r==="secrets"&&ko(a,s)})})}function ji(e,t,i){const s=i.filter(a=>a.riskLevel==="high");e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function be(e){var a,n;const t=(ee||[]).filter(r=>r.status==="expiring").length,i=(ee||[]).filter(r=>r.status==="expired").length,s=(Pe||[]).filter(r=>r.severity==="critical").length;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-app-window"></i> Entra Applications</div>
        <div class="page-subtitle">Application Registrations & Enterprise Apps · ${F.length} app registrations · Last sync: Today 08:45</div>
      </div>
      <div class="page-actions">
    ...
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
        <div class="kpi-value info">${F.length}</div>
      ...
      <div class="kpi-tile">
        <div class="kpi-value warning">${yo.highPrivilegeApps}</div>
    ...
    <div class="tabs" id="app-subnav">
      ${Rs.map(r=>`
        <button class="tab-btn ${st===r.id?"active":""}" data-app-section="${r.id}">
          <i class="ti ${r.icon}"></i><span>${r.label}</span>
          ${r.id==="secrets"&&i+t>0?`<span class="app-tab-badge red">${i+t}</span>`:""}
          ${r.id==="risk"&&s>0?`<span class="app-tab-badge red">${s}</span>`:""}
          ${r.id==="recommendations"?`<span class="app-tab-badge amber">${nt.length}</span>`:""}
        </button>
      `).join("")}
    </div>

    <!-- Content area -->
    <div id="app-content" style="margin-top:16px">${Ao()}</div>
  `,e.querySelectorAll("#app-subnav .tab-btn").forEach(r=>{r.addEventListener("click",()=>{st=r.dataset.appSection,be(e)})}),(a=e.querySelector("#app-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#app-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u(`Application inventory updated — ${F.length} app registrations, ${pe.length} service principals scanned.`,"success")},2200)}),(n=e.querySelector("#app-audit"))==null||n.addEventListener("click",()=>u("Application audit exported as CSV.","success")),qo(e)}function Ao(){return({executive:Fi,appregistrations:So,enterprise:$o,secrets:Eo,permissions:Co,auditconsents:Po,owners:Mo,usage:To,risk:Lo,lifecycle:Ro,recommendations:Do,copilot:Io}[st]||Fi)()}function Fi(){console.log(`📊 Executive: Apps=${F.length}, SPs=${pe.length}, Secrets=${ee.length}`);const e=ee.filter(a=>a.status==="expiring").length,t=ee.filter(a=>a.status==="expired").length,i=Pe.filter(a=>a.severity==="critical").length,s=ke.filter(a=>a.status==="unused").length;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-header">
          <span class="card-title"><i class="ti ti-app-window"></i> Application Inventory</span>
        </div>
        ${Bi([{label:"Total App Registrations",val:F.length,cls:"info"},{label:"Enterprise Applications",val:pe.length,cls:"info"},{label:"Multi-Tenant Apps",val:(F.filter(a=>a.signInAudience==="AzureADMultipleOrgs")||[]).length,cls:"warning"},{label:"High Privilege Apps",val:at.filter(a=>a.riskLevel==="critical").length,cls:"danger"},{label:"Certificate-Based",val:ee.filter(a=>a.type==="Certificate").length,cls:"success"},{label:"Unused (90+ days)",val:s,cls:"warning"}])}
      </div>
      ...
      <div class="card">
        ...
        ${Bi([{label:"Expired Secrets",val:t,cls:"danger"},{label:"Expiring (30 days)",val:e,cls:"warning"},{label:"Expiring (60 days)",val:ee.filter(a=>a.daysRemaining<=60&&a.daysRemaining>30).length,cls:"warning"},{label:"Apps Requiring Admin Consent",val:Vt.length,cls:"warning"}])}
      </div>
    </div>
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        ${nt.filter(a=>a.priority==="critical").slice(0,4).map(a=>`
  ...
  `}function So(){const e=F.length>0?F:[],t=e.filter(s=>!(B.type!=="all"&&s.category!==B.type||B.status!=="all"&&s.status!==B.status||B.search&&!s.name.toLowerCase().includes(B.search.toLowerCase()))),i=[...new Set(e.map(s=>s.category))];return`
    <div class="filter-bar mb-3">
      <input type="text" class="form-input" id="app-search" placeholder="Search app name..." value="${B.search}" style="min-width:200px">
      <select class="form-select" id="app-type-filter">
        <option value="all">All Categories</option>
        ${i.map(s=>`<option value="${s}" ${B.type===s?"selected":""}>${s}</option>`).join("")}
      </select>
  ...
  `}function $o(){const e=pe.length>0?pe:[];return`
    <div class="filter-bar mb-3">
  ...
  `}function Eo(){const e=ee.filter(s=>s.status==="expired"),t=ee.filter(s=>s.status==="expiring"),i=ee.filter(s=>s.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Co(){const e=at.filter(i=>i.riskLevel==="critical"),t=at.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Po(){return`
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <div style="padding:12px;border-bottom:0.5px solid var(--color-border-secondary);background:var(--color-background-secondary)">
        <span style="font-weight:600;font-size:12px">Consent Activities from Audit Logs (${Ve.length})</span>
      </div>
      ${Ve.length===0?`
        <div style="padding:20px;text-align:center;color:var(--color-text-tertiary)">
          <i class="ti ti-inbox" style="font-size:28px;margin-bottom:8px;display:block"></i>
      ...
      `:`
        <table style="width:100%">
          ...
          <tbody>
            ${Ve.map(e=>{var s;const t=e.scope&&e.scope!=="N/A"?e.scope:"—",i=t!=="—"&&!t.toLowerCase().includes("read");return`
  ...
  `}function Mo(){const e=F.length>0?F:[],t=e.filter(a=>!a.owners||a.owners.length===0),i=e.filter(a=>a.owners&&a.owners.length===1),s=e.filter(a=>a.owners&&a.owners.length>1);return`
    ${t.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function To(){const e=ke.filter(s=>s.status==="active"),t=ke.filter(s=>s.status==="lowuse"),i=ke.filter(s=>s.status==="unused");return`
    ...
    `).join("")}
  `}function Lo(){const e=Pe.filter(i=>i.severity==="critical"),t=Pe.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Ro(){const e=F.length>0?F:[],t=e.filter(a=>{const n=a.createdDateTime?new Date(a.createdDateTime):null;if(!n)return!1;const r=new Date(Date.now()-30*24*60*60*1e3);return n>r}),i=e.filter(a=>!a.owners||a.owners.length===0),s=ke.filter(a=>a.status==="unused");return`
  ...
  `}function Io(){(!Oi||_e.length===0)&&(_e=[{role:"ai",text:`**Applications & App Registrations Copilot** — Ask me about app security, secrets, permissions, risks, and more.
...
Current state: **87 app registrations**, **124 enterprise apps**, **5 expiring secrets (30d)**, **2 critical risk apps**`}],Oi=!0);const e=["Show expiring secrets","Which apps have Directory.ReadWrite.All?","List apps without owners","Show high-risk applications","Unused apps (90+ days)","Multi-tenant applications"];return`
      ...
      <div style="overflow-y:auto;flex:1;padding-bottom:8px" id="app-cop-msgs">
        ${_e.map(t=>`
          <div class="chat-msg ${t.role==="ai"?"ai":"user-msg"}" style="max-width:85%;margin-bottom:12px">
            ...
            <div class="chat-bubble">${Ds(t.text)}</div>
          </div>
        `).join("")}
      </div>
  ...
  `}function Bi(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
    ...
    `).join("")}
  </div>`}function qo(e){var a,n,r,o,l;const t=e.querySelector("#app-content");if(!t)return;(a=t.querySelector("#app-search"))==null||a.addEventListener("input",c=>{B.search=c.target.value,be(e)}),(n=t.querySelector("#app-type-filter"))==null||n.addEventListener("change",c=>{B.type=c.target.value,be(e)}),(r=t.querySelector("#app-status-filter"))==null||r.addEventListener("change",c=>{B.status=c.target.value,be(e)}),(o=t.querySelector("#exec-view-risk"))==null||o.addEventListener("click",()=>{st="risk",be(e)}),(l=t.querySelector("#exec-view-recs"))==null||l.addEventListener("click",()=>{st="recommendations",be(e)});const i=t.querySelector("#app-cop-send"),s=t.querySelector("#app-cop-input");i&&s&&(i.addEventListener("click",()=>Tt(e,s)),s.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),Tt(e,s))})),t.querySelectorAll(".app-cop-pill").forEach(c=>{c.addEventListener("click",()=>{const d=t.querySelector("#app-cop-input");d&&(d.value=c.dataset.q,Tt(e,d))})})}function Tt(e,t){const i=t.value.trim();if(!i)return;_e.push({role:"user",text:i}),t.value="";const s=e.querySelector("#app-cop-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,s.scrollTop=s.scrollHeight),setTimeout(()=>{const a=i.toLowerCase(),n=fo.find(o=>o.keywords.some(l=>a.includes(l))),r=(n==null?void 0:n.response)||`Searching application data for **"${i}"**...

Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;_e.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        <div class="chat-sender"><i class="ti ti-app-window" style="color:var(--clr-info-text)"></i> App Copilot</div>
        <div class="chat-bubble">${Ds(r)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function Ds(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}let Wt="executive",ht=[],Hi=!1,We=[],Je=[],E={summary:{},endpointSecurity:{},patchManagement:{},riskAssessment:{},deviceHealth:[],applications:[],policies:{configurationPolicies:[],conditionalAccessPolicies:[]},recommendations:[]};const Is=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"health",label:"Device Health",icon:"ti-heartbeat"},{id:"compliance",label:"Compliance",icon:"ti-check-circle"},{id:"inventory",label:"Device Inventory",icon:"ti-device-laptop"},{id:"security",label:"Endpoint Security",icon:"ti-shield-check"},{id:"patches",label:"Patch Management",icon:"ti-refresh"},{id:"apps",label:"Applications",icon:"ti-app-window"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"policies",label:"Policies",icon:"ti-settings-2"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Intune Copilot",icon:"ti-robot"}],zo={windowsBaseline:{score:92,compliant:847,nonCompliant:15},defenderBaseline:{score:88,compliant:832,nonCompliant:30},edgeBaseline:{score:95,compliant:856,nonCompliant:6},msAppsBaseline:{score:85,compliant:812,nonCompliant:50}};async function No(){const e=document.getElementById("page-intune");if(e){if(K()){console.log("🎭 Demo account detected - showing demo Intune data"),Go(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading comprehensive Intune data...</p></div>',console.log("📡 Fetching comprehensive Intune data from backend...");try{const[t,i,s,a,n,r,o,l,c,d]=await Promise.all([Jt(),sa(),M("/intune/summary"),M("/intune/endpoint-security"),M("/intune/patch-management"),M("/intune/risk-assessment"),M("/intune/device-health"),M("/intune/applications"),M("/intune/policies"),M("/intune/recommendations")]);t.success&&t.data?(We=t.data,console.log(`✅ Loaded ${We.length} real devices`)):(console.warn("⚠️ No device data available from API"),We=[]),i.success&&i.data?(Je=i.data,console.log(`✅ Loaded ${Je.length} real policies`)):(console.warn("⚠️ No policy data available from API"),Je=[]),s.success&&s.data?(E.summary=s.data,console.log("✅ Loaded Intune summary")):E.summary={},a.success&&a.data&&(E.endpointSecurity=a.data,console.log("✅ Loaded endpoint security data")),n.success&&n.data&&(E.patchManagement=n.data,console.log("✅ Loaded patch management data")),r.success&&r.data&&(E.riskAssessment=r.data,console.log("✅ Loaded risk assessment data")),o.success&&o.data&&(E.deviceHealth=o.data,console.log("✅ Loaded device health data")),l.success&&l.data&&(E.applications=l.data,console.log("✅ Loaded applications data")),c.success&&c.data&&(E.policies=c.data,console.log("✅ Loaded policies data")),d.success&&d.data&&(E.recommendations=d.data,console.log("✅ Loaded recommendations data")),console.log("✅ All Intune data loaded successfully")}catch(t){console.error("❌ Error loading Intune data:",t)}qs(e)}}function Go(e){const t=[{id:"DEV-001",name:"LAPTOP-PRIYA01",os:"Windows 11",osVersion:"23H2",compliance:"Compliant",owner:"Priya Kumar",lastSync:"2026-06-01"},{id:"DEV-002",name:"LAPTOP-CHEN02",os:"Windows 11",osVersion:"23H2",compliance:"Compliant",owner:"Chen Wei",lastSync:"2026-06-01"},{id:"DEV-003",name:"IPAD-AISHA01",os:"iPadOS",osVersion:"17.5",compliance:"Compliant",owner:"Aisha Raza",lastSync:"2026-06-01"},{id:"DEV-004",name:"IPHONE-SANJAY01",os:"iOS",osVersion:"17.5",compliance:"Non-compliant",owner:"Sanjay Kumar",lastSync:"2026-05-31"},{id:"DEV-005",name:"LAPTOP-JAMES03",os:"Windows 10",osVersion:"22H2",compliance:"Non-compliant",owner:"James Liu",lastSync:"2026-05-30"}],i={totalDevices:847,compliantDevices:801,nonCompliantDevices:46,enrolledToday:3,updatesPending:12};e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#intune-content");_i(s,i,t),e.querySelectorAll("#intune-tabs .tab-btn").forEach(a=>{a.addEventListener("click",()=>{e.querySelectorAll("#intune-tabs .tab-btn").forEach(r=>r.classList.remove("active")),a.classList.add("active");const n=a.dataset.tab;n==="executive"?_i(s,i,t):n==="health"?Oo(s,t):n==="compliance"?Uo(s):n==="inventory"?jo(s,t):n==="security"?Fo(s):n==="patches"?Bo(s):s.innerHTML=`<div class="card"><div class="card-header"><span class="card-title">${a.textContent}</span></div><div style="padding:20px;text-align:center;color:var(--color-text-tertiary)">Demo data for ${a.textContent}</div></div>`})})}function _i(e,t,i){e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function qs(e){var a,n;const t=E.summary,i=E.riskAssessment.criticalRiskCount||0,s=E.riskAssessment.highRiskCount||0;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-device-laptop"></i> Microsoft Intune Insights</div>
    ...
    <div class="tabs" id="intune-subnav">
      ${Is.map(r=>`
        <button class="tab-btn ${Wt===r.id?"active":""}" data-intune-section="${r.id}">
          <i class="ti ${r.icon}"></i><span>${r.label}</span>
  ...
  `,e.querySelectorAll("#intune-subnav .tab-btn").forEach(r=>{r.addEventListener("click",()=>{Wt=r.dataset.intuneSection,qs(e)})}),(a=e.querySelector("#intune-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#intune-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u("Intune inventory updated — 847 devices scanned, 4 compliance policies evaluated.","success")},2200)}),(n=e.querySelector("#intune-remediate"))==null||n.addEventListener("click",()=>u("Remediation workflow initiated — ${criticalRisks} critical devices tagged for action.","info")),tl(e)}function Ho(){return({executive:Vi,health:_o,compliance:Vo,inventory:Wo,security:Jo,patches:Ko,apps:Yo,risk:Zo,policies:Qo,recommendations:Xo,copilot:el}[Wt]||Vi)()}function Vi(){const e=E.summary,t=E.summary.platformDistribution||PLATFORM_DISTRIBUTION;return`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${["windowsBaseline","defenderBaseline","edgeBaseline","msAppsBaseline"].map((i,s)=>{const a=zo[i];return`
            <div style="margin-bottom:10px">
              <div style="display:flex;justify-content:space-between;margin-bottom:4px;font-size:11px;font-weight:600">
  ...
  `}function _o(){const e=E.summary,t=E.deviceHealth||[];return t.length>0&&Math.round(t.reduce((i,s)=>i+s.healthScore,0)/t.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Vo(){const e=E.summary,t=Math.max(0,(e.totalManagedDevices||0)-(e.nonCompliant||0));return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        ...
        <tbody>
          ...
          `).join("")}
          ${Je.length===0?'<tr><td colspan="6" style="text-align:center;padding:20px;color:var(--color-text-tertiary)">No compliance policies found - Real data from tenant</td></tr>':""}
        </tbody>
      </table>
    </div>
  `}function Wo(){return`
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <table style="font-size:11px">
        ...
        <tbody>
          ...
          `).join("")}
          ${We.length===0?'<tr><td colspan="9" style="text-align:center;padding:20px;color:var(--color-text-tertiary)">No devices enrolled in Intune - Real data from tenant</td></tr>':""}
        </tbody>
      </table>
    </div>
  ...
  `}function Ko(){const e=E.patchManagement;return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
  ...
  `}function Zo(){const e=E.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function Qo(){const e=E.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
  ...
  `}function Xo(){const e=E.recommendations||[];return`
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        <thead><tr>
          <th style="width:11%">Priority</th>
  ...
  `}function el(){if(!Hi){const t=E.summary||{},i=E.riskAssessment||{};ht=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.

**Current state:** ${t.totalManagedDevices||0} managed devices, ${t.compliancePercentage||0}% compliant, ${t.deviceHealthScore||0}/100 health score, ${i.criticalRiskCount||0} critical risks`}],Hi=!0}const e=["Show device health summary","Patch management status","Encryption coverage","Firewall & protection status","Critical risk devices","Compliance policies"];return`
    <div style="display:flex;flex-direction:column;height:calc(100vh - 340px);min-height:450px">
  ...
  `}function zs(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
      <div style="padding:8px 10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md)">
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:3px;text-transform:uppercase;font-weight:600">${t.label}</div>
        <div style="font-size:16px;font-weight:700;color:${t.cls==="success"?"var(--clr-success-text)":t.cls==="danger"?"var(--clr-danger-text)":t.cls==="warning"?"var(--clr-warning-text)":"var(--clr-info-text)"}">${t.val}</div>
    ...
    `).join("")}
  </div>`}function tl(e){const t=e.querySelector("#intune-content");if(!t)return;const i=t.querySelector("#intune-cop-send"),s=t.querySelector("#intune-cop-input");i&&s&&(i.addEventListener("click",()=>Lt(e,s)),s.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),Lt(e,s))})),t.querySelectorAll(".intune-cop-pill").forEach(a=>{a.addEventListener("click",()=>{const n=t.querySelector("#intune-cop-input");n&&(n.value=a.dataset.q,Lt(e,n))})})}function Lt(e,t){const i=t.value.trim();if(!i)return;ht.push({role:"user",text:i}),t.value="";const s=e.querySelector("#intune-cop-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
...
Ask me about device health, compliance, security, patches, or recommendations!`;ht.push({role:"ai",text:c}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        <div class="chat-sender"><i class="ti ti-robot" style="color:var(--clr-info-text)"></i> Intune Advisor</div>
        <div class="chat-bubble">${Ns(c)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function Ns(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}const Gs={displayName:"Rajkumar Duraisami",upn:"rajkumar.duraisami@contoso.com",email:"rajkumar.duraisami@contoso.com",employeeId:"EMP-2024-001",jobTitle:"Cloud Solutions Architect",department:"Cloud Engineering",manager:"Sarah Johnson",lastSignIn:"Today 08:45",accountStatus:"Enabled",phone:"+1 (555) 123-4567",office:"Seattle, WA",mobilePhone:"+1 (555) 987-6543"},Os={mfaStatus:"Enabled",mfaDefaultMethod:"Microsoft Authenticator",passwordLastChanged:"45 days ago",passwordExpiryDate:"15 days remaining",ssfrRegistration:"Completed",riskLevel:"Low",securityScore:92,authenticationMethods:[{type:"Password",status:"Enabled"},{type:"Microsoft Authenticator",status:"Enabled",registered:!0},{type:"FIDO2 Security Key",status:"Not registered"},{type:"Phone Authentication",status:"Enabled"},{type:"Email OTP",status:"Not registered"}],riskDetections:[{type:"Impossible Travel",status:"No",lastDetected:null},{type:"Anonymous IP",status:"No",lastDetected:null},{type:"Malware-linked IP",status:"No",lastDetected:null},{type:"Unfamiliar Sign-in",status:"No",lastDetected:null}]},Us=[{date:"Today 08:45",app:"Microsoft 365 Portal",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 17:30",app:"Teams",device:"iPhone",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 09:15",app:"Exchange Online",device:"Windows-Laptop",browser:"Edge",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"2 days ago 14:20",app:"SharePoint",device:"iPad",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"3 days ago 10:00",app:"OneDrive",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"}],js=[{name:"Microsoft 365 E5",sku:"ENTERPRISEPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Enterprise Mobility + Security E5",sku:"EMSPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Power BI Premium",sku:"POWER_BI_PREMIUM_P1",assignmentType:"Group",assignmentSource:"Group License"},{name:"Teams Phone Standard",sku:"TEAMS_PHONE_STANDARD",assignmentType:"Direct",assignmentSource:"Admin"}],Ke={securityGroups:[{name:"Cloud Architects",type:"Security",membershipType:"Member"},{name:"M365-Admins",type:"Security",membershipType:"Member"},{name:"Security Review Board",type:"Security",membershipType:"Member"},{name:"Global Readers",type:"Security",membershipType:"Member"}],microsoft365Groups:[{name:"Engineering Team",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!1},{name:"Cloud Solutions Architects",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!0},{name:"Product Innovation",type:"Microsoft 365",teamConnected:!1,dynamicMembership:!1}],distributionLists:[{name:"Cloud-Engineering@contoso.com",type:"Distribution List",membershipType:"Member"},{name:"Security-Team@contoso.com",type:"Distribution List",membershipType:"Owner"}]},Fs={totalStorage:"1 TB",usedStorage:"420 GB",availableStorage:"580 GB",percentageUsed:42,lastActivity:"Today 08:45",fileCount:2847,sharedItems:156,externalShares:12,anonymousLinks:3},Bs={teamsMembership:12,teamsOwned:3,guestAccessTeams:2,teamsPhoneLicense:!0,assignedNumber:"+1 (555) 123-7890",callingPlan:"Domestic and International",teams:[{name:"Engineering Team",role:"Member",owner:"Sarah Johnson"},{name:"Cloud Architects",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Security Review Board",role:"Member",owner:"Chen Wei"},{name:"Product Innovation",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Global Company",role:"Member",owner:"System"}]},Hs=[{name:"LAPTOP-RAJ-001",type:"Windows",osVersion:"22H2",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"BitLocker Enabled",defender:"Active"},{name:"IPHONE-RAJ-001",type:"iOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"Device Encrypted",defender:"Enabled"},{name:"IPAD-RAJ-001",type:"iPadOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"BYOD",lastCheckIn:"Yesterday",encryption:"Device Encrypted",defender:"Enabled"}],il=[{name:"Microsoft Teams",lastAccessed:"Today 08:45",permissionScope:"Full",riskLevel:"Low"},{name:"SharePoint Online",lastAccessed:"Yesterday 14:20",permissionScope:"Read/Write",riskLevel:"Low"},{name:"OneDrive for Business",lastAccessed:"Today 10:15",permissionScope:"Full",riskLevel:"Low"},{name:"Exchange Online",lastAccessed:"Today 09:30",permissionScope:"Full",riskLevel:"Low"},{name:"Power BI",lastAccessed:"2 days ago",permissionScope:"Admin",riskLevel:"Medium"},{name:"Dynamics 365",lastAccessed:"5 days ago",permissionScope:"Read/Write",riskLevel:"Low"}],Ye=[{type:"Group Membership Request",group:"Data Governance Board",status:"Pending",submittedDate:"2 days ago",description:"Waiting for manager approval"},{type:"Distribution List Request",list:"Customer Success@contoso.com",status:"Pending",submittedDate:"1 day ago",description:"Awaiting IT approval"}],sl={personalAIReadinessScore:85,recommendations:[{title:"Enable Microsoft Authenticator",impact:"Improves security by 15%",priority:"High",status:"Recommended"},{title:"Complete Security Awareness Training",impact:"Unlocks advanced features",priority:"High",status:"Recommended"},{title:"Review OneDrive Sharing Settings",impact:"Improves data governance by 8%",priority:"Medium",status:"Recommended"},{title:"Register FIDO2 Security Key",impact:"Improves security by 20%",priority:"Medium",status:"Optional"}],exchangeUsage:78,teamsUsage:92,oneDriveUsage:42,sharePointUsage:65};let Fe="executive",$={profile:Gs,security:Os,signin:Us,licenses:js,groups:Ke,onedrive:Fs,teams:Bs,devices:Hs};const al=[{id:"executive",label:"Executive Summary",icon:"ti-dashboard"},{id:"profile",label:"Profile",icon:"ti-user"},{id:"security",label:"Security",icon:"ti-shield-check"},{id:"signin",label:"Sign-in Activity",icon:"ti-login"},{id:"licenses",label:"Licenses",icon:"ti-license"},{id:"groups",label:"Groups",icon:"ti-users"},{id:"devices",label:"Devices",icon:"ti-device-laptop"},{id:"apps",label:"Apps & Access",icon:"ti-app-window"},{id:"onedrive",label:"OneDrive",icon:"ti-cloud"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"approvals",label:"Pending Approvals",icon:"ti-check"},{id:"copilot",label:"Copilot Insights",icon:"ti-robot"}];async function nl(){const e=document.getElementById("page-myaccount");if(e){try{console.log("📡 Fetching My Account data from backend...");const t=window.userEmail;if(!t){console.error("❌ User email not found. Make sure you are logged in."),u("Error: User not authenticated. Please log in again.","error");return}console.log(`Fetching data for user: ${t}`);const[i,s,a,n,r,o,l,c,d]=await Promise.allSettled([fetch(`${A}/me/profile?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/security?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/signin-activity?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/licenses?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/groups?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/onedrive?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/teams?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/devices?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/mailbox?email=${encodeURIComponent(t)}`).then(p=>p.json())]);$.profile=i.status==="fulfilled"&&i.value.success?i.value.data:Gs,$.security=s.status==="fulfilled"&&s.value.success?s.value.data:Os,$.signin=a.status==="fulfilled"&&a.value.success?a.value.data.recentSignins:Us,$.licenses=n.status==="fulfilled"&&n.value.success?n.value.data:js,$.groups=r.status==="fulfilled"&&r.value.success?r.value.data:Ke,$.onedrive=o.status==="fulfilled"&&o.value.success?o.value.data:Fs,$.teams=l.status==="fulfilled"&&l.value.success?l.value.data:Bs,$.devices=c.status==="fulfilled"&&c.value.success?c.value.data:Hs,$.mailbox=d.status==="fulfilled"&&d.value.success?d.value.data:{mailboxUsage:65},console.log("✓ My Account data loaded")}catch(t){console.warn("⚠️ Using simulated data:",t.message)}rl(e)}}function rl(e){var t;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="tabs" id="myacc-subnav">
      ${al.map(i=>`
        <button class="tab-btn ${Fe===i.id?"active":""}" data-tab="${i.id}">
          <i class="ti ${i.icon}"></i><span>${i.label}</span>
          ${i.id==="approvals"&&Ye.length>0?`<span class="intune-tab-badge red">${Ye.length}</span>`:""}
        </button>
      `).join("")}
    </div>

    <!-- Content -->
    <div id="myacc-content" style="margin-top:16px">${Wi()}</div>
  `,e.querySelectorAll("#myacc-subnav .tab-btn").forEach(i=>{i.addEventListener("click",()=>{Fe=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=Wi(),Fe==="signin"&&setTimeout(()=>Ji(e),100)})}),Fe==="signin"&&setTimeout(()=>Ji(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,u("Your profile has been refreshed.","success")},1500)})}function Wi(){const t={executive:ol,profile:ll,security:dl,signin:cl,licenses:pl,groups:ul,devices:vl,apps:gl,onedrive:ml,teams:yl,approvals:fl,copilot:hl}[Fe];return t?t():""}function ol(){var d,p,v,f,b,k,y,w;const e=((d=$.security)==null?void 0:d.securityScore)||85,t=((p=$.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((v=$.security)==null?void 0:v.riskLevel)||"Low",s=($.licenses&&Array.isArray($.licenses)?$.licenses.length:0)||((f=$.licenses)==null?void 0:f.count)||0,a=($.devices&&Array.isArray($.devices)?$.devices.length:0)||((b=$.devices)==null?void 0:b.count)||0,n=($.groups&&$.groups.securityGroups?$.groups.securityGroups.length:0)||0,r=((k=$.teams)==null?void 0:k.teamsMembership)||0,o=0,l=((y=$.onedrive)==null?void 0:y.percentageUsed)||0,c=((w=$.mailbox)==null?void 0:w.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function ll(){const e=$.profile;return`
    <div class="card">
  ...
  `}function dl(){const e=$.security;return`
    <div class="card">
  ...
  `}function cl(){const e=$.signin.filter(i=>i.result==="Success"),t=$.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function ul(){return`
    <div style="display:flex;flex-direction:column;gap:16px">
      <div class="card">
        <div class="card-header"><span class="card-title">Security Groups (${Ke.securityGroups.length})</span></div>
        <div style="padding:0;border-top:0.5px solid var(--color-border-secondary)">
      ...
      <div class="card">
        <div class="card-header"><span class="card-title">Microsoft 365 Groups (${Ke.microsoft365Groups.length})</span></div>
        <div style="padding:0;border-top:0.5px solid var(--color-border-secondary)">
      ...
      <div class="card">
        <div class="card-header"><span class="card-title">Distribution Lists (${Ke.distributionLists.length})</span></div>
        <div style="padding:0;border-top:0.5px solid var(--color-border-secondary)">
  ...
  `}function ml(){const e=$.onedrive;return`
    <div class="card">
  ...
  `}function yl(){const e=$.teams;return`
    <div class="card">
  ...
  `}function fl(){return!Ye||Ye.length===0?`
      <div class="card">
  ...
  `,ba(),ss()}function $l(){return["dashboard","requests","security","tenantguard","user-investigation","zerotrust","privaccts","m365config","msgcenter","tasks","applications","intune","licenses","agents","approvals","portal","myreqs","myaccount","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}xl();Zi().catch(e=>{console.error("Login render error:",e),Zi()});
