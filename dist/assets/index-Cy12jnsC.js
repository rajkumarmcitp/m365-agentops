(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const ci=[{id:"demo",name:"Demo Account",email:"demo@contoso.com",role:"admin",initials:"DM",color:"#00C7B7",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"],isDemoAccount:!0},{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","myaccount","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["requests","msgcenter","portal","myreqs","myaccount","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings","graphapi","sso"]}],Qi={auth:{clientId:"04d3be8d-d433-4367-893e-eccc82190a11",authority:"https://login.microsoftonline.com/b9cc8284-05ed-452f-877a-970779430dcb",redirectUri:window.location.origin+"/callback"},cache:{cacheLocation:"sessionStorage",storeAuthStateInCookie:!1},system:{allowNativeBroker:!1}},Xi={scopes:["openid","profile","email","User.Read"]};let F=null;async function es(){try{if(!window.msal)return console.warn("MSAL not loaded yet"),null;F=new window.msal.PublicClientApplication(Qi),await F.initialize();const e=await F.handleRedirectPromise();if(e)return console.log("✓ Authenticated from redirect:",e.account.name),e.account;const t=F.getAllAccounts();return t.length>0?(console.log("✓ Already authenticated as:",t[0].name),t[0]):null}catch(e){return console.error("MSAL init error:",e.message),null}}async function ts(){try{if(!F)return console.error("MSAL not initialized"),null;const e=await F.loginPopup(Xi);return console.log("✓ Login successful:",e.account.name),e.account}catch(e){return e.errorCode==="user_cancelled"?console.log("User cancelled login"):console.error("Login error:",e.errorCode,e.errorMessage),null}}async function is(){try{if(!F)return;const e={account:F.getAllAccounts()[0]};await F.logout(e),console.log("✓ Logged out")}catch(e){console.error("Logout error:",e)}}function ss(){if(!F)return null;const e=F.getAllAccounts();return e.length>0?e[0]:null}function as(){if(window.userEmail)return console.log("📧 getUserEmail from window.userEmail:",window.userEmail),window.userEmail;const e=ss();if(!e)return null;const t=e.username||e.mail||e.email;return console.log("📧 getUserEmail from MSAL:",t),t}function ns(){const e=document.getElementById("app-header"),t=y.currentUser;t&&(e.innerHTML=`
  ...
  `,s.appendChild(a);const n=()=>{a.style.animation="toast-out 200ms ease forwards",setTimeout(()=>a.remove(),200)};a.querySelector(".toast-close").addEventListener("click",n),setTimeout(n,i)}const os=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",A=os?"http://localhost:3000/api":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api",ls=A;async function $(e){try{const t=`${ls}${e}`;console.log(`🔄 Calling: ${t}`);const i=await fetch(t,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"});if(!i.ok)throw new Error(`HTTP ${i.status}: ${i.statusText}`);const s=await i.json();return console.log(`✓ ${e}:`,s),s}catch(t){return console.error(`✗ API error on ${e}:`,t.message),{success:!1,error:t.message,data:[],count:0}}}async function xt(){return $("/devices")}async function ds(){return $("/device-compliance-policies")}async function pi(){return $("/security/score")}async function cs(){return $("/security/incidents")}async function ps(){return $("/identity/posture")}async function us(){return $("/privileged-accounts")}async function vs(){return $("/users")}async function gs(){return $("/applications")}async function ms(){return $("/service-principals")}const ys=["demo@contoso.com","demo@m365ops.com","demo.user@contoso.com"];function fe(){const e=as();if(console.log("🔍 isDemoAccount() check - email:",e),!e)return console.log("❌ No email found"),!1;const t=e.toLowerCase(),i=ys.some(s=>t===s.toLowerCase());return console.log(`✅ isDemoAccount result: ${i}`),i}let Qe=0,Xe=0,et=null,le=[];function fs(){const e=localStorage.getItem("dashboard_consents_dismissed");if(!e)return!1;const t=new Date().getTime(),i=parseInt(e);return(t-i)/(1e3*60*60)<24}async function hs(){var i,s,a,n,r,o,d,l;const e=document.getElementById("page-dashboard");if(!e)return;if(fe()){bs(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading dashboard data...</p></div>';try{console.log("📡 Fetching real dashboard data from backend...");const c=await xt(),p=await vs(),b=await pi();Qe=c.success&&c.count?c.count:0,Xe=p.success&&p.count?p.count:0,et=b.success?b.data:null;try{const x=await $("/audit-logs/consents");if(x.success&&x.data){const g=new Date,m=new Date(g.getTime()-24*60*60*1e3);le=x.data.filter(v=>new Date(v.activityDateTime)>=m).sort((v,w)=>new Date(w.activityDateTime)-new Date(v.activityDateTime)).slice(0,5),console.log(`✅ Loaded ${le.length} recent admin consents (last 24 hours)`)}}catch(x){console.warn("⚠️ Could not fetch recent admin consents:",x.message)}console.log(`✅ Loaded dashboard data: ${Qe} devices, ${Xe} users`)}catch(c){console.error("❌ Error loading dashboard data:",c)}e.innerHTML=`
  ...
  `}let O=[],ce=null,Oe="PENDING_APPROVAL",Be="list";async function ws(){const e=document.getElementById("page-requests");e&&(await ui(),Ye(e))}async function ui(e){try{const i=await(await fetch(`${A}/requests?limit=100`)).json();O=Array.isArray(i.data)?i.data:[],console.log(`📋 Loaded ${O.length} requests`)}catch(t){console.error("Error loading requests:",t),u("Failed to load requests","error")}}function Ye(e){if(!e||!e.querySelector){console.error("❌ Page element not found or invalid");return}const t=Oe==="ALL"?O:O.filter(s=>s.status===Oe),i={total:O.length,pending:O.filter(s=>s.status==="PENDING_APPROVAL").length,approved:O.filter(s=>s.status==="APPROVED").length,rejected:O.filter(s=>s.status==="REJECTED").length,completed:O.filter(s=>s.status==="COMPLETED").length};e.innerHTML=`
    <div class="page-header">
      <div>
              ...
              ${t.map(s=>{var a,n;return`
                <tr style="border-bottom:0.5px solid var(--color-border-tertiary);cursor:pointer" data-id="${s.id}">
                  ...
                  <td style="padding:10px 12px">
                    <span style="padding:2px 6px;border-radius:3px;font-size:10px;background:${gi((a=s.validation)==null?void 0:a.riskLevel)};color:white">
                      ${((n=s.validation)==null?void 0:n.riskLevel)||"MEDIUM"}
                    </span>
                  </td>
                  <td style="padding:10px 12px">${vi(s.status)}</td>
  ...
  `,e&&e.querySelector&&["ALL","PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].forEach(s=>{const a=e.querySelector(`#filter-${s}`);a&&a.addEventListener("click",()=>{Oe=s,Ye(e)})}),e&&e.querySelectorAll&&(e.querySelectorAll("tr[data-id]").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;ce=O.find(n=>n.id===a),ce&&(Be="details",Ct(e))})}),e.querySelectorAll(".req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;ce=O.find(r=>r.id===n),ce&&(Be="details",Ct(e))})}))}function Ct(e){var a,n,r,o,d;if(!e||!e.querySelector||!ce)return;const t=ce,i=As(t);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        <button class="btn" id="back-btn"><i class="ti ti-arrow-left"></i> Back</button>
        <div>
          <div class="page-title">${t.id}</div>
          <div class="page-subtitle">${t.operationId} • ${vi(t.status)}</div>
        </div>
      </div>
    </div>
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
              <div style="font-size:28px;font-weight:600;color:${gi((a=t.validation)==null?void 0:a.riskLevel)}">${((n=t.validation)==null?void 0:n.riskScore)||0}</div>
              <div>
  ...
  `;const s=e.querySelector("#back-btn");if(s&&s.addEventListener("click",()=>{Be="list",Ye(e)}),t.status==="PENDING_APPROVAL"&&i){const l=e.querySelector("#approve-btn"),c=e.querySelector("#reject-btn");l&&l.addEventListener("click",async()=>{const p=e.querySelector("#approval-comment").value;await Mt(t.id,"APPROVED",i.step,p,e)}),c&&c.addEventListener("click",async()=>{const p=e.querySelector("#approval-comment").value;if(!p){u("Please provide a reason for rejection","warning");return}await Mt(t.id,"REJECTED",i.step,p,e)})}}function vi(e){return{PENDING_APPROVAL:'<span style="color:var(--clr-warning-text)">⏳ Pending</span>',APPROVED:'<span style="color:var(--clr-success-text)">✓ Approved</span>',REJECTED:'<span style="color:var(--clr-danger-text)">✗ Rejected</span>',COMPLETED:'<span style="color:var(--clr-success-text)">✓✓ Completed</span>',FAILED:'<span style="color:var(--clr-danger-text)">! Failed</span>'}[e]||e}function gi(e){return{LOW:"#10b981",MEDIUM:"#f59e0b",HIGH:"#ef4444",CRITICAL:"#991b1b"}[e]||"#6b7280"}function As(e){var i;if(e.status!=="PENDING_APPROVAL")return null;const t=((i=e.validation)==null?void 0:i.approvalPath)||["manager","it","agent","action"];for(const s of t){if(s==="agent"||s==="action")continue;if(!e.approvals.find(n=>n.step===s&&n.status==="APPROVED"))return{step:s,approverRole:s,status:"PENDING"}}return null}async function Mt(e,t,i,s,a){try{const n=t==="APPROVED"?"approve":"reject",r=t==="APPROVED"?{approverEmail:window.userEmail,approverRole:i,comment:s}:{rejectorEmail:window.userEmail,rejectorRole:i,reason:s};(await(await fetch(`${A}/requests/${e}/${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})).json()).success?(u(`Request ${t==="APPROVED"?"approved":"rejected"} successfully`,"success"),await ui(a),Be="list",Ye(a)):u("Failed to process approval","error")}catch(n){console.error("Approval error:",n),u("Error submitting approval. Please try again.","error")}}const S={totalUsers:1e3,privAccounts:14,globalAdmins:2,serviceAccounts:12,breakGlass:2,mfaEnabled:870,mfaExcluded:130,passwordlessAdoption:23,fido2Adoption:5,legacyAuthConnections:12,highRiskUsers:3,riskySignIns30d:47,impossibleTravel30d:2,anonymousIP30d:8,passwordSpray30d:0,caPoliciesEnabled:25,caPoliciesDisabled:5,caPoliciesReportOnly:3,caUsersExcluded:18,identitySecureScore:72},ks=[{id:"INC-2341",severity:"critical",title:"Ransomware Indicators — Device MBX-LAPTOP-047",category:"Malware",status:"active",assignee:"Aisha Raza",created:"3h ago",services:["Endpoint","Identity"]},{id:"INC-2338",severity:"high",title:"BEC Attempt — Invoice Fraud Pattern Detected",category:"Phishing",status:"active",assignee:"Chen Wei",created:"6h ago",services:["Exchange"]},{id:"INC-2335",severity:"high",title:"Risky Sign-in — kevin.osei@contoso.com (Unfamiliar Location)",category:"Identity Attack",status:"active",assignee:"Aisha Raza",created:"14h ago",services:["Identity"]},{id:"INC-2330",severity:"high",title:"Suspicious Inbox Rule — Auto-Forward to External",category:"Data Exposure",status:"investigating",assignee:"Chen Wei",created:"Yesterday",services:["Exchange"]},{id:"INC-2298",severity:"medium",title:"Multiple Failed Sign-ins — Brute Force Pattern",category:"Identity Attack",status:"monitoring",assignee:"Chen Wei",created:"2 days ago",services:["Identity"]},{id:"INC-2290",severity:"medium",title:"Sensitive File Shared Externally — Finance folder",category:"Data Exposure",status:"monitoring",assignee:"Aisha Raza",created:"3 days ago",services:["SharePoint","OneDrive"]},{id:"INC-2281",severity:"medium",title:"DLP Policy Violation — PII Data in Teams Chat",category:"Insider Threat",status:"resolved",assignee:"Chen Wei",created:"4 days ago",services:["Teams","Purview"]},{id:"INC-2267",severity:"low",title:"Guest Account — Excessive Resource Access",category:"Identity Attack",status:"resolved",assignee:"Aisha Raza",created:"5 days ago",services:["Identity"]}];`${new Date().toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"})}`;let He=null,M=[],E=S,ve="executive",P={priority:"all",category:"all",status:"all"},Fe="7d",ke=[],Dt=!1;const Ss=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"},{id:"apiref",label:"API Reference",icon:"ti-api"}];async function $s(){const e=document.getElementById("page-security");if(e){if(fe()){console.log("🎭 Demo account detected - showing demo security data"),Hs(e);return}try{console.log("📡 Fetching real security data from backend...");const t=await pi();t.success&&t.data?(He=t.data,console.log("✅ Loaded real secure score from API")):(console.warn("⚠️ No secure score data available from API"),He=null);let i=[];try{const r=await xt();r.success&&r.data&&(i=r.data,console.log(`✅ Loaded ${i.length} real devices from Intune`))}catch(r){console.warn("⚠️ Could not fetch device data:",r.message)}const s=r=>r.map(o=>{var l,c,p,b,x,g;const d=o.deviceName||((c=(l=o.description)==null?void 0:l.match(/Device ([A-Z0-9-]+)/))==null?void 0:c[1])||((b=(p=o.title)==null?void 0:p.match(/([A-Z0-9-]+)/))==null?void 0:b[1])||((g=(x=o.description)==null?void 0:x.match(/([A-Z0-9]{3,})/))==null?void 0:g[1]);if(d&&i.length>0){const m=i.find(v=>{var w,X;return((w=v.deviceName)==null?void 0:w.toUpperCase().includes(d.toUpperCase()))||((X=v.deviceName)==null?void 0:X.includes(d))||v.id===d});if(m)return{...o,deviceId:m.id,deviceName:m.deviceName,deviceOS:m.operatingSystem,compliant:m.complianceState==="Compliant",managed:!0,owner:m.userDisplayName}}return o}),a=await cs();a.success&&Array.isArray(a.data)&&a.data.length>0?(M=s(a.data),console.log(`✅ Loaded ${M.length} real incidents from alerts (enriched with device data)`)):(console.warn("⚠️ No active incidents found"),M=[]);const n=await ps();n.success&&n.data&&(E={totalUsers:n.data.totalUsers||S.totalUsers,privAccounts:n.data.privilegedAccounts||S.privAccounts,globalAdmins:n.data.globalAdmins||S.globalAdmins,serviceAccounts:n.data.serviceAccounts||S.serviceAccounts,breakGlass:n.data.breakGlassAccounts||S.breakGlass,identitySecureScore:n.data.identitySecureScore||S.identitySecureScore,mfaEnabled:n.data.mfaEnabled||S.mfaEnabled,mfaExcluded:n.data.mfaExcluded||S.mfaExcluded,passwordlessAdoption:n.data.passwordlessAdoption||S.passwordlessAdoption,fido2Adoption:n.data.fido2Adoption||S.fido2Adoption,legacyAuthConnections:n.data.legacyAuthConnections||S.legacyAuthConnections,highRiskUsers:n.data.highRiskUsers||S.highRiskUsers,riskySignIns30d:n.data.riskySignIns30d||S.riskySignIns30d,impossibleTravel30d:S.impossibleTravel30d,anonymousIP30d:S.anonymousIP30d,passwordSpray30d:S.passwordSpray30d,caPoliciesEnabled:n.data.caPoliciesEnabled||S.caPoliciesEnabled,caPoliciesDisabled:n.data.caPoliciesDisabled||S.caPoliciesDisabled,caPoliciesReportOnly:n.data.caPoliciesReportOnly||S.caPoliciesReportOnly,caUsersExcluded:n.data.caUsersExcluded||S.caUsersExcluded},console.log("✅ Loaded real identity posture data from Azure AD"))}catch(t){console.error("❌ Error loading security data:",t.message)}J(e)}}function J(e){var a,n;const t=Array.isArray(M)?M:[],i=t.filter(r=>r.severity==="critical").length;t.filter(r=>r.severity==="high"&&r.status!=="resolved").length;const s=RECOMMENDATIONS.filter(r=>r.priority==="critical"||r.priority==="high").length;e.innerHTML=`
    ...
    <div class="sec-subnav" id="sec-subnav">
      ${Ss.map(r=>`
        <button class="sec-tab-btn ${ve===r.id?"active":""}" data-sec="${r.id}">
  ...
  </svg>`}function Ps(e,t=24){const i=Math.max(...e),s=Math.min(...e),a=i-s||1;return`<div style="display:flex;align-items:flex-end;gap:2px;height:${t}px">
  ...
  </div>`}function Cs(e,t){return e==="pass"||e===!0?`<span style="color:var(--clr-success-text)"><i class="ti ti-circle-check"></i> ${t}</span>`:e==="partial"||e==="warn"?`<span style="color:var(--clr-warning-text)"><i class="ti ti-alert-triangle"></i> ${t}</span>`:`<span style="color:var(--clr-danger-text)"><i class="ti ti-circle-x"></i> ${t}</span>`}function Ms(){return({executive:Lt,securescore:Ds,identity:Ls,email:Is,endpoint:Rs,teams:Ts,sharepoint:qs,dataprotection:zs,privaccess:Ns,guests:Gs,incidents:Os,recommendations:Us,copilot:Fs,apiref:js}[ve]||Lt)()}function Lt(){const e=He||SECURE_SCORE,t=Array.isArray(M)?M:[];return`
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        <div style="margin-bottom:12px" id="exec-trend-chart">
          ${Ps((Fe==="30d"?e.trend30d:e.trend7d)||[72,73,74,75,76,77,78],32)}
        </div>
  ...
  `}function Ds(){const e=SECURE_SCORE;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function Is(){const e=EMAIL;return`
    <div class="kpi-row mb-3">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          ${[{label:"SPF Record",ok:e.spf==="pass",note:e.spf==="pass"?"Configured — v=spf1 include:protection.outlook.com -all":"Missing or misconfigured"},{label:"DKIM Signing",ok:e.dkim==="pass",note:e.dkim==="pass"?"Enabled for contoso.com":"Not configured"},{label:"DMARC Policy",ok:e.dmarc==="reject"?"pass":e.dmarc==="quarantine"?"warn":!1,note:`Policy: ${e.dmarc} — ${e.dmarc!=="reject"?"upgrade to reject for full protection":"optimal"}`},{label:"Safe Links",ok:e.safeLinks==="enabled",note:e.safeLinks==="enabled"?"Active for all users":"Disabled"},{label:"Safe Attachments",ok:e.safeAttachments==="enabled"?"pass":"warn",note:e.safeAttachments==="partial"?"Partial — not all users covered":e.safeAttachments},{label:"Anti-spam Policy",ok:e.antiSpamPolicy==="strict"?"pass":"warn",note:`Level: ${e.antiSpamPolicy} — recommend strict`}].map(t=>`
            <div style="padding:10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:0.5px solid var(--color-border-tertiary)">
              ...
              <div style="font-size:12px;font-weight:600;margin-bottom:3px">${Cs(t.ok,t.ok==="pass"||t.ok===!0?"Pass":t.ok==="warn"?"Warning":"Fail")}</div>
  ...
  `}function Rs(){const e=ENDPOINT;return`
    <div class="kpi-row mb-3">
  ...
  `}function Ts(){const e=TEAMS_SEC;return`
    <div class="kpi-row mb-3">
  ...
  `}function qs(){const e=SHAREPOINT_SEC;return`
    <div class="kpi-row mb-3">
  ...
  `}function zs(){const e=DATA_PROTECTION;return`
    <div class="kpi-row mb-3">
  ...
  `}function Ns(){const e=PRIV_ACCESS;return`
    <div class="kpi-row mb-3">
  ...
  `}function Gs(){const e=GUEST_GOVERNANCE;return`
    <div class="kpi-row mb-3">
  ...
  `}function Os(){const e=M.filter(r=>r.status!=="resolved"),t=M.filter(r=>r.status==="resolved"),i=M.filter(r=>r.severity==="critical").length,s=M.filter(r=>r.severity==="high").length,a=M.filter(r=>r.severity==="medium").length,n=M.filter(r=>r.severity==="low").length;return`
    <div class="kpi-row mb-3">
    ...
    ${t.length>0?`
      ...
      `).join("")}
    `:""}
  `}function Us(){const e=RECOMMENDATIONS.filter(s=>!(P.priority!=="all"&&s.priority!==P.priority||P.category!=="all"&&s.category!==P.category||P.status!=="all"&&s.status!==P.status)),t=e.reduce((s,a)=>s+a.scoreGain,0),i=[...new Set(RECOMMENDATIONS.map(s=>s.category))];return`
  ...
  `}function Fs(){(!Dt||ke.length===0)&&(ke=[{role:"ai",text:`**M365 Security Copilot** — I have full context of your security posture across all 15 data sources.
...
Ask me anything about your security posture, specific risks, or recommended actions.`}],Dt=!0);const e=["Show me all high-risk users","Why did Secure Score drop this week?","Which Teams have external guests?","Top 10 security improvements","Which devices are vulnerable to ransomware?","Summarize today's security posture","Email security status","MFA coverage and gaps","Conditional Access coverage","Guest user governance"];return`
      ...
      <div style="overflow-y:auto;flex:1;padding-bottom:8px" id="sec-copilot-msgs">
        ${ke.map(t=>`
          <div class="chat-msg ${t.role==="ai"?"ai":"user-msg"}" style="max-width:85%;margin-bottom:12px">
            ...
            <div class="chat-bubble">${mi(t.text)}</div>
          </div>
        `).join("")}
      </div>
  ...
  `}function Bs(e){var a,n,r,o,d;const t=e.querySelector("#sec-content");if(!t)return;t.querySelectorAll("[data-trend]").forEach(l=>{l.addEventListener("click",()=>{Fe=l.dataset.trend,J(e)})}),t.querySelectorAll("[data-goto]").forEach(l=>{l.addEventListener("click",()=>{const p={identity:"identity",email:"email",endpoint:"endpoint",teams:"teams",sharepoint:"sharepoint",data:"dataprotection",privaccess:"privaccess",guests:"guests"}[l.dataset.goto];p&&(ve=p,J(e))})}),(a=t.querySelector("#exec-view-incidents"))==null||a.addEventListener("click",()=>{ve="incidents",J(e)}),(n=t.querySelector("#exec-view-recs"))==null||n.addEventListener("click",()=>{ve="recommendations",J(e)}),(r=t.querySelector("#rec-priority"))==null||r.addEventListener("change",l=>{P.priority=l.target.value,J(e)}),(o=t.querySelector("#rec-category"))==null||o.addEventListener("change",l=>{P.category=l.target.value,J(e)}),(d=t.querySelector("#rec-status"))==null||d.addEventListener("change",l=>{P.status=l.target.value,J(e)});const i=t.querySelector("#sec-cop-send"),s=t.querySelector("#sec-cop-input");i&&s&&(i.addEventListener("click",()=>tt(e,s)),s.addEventListener("keydown",l=>{l.key==="Enter"&&!l.shiftKey&&(l.preventDefault(),tt(e,s))})),t.querySelectorAll(".sec-cop-pill").forEach(l=>{l.addEventListener("click",()=>{const c=t.querySelector("#sec-cop-input");c&&(c.value=l.dataset.q,tt(e,c))})}),t.querySelectorAll(".api-copy").forEach(l=>{l.addEventListener("click",()=>{navigator.clipboard.writeText(l.dataset.code),u("Endpoint copied to clipboard.","success")})})}function tt(e,t){const i=t.value.trim();if(!i)return;ke.push({role:"user",text:i}),t.value="";const s=e.querySelector("#sec-copilot-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
...
Current status: Secure Score 64/95 · ${M.filter(o=>o.status!=="resolved").length} active incidents · ${S.highRiskUsers} high-risk users.`;ke.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        ...
        <div class="chat-bubble">${mi(r)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function mi(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"<br><br>").replace(/\n/g,"<br>").replace(/\|(.+)\|\n\|[-|: ]+\|\n/g,"").replace(/\|(.+)\|/g,t=>`<span style="display:flex;gap:16px;font-size:11px;padding:2px 0">${t.split("|").filter(s=>s.trim()).map(s=>`<span>${s.trim()}</span>`).join("")}</span>`)}function Hs(e){const t={overallScore:78,categoryScores:{identity:82,data:75,devices:72,apps:76,infrastructure:79}},i=ks.slice(0,5);e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `}function j(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
  </div>`}async function ie(e,t={}){const s=`${window.location.hostname==="localhost"?"http://localhost:3000":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net"}/api/tenantguard${e}`;try{const a=await fetch(s,{method:t.method||"GET",headers:{"Content-Type":"application/json",...t.headers},body:t.body?JSON.stringify(t.body):void 0});if(!a.ok)throw new Error(`API error: ${a.status}`);return await a.json()}catch(a){throw console.error("TenantGuard API error:",a),a}}async function Js(){return(await ie("/alerts/summary")).data}async function Ks(e="all",t=50){let i=`/alerts?limit=${t}`;return e!=="all"&&(i+=`&severity=${e}`),(await ie(i)).data}async function yi(e,t=""){return await ie(`/alerts/${e}/dismiss`,{method:"POST",body:{reason:t}})}async function Ys(e="all"){let t="/correlations";return e!=="all"&&(t+=`?severity=${e}`),(await ie(t)).data}async function Zs(e=null,t=null,i=null){return(await ie("/investigate",{method:"POST",body:{alertId:e,correlationId:t,title:i}})).data}async function Qs(e){return(await ie(`/investigations/${e}`)).data}async function Xs(e,t){return(await ie(`/investigations/${e}/chat`,{method:"POST",body:{message:t}})).data}async function ea(e){return(await ie(`/investigations/${e}/report`,{method:"POST"})).data}let U="alerts",K="all",ge=[],De=[],oe=null,it=null;const ta=[{id:"all",label:"All Alerts",icon:"ti-list"},{id:"CRITICAL",label:"Critical",icon:"ti-alert-triangle"},{id:"HIGH",label:"High",icon:"ti-alert-circle"},{id:"MEDIUM",label:"Medium",icon:"ti-alert-octagon"}],ia=[{id:"alerts",label:"Alerts",icon:"ti-list"},{id:"correlations",label:"Correlations",icon:"ti-link"},{id:"patterns",label:"Attack Patterns",icon:"ti-alert-triangle"},{id:"investigation",label:"AI Investigation",icon:"ti-robot"}];async function sa(){const e=document.getElementById("page-tenantguard");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading TenantGuard alerts...</p></div>';try{await Le()}catch(t){console.error("Error initializing TenantGuard:",t),u("Failed to load alerts","error")}it&&clearInterval(it),it=setInterval(Le,5*60*1e3)}}async function Le(){try{const[e,t,i]=await Promise.all([Js(),Ks("all",100),Ys("all")]);ge=t||[],De=i||[],aa(e)}catch(e){console.error("Error refreshing data:",e),u("Failed to refresh alerts: "+e.message,"error")}}function aa(e){var r;const t=document.getElementById("page-tenantguard");if(!t)return;const i=e.critical||0,s=e.high||0;e.medium;const a=e.total||0,n=De.length;t.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div id="tg-content" style="margin-top:16px">
      ${U==="alerts"?lt():U==="correlations"?Rt():U==="patterns"?Tt():na()}
    </div>
  `,t.querySelectorAll("[data-section]").forEach(o=>{o.addEventListener("click",()=>{U=o.dataset.section,K="all";const d=t.querySelector("#tg-content");d&&(d.innerHTML=U==="alerts"?lt():U==="correlations"?Rt():Tt(),U==="alerts"&&dt(t)),t.querySelectorAll("[data-section]").forEach(l=>l.classList.remove("active")),o.classList.add("active")})}),(r=t.querySelector("#tg-refresh"))==null||r.addEventListener("click",async()=>{const o=t.querySelector("#tg-refresh"),d=o.innerHTML;o.innerHTML='<span class="spinner dark"></span> Scanning...',o.disabled=!0,await Le(),o.innerHTML=d,o.disabled=!1}),U==="alerts"&&dt(t)}function lt(){return`
    ...
    <div id="tg-alerts-list" style="margin-top:12px">${hi()}</div>
  ...
  `).join("")}function Tt(){return'<div style="padding:20px;text-align:center"><div class="spinner"></div><p style="color:var(--color-text-secondary)">Loading patterns...</p></div>'}function na(){return oe?fi():`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function fi(){return`
    <div class="card mb-3">
      <div class="card-header">
        <span class="card-title"><i class="ti ti-robot"></i> ${I(oe.title)}</span>
  ...
  `}function hi(){const e=K==="all"?ge:ge.filter(t=>t.severity===K);return e.length===0?`
      <div style="text-align:center;padding:40px 20px;color:var(--color-text-secondary)">
        <div style="font-size:48px;margin-bottom:12px;opacity:0.5">✓</div>
      ...
      <div style="margin-bottom:16px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;font-size:11px">
          <div>
            ...
            <div style="font-weight:700;font-size:14px;color:${da(a.severity||t.severity)}">${a.score||t.score}/100</div>
          </div>
          <div>
          ...
          ${Object.entries(a.levels||{}).map(([r,o])=>`
            <div>
              <div style="color:var(--color-text-tertiary)">${la(r)}</div>
  ...
  `;const n=K==="all"?ge.filter(r=>r.id!==e):ge.filter(r=>r.severity===K&&r.id!==e);if(n.length>0){const r=`
    ...
    `,o=i.querySelector("#other-alerts");o&&(o.innerHTML=r)}else{const r=i.querySelector("#other-alerts");r&&(r.style.display="none")}}window.dismissAndRefreshDetail=async function(e){try{await yi(e),u("Alert dismissed","success"),await Le()}catch{u("Failed to dismiss alert","error")}};window.showAlertDetailsFromDetail=function(e){bi(e)};window.startCorrInvestigation=async function(e,t){try{U="investigation",oe=await Zs(null,e,t);const i=document.getElementById("page-tenantguard");if(i){const s=i.querySelector("#tg-content");s&&(s.innerHTML=fi(),ra(i),oa())}}catch(i){u("Failed to start investigation: "+i.message,"error")}};window.closeInvestigation=function(){oe=null,U="alerts";const e=document.getElementById("page-tenantguard");if(e){const t=e.querySelector("#tg-content");t&&(t.innerHTML=lt(),dt(e))}};async function ra(e){const t=e.querySelector("#investigation-send"),i=e.querySelector("#investigation-input"),s=e.querySelector("#investigation-report");t&&i&&(t.addEventListener("click",zt),i.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),zt())})),s&&s.addEventListener("click",async()=>{try{s.disabled=!0,s.innerHTML='<span class="spinner dark"></span>';const a=await ea(oe.id);u("Report generated! Downloading...","success"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}catch(a){u("Failed to generate report: "+a.message,"error"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}})}async function zt(){const e=document.getElementById("page-tenantguard"),t=e==null?void 0:e.querySelector("#investigation-input");if(!t)return;const i=t.value.trim();if(i)try{t.value="",t.disabled=!0;const s=e.querySelector("#investigation-messages");s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight);const a=await Xs(oe.id,i);s&&(s.innerHTML+=`
      ...
      `).join(""),t.scrollTop=t.scrollHeight)}catch(e){console.error("Failed to load messages:",e)}}function ct(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"Unknown"}function la(e){return e.charAt(0).toUpperCase()+e.slice(1)}function I(e){if(!e)return"";const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return String(e).replace(/[&<>"']/g,i=>t[i])}function Ie(e){switch(e==null?void 0:e.toUpperCase()){case"CRITICAL":return"danger";case"HIGH":return"warning";case"MEDIUM":return"info";default:return"neutral"}}function da(e){switch(e==null?void 0:e.toUpperCase()){case"CRITICAL":return"var(--clr-danger-text)";case"HIGH":return"var(--clr-warning-text)";case"MEDIUM":return"var(--clr-info-text)";default:return"var(--color-text-primary)"}}const ca=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",xi=ca?"http://localhost:3000/api":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api";async function pa(){const e=await fetch(`${xi}/tenantguard/users`);if(!e.ok)throw new Error(`Failed to fetch users: ${e.statusText}`);return e.json()}async function ua(e,t,i){const s=new URLSearchParams;t&&s.append("startDate",t),i&&s.append("endDate",i);const a=`${xi}/tenantguard/users/${e}/investigation?${s.toString()}`,n=await fetch(a);if(!n.ok)throw new Error(`Failed to fetch investigation: ${n.statusText}`);return n.json()}function va(){const e=document.getElementById("page-user-investigation");e&&ga(e)}function ga(e){e.innerHTML=`
    <div class="page-header">
  ...
  `;let t=[],i=null;const s=e.querySelector("#user-search"),a=e.querySelector("#user-dropdown"),n=e.querySelector("#days-back");e.querySelector("#custom-date");const r=e.querySelector("#investigate-btn");o();async function o(){try{t=(await pa()).data||[]}catch(d){console.error("Failed to load users:",d),u("Failed to load user list","error")}}s.addEventListener("input",d=>{const l=d.target.value.toLowerCase();if(!l){a.style.display="none";return}const c=t.filter(p=>p.displayName.toLowerCase().includes(l)||p.mail.toLowerCase().includes(l));a.innerHTML=c.map(p=>`
    ...
    `).join(""),c.forEach(p=>{const b=a.querySelector(`[data-id="${p.id}"]`);b==null||b.addEventListener("click",()=>{i=p.id,s.value=p.displayName,a.style.display="none",r.disabled=!1})}),a.style.display=c.length>0?"block":"none"}),r.addEventListener("click",async()=>{if(!i){u("Please select a user","warning");return}const d=parseInt(n.value),l=new Date,c=new Date(l);c.setDate(c.getDate()-d),st(e,!0);try{const p=await ua(i,c.toISOString().split("T")[0],l.toISOString().split("T")[0]);ma(e,p.data),st(e,!1)}catch(p){console.error("Investigation error:",p),u("Failed to load investigation data","error"),st(e,!1)}}),document.addEventListener("click",d=>{!s.contains(d.target)&&!a.contains(d.target)&&(a.style.display="none")})}function st(e,t){e.querySelector("#loading-state").style.display=t?"block":"none",e.querySelector("#investigation-results").style.display=t?"none":"block",e.querySelector("#empty-state").style.display="none"}function ma(e,t){const{user:i,applicationAccess:s,signInLogs:a,auditLogs:n,actionsOnOtherAccounts:r,timeline:o,summary:d}=t,l=`
    <div class="info-card">
    ...
    <div class="info-card">
      ...
      <div style="color:var(--color-text-secondary);font-size:11px;margin-top:4px">${ya(i.lastActive)}</div>
    </div>
        ...
        <tbody>
          ${s.map(v=>`
            <tr>
              ...
              <td>
                <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${Gt(v.status).bg};color:${Gt(v.status).text}">
                  ${v.status}
                </span>
              </td>
  ...
  `,xa(e),e.querySelector("#zt-rescan").addEventListener("click",()=>{const l=e.querySelector("#zt-rescan");l.innerHTML='<span class="spinner dark"></span> Scanning...',l.disabled=!0,setTimeout(()=>{l.innerHTML='<i class="ti ti-refresh"></i> Re-scan',l.disabled=!1,u("Zero Trust scan complete — 12 controls assessed.","success")},2e3)})}function ba(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-lock-check"></i> Zero Trust Compliance</div>
  ...
  `,e.querySelector("#zt-rescan").addEventListener("click",()=>{const t=e.querySelector("#zt-rescan");t.innerHTML='<span class="spinner dark"></span> Scanning...',t.disabled=!0,setTimeout(()=>{t.innerHTML='<i class="ti ti-refresh"></i> Rescan',t.disabled=!1,u("No Zero Trust assessment data available from Graph API","info")},2e3)})}function xa(e){const t=e.querySelector("#zt-pillars");t&&(t.innerHTML=wi.map((i,s)=>{const a=i.controls.filter(l=>l.status==="pass").length,n=i.controls.filter(l=>l.status==="warn").length,r=i.controls.filter(l=>l.status==="fail").length,o=i.controls.length,d=r>0?"danger":n>0?"warning":"success";return`
      <div class="card mb-3" style="padding:0;overflow:hidden">
  ...
  `;const s=e.querySelector("#cfg-topic-grid");Ai.forEach(a=>{const n=ki(a),r=pt(n.score),o=document.createElement("div");o.className="cfg-topic-card";const d=wa[a.id]||{bg:"#f0f0f0",color:"#555"};o.innerHTML=`
    ...
    `,o.addEventListener("click",()=>{Ea(e,a)}),s.appendChild(o)}),e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const a=e.querySelector("#cfg-scan-now");a.innerHTML='<span class="spinner dark"></span> Scanning...',a.disabled=!0,setTimeout(()=>{a.innerHTML='<i class="ti ti-refresh"></i> Run scan now',a.disabled=!1,u("CIS Benchmark scan complete — see results above","success")},2e3)})}function Ea(e,t){const i=ki(t),s=pt(i.score);e.innerHTML=`
    <div class="page-header">
      <div>
        ...
        <tbody>
          ${n.controls.map(o=>`
            <tr style="border-bottom:0.5px solid var(--color-border-tertiary)">
              ...
              <td style="padding:10px 12px;font-size:10px">${Sa(wt(o))}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,a.appendChild(r)}),e.querySelector("#cfg-back").addEventListener("click",()=>{Si()})}function Pa(e){e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const t=e.querySelector("#cfg-scan-now");t.innerHTML='<span class="spinner dark"></span> Scanning...',t.disabled=!0,setTimeout(()=>{t.innerHTML='<i class="ti ti-refresh"></i> Run scan',t.disabled=!1,u("No configuration data available from Graph API","info")},2e3)})}let $i=[],pe=[],q={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0};async function Ca(){var t;const e=document.getElementById("page-privaccts");if(e){try{console.log("📡 Fetching real privileged accounts from Azure AD...");const i=await us();i.success&&((t=i.data)!=null&&t.accounts)?(pe=i.data.accounts,q=i.data.summary,console.log(`✅ Loaded ${pe.length} real privileged accounts`)):(console.warn("⚠️ No privileged account data available from API"),pe=[],q={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0})}catch(i){console.error("❌ Error loading privileged accounts:",i.message),pe=[],q={totalAccounts:0,atRisk:0,noMFA:0,permanentRoles:0,servicePrincipals:0}}e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,La(e),Ia(e),Ra(e),e.querySelectorAll("#pa-tabs .tab-btn").forEach(i=>{i.addEventListener("click",()=>{e.querySelectorAll("#pa-tabs .tab-btn").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(s=>s.classList.remove("active")),i.classList.add("active"),e.querySelector(`#pa-tab-${i.dataset.tab}`).classList.add("active")})}),e.querySelector("#pa-sync").addEventListener("click",()=>{const i=e.querySelector("#pa-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync tenant',i.disabled=!1,u("Tenant sync complete — 14 accounts updated.","success")},2e3)}),e.querySelector("#pa-tag-account").addEventListener("click",()=>{u("Tag account: select an account from the table below.","info")})}}function Ot(e){return e==="High"?'<span class="badge danger dot">High</span>':e==="Medium"?'<span class="badge warning dot">Medium</span>':'<span class="badge neutral dot">None</span>'}function Ma(e){return!e||e.length===0?'<span class="pa-mfa-pill none">No MFA</span>':e.map(t=>t==="SMS"?'<span class="pa-mfa-pill sms">SMS</span>':`<span class="pa-mfa-pill">${t}</span>`).join("")}function Da(e){return`<span class="pa-role-chip ${e.toLowerCase().includes("global")?"global":""}">${e}</span>`}function La(e){var a,n;const t=e.querySelector("#pa-tab-accounts"),i="pa-acct-search";let s=`
  ...
  `;t.innerHTML=s,Pi(t),(a=t.querySelector(`#${i}`))==null||a.addEventListener("input",r=>{var l;const o=r.target.value.toLowerCase(),d=((l=t.querySelector("#pa-risk-filter"))==null?void 0:l.value)||"all";Ut(t,o,d)}),(n=t.querySelector("#pa-risk-filter"))==null||n.addEventListener("change",r=>{var d;const o=((d=t.querySelector(`#${i}`))==null?void 0:d.value.toLowerCase())||"";Ut(t,o,r.target.value)})}function Ut(e,t,i){const s=e.querySelector("#pa-acct-tbody");s&&(s.innerHTML=pe.filter(a=>{const n=!t||a.upn.toLowerCase().includes(t)||a.name.toLowerCase().includes(t),r=i==="all"||a.risk===i;return n&&r}).map(a=>Ei(a)).join(""),Pi(e))}function Ei(e){return`
    <tr class="pa-acct-row" data-id="${e.id}">
      ...
      <td><div class="pill-group">${e.roles.map(Da).join("")}</div></td>
      <td><div class="pill-group">${Ma(e.mfa)}</div></td>
      <td>${Ot(e.risk)}</td>
        ...
        <div class="pa-expand-panel" style="display:block">
          <div class="grid-2" style="gap:16px">
            ...
            <div>
              ...
              <div style="margin-top:8px">Risk level: ${Ot(e.risk)}</div>
            </div>
          </div>
  ...
  `}function Pi(e){e.querySelectorAll(".pa-acct-expand").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const a=t.closest(".pa-acct-row").dataset.id,n=e.querySelector(`.pa-acct-expand-row[data-id="${a}"]`),r=n.style.display!=="none";n.style.display=r?"none":"table-row",t.classList.toggle("open",!r)})}),e.querySelectorAll(".pa-action").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const{action:s,id:a}=t.dataset,n=PA_ACCOUNTS.find(r=>r.id===a);s==="pwd-reset"?(u(`Password reset initiated for ${n==null?void 0:n.name}.`,"warning"),ue("risk",`Password reset forced for ${n==null?void 0:n.upn}`,"Admin")):s==="convert-pim"?(u(`${n==null?void 0:n.name} converted to PIM eligible assignment.`,"success"),ue("add",`${n==null?void 0:n.upn} converted to PIM eligible`,"Admin")):s==="mfa-enroll"?(u(`MFA enrollment triggered for ${n==null?void 0:n.name}.`,"info"),ue("mfa",`MFA enrollment triggered for ${n==null?void 0:n.upn}`,"Admin")):s==="remove"&&(u(`${n==null?void 0:n.name} removed from privileged role.`,"danger"),ue("remove",`${n==null?void 0:n.upn} removed from privileged role`,"Admin"))})})}function Ia(e){const t=e.querySelector("#pa-tab-groups");t.innerHTML=`
    <div class="filter-bar" style="margin-bottom:12px">
  ...
  `}function jt(e){e.querySelectorAll(".pa-grp-expand").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,s=e.querySelector(`.pa-grp-expand-row[data-id="${i}"]`);s.style.display=s.style.display==="none"?"table-row":"none"})}),e.querySelectorAll(".pa-grp-untag").forEach(t=>{t.addEventListener("click",()=>{const i=PA_GROUPS.find(s=>s.id===t.dataset.id);u(`${i==null?void 0:i.name} untagged as privileged group.`,"warning"),ue("remove",`Group "${i==null?void 0:i.name}" untagged`,"Admin")})}),e.querySelectorAll(".pa-grp-remove-member").forEach(t=>{t.addEventListener("click",()=>{u(`${t.dataset.upn} removed from group.`,"success"),ue("remove",`${t.dataset.upn} removed from group`,"Admin")})})}function Ra(e){const t=e.querySelector("#pa-tab-log");Ci(t)}function Ci(e){e.innerHTML=`
  ...
  `}function ue(e,t,i){const s={add:"ti-user-plus",remove:"ti-user-minus",risk:"ti-alert-triangle",mfa:"ti-shield",tag:"ti-tag",review:"ti-clipboard-check"},a={add:"var(--clr-info-text)",remove:"var(--clr-warning-text)",risk:"var(--clr-danger-text)",mfa:"var(--clr-success-text)",tag:"var(--clr-info-text)",review:"var(--clr-success-text)"},n={add:"var(--clr-info-bg)",remove:"var(--clr-warning-bg)",risk:"var(--clr-danger-bg)",mfa:"var(--clr-success-bg)",tag:"var(--clr-info-bg)",review:"var(--clr-success-bg)"};$i.unshift({id:Date.now(),type:e,icls:s[e]||"ti-info-circle",ic:a[e]||"var(--clr-info-text)",bg:n[e]||"var(--clr-info-bg)",title:t,detail:t,by:i,time:"Just now"});const r=document.querySelector("#pa-tab-log");r&&Ci(r)}let N=[],xe={total:0,consumed:0,available:0,utilizationPct:0},we=[],ut=[],je={},Ue="summary";const Ta=[{id:"summary",label:"Executive Summary",icon:"ti-layout-dashboard"},{id:"inventory",label:"License Inventory",icon:"ti-box"},{id:"services",label:"Service Plans",icon:"ti-list-check"},{id:"assignments",label:"User Assignments",icon:"ti-users"},{id:"groups",label:"Group Licensing",icon:"ti-users-group"},{id:"compliance",label:"Compliance",icon:"ti-shield-check"}];async function Mi(){const e=document.getElementById("page-licenses");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading comprehensive license data...</p></div>';try{console.log("📡 Fetching comprehensive license data...");const[t,i,s,a]=await Promise.all([$("/licenses"),$("/licenses/assignments"),$("/licenses/groups"),$("/licenses/compliance")]);t.success&&t.data&&(N=t.data,xe=t.summary||{total:0,consumed:0,available:0,utilizationPct:0}),i.success&&i.data&&(we=i.data),s.success&&s.data&&(ut=s.data),a.success&&a.data&&(je=a.data),console.log("✅ Loaded all license data")}catch(t){console.error("❌ Error loading license data:",t)}Di(e)}}function Di(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,e.querySelectorAll(".license-tab-btn").forEach(s=>{s.addEventListener("click",()=>{Ue=s.dataset.tab,Di(e)})}),(t=e.querySelector("#license-refresh"))==null||t.addEventListener("click",()=>{Mi()}),(i=e.querySelector("#license-export"))==null||i.addEventListener("click",()=>{alert("Export functionality coming soon")})}function qa(e){switch(e){case"summary":return za();case"inventory":return Na();case"services":return Ga();case"assignments":return Oa();case"groups":return Ua();case"compliance":return Fa();default:return""}}function za(){return`
  ...
  `}function Fa(){const e=je.scores||{utilization:0,costOptimization:0,securityCoverage:0,compliance:0};return`
  ...
  `}let Z="dashboard",Re=null,de=[],Li=[],vt="PENDING_APPROVAL";async function _a(){const e=document.getElementById("page-approvals");e&&(Y(e),await Ii(e))}async function Ii(e){var t;try{const s=await(await fetch(`${A}/requests?status=${vt}&limit=50`)).json();de=Array.isArray(s.data)?s.data:[];const n=await(await fetch(`${A}/audit-logs?limit=20`)).json();Li=Array.isArray((t=n.data)==null?void 0:t.data)?n.data.data:Array.isArray(n.data)?n.data:[],Y(e)}catch(i){console.error("Error loading approvals data:",i),u("Failed to load approvals data","error")}}function Y(e){Z==="dashboard"?Va(e):Z==="details"?Wa(e):Z==="audit"&&Ja(e)}function Va(e){if(!e){console.error("❌ Page element not found");return}if(e.innerHTML=`
    <div class="page-header">
      <div>
            ...
            <tbody>
              ${de.map(t=>{var i,s;return`
                <tr style="border-bottom:0.5px solid var(--color-border-tertiary);cursor:pointer" id="req-${t.id}" data-id="${t.id}">
                  ...
                  <td style="padding:10px 12px">
                    <span style="padding:2px 6px;border-radius:3px;font-size:10px;background:${Ri((i=t.validation)==null?void 0:i.riskLevel)};color:white">
  ...
  `,e&&e.querySelectorAll&&["PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].forEach(t=>{const i=e.querySelector(`#filter-${t}`);i&&i.addEventListener("click",()=>{vt=t,Y(e),Ii(e)})}),e&&e.querySelectorAll){e.querySelectorAll(".btn-sm-approve").forEach(i=>{i.addEventListener("click",s=>{s.stopPropagation();const a=i.dataset.id;Re=de.find(n=>n.id===a),Z="details",Y(e)})});const t=e.querySelector("#view-audit-btn");t&&t.addEventListener("click",()=>{Z="audit",Y(e)}),e.querySelectorAll("tr[data-id]").forEach(i=>{i.addEventListener("click",()=>{const s=i.dataset.id;Re=de.find(a=>a.id===s),Z="details",Y(e)})})}}function Wa(e){var s,a,n,r,o;if(!e||!Re)return;const t=Re,i=Ka(t);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            <div style="margin-bottom:12px">
              <div style="display:flex;align-items:center;gap:10px">
                <div style="font-size:24px;font-weight:600;color:${Ri((s=t.validation)==null?void 0:s.riskLevel)}">${((a=t.validation)==null?void 0:a.riskScore)||0}</div>
                <div>
  ...
  `;const a=e.querySelector("#portal-service-grid");Ve.forEach(n=>{var l,c;const r=We(Vt(n.id)),o=Te(n.id)?me.reduce((p,b)=>{var x,g;return p+(((g=(x=ye(b.id))==null?void 0:x.operations)==null?void 0:g.length)||0)},0):((c=(l=ye(n.id))==null?void 0:l.operations)==null?void 0:c.length)||0,d=document.createElement("div");d.className=`portal-svc-card ${r?"":"disabled"}`,d.innerHTML=`
    ...
    `,r||(d.title="This service has been disabled by your administrator."),a.appendChild(d)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(n=>{n.addEventListener("click",()=>{B=n.dataset.gid,Te(B)&&(_=tn()),z=null,ee={},R="service",V(e)})})}function an(e){const t=At(B);if(!t){R="landing",V(e);return}const i=Ze(),s=ye(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{R="landing",V(e)}),Te(B)&&e.querySelectorAll(".ex-sub-tab").forEach(a=>{a.addEventListener("click",()=>{_=a.dataset.sub,z=null,Wt(e,ye(_)),e.querySelectorAll(".ex-sub-tab").forEach(n=>n.classList.toggle("active",n.dataset.sub===_))})}),Wt(e,s)}function nn(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
    <div class="tabs mb-3" style="margin-bottom:16px">
      ${me.map(t=>{const i=We(e[t.id]);return`<button class="tab-btn ex-sub-tab ${t.id===_?"active":""} ${i?"":"disabled-tab"}"
  ...
  `,s.querySelector("#svc-start-form").addEventListener("click",()=>{R="form",ee={};const o=document.getElementById("page-portal");V(o)})}function rn(e){var n;const t=At(B),i=Ze(),s=qi(i,z);if(!s||!t){R="service",V(e);return}const a=qe(s);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div>
          ...
          <div class="page-subtitle">${t.name}${_?" — "+(((n=me.find(r=>r.id===_))==null?void 0:n.name)||""):""}</div>
        </div>
      </div>
    </div>
  ...
  `,e.querySelector("#form-back").addEventListener("click",()=>{R="service",V(e)}),e.querySelector("#form-submit").addEventListener("click",()=>ln(e,s))}function on(e){const t=e.required?" *":"",i=e.hint?`<div style="font-size:10px;color:var(--color-text-tertiary);margin-top:3px">${e.hint}</div>`:"";return e.type==="text"||e.type==="email"?`<div class="form-group" data-field="${e.id}">
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{R="landing",B=null,_=null,z=null,ee={},V(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{Qa(()=>Promise.resolve().then(()=>Er),void 0).then(d=>d.go("myreqs"))})}function un(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
...
Full details available in **Graph API** page (super admin only).`}],gn=`I'm your **M365 AgentOps AI Copilot**. I can help you with:
...
- "What are the M365 Config failures?"`;let Je=[],Zt=!1;function mn(){const e=document.getElementById("page-chat");if(!e)return;const t=y.currentUser,i=Yt[t==null?void 0:t.role]||Yt.user;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#chat-messages"),a=e.querySelector("#chat-input");!Zt||Je.length===0?(Je=[],yt("ai",gn),Zt=!0):ft(s),e.querySelector("#chat-send").addEventListener("click",()=>at(e)),a.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),at(e))}),a.addEventListener("input",()=>{a.style.height="auto",a.style.height=Math.min(a.scrollHeight,120)+"px"}),e.querySelectorAll(".suggestion-pill").forEach(n=>{n.addEventListener("click",()=>{a.value=n.dataset.text,at(e)})})}function yt(e,t){Je.push({role:e,text:t,ts:new Date().toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"})})}function ft(e){e.innerHTML=Je.map(t=>{var a;const i=t.role==="ai",s=yn(t.text);return`
...
Try rephrasing your question or ask about a specific service name.`}function hn(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(d=>d.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(d=>d.classList.remove("active")),o.classList.add("active"),e.querySelector(`#graph-tab-${o.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",()=>{navigator.clipboard.writeText(o.dataset.val),u("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const o=e.querySelector("#graph-secret");o.type=o.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>u("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>u("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>u("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>u("Throttling configuration saved.","success"))}}function bn(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `;const r=n.querySelector("input");return r.addEventListener("change",()=>a(r.checked)),n}const wn=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",kt=wn?"http://localhost:3000/api/tenantguard":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api/tenantguard";async function An(){try{return(await(await fetch(`${kt}/settings/claude-status`)).json()).data}catch(e){return console.error("Error getting Claude status:",e),null}}async function kn(e){try{return await(await fetch(`${kt}/settings/claude-api-key`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:e})})).json()}catch(t){return console.error("Error setting Claude API key:",t),{success:!1,error:t.message}}}async function Sn(){try{return await(await fetch(`${kt}/settings/claude-api-key`,{method:"DELETE"})).json()}catch(e){return console.error("Error removing Claude API key:",e),{success:!1,error:e.message}}}function $n(){const e=document.getElementById("page-settings");e&&Ni(e)}function Ni(e){const t=y.settings;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,u(`Synced ${be.length} messages`,"success")},2e3)})}function Cn(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `,e.querySelectorAll(".app-tab-btn").forEach(r=>{r.addEventListener("click",()=>{ze=r.dataset.appSection,ae(e)})}),(a=e.querySelector("#app-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#app-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u(`Application inventory updated — ${D.length} app registrations, ${Q.length} service principals scanned.`,"success")},2200)}),(n=e.querySelector("#app-audit"))==null||n.addEventListener("click",()=>u("Application audit exported as CSV.","success")),Bn(e)}function Ln(){return({executive:ei,appregistrations:In,enterprise:Rn,secrets:Tn,permissions:qn,auditconsents:zn,owners:Nn,usage:Gn,risk:On,lifecycle:Un,recommendations:Fn,copilot:jn}[ze]||ei)()}function ei(){console.log(`📊 Executive: Apps=${D.length}, SPs=${Q.length}, Secrets=${G.length}`);const e=G.filter(a=>a.status==="expiring").length,t=G.filter(a=>a.status==="expired").length,i=re.filter(a=>a.severity==="critical").length,s=ne.filter(a=>a.status==="unused").length;return`
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        ${ti([{label:"Expired Secrets",val:t,cls:"danger"},{label:"Expiring (30 days)",val:e,cls:"warning"},{label:"Expiring (60 days)",val:G.filter(a=>a.daysRemaining<=60&&a.daysRemaining>30).length,cls:"warning"},{label:"Apps Requiring Admin Consent",val:ht.length,cls:"warning"}])}
      </div>
    </div>
  ...
  `}function In(){const e=D.length>0?D:[],t=e.filter(s=>!(L.type!=="all"&&s.category!==L.type||L.status!=="all"&&s.status!==L.status||L.search&&!s.name.toLowerCase().includes(L.search.toLowerCase()))),i=[...new Set(e.map(s=>s.category))];return`
    <div class="filter-bar mb-3">
  ...
  `}function Rn(){const e=Q.length>0?Q:[];return`
    <div class="filter-bar mb-3">
  ...
  `}function Tn(){const e=G.filter(s=>s.status==="expired"),t=G.filter(s=>s.status==="expiring"),i=G.filter(s=>s.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function qn(){const e=Ne.filter(i=>i.riskLevel==="critical"),t=Ne.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Nn(){const e=D.length>0?D:[],t=e.filter(a=>!a.owners||a.owners.length===0),i=e.filter(a=>a.owners&&a.owners.length===1),s=e.filter(a=>a.owners&&a.owners.length>1);return`
    ${t.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Gn(){const e=ne.filter(s=>s.status==="active"),t=ne.filter(s=>s.status==="lowuse"),i=ne.filter(s=>s.status==="unused");return`
    ...
    `).join("")}
  `}function On(){const e=re.filter(i=>i.severity==="critical"),t=re.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Un(){const e=D.length>0?D:[],t=e.filter(a=>{const n=a.createdDateTime?new Date(a.createdDateTime):null;if(!n)return!1;const r=new Date(Date.now()-30*24*60*60*1e3);return n>r}),i=e.filter(a=>!a.owners||a.owners.length===0),s=ne.filter(a=>a.status==="unused");return`
...
Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;Se.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
      ...
      </div>`,s.scrollTop=s.scrollHeight)},600)}function Gi(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}let bt="executive",Ke=[],ii=!1,Ee=[],Pe=[],h={summary:{},endpointSecurity:{},patchManagement:{},riskAssessment:{},deviceHealth:[],applications:[],policies:{configurationPolicies:[],conditionalAccessPolicies:[]},recommendations:[]};const Hn=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"health",label:"Device Health",icon:"ti-heartbeat"},{id:"compliance",label:"Compliance",icon:"ti-check-circle"},{id:"inventory",label:"Device Inventory",icon:"ti-device-laptop"},{id:"security",label:"Endpoint Security",icon:"ti-shield-check"},{id:"patches",label:"Patch Management",icon:"ti-refresh"},{id:"apps",label:"Applications",icon:"ti-app-window"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"policies",label:"Policies",icon:"ti-settings-2"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Intune Copilot",icon:"ti-robot"}];async function _n(){const e=document.getElementById("page-intune");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading comprehensive Intune data...</p></div>',console.log("📡 Fetching comprehensive Intune data from backend...");try{const[t,i,s,a,n,r,o,d,l,c]=await Promise.all([xt(),ds(),$("/intune/summary"),$("/intune/endpoint-security"),$("/intune/patch-management"),$("/intune/risk-assessment"),$("/intune/device-health"),$("/intune/applications"),$("/intune/policies"),$("/intune/recommendations")]);t.success&&t.data?(Ee=t.data,console.log(`✅ Loaded ${Ee.length} real devices`)):(console.warn("⚠️ No device data available from API"),Ee=[]),i.success&&i.data?(Pe=i.data,console.log(`✅ Loaded ${Pe.length} real policies`)):(console.warn("⚠️ No policy data available from API"),Pe=[]),s.success&&s.data?(h.summary=s.data,console.log("✅ Loaded Intune summary")):h.summary={},a.success&&a.data&&(h.endpointSecurity=a.data,console.log("✅ Loaded endpoint security data")),n.success&&n.data&&(h.patchManagement=n.data,console.log("✅ Loaded patch management data")),r.success&&r.data&&(h.riskAssessment=r.data,console.log("✅ Loaded risk assessment data")),o.success&&o.data&&(h.deviceHealth=o.data,console.log("✅ Loaded device health data")),d.success&&d.data&&(h.applications=d.data,console.log("✅ Loaded applications data")),l.success&&l.data&&(h.policies=l.data,console.log("✅ Loaded policies data")),c.success&&c.data&&(h.recommendations=c.data,console.log("✅ Loaded recommendations data")),console.log("✅ All Intune data loaded successfully")}catch(t){console.error("❌ Error loading Intune data:",t)}Oi(e)}}function Oi(e){var a,n;const t=h.summary,i=h.riskAssessment.criticalRiskCount||0,s=h.riskAssessment.highRiskCount||0;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `}function Wn(){const e=h.summary,t=h.deviceHealth||[];return t.length>0&&Math.round(t.reduce((i,s)=>i+s.healthScore,0)/t.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Jn(){const e=h.summary,t=Math.max(0,(e.totalManagedDevices||0)-(e.nonCompliant||0));return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Yn(){var t,i,s,a,n,r,o,d;const e=h.endpointSecurity;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function Zn(){const e=h.patchManagement;return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
  ...
  `}function Xn(){const e=h.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function er(){const e=h.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
  ...
  `}function tr(){const e=h.recommendations||[];return`
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        <thead><tr>
          <th style="width:11%">Priority</th>
  ...
  `}function ir(){if(!ii){const t=h.summary||{},i=h.riskAssessment||{};Ke=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.
...
Ask me about device health, compliance, security, patches, or recommendations!`;Ke.push({role:"ai",text:l}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        ...
        <div class="chat-bubble">${Fi(l)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function Fi(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}const ji={displayName:"Rajkumar Duraisami",upn:"rajkumar.duraisami@contoso.com",email:"rajkumar.duraisami@contoso.com",employeeId:"EMP-2024-001",jobTitle:"Cloud Solutions Architect",department:"Cloud Engineering",manager:"Sarah Johnson",lastSignIn:"Today 08:45",accountStatus:"Enabled",phone:"+1 (555) 123-4567",office:"Seattle, WA",mobilePhone:"+1 (555) 987-6543"},Bi={mfaStatus:"Enabled",mfaDefaultMethod:"Microsoft Authenticator",passwordLastChanged:"45 days ago",passwordExpiryDate:"15 days remaining",ssfrRegistration:"Completed",riskLevel:"Low",securityScore:92,authenticationMethods:[{type:"Password",status:"Enabled"},{type:"Microsoft Authenticator",status:"Enabled",registered:!0},{type:"FIDO2 Security Key",status:"Not registered"},{type:"Phone Authentication",status:"Enabled"},{type:"Email OTP",status:"Not registered"}],riskDetections:[{type:"Impossible Travel",status:"No",lastDetected:null},{type:"Anonymous IP",status:"No",lastDetected:null},{type:"Malware-linked IP",status:"No",lastDetected:null},{type:"Unfamiliar Sign-in",status:"No",lastDetected:null}]},Hi=[{date:"Today 08:45",app:"Microsoft 365 Portal",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 17:30",app:"Teams",device:"iPhone",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 09:15",app:"Exchange Online",device:"Windows-Laptop",browser:"Edge",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"2 days ago 14:20",app:"SharePoint",device:"iPad",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"3 days ago 10:00",app:"OneDrive",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"}],_i=[{name:"Microsoft 365 E5",sku:"ENTERPRISEPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Enterprise Mobility + Security E5",sku:"EMSPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Power BI Premium",sku:"POWER_BI_PREMIUM_P1",assignmentType:"Group",assignmentSource:"Group License"},{name:"Teams Phone Standard",sku:"TEAMS_PHONE_STANDARD",assignmentType:"Direct",assignmentSource:"Admin"}],Ce={securityGroups:[{name:"Cloud Architects",type:"Security",membershipType:"Member"},{name:"M365-Admins",type:"Security",membershipType:"Member"},{name:"Security Review Board",type:"Security",membershipType:"Member"},{name:"Global Readers",type:"Security",membershipType:"Member"}],microsoft365Groups:[{name:"Engineering Team",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!1},{name:"Cloud Solutions Architects",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!0},{name:"Product Innovation",type:"Microsoft 365",teamConnected:!1,dynamicMembership:!1}],distributionLists:[{name:"Cloud-Engineering@contoso.com",type:"Distribution List",membershipType:"Member"},{name:"Security-Team@contoso.com",type:"Distribution List",membershipType:"Owner"}]},Vi={totalStorage:"1 TB",usedStorage:"420 GB",availableStorage:"580 GB",percentageUsed:42,lastActivity:"Today 08:45",fileCount:2847,sharedItems:156,externalShares:12,anonymousLinks:3},Wi={teamsMembership:12,teamsOwned:3,guestAccessTeams:2,teamsPhoneLicense:!0,assignedNumber:"+1 (555) 123-7890",callingPlan:"Domestic and International",teams:[{name:"Engineering Team",role:"Member",owner:"Sarah Johnson"},{name:"Cloud Architects",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Security Review Board",role:"Member",owner:"Chen Wei"},{name:"Product Innovation",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Global Company",role:"Member",owner:"System"}]},Ji=[{name:"LAPTOP-RAJ-001",type:"Windows",osVersion:"22H2",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"BitLocker Enabled",defender:"Active"},{name:"IPHONE-RAJ-001",type:"iOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"Device Encrypted",defender:"Enabled"},{name:"IPAD-RAJ-001",type:"iPadOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"BYOD",lastCheckIn:"Yesterday",encryption:"Device Encrypted",defender:"Enabled"}],ar=[{name:"Microsoft Teams",lastAccessed:"Today 08:45",permissionScope:"Full",riskLevel:"Low"},{name:"SharePoint Online",lastAccessed:"Yesterday 14:20",permissionScope:"Read/Write",riskLevel:"Low"},{name:"OneDrive for Business",lastAccessed:"Today 10:15",permissionScope:"Full",riskLevel:"Low"},{name:"Exchange Online",lastAccessed:"Today 09:30",permissionScope:"Full",riskLevel:"Low"},{name:"Power BI",lastAccessed:"2 days ago",permissionScope:"Admin",riskLevel:"Medium"},{name:"Dynamics 365",lastAccessed:"5 days ago",permissionScope:"Read/Write",riskLevel:"Low"}],Me=[{type:"Group Membership Request",group:"Data Governance Board",status:"Pending",submittedDate:"2 days ago",description:"Waiting for manager approval"},{type:"Distribution List Request",list:"Customer Success@contoso.com",status:"Pending",submittedDate:"1 day ago",description:"Awaiting IT approval"}],nr={personalAIReadinessScore:85,recommendations:[{title:"Enable Microsoft Authenticator",impact:"Improves security by 15%",priority:"High",status:"Recommended"},{title:"Complete Security Awareness Training",impact:"Unlocks advanced features",priority:"High",status:"Recommended"},{title:"Review OneDrive Sharing Settings",impact:"Improves data governance by 8%",priority:"Medium",status:"Recommended"},{title:"Register FIDO2 Security Key",impact:"Improves security by 20%",priority:"Medium",status:"Optional"}],exchangeUsage:78,teamsUsage:92,oneDriveUsage:42,sharePointUsage:65};let Ae="executive",f={profile:ji,security:Bi,signin:Hi,licenses:_i,groups:Ce,onedrive:Vi,teams:Wi,devices:Ji};const rr=[{id:"executive",label:"Executive Summary",icon:"ti-dashboard"},{id:"profile",label:"Profile",icon:"ti-user"},{id:"security",label:"Security",icon:"ti-shield-check"},{id:"signin",label:"Sign-in Activity",icon:"ti-login"},{id:"licenses",label:"Licenses",icon:"ti-license"},{id:"groups",label:"Groups",icon:"ti-users"},{id:"devices",label:"Devices",icon:"ti-device-laptop"},{id:"apps",label:"Apps & Access",icon:"ti-app-window"},{id:"onedrive",label:"OneDrive",icon:"ti-cloud"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"approvals",label:"Pending Approvals",icon:"ti-check"},{id:"copilot",label:"Copilot Insights",icon:"ti-robot"}];async function or(){const e=document.getElementById("page-myaccount");if(e){try{console.log("📡 Fetching My Account data from backend...");const t=window.userEmail;if(!t){console.error("❌ User email not found. Make sure you are logged in."),u("Error: User not authenticated. Please log in again.","error");return}console.log(`Fetching data for user: ${t}`);const[i,s,a,n,r,o,d,l,c]=await Promise.allSettled([fetch(`${A}/me/profile?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/security?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/signin-activity?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/licenses?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/groups?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/onedrive?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/teams?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/devices?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/mailbox?email=${encodeURIComponent(t)}`).then(p=>p.json())]);f.profile=i.status==="fulfilled"&&i.value.success?i.value.data:ji,f.security=s.status==="fulfilled"&&s.value.success?s.value.data:Bi,f.signin=a.status==="fulfilled"&&a.value.success?a.value.data.recentSignins:Hi,f.licenses=n.status==="fulfilled"&&n.value.success?n.value.data:_i,f.groups=r.status==="fulfilled"&&r.value.success?r.value.data:Ce,f.onedrive=o.status==="fulfilled"&&o.value.success?o.value.data:Vi,f.teams=d.status==="fulfilled"&&d.value.success?d.value.data:Wi,f.devices=l.status==="fulfilled"&&l.value.success?l.value.data:Ji,f.mailbox=c.status==="fulfilled"&&c.value.success?c.value.data:{mailboxUsage:65},console.log("✓ My Account data loaded")}catch(t){console.warn("⚠️ Using simulated data:",t.message)}lr(e)}}function lr(e){var t;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <!-- Content -->
    <div id="myacc-content" style="margin-top:16px">${ai()}</div>
  `,e.querySelectorAll(".intune-tab-btn").forEach(i=>{i.addEventListener("click",()=>{Ae=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=ai(),Ae==="signin"&&setTimeout(()=>ni(e),100)})}),Ae==="signin"&&setTimeout(()=>ni(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,u("Your profile has been refreshed.","success")},1500)})}function ai(){const t={executive:dr,profile:cr,security:pr,signin:ur,licenses:vr,groups:gr,devices:mr,apps:yr,onedrive:fr,teams:hr,approvals:br,copilot:xr}[Ae];return t?t():""}function dr(){var c,p,b,x,g,m,v,w;const e=((c=f.security)==null?void 0:c.securityScore)||85,t=((p=f.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((b=f.security)==null?void 0:b.riskLevel)||"Low",s=(f.licenses&&Array.isArray(f.licenses)?f.licenses.length:0)||((x=f.licenses)==null?void 0:x.count)||0,a=(f.devices&&Array.isArray(f.devices)?f.devices.length:0)||((g=f.devices)==null?void 0:g.count)||0,n=(f.groups&&f.groups.securityGroups?f.groups.securityGroups.length:0)||0,r=((m=f.teams)==null?void 0:m.teamsMembership)||0,o=0,d=((v=f.onedrive)==null?void 0:v.percentageUsed)||0,l=((w=f.mailbox)==null?void 0:w.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function pr(){const e=f.security;return`
    <div class="card">
  ...
  `}function ur(){const e=f.signin.filter(i=>i.result==="Success"),t=f.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function fr(){const e=f.onedrive;return`
    <div class="card">
  ...
  `}function hr(){const e=f.teams;return`
    <div class="card">
  ...
  `}function br(){return!Me||Me.length===0?`
      <div class="card">
  ...
  `,ns(),rs()}function $r(){return["dashboard","requests","security","tenantguard","user-investigation","zerotrust","privaccts","m365config","msgcenter","applications","intune","licenses","agents","approvals","portal","myreqs","myaccount","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}Ar();li().catch(e=>{console.error("Login render error:",e),li()});const Er=Object.freeze(Object.defineProperty({__proto__:null,go:C,hasAccess:Yi,isRole:kr,resetSettings:Ki,saveState:T,state:y},Symbol.toStringTag,{value:"Module"}));
