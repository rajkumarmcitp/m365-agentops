...
Current status: Secure Score 64/95 · ${R.filter(l=>l.status!=="resolved").length} active incidents · ${P.highRiskUsers} high-risk users.`;Re.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `;let t=[],i=null;const s=e.querySelector("#user-search"),a=e.querySelector("#user-dropdown"),n=e.querySelector("#days-back");e.querySelector("#custom-date");const r=e.querySelector("#investigate-btn");l();async function l(){try{t=(await nn()).data||[]}catch(o){console.error("Failed to load users:",o),v("Failed to load user list","error")}}s.addEventListener("input",o=>{const d=o.target.value.toLowerCase();if(!d){a.style.display="none";return}const c=t.filter(p=>p.displayName.toLowerCase().includes(d)||p.mail.toLowerCase().includes(d));a.innerHTML=c.map(p=>`
...
Try rephrasing your question or ask about a specific service name.`}function mr(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>o.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(o=>o.classList.remove("active")),l.classList.add("active"),e.querySelector(`#graph-tab-${l.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(l=>{l.addEventListener("click",()=>{navigator.clipboard.writeText(l.dataset.val),v("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const l=e.querySelector("#graph-secret");l.type=l.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>v("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>v("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>v("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>v("Throttling configuration saved.","success"))}}function yr(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,v(`Synced ${pe.length} messages`,"success")},2e3)})}async function ps(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `;try{const t=await Ii(),i=await zi();if(!t.success||!t.data||t.data.length===0){fi(e);return}const s=t.data,a=s.filter(r=>r.actionRequired).length,n=s.filter(r=>r.severity==="high").length;e.innerHTML=`
      ...
      <div class="card">
        <div class="card-header">
          ...
          <span class="badge info">${s.length} messages</span>
        </div>
          ...
          ${s.slice(0,50).map(r=>`
            <div style="padding:12px;border-bottom:0.5px solid var(--color-border-tertiary)">
              <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:6px">
                <div style="flex:1">
                  <div style="font-weight:600;font-size:12px;color:var(--color-text-primary)">${r.title||r.id}</div>
                  <div style="font-size:10px;color:var(--color-text-secondary);margin-top:4px">
                    Service: <strong>${r.service||"Unknown"}</strong> · ID: <code style="font-family:monospace;font-size:9px">${r.id}</code>
                  </div>
                </div>
                <span class="badge ${r.severity==="high"?"danger":r.severity==="medium"?"warning":"success"}" style="flex-shrink:0;font-size:9px">
                  ${r.severity||"normal"}
                </span>
              </div>
...
Current state: **87 app registrations**, **124 enterprise apps**, **5 expiring secrets (30d)**, **2 critical risk apps**`}],hi=!0);const e=["Show expiring secrets","Which apps have Directory.ReadWrite.All?","List apps without owners","Show high-risk applications","Unused apps (90+ days)","Multi-tenant applications"];return`
  ...
  `}function Ai(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
  </div>`}function _r(e){var a,n,r,l,o;const t=e.querySelector("#app-content");if(!t)return;(a=t.querySelector("#app-search"))==null||a.addEventListener("input",d=>{T.search=d.target.value,ve(e)}),(n=t.querySelector("#app-type-filter"))==null||n.addEventListener("change",d=>{T.type=d.target.value,ve(e)}),(r=t.querySelector("#app-status-filter"))==null||r.addEventListener("change",d=>{T.status=d.target.value,ve(e)}),(l=t.querySelector("#exec-view-risk"))==null||l.addEventListener("click",()=>{He="risk",ve(e)}),(o=t.querySelector("#exec-view-recs"))==null||o.addEventListener("click",()=>{He="recommendations",ve(e)});const i=t.querySelector("#app-cop-send"),s=t.querySelector("#app-cop-input");i&&s&&(i.addEventListener("click",()=>ht(e,s)),s.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),ht(e,s))})),t.querySelectorAll(".app-cop-pill").forEach(d=>{d.addEventListener("click",()=>{const c=t.querySelector("#app-cop-input");c&&(c.value=d.dataset.q,ht(e,c))})})}function ht(e,t){const i=t.value.trim();if(!i)return;Le.push({role:"user",text:i}),t.value="";const s=e.querySelector("#app-cop-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
...
Ask me about device health, compliance, security, patches, or recommendations!`;tt.push({role:"ai",text:d}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `,e.querySelectorAll(".intune-tab-btn").forEach(i=>{i.addEventListener("click",()=>{De=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=Ei(),De==="signin"&&setTimeout(()=>Pi(e),100)})}),De==="signin"&&setTimeout(()=>Pi(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,v("Your profile has been refreshed.","success")},1500)})}function Ei(){const t={executive:ho,profile:bo,security:xo,signin:wo,licenses:Ao,groups:ko,devices:So,apps:$o,onedrive:Eo,teams:Po,approvals:Co,copilot:Mo}[De];return t?t():""}function ho(){var c,p,f,b,g,m,u,A;const e=((c=h.security)==null?void 0:c.securityScore)||85,t=((p=h.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((f=h.security)==null?void 0:f.riskLevel)||"Low",s=(h.licenses&&Array.isArray(h.licenses)?h.licenses.length:0)||((b=h.licenses)==null?void 0:b.count)||0,a=(h.devices&&Array.isArray(h.devices)?h.devices.length:0)||((g=h.devices)==null?void 0:g.count)||0,n=(h.groups&&h.groups.securityGroups?h.groups.securityGroups.length:0)||0,r=((m=h.teams)==null?void 0:m.teamsMembership)||0,l=0,o=((u=h.onedrive)==null?void 0:u.percentageUsed)||0,d=((A=h.mailbox)==null?void 0:A.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
