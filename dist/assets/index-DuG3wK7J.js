(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const Ei=[{id:"demo",name:"Demo Account",email:"demo@contoso.com",role:"admin",initials:"DM",color:"#00C7B7",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"],isDemoAccount:!0},{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","myaccount","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["requests","msgcenter","portal","myreqs","myaccount","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings","graphapi","sso"]}],ws={auth:{clientId:"04d3be8d-d433-4367-893e-eccc82190a11",authority:"https://login.microsoftonline.com/b9cc8284-05ed-452f-877a-970779430dcb",redirectUri:window.location.origin+"/callback"},cache:{cacheLocation:"sessionStorage",storeAuthStateInCookie:!1},system:{allowNativeBroker:!1}},As={scopes:["openid","profile","email","User.Read"]};let I=null;async function ks(){try{if(!window.msal)return console.warn("MSAL not loaded yet"),null;I=new window.msal.PublicClientApplication(ws),await I.initialize();const e=await I.handleRedirectPromise();if(e)return console.log("✓ Authenticated from redirect:",e.account.name),e.account;const t=I.getAllAccounts();return t.length>0?(console.log("✓ Already authenticated as:",t[0].name),t[0]):null}catch(e){return console.error("MSAL init error:",e.message),null}}async function Ss(){try{if(!I)return console.error("MSAL not initialized"),null;const e=await I.loginPopup(As);return console.log("✓ Login successful:",e.account.name),e.account}catch(e){return e.errorCode==="user_cancelled"?console.log("User cancelled login"):console.error("Login error:",e.errorCode,e.errorMessage),null}}async function $s(){try{if(!I)return null;const e=I.getAllAccounts();if(e.length===0)return null;const t={scopes:["https://graph.microsoft.com/.default"],account:e[0]};return(await I.acquireTokenSilent(t)).accessToken}catch(e){return console.error("Token error:",e.message),null}}async function Es(){try{if(!I)return;const e={account:I.getAllAccounts()[0]};await I.logout(e),console.log("✓ Logged out")}catch(e){console.error("Logout error:",e)}}function Ps(){if(!I)return null;const e=I.getAllAccounts();return e.length>0?e[0]:null}function Cs(){if(window.userEmail)return console.log("📧 getUserEmail from window.userEmail:",window.userEmail),window.userEmail;const e=Ps();if(!e)return null;const t=e.username||e.mail||e.email;return console.log("📧 getUserEmail from MSAL:",t),t}function Ms(){const e=document.getElementById("app-header"),t=y.currentUser;t&&(e.innerHTML=`
  ...
  `,e.querySelectorAll(".demo-filter-btn").forEach(s=>{s.addEventListener("click",()=>{_=s.dataset.status,Rt(e)})}),e.querySelectorAll(".demo-req-row").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;H=C.find(n=>n.id===a),H&&(me="details",Nt(e))})}),e.querySelectorAll(".demo-req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;H=C.find(r=>r.id===n),H&&(me="details",Nt(e))})})}function Nt(e){var i,s,a,n,r,l;if(!e||!e.querySelector||!H)return;const t=H;e.innerHTML=`
    <div class="page-header">
...
**Graph API:** GET /beta/identity/conditionalAccess/policies`}];let Ke=null,R=[],P=$,Ae="executive",D={priority:"all",category:"all",status:"all"},We="7d",Re=[],jt=!1;const ia=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"},{id:"apiref",label:"API Reference",icon:"ti-api"}];async function sa(){const e=document.getElementById("page-security");if(e){if(N()){console.log("🎭 Demo account detected - showing demo security data"),Aa(e);return}try{console.log("📡 Fetching real security data from backend...");const t=await Ci();t.success&&t.data?(Ke=t.data,console.log("✅ Loaded real secure score from API")):(console.warn("⚠️ No secure score data available from API"),Ke=null);let i=[];try{const r=await Dt();r.success&&r.data&&(i=r.data,console.log(`✅ Loaded ${i.length} real devices from Intune`))}catch(r){console.warn("⚠️ Could not fetch device data:",r.message)}const s=r=>r.map(l=>{var d,c,p,f,x,g;const o=l.deviceName||((c=(d=l.description)==null?void 0:d.match(/Device ([A-Z0-9-]+)/))==null?void 0:c[1])||((f=(p=l.title)==null?void 0:p.match(/([A-Z0-9-]+)/))==null?void 0:f[1])||((g=(x=l.description)==null?void 0:x.match(/([A-Z0-9]{3,})/))==null?void 0:g[1]);if(o&&i.length>0){const m=i.find(v=>{var A,V;return((A=v.deviceName)==null?void 0:A.toUpperCase().includes(o.toUpperCase()))||((V=v.deviceName)==null?void 0:V.includes(o))||v.id===o});if(m)return{...l,deviceId:m.id,deviceName:m.deviceName,deviceOS:m.operatingSystem,compliant:m.complianceState==="Compliant",managed:!0,owner:m.userDisplayName}}return l}),a=await Ts();a.success&&Array.isArray(a.data)&&a.data.length>0?(R=s(a.data),console.log(`✅ Loaded ${R.length} real incidents from alerts (enriched with device data)`)):(console.warn("⚠️ No active incidents found"),R=[]);const n=await Is();n.success&&n.data&&(P={totalUsers:n.data.totalUsers||$.totalUsers,privAccounts:n.data.privilegedAccounts||$.privAccounts,globalAdmins:n.data.globalAdmins||$.globalAdmins,serviceAccounts:n.data.serviceAccounts||$.serviceAccounts,breakGlass:n.data.breakGlassAccounts||$.breakGlass,identitySecureScore:n.data.identitySecureScore||$.identitySecureScore,mfaEnabled:n.data.mfaEnabled||$.mfaEnabled,mfaExcluded:n.data.mfaExcluded||$.mfaExcluded,passwordlessAdoption:n.data.passwordlessAdoption||$.passwordlessAdoption,fido2Adoption:n.data.fido2Adoption||$.fido2Adoption,legacyAuthConnections:n.data.legacyAuthConnections||$.legacyAuthConnections,highRiskUsers:n.data.highRiskUsers||$.highRiskUsers,riskySignIns30d:n.data.riskySignIns30d||$.riskySignIns30d,impossibleTravel30d:$.impossibleTravel30d,anonymousIP30d:$.anonymousIP30d,passwordSpray30d:$.passwordSpray30d,caPoliciesEnabled:n.data.caPoliciesEnabled||$.caPoliciesEnabled,caPoliciesDisabled:n.data.caPoliciesDisabled||$.caPoliciesDisabled,caPoliciesReportOnly:n.data.caPoliciesReportOnly||$.caPoliciesReportOnly,caUsersExcluded:n.data.caUsersExcluded||$.caUsersExcluded},console.log("✅ Loaded real identity posture data from Azure AD"))}catch(t){console.error("❌ Error loading security data:",t.message)}ie(e)}}function ie(e){var a,n;const t=Array.isArray(R)?R:[],i=t.filter(r=>r.severity==="critical").length;t.filter(r=>r.severity==="high"&&r.status!=="resolved").length;const s=ve.filter(r=>r.priority==="critical"||r.priority==="high").length;e.innerHTML=`
  ...
  `}function fa(){const e=R.filter(r=>r.status!=="resolved"),t=R.filter(r=>r.status==="resolved"),i=R.filter(r=>r.severity==="critical").length,s=R.filter(r=>r.severity==="high").length,a=R.filter(r=>r.severity==="medium").length,n=R.filter(r=>r.severity==="low").length;return`
    <div class="kpi-row mb-3">
  ...
  `}function ba(){(!jt||Re.length===0)&&(Re=[{role:"ai",text:`**M365 Security Copilot** — I have full context of your security posture across all 15 data sources.
...
Current status: Secure Score 64/95 · ${R.filter(l=>l.status!=="resolved").length} active incidents · ${$.highRiskUsers} high-risk users.`;Re.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `).join("")}function Wt(){return'<div style="padding:20px;text-align:center"><div class="spinner"></div><p style="color:var(--color-text-secondary)">Loading patterns...</p></div>'}function Ua(){return fe?Li():`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `;const n=Z==="all"?Q.filter(r=>r.id!==e):Q.filter(r=>r.severity===Z&&r.id!==e);if(n.length>0){const r=`
    ...
    `,l=i.querySelector("#other-alerts");l&&(l.innerHTML=r)}else{const r=i.querySelector("#other-alerts");r&&(r.style.display="none")}}window.dismissAndRefreshDetail=async function(e){try{await Ri(e),u("Alert dismissed","success"),await Ne()}catch{u("Failed to dismiss alert","error")}};window.showAlertDetailsFromDetail=function(e){Ii(e)};window.startCorrInvestigation=async function(e,t){try{U="investigation",fe=await Ma(null,e,t);const i=document.getElementById("page-tenantguard");if(i){const s=i.querySelector("#tg-content");s&&(s.innerHTML=Li(),Fa(i),ja())}}catch(i){u("Failed to start investigation: "+i.message,"error")}};window.closeInvestigation=function(){fe=null,U="alerts";const e=document.getElementById("page-tenantguard");if(e){const t=e.querySelector("#tg-content");t&&(t.innerHTML=ft(),ht(e))}};async function Fa(e){const t=e.querySelector("#investigation-send"),i=e.querySelector("#investigation-input"),s=e.querySelector("#investigation-report");t&&i&&(t.addEventListener("click",Kt),i.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),Kt())})),s&&s.addEventListener("click",async()=>{try{s.disabled=!0,s.innerHTML='<span class="spinner dark"></span>';const a=await La(fe.id);u("Report generated! Downloading...","success"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}catch(a){u("Failed to generate report: "+a.message,"error"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}})}async function Kt(){const e=document.getElementById("page-tenantguard"),t=e==null?void 0:e.querySelector("#investigation-input");if(!t)return;const i=t.value.trim();if(i)try{t.value="",t.disabled=!0;const s=e.querySelector("#investigation-messages");s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight);const a=await Ra(fe.id,i);s&&(s.innerHTML+=`
  ...
  `,e.querySelectorAll(".license-tab-btn").forEach(s=>{s.addEventListener("click",()=>{_e=s.dataset.tab,Ji(e)})}),(t=e.querySelector("#license-refresh"))==null||t.addEventListener("click",()=>{Wi()}),(i=e.querySelector("#license-export"))==null||i.addEventListener("click",()=>{alert("Export functionality coming soon")})}function $n(e){switch(e){case"summary":return En();case"inventory":return Pn();case"services":return Cn();case"assignments":return Mn();case"groups":return Dn();case"compliance":return Rn();default:return""}}function En(){return`
  ...
  `}function Rn(){const e=Je.scores||{utilization:0,costOptimization:0,securityCoverage:0,compliance:0};return`
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{q="landing",J=null,X=null,F=null,oe={},ee(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{jn(()=>Promise.resolve().then(()=>Mo),void 0).then(o=>o.go("myreqs"))})}function tr(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
...
→ **Applications → Secret & Certificate Expiry** for rotation roadmap.`}];let Be="executive",T={type:"all",status:"all",search:""},Le=[],ui=!1,L=[],ne=[],B=[],He=[],Ct=[],Te=[],vi=[],ge=[],ye=[],Ve=[];const is=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"appregistrations",label:"App Registrations",icon:"ti-app-window"},{id:"enterprise",label:"Enterprise Apps",icon:"ti-grid-dots"},{id:"secrets",label:"Secrets & Certs",icon:"ti-lock"},{id:"permissions",label:"Permissions",icon:"ti-shield-check"},{id:"auditconsents",label:"Audit Consents",icon:"ti-history"},{id:"owners",label:"Owners",icon:"ti-users"},{id:"usage",label:"Usage Analytics",icon:"ti-chart-line"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"lifecycle",label:"Lifecycle",icon:"ti-timeline"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"App Copilot",icon:"ti-robot"}];async function xr(){const e=document.getElementById("page-applications");if(!e)return;if(N()){console.log("🎭 Demo account detected - showing demo applications data"),wr(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading real M365 application data...</p></div>',console.log("📡 Fetching real application data from backend...");const t=await Gs();t!=null&&t.success&&t.data?(L=t.data,console.log(`✅ Apps: ${L.length}`)):(console.warn("⚠️ No application data available from API"),L=[]);const i=await Ns();i!=null&&i.success&&i.data?(ne=i.data,console.log(`✅ SPs: ${ne.length}`)):(console.warn("⚠️ No service principal data available from API"),ne=[]);try{const a=await(await fetch(`${S}/secrets-certificates`)).json();a!=null&&a.success&&(B=a.data||[],console.log(`✅ Secrets: ${B.length}`))}catch(s){console.warn("⚠️ Secrets error:",s.message)}try{console.log(`🔄 Fetching permissions from ${S}/permissions`);const s=await fetch(`${S}/permissions`);console.log(`📦 Permissions response status: ${s.status}`);const a=await s.json();console.log("📊 Permissions response:",a),a!=null&&a.success?(He=a.data||[],console.log(`✅ Permissions: ${He.length} items`)):console.warn("⚠️ Permissions endpoint returned success=false")}catch(s){console.warn("⚠️ Permissions error:",s.message,s.stack)}try{const a=await(await fetch(`${S}/admin-consents`)).json();a!=null&&a.success&&(Ct=a.data||[],console.log(`✅ Consents: ${Ct.length}`))}catch(s){console.warn("⚠️ Consents error:",s.message)}try{const a=await(await fetch(`${S}/recent-consents`)).json();a!=null&&a.success&&(vi=a.data||[],console.log(`✅ Recent Consents: ${vi.length}`))}catch(s){console.warn("⚠️ Recent Consents error:",s.message)}try{const a=await(await fetch(`${S}/audit-logs/consents`)).json();a!=null&&a.success&&(Te=a.data||[],console.log(`✅ Audit Consents: ${Te.length}`))}catch(s){console.warn("⚠️ Audit Consents error:",s.message)}try{const a=await(await fetch(`${S}/usage-analytics`)).json();a!=null&&a.success&&(ge=a.data||[],console.log(`✅ Usage: ${ge.length}`))}catch(s){console.warn("⚠️ Usage error:",s.message)}try{const a=await(await fetch(`${S}/risk-assessment`)).json();a!=null&&a.success&&(ye=a.data||[],console.log(`✅ Risks: ${ye.length}`))}catch(s){console.warn("⚠️ Risk error:",s.message)}try{const a=await(await fetch(`${S}/recommendations`)).json();a!=null&&a.success&&(Ve=a.data||[],console.log(`✅ Recs: ${Ve.length}`))}catch(s){console.warn("⚠️ Recs error:",s.message)}ue(e)}function wr(e){const t=[{id:"app-001",name:"Power BI Service",owners:["Chen Wei","Priya Kumar"],lastUsed:"2026-06-01",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-002",name:"Salesforce Integration",owners:["Aisha Raza"],lastUsed:"2026-06-01",status:"active",riskLevel:"medium",secretsExpiring:1},{id:"app-003",name:"ServiceNow Connector",owners:["Chen Wei","Sanjay Kumar"],lastUsed:"2026-05-31",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-004",name:"Slack Integration",owners:["Priya Kumar"],lastUsed:"2026-05-30",status:"inactive",riskLevel:"low",secretsExpiring:0},{id:"app-005",name:"Azure DevOps Extension",owners:["Chen Wei"],lastUsed:"2026-06-01",status:"active",riskLevel:"high",secretsExpiring:2}],i={totalApps:t.length,activeApps:4,appPermissions:12,delegatedPermissions:18,appRoles:8,secretsExpiring:3},s=[{appName:"Power BI Service",permissions:"Dataset.ReadWrite.All, Report.Read.All",grantedBy:"Chen Wei",grantedAt:"2026-06-01 14:32",status:"Approved"},{appName:"Salesforce Integration",permissions:"User.Read.All, Directory.Read.All",grantedBy:"Aisha Raza",grantedAt:"2026-06-01 11:15",status:"Approved"},{appName:"ServiceNow Connector",permissions:"Mail.Send, Mail.Read",grantedBy:"Admin",grantedAt:"2026-05-30 09:45",status:"Approved"}],a=[{appName:"Salesforce Integration",type:"Client Secret",expiresAt:"2026-06-15",status:"Expiring soon",daysLeft:14},{appName:"Azure DevOps Extension",type:"Client Secret",expiresAt:"2026-06-10",status:"Expiring soon",daysLeft:9},{appName:"Azure DevOps Extension",type:"Certificate",expiresAt:"2026-06-08",status:"Critical",daysLeft:7}];e.innerHTML=`
  ...
  `;const n=e.querySelector("#app-content");gi(n,i,t),e.querySelectorAll("#app-tabs .tab-btn").forEach(r=>{r.addEventListener("click",()=>{e.querySelectorAll("#app-tabs .tab-btn").forEach(o=>o.classList.remove("active")),r.classList.add("active");const l=r.dataset.tab;l==="executive"?gi(n,i,t):l==="appregistrations"?Ar(n,t):l==="enterprise"?kr(n,t):l==="secrets"?Sr(n,a):l==="permissions"?$r(n,i):l==="auditconsents"&&Er(n,s)})})}function gi(e,t,i){const s=i.filter(a=>a.riskLevel==="high");e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function ue(e){var a,n;const t=(B||[]).filter(r=>r.status==="expiring").length,i=(B||[]).filter(r=>r.status==="expired").length,s=(ye||[]).filter(r=>r.severity==="critical").length;e.innerHTML=`
    ...
    <div class="kpi-row mb-3">
      ...
      <div class="kpi-tile">
        <div class="kpi-value warning">${hr.highPrivilegeApps}</div>
  ...
  `}function Cr(){const e=L.length>0?L:[],t=e.filter(s=>!(T.type!=="all"&&s.category!==T.type||T.status!=="all"&&s.status!==T.status||T.search&&!s.name.toLowerCase().includes(T.search.toLowerCase()))),i=[...new Set(e.map(s=>s.category))];return`
    <div class="filter-bar mb-3">
  ...
  `}function Mr(){const e=ne.length>0?ne:[];return`
    <div class="filter-bar mb-3">
  ...
  `}function Dr(){const e=B.filter(s=>s.status==="expired"),t=B.filter(s=>s.status==="expiring"),i=B.filter(s=>s.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Rr(){const e=He.filter(i=>i.riskLevel==="critical"),t=He.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Tr(){const e=L.length>0?L:[],t=e.filter(a=>!a.owners||a.owners.length===0),i=e.filter(a=>a.owners&&a.owners.length===1),s=e.filter(a=>a.owners&&a.owners.length>1);return`
    ${t.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Ir(){const e=ge.filter(s=>s.status==="active"),t=ge.filter(s=>s.status==="lowuse"),i=ge.filter(s=>s.status==="unused");return`
    ...
    `).join("")}
  `}function zr(){const e=ye.filter(i=>i.severity==="critical"),t=ye.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function qr(){const e=L.length>0?L:[],t=e.filter(a=>{const n=a.createdDateTime?new Date(a.createdDateTime):null;if(!n)return!1;const r=new Date(Date.now()-30*24*60*60*1e3);return n>r}),i=e.filter(a=>!a.owners||a.owners.length===0),s=ge.filter(a=>a.status==="unused");return`
  ...
  `}function Nr(){(!ui||Le.length===0)&&(Le=[{role:"ai",text:`**Applications & App Registrations Copilot** — Ask me about app security, secrets, permissions, risks, and more.
...
Current state: **87 app registrations**, **124 enterprise apps**, **5 expiring secrets (30d)**, **2 critical risk apps**`}],ui=!0);const e=["Show expiring secrets","Which apps have Directory.ReadWrite.All?","List apps without owners","Show high-risk applications","Unused apps (90+ days)","Multi-tenant applications"];return`
  ...
  `}function yi(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
  </div>`}function Or(e){var a,n,r,l,o;const t=e.querySelector("#app-content");if(!t)return;(a=t.querySelector("#app-search"))==null||a.addEventListener("input",d=>{T.search=d.target.value,ue(e)}),(n=t.querySelector("#app-type-filter"))==null||n.addEventListener("change",d=>{T.type=d.target.value,ue(e)}),(r=t.querySelector("#app-status-filter"))==null||r.addEventListener("change",d=>{T.status=d.target.value,ue(e)}),(l=t.querySelector("#exec-view-risk"))==null||l.addEventListener("click",()=>{Be="risk",ue(e)}),(o=t.querySelector("#exec-view-recs"))==null||o.addEventListener("click",()=>{Be="recommendations",ue(e)});const i=t.querySelector("#app-cop-send"),s=t.querySelector("#app-cop-input");i&&s&&(i.addEventListener("click",()=>mt(e,s)),s.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),mt(e,s))})),t.querySelectorAll(".app-cop-pill").forEach(d=>{d.addEventListener("click",()=>{const c=t.querySelector("#app-cop-input");c&&(c.value=d.dataset.q,mt(e,c))})})}function mt(e,t){const i=t.value.trim();if(!i)return;Le.push({role:"user",text:i}),t.value="";const s=e.querySelector("#app-cop-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,s.scrollTop=s.scrollHeight),setTimeout(()=>{const a=i.toLowerCase(),n=br.find(l=>l.keywords.some(o=>a.includes(o))),r=(n==null?void 0:n.response)||`Searching application data for **"${i}"**...
...
Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;Le.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function Jr(){const e=b.summary,t=b.deviceHealth||[];return t.length>0&&Math.round(t.reduce((i,s)=>i+s.healthScore,0)/t.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Kr(){const e=b.summary,t=Math.max(0,(e.totalManagedDevices||0)-(e.nonCompliant||0));return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Zr(){var t,i,s,a,n,r,l,o;const e=b.endpointSecurity;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function Qr(){const e=b.patchManagement;return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
  ...
  `}function eo(){const e=b.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function to(){const e=b.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
  ...
  `}function io(){const e=b.recommendations||[];return`
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        <thead><tr>
          <th style="width:11%">Priority</th>
  ...
  `}function so(){if(!fi){const t=b.summary||{},i=b.riskAssessment||{};et=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.
...
Ask me about device health, compliance, security, patches, or recommendations!`;et.push({role:"ai",text:d}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `,e.querySelectorAll(".intune-tab-btn").forEach(i=>{i.addEventListener("click",()=>{De=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=xi(),De==="signin"&&setTimeout(()=>wi(e),100)})}),De==="signin"&&setTimeout(()=>wi(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,u("Your profile has been refreshed.","success")},1500)})}function xi(){const t={executive:po,profile:uo,security:vo,signin:go,licenses:mo,groups:yo,devices:fo,apps:ho,onedrive:bo,teams:xo,approvals:wo,copilot:Ao}[De];return t?t():""}function po(){var c,p,f,x,g,m,v,A;const e=((c=h.security)==null?void 0:c.securityScore)||85,t=((p=h.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((f=h.security)==null?void 0:f.riskLevel)||"Low",s=(h.licenses&&Array.isArray(h.licenses)?h.licenses.length:0)||((x=h.licenses)==null?void 0:x.count)||0,a=(h.devices&&Array.isArray(h.devices)?h.devices.length:0)||((g=h.devices)==null?void 0:g.count)||0,n=(h.groups&&h.groups.securityGroups?h.groups.securityGroups.length:0)||0,r=((m=h.teams)==null?void 0:m.teamsMembership)||0,l=0,o=((v=h.onedrive)==null?void 0:v.percentageUsed)||0,d=((A=h.mailbox)==null?void 0:A.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function uo(){const e=h.profile;return`
    <div class="card">
  ...
  `}function vo(){const e=h.security;return`
    <div class="card">
  ...
  `}function go(){const e=h.signin.filter(i=>i.result==="Success"),t=h.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function bo(){const e=h.onedrive;return`
    <div class="card">
  ...
  `}function xo(){const e=h.teams;return`
    <div class="card">
  ...
  `}function wo(){return!Ge||Ge.length===0?`
      <div class="card">
  ...
  `,Ms(),Pi()}function Co(){return["dashboard","requests","security","tenantguard","user-investigation","zerotrust","privaccts","m365config","msgcenter","applications","intune","licenses","agents","approvals","portal","myreqs","myaccount","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}So();Si().catch(e=>{console.error("Login render error:",e),Si()});const Mo=Object.freeze(Object.defineProperty({__proto__:null,go:w,hasAccess:ys,isRole:$o,resetSettings:ms,saveState:G,state:y},Symbol.toStringTag,{value:"Module"}));
