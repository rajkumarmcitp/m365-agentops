(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const pi=[{id:"demo",name:"Demo Account",email:"demo@contoso.com",role:"admin",initials:"DM",color:"#00C7B7",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"],isDemoAccount:!0},{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","myaccount","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["requests","msgcenter","portal","myreqs","myaccount","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings","graphapi","sso"]}],is={auth:{clientId:"04d3be8d-d433-4367-893e-eccc82190a11",authority:"https://login.microsoftonline.com/b9cc8284-05ed-452f-877a-970779430dcb",redirectUri:window.location.origin+"/callback"},cache:{cacheLocation:"sessionStorage",storeAuthStateInCookie:!1},system:{allowNativeBroker:!1}},ss={scopes:["openid","profile","email","User.Read"]};let F=null;async function as(){try{if(!window.msal)return console.warn("MSAL not loaded yet"),null;F=new window.msal.PublicClientApplication(is),await F.initialize();const e=await F.handleRedirectPromise();if(e)return console.log("✓ Authenticated from redirect:",e.account.name),e.account;const t=F.getAllAccounts();return t.length>0?(console.log("✓ Already authenticated as:",t[0].name),t[0]):null}catch(e){return console.error("MSAL init error:",e.message),null}}async function ns(){try{if(!F)return console.error("MSAL not initialized"),null;const e=await F.loginPopup(ss);return console.log("✓ Login successful:",e.account.name),e.account}catch(e){return e.errorCode==="user_cancelled"?console.log("User cancelled login"):console.error("Login error:",e.errorCode,e.errorMessage),null}}async function rs(){try{if(!F)return;const e={account:F.getAllAccounts()[0]};await F.logout(e),console.log("✓ Logged out")}catch(e){console.error("Logout error:",e)}}function os(){if(!F)return null;const e=F.getAllAccounts();return e.length>0?e[0]:null}function ls(){if(window.userEmail)return console.log("📧 getUserEmail from window.userEmail:",window.userEmail),window.userEmail;const e=os();if(!e)return null;const t=e.username||e.mail||e.email;return console.log("📧 getUserEmail from MSAL:",t),t}function ds(){const e=document.getElementById("app-header"),t=y.currentUser;t&&(e.innerHTML=`
  ...
  `,s.appendChild(a);const n=()=>{a.style.animation="toast-out 200ms ease forwards",setTimeout(()=>a.remove(),200)};a.querySelector(".toast-close").addEventListener("click",n),setTimeout(n,i)}const ps=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",A=ps?"http://localhost:3000/api":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api",us=A;async function $(e){try{const t=`${us}${e}`;console.log(`🔄 Calling: ${t}`);const i=await fetch(t,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"include"});if(!i.ok)throw new Error(`HTTP ${i.status}: ${i.statusText}`);const s=await i.json();return console.log(`✓ ${e}:`,s),s}catch(t){return console.error(`✗ API error on ${e}:`,t.message),{success:!1,error:t.message,data:[],count:0}}}async function xt(){return $("/devices")}async function vs(){return $("/device-compliance-policies")}async function ui(){return $("/security/score")}async function gs(){return $("/security/incidents")}async function ms(){return $("/identity/posture")}async function ys(){return $("/privileged-accounts")}async function fs(){return $("/users")}async function hs(){return $("/applications")}async function bs(){return $("/service-principals")}const xs=["demo@contoso.com","demo@m365ops.com","demo.user@contoso.com"];function te(){const e=ls();if(console.log("🔍 isDemoAccount() check - email:",e),!e)return console.log("❌ No email found"),!1;const t=e.toLowerCase(),i=xs.some(s=>t===s.toLowerCase());return console.log(`✅ isDemoAccount result: ${i}`),i}let Qe=0,Xe=0,et=null,de=[];function ws(){const e=localStorage.getItem("dashboard_consents_dismissed");if(!e)return!1;const t=new Date().getTime(),i=parseInt(e);return(t-i)/(1e3*60*60)<24}async function As(){var i,s,a,n,r,o,d,l;const e=document.getElementById("page-dashboard");if(!e)return;if(te()){ks(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading dashboard data...</p></div>';try{console.log("📡 Fetching real dashboard data from backend...");const c=await xt(),p=await fs(),b=await ui();Qe=c.success&&c.count?c.count:0,Xe=p.success&&p.count?p.count:0,et=b.success?b.data:null;try{const x=await $("/audit-logs/consents");if(x.success&&x.data){const g=new Date,m=new Date(g.getTime()-24*60*60*1e3);de=x.data.filter(v=>new Date(v.activityDateTime)>=m).sort((v,w)=>new Date(w.activityDateTime)-new Date(v.activityDateTime)).slice(0,5),console.log(`✅ Loaded ${de.length} recent admin consents (last 24 hours)`)}}catch(x){console.warn("⚠️ Could not fetch recent admin consents:",x.message)}console.log(`✅ Loaded dashboard data: ${Qe} devices, ${Xe} users`)}catch(c){console.error("❌ Error loading dashboard data:",c)}e.innerHTML=`
  ...
  `}let G=[],pe=null,Ge="PENDING_APPROVAL",Be="list";async function $s(){const e=document.getElementById("page-requests");e&&(await vi(),Ye(e))}async function vi(e){try{const i=await(await fetch(`${A}/requests?limit=100`)).json();G=Array.isArray(i.data)?i.data:[],console.log(`📋 Loaded ${G.length} requests`)}catch(t){console.error("Error loading requests:",t),u("Failed to load requests","error")}}function Ye(e){if(!e||!e.querySelector){console.error("❌ Page element not found or invalid");return}const t=Ge==="ALL"?G:G.filter(s=>s.status===Ge),i={total:G.length,pending:G.filter(s=>s.status==="PENDING_APPROVAL").length,approved:G.filter(s=>s.status==="APPROVED").length,rejected:G.filter(s=>s.status==="REJECTED").length,completed:G.filter(s=>s.status==="COMPLETED").length};e.innerHTML=`
    <div class="page-header">
      <div>
              ...
              ${t.map(s=>{var a,n;return`
                <tr style="border-bottom:0.5px solid var(--color-border-tertiary);cursor:pointer" data-id="${s.id}">
                  ...
                  <td style="padding:10px 12px">
                    <span style="padding:2px 6px;border-radius:3px;font-size:10px;background:${mi((a=s.validation)==null?void 0:a.riskLevel)};color:white">
                      ${((n=s.validation)==null?void 0:n.riskLevel)||"MEDIUM"}
                    </span>
                  </td>
                  <td style="padding:10px 12px">${gi(s.status)}</td>
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
              <div style="font-size:28px;font-weight:600;color:${mi((a=t.validation)==null?void 0:a.riskLevel)}">${((n=t.validation)==null?void 0:n.riskScore)||0}</div>
              <div>
  ...
  </svg>`}function Ls(e,t=24){const i=Math.max(...e),s=Math.min(...e),a=i-s||1;return`<div style="display:flex;align-items:flex-end;gap:2px;height:${t}px">
  ...
  </div>`}function Is(e,t){return e==="pass"||e===!0?`<span style="color:var(--clr-success-text)"><i class="ti ti-circle-check"></i> ${t}</span>`:e==="partial"||e==="warn"?`<span style="color:var(--clr-warning-text)"><i class="ti ti-alert-triangle"></i> ${t}</span>`:`<span style="color:var(--clr-danger-text)"><i class="ti ti-circle-x"></i> ${t}</span>`}function Rs(){return({executive:Lt,securescore:Ts,identity:qs,email:zs,endpoint:Ns,teams:Os,sharepoint:Gs,dataprotection:Us,privaccess:Fs,guests:js,incidents:Bs,recommendations:Hs,copilot:_s,apiref:Vs}[ge]||Lt)()}function Lt(){const e=He||SECURE_SCORE,t=Array.isArray(M)?M:[];return`
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        <div style="margin-bottom:12px" id="exec-trend-chart">
          ${Ls((Fe==="30d"?e.trend30d:e.trend7d)||[72,73,74,75,76,77,78],32)}
        </div>
  ...
  `}function Ts(){const e=SECURE_SCORE;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function zs(){const e=EMAIL;return`
    <div class="kpi-row mb-3">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
          ${[{label:"SPF Record",ok:e.spf==="pass",note:e.spf==="pass"?"Configured — v=spf1 include:protection.outlook.com -all":"Missing or misconfigured"},{label:"DKIM Signing",ok:e.dkim==="pass",note:e.dkim==="pass"?"Enabled for contoso.com":"Not configured"},{label:"DMARC Policy",ok:e.dmarc==="reject"?"pass":e.dmarc==="quarantine"?"warn":!1,note:`Policy: ${e.dmarc} — ${e.dmarc!=="reject"?"upgrade to reject for full protection":"optimal"}`},{label:"Safe Links",ok:e.safeLinks==="enabled",note:e.safeLinks==="enabled"?"Active for all users":"Disabled"},{label:"Safe Attachments",ok:e.safeAttachments==="enabled"?"pass":"warn",note:e.safeAttachments==="partial"?"Partial — not all users covered":e.safeAttachments},{label:"Anti-spam Policy",ok:e.antiSpamPolicy==="strict"?"pass":"warn",note:`Level: ${e.antiSpamPolicy} — recommend strict`}].map(t=>`
            <div style="padding:10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:0.5px solid var(--color-border-tertiary)">
              ...
              <div style="font-size:12px;font-weight:600;margin-bottom:3px">${Is(t.ok,t.ok==="pass"||t.ok===!0?"Pass":t.ok==="warn"?"Warning":"Fail")}</div>
  ...
  `}function Ns(){const e=ENDPOINT;return`
    <div class="kpi-row mb-3">
  ...
  `}function Os(){const e=TEAMS_SEC;return`
    <div class="kpi-row mb-3">
  ...
  `}function Gs(){const e=SHAREPOINT_SEC;return`
    <div class="kpi-row mb-3">
  ...
  `}function Us(){const e=DATA_PROTECTION;return`
    <div class="kpi-row mb-3">
  ...
  `}function Fs(){const e=PRIV_ACCESS;return`
    <div class="kpi-row mb-3">
  ...
  `}function js(){const e=GUEST_GOVERNANCE;return`
    <div class="kpi-row mb-3">
  ...
  `}function Bs(){const e=M.filter(r=>r.status!=="resolved"),t=M.filter(r=>r.status==="resolved"),i=M.filter(r=>r.severity==="critical").length,s=M.filter(r=>r.severity==="high").length,a=M.filter(r=>r.severity==="medium").length,n=M.filter(r=>r.severity==="low").length;return`
    <div class="kpi-row mb-3">
    ...
    ${t.length>0?`
      ...
      `).join("")}
    `:""}
  `}function Hs(){const e=RECOMMENDATIONS.filter(s=>!(P.priority!=="all"&&s.priority!==P.priority||P.category!=="all"&&s.category!==P.category||P.status!=="all"&&s.status!==P.status)),t=e.reduce((s,a)=>s+a.scoreGain,0),i=[...new Set(RECOMMENDATIONS.map(s=>s.category))];return`
  ...
  `}function _s(){(!Dt||ke.length===0)&&(ke=[{role:"ai",text:`**M365 Security Copilot** — I have full context of your security posture across all 15 data sources.
...
Current status: Secure Score 64/95 · ${M.filter(o=>o.status!=="resolved").length} active incidents · ${S.highRiskUsers} high-risk users.`;ke.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
      ...
      </div>`,s.scrollTop=s.scrollHeight)},600)}function yi(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"<br><br>").replace(/\n/g,"<br>").replace(/\|(.+)\|\n\|[-|: ]+\|\n/g,"").replace(/\|(.+)\|/g,t=>`<span style="display:flex;gap:16px;font-size:11px;padding:2px 0">${t.split("|").filter(s=>s.trim()).map(s=>`<span>${s.trim()}</span>`).join("")}</span>`)}function Js(e){const t={overallScore:78,categoryScores:{identity:82,data:75,devices:72,apps:76,infrastructure:79}},i=Ps.slice(0,5);e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#security-content");It(s,t,i),e.querySelectorAll("#sec-tabs .tab-btn").forEach(a=>{a.addEventListener("click",()=>{e.querySelectorAll("#sec-tabs .tab-btn").forEach(r=>r.classList.remove("active")),a.classList.add("active");const n=a.dataset.section;n==="executive"?It(s,t,i):n==="securescore"?Ks(s,t):n==="identity"?Ys(s):n==="incidents"&&Zs(s,i)})})}function It(e,t,i){e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function j(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
  </div>`}async function se(e,t={}){const s=`${window.location.hostname==="localhost"?"http://localhost:3000":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net"}/api/tenantguard${e}`;try{const a=await fetch(s,{method:t.method||"GET",headers:{"Content-Type":"application/json",...t.headers},body:t.body?JSON.stringify(t.body):void 0});if(!a.ok)throw new Error(`API error: ${a.status}`);return await a.json()}catch(a){throw console.error("TenantGuard API error:",a),a}}async function Qs(){return(await se("/alerts/summary")).data}async function Xs(e="all",t=50){let i=`/alerts?limit=${t}`;return e!=="all"&&(i+=`&severity=${e}`),(await se(i)).data}async function fi(e,t=""){return await se(`/alerts/${e}/dismiss`,{method:"POST",body:{reason:t}})}async function ea(e="all"){let t="/correlations";return e!=="all"&&(t+=`?severity=${e}`),(await se(t)).data}async function ta(e=null,t=null,i=null){return(await se("/investigate",{method:"POST",body:{alertId:e,correlationId:t,title:i}})).data}async function ia(e){return(await se(`/investigations/${e}`)).data}async function sa(e,t){return(await se(`/investigations/${e}/chat`,{method:"POST",body:{message:t}})).data}async function aa(e){return(await se(`/investigations/${e}/report`,{method:"POST"})).data}let U="alerts",K="all",me=[],De=[],le=null,it=null;const na=[{id:"all",label:"All Alerts",icon:"ti-list"},{id:"CRITICAL",label:"Critical",icon:"ti-alert-triangle"},{id:"HIGH",label:"High",icon:"ti-alert-circle"},{id:"MEDIUM",label:"Medium",icon:"ti-alert-octagon"}],ra=[{id:"alerts",label:"Alerts",icon:"ti-list"},{id:"correlations",label:"Correlations",icon:"ti-link"},{id:"patterns",label:"Attack Patterns",icon:"ti-alert-triangle"},{id:"investigation",label:"AI Investigation",icon:"ti-robot"}];async function oa(){const e=document.getElementById("page-tenantguard");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading TenantGuard alerts...</p></div>';try{await Le()}catch(t){console.error("Error initializing TenantGuard:",t),u("Failed to load alerts","error")}it&&clearInterval(it),it=setInterval(Le,5*60*1e3)}}async function Le(){try{const[e,t,i]=await Promise.all([Qs(),Xs("all",100),ea("all")]);me=t||[],De=i||[],la(e)}catch(e){console.error("Error refreshing data:",e),u("Failed to refresh alerts: "+e.message,"error")}}function la(e){var r;const t=document.getElementById("page-tenantguard");if(!t)return;const i=e.critical||0,s=e.high||0;e.medium;const a=e.total||0,n=De.length;t.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,t.querySelectorAll("[data-section]").forEach(o=>{o.addEventListener("click",()=>{U=o.dataset.section,K="all";const d=t.querySelector("#tg-content");d&&(d.innerHTML=U==="alerts"?lt():U==="correlations"?Rt():Tt(),U==="alerts"&&dt(t)),t.querySelectorAll("[data-section]").forEach(l=>l.classList.remove("active")),o.classList.add("active")})}),(r=t.querySelector("#tg-refresh"))==null||r.addEventListener("click",async()=>{const o=t.querySelector("#tg-refresh"),d=o.innerHTML;o.innerHTML='<span class="spinner dark"></span> Scanning...',o.disabled=!0,await Le(),o.innerHTML=d,o.disabled=!1}),U==="alerts"&&dt(t)}function lt(){return`
    ...
    <div id="tg-alerts-list" style="margin-top:12px">${bi()}</div>
  `}function Rt(){return De.length===0?`
    ...
    <div class="tenantguard-alert-card ${e.risk_level.toLowerCase()}" data-corr-id="${e.id}" style="cursor:pointer">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px">
        ...
        <span class="badge ${Ie(e.risk_level)}">${e.risk_level}</span>
      </div>
    </div>
  `).join("")}function Tt(){return'<div style="padding:20px;text-align:center"><div class="spinner"></div><p style="color:var(--color-text-secondary)">Loading patterns...</p></div>'}function da(){return le?hi():`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function hi(){return`
    <div class="card mb-3">
      <div class="card-header">
        <span class="card-title"><i class="ti ti-robot"></i> ${I(le.title)}</span>
  ...
  `}function bi(){const e=K==="all"?me:me.filter(t=>t.severity===K);return e.length===0?`
      <div style="text-align:center;padding:40px 20px;color:var(--color-text-secondary)">
        <div style="font-size:48px;margin-bottom:12px;opacity:0.5">✓</div>
    ...
    <div class="tenantguard-alert-card ${t.severity.toLowerCase()}" data-alert-id="${t.id}">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px">
        ...
        <span class="badge ${Ie(t.severity)}" style="margin-left:8px">${t.severity}</span>
      </div>
      ...
      <div style="margin-bottom:16px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;font-size:11px">
          <div>
            ...
            <div style="font-weight:700;font-size:14px;color:${va(a.severity||t.severity)}">${a.score||t.score}/100</div>
          </div>
          <div>
            <div style="color:var(--color-text-tertiary)">Severity</div>
            <div style="font-weight:700;margin-top:4px"><span class="badge ${Ie(a.severity||t.severity)}">${a.severity||t.severity}</span></div>
          </div>
          ${Object.entries(a.levels||{}).map(([r,o])=>`
            <div>
              <div style="color:var(--color-text-tertiary)">${ua(r)}</div>
        ...
        ${n.map(d=>`
          <div class="tenantguard-alert-card ${d.severity.toLowerCase()}" style="cursor:pointer" onclick="showAlertDetailsFromDetail('${d.id}')">
            <div style="display:flex;justify-content:space-between;align-items:flex-start">
              <div style="flex:1">
                <div style="font-weight:600;font-size:12px">${I(d.headline)}</div>
                <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:4px">${ct(d.action_timestamp)}</div>
              </div>
              <span class="badge ${Ie(d.severity)}">${d.severity}</span>
            </div>
          </div>
        `).join("")}
      </div>
    `,o=i.querySelector("#other-alerts");o&&(o.innerHTML=r)}else{const r=i.querySelector("#other-alerts");r&&(r.style.display="none")}}window.dismissAndRefreshDetail=async function(e){try{await fi(e),u("Alert dismissed","success"),await Le()}catch{u("Failed to dismiss alert","error")}};window.showAlertDetailsFromDetail=function(e){xi(e)};window.startCorrInvestigation=async function(e,t){try{U="investigation",le=await ta(null,e,t);const i=document.getElementById("page-tenantguard");if(i){const s=i.querySelector("#tg-content");s&&(s.innerHTML=hi(),ca(i),pa())}}catch(i){u("Failed to start investigation: "+i.message,"error")}};window.closeInvestigation=function(){le=null,U="alerts";const e=document.getElementById("page-tenantguard");if(e){const t=e.querySelector("#tg-content");t&&(t.innerHTML=lt(),dt(e))}};async function ca(e){const t=e.querySelector("#investigation-send"),i=e.querySelector("#investigation-input"),s=e.querySelector("#investigation-report");t&&i&&(t.addEventListener("click",zt),i.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),zt())})),s&&s.addEventListener("click",async()=>{try{s.disabled=!0,s.innerHTML='<span class="spinner dark"></span>';const a=await aa(le.id);u("Report generated! Downloading...","success"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}catch(a){u("Failed to generate report: "+a.message,"error"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}})}async function zt(){const e=document.getElementById("page-tenantguard"),t=e==null?void 0:e.querySelector("#investigation-input");if(!t)return;const i=t.value.trim();if(i)try{t.value="",t.disabled=!0;const s=e.querySelector("#investigation-messages");s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight);const a=await sa(le.id,i);s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight),t.disabled=!1,t.focus()}catch(s){u("Failed to send message: "+s.message,"error");const a=e==null?void 0:e.querySelector("#investigation-input");a&&(a.disabled=!1)}}async function pa(){try{const e=await ia(le.id),t=document.querySelector("#investigation-messages");t&&e.messages&&(t.innerHTML=e.messages.map(i=>`
      ...
      `).join(""),t.scrollTop=t.scrollHeight)}catch(e){console.error("Failed to load messages:",e)}}function ct(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"Unknown"}function ua(e){return e.charAt(0).toUpperCase()+e.slice(1)}function I(e){if(!e)return"";const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return String(e).replace(/[&<>"']/g,i=>t[i])}function Ie(e){switch(e==null?void 0:e.toUpperCase()){case"CRITICAL":return"danger";case"HIGH":return"warning";case"MEDIUM":return"info";default:return"neutral"}}function va(e){switch(e==null?void 0:e.toUpperCase()){case"CRITICAL":return"var(--clr-danger-text)";case"HIGH":return"var(--clr-warning-text)";case"MEDIUM":return"var(--clr-info-text)";default:return"var(--color-text-primary)"}}const ga=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",wi=ga?"http://localhost:3000/api":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api";async function ma(){const e=await fetch(`${wi}/tenantguard/users`);if(!e.ok)throw new Error(`Failed to fetch users: ${e.statusText}`);return e.json()}async function ya(e,t,i){const s=new URLSearchParams;t&&s.append("startDate",t),i&&s.append("endDate",i);const a=`${wi}/tenantguard/users/${e}/investigation?${s.toString()}`,n=await fetch(a);if(!n.ok)throw new Error(`Failed to fetch investigation: ${n.statusText}`);return n.json()}function fa(){const e=document.getElementById("page-user-investigation");e&&ha(e)}function ha(e){e.innerHTML=`
    <div class="page-header">
  ...
  `;let t=[],i=null;const s=e.querySelector("#user-search"),a=e.querySelector("#user-dropdown"),n=e.querySelector("#days-back");e.querySelector("#custom-date");const r=e.querySelector("#investigate-btn");o();async function o(){try{t=(await ma()).data||[]}catch(d){console.error("Failed to load users:",d),u("Failed to load user list","error")}}s.addEventListener("input",d=>{const l=d.target.value.toLowerCase();if(!l){a.style.display="none";return}const c=t.filter(p=>p.displayName.toLowerCase().includes(l)||p.mail.toLowerCase().includes(l));a.innerHTML=c.map(p=>`
    ...
    `).join(""),c.forEach(p=>{const b=a.querySelector(`[data-id="${p.id}"]`);b==null||b.addEventListener("click",()=>{i=p.id,s.value=p.displayName,a.style.display="none",r.disabled=!1})}),a.style.display=c.length>0?"block":"none"}),r.addEventListener("click",async()=>{if(!i){u("Please select a user","warning");return}const d=parseInt(n.value),l=new Date,c=new Date(l);c.setDate(c.getDate()-d),st(e,!0);try{const p=await ya(i,c.toISOString().split("T")[0],l.toISOString().split("T")[0]);ba(e,p.data),st(e,!1)}catch(p){console.error("Investigation error:",p),u("Failed to load investigation data","error"),st(e,!1)}}),document.addEventListener("click",d=>{!s.contains(d.target)&&!a.contains(d.target)&&(a.style.display="none")})}function st(e,t){e.querySelector("#loading-state").style.display=t?"block":"none",e.querySelector("#investigation-results").style.display=t?"none":"block",e.querySelector("#empty-state").style.display="none"}function ba(e,t){const{user:i,applicationAccess:s,signInLogs:a,auditLogs:n,actionsOnOtherAccounts:r,timeline:o,summary:d}=t,l=`
    <div class="info-card">
    ...
    <div class="info-card">
      ...
      <div style="color:var(--color-text-secondary);font-size:11px;margin-top:4px">${xa(i.lastActive)}</div>
    </div>
  ...
  `;e.querySelector("#applications-section").innerHTML=c;const p={};a.forEach(v=>{p[v.application]||(p[v.application]=[]),p[v.application].push(v)});const b=`
    <div style="display:grid;gap:16px">
      ${Object.entries(p).slice(0,10).map(([v,w])=>{const X=w.filter(k=>k.status==="success").length,St=w.filter(k=>k.status==="failure").length,$t=w.filter(k=>k.compliant==="No").length,Et=w.filter(k=>k.managed==="No").length;return`
  ...
  `,Sa(e),e.querySelector("#zt-rescan").addEventListener("click",()=>{const l=e.querySelector("#zt-rescan");l.innerHTML='<span class="spinner dark"></span> Scanning...',l.disabled=!0,setTimeout(()=>{l.innerHTML='<i class="ti ti-refresh"></i> Re-scan',l.disabled=!1,u("Zero Trust scan complete — 12 controls assessed.","success")},2e3)})}function ka(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-lock-check"></i> Zero Trust Compliance</div>
  ...
  `,e.querySelector("#zt-rescan").addEventListener("click",()=>{const t=e.querySelector("#zt-rescan");t.innerHTML='<span class="spinner dark"></span> Scanning...',t.disabled=!0,setTimeout(()=>{t.innerHTML='<i class="ti ti-refresh"></i> Rescan',t.disabled=!1,u("No Zero Trust assessment data available from Graph API","info")},2e3)})}function Sa(e){const t=e.querySelector("#zt-pillars");t&&(t.innerHTML=Ai.map((i,s)=>{const a=i.controls.filter(l=>l.status==="pass").length,n=i.controls.filter(l=>l.status==="warn").length,r=i.controls.filter(l=>l.status==="fail").length,o=i.controls.length,d=r>0?"danger":n>0?"warning":"success";return`
      <div class="card mb-3" style="padding:0;overflow:hidden">
  ...
  `;const s=e.querySelector("#cfg-topic-grid");ki.forEach(a=>{const n=Si(a),r=pt(n.score),o=document.createElement("div");o.className="cfg-topic-card";const d=$a[a.id]||{bg:"#f0f0f0",color:"#555"};o.innerHTML=`
    ...
    `,o.addEventListener("click",()=>{Da(e,a)}),s.appendChild(o)}),e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const a=e.querySelector("#cfg-scan-now");a.innerHTML='<span class="spinner dark"></span> Scanning...',a.disabled=!0,setTimeout(()=>{a.innerHTML='<i class="ti ti-refresh"></i> Run scan now',a.disabled=!1,u("CIS Benchmark scan complete — see results above","success")},2e3)})}function Da(e,t){const i=Si(t),s=pt(i.score);e.innerHTML=`
    <div class="page-header">
      <div>
        ...
        <tbody>
          ${n.controls.map(o=>`
            <tr style="border-bottom:0.5px solid var(--color-border-tertiary)">
              ...
              <td style="padding:10px 12px;font-size:10px">${Ca(wt(o))}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,a.appendChild(r)}),e.querySelector("#cfg-back").addEventListener("click",()=>{$i()})}function La(e){e.innerHTML=`
    <div class="page-header">
      <div>
        ...
        <tbody>
          ${t.map((s,a)=>`
            <tr style="border-bottom:${a<t.length-1?"0.5px solid var(--color-border-tertiary)":"none"}">
              ...
              <td style="padding:10px 12px;font-size:10px">${Ci(s.role)}</td>
              <td style="padding:10px 12px;font-size:10px">${Pi(s.mfa)}</td>
  ...
  `}function qa(e,t){const i=e.querySelector("#pa-tab-groups");i.innerHTML=`
    <div class="card" style="padding:0;overflow:hidden">
      <table style="width:100%">
        <thead style="background:var(--color-background-secondary)">
          <tr>
  ...
  `}function za(e,t){const i=e.querySelector("#pa-tab-log");i.innerHTML=`
    <div class="card" style="padding:0;overflow:hidden">
      <table style="width:100%">
        <thead style="background:var(--color-background-secondary)">
          <tr>
  ...
  `}function Na(e){var a,n;const t=e.querySelector("#pa-tab-accounts"),i="pa-acct-search";let s=`
  ...
  `;t.innerHTML=s,Di(t),(a=t.querySelector(`#${i}`))==null||a.addEventListener("input",r=>{var l;const o=r.target.value.toLowerCase(),d=((l=t.querySelector("#pa-risk-filter"))==null?void 0:l.value)||"all";Ut(t,o,d)}),(n=t.querySelector("#pa-risk-filter"))==null||n.addEventListener("change",r=>{var d;const o=((d=t.querySelector(`#${i}`))==null?void 0:d.value.toLowerCase())||"";Ut(t,o,r.target.value)})}function Ut(e,t,i){const s=e.querySelector("#pa-acct-tbody");s&&(s.innerHTML=ue.filter(a=>{const n=!t||a.upn.toLowerCase().includes(t)||a.name.toLowerCase().includes(t),r=i==="all"||a.risk===i;return n&&r}).map(a=>Mi(a)).join(""),Di(e))}function Mi(e){return`
    <tr class="pa-acct-row" data-id="${e.id}">
      ...
      <td><div class="pill-group">${e.roles.map(Ci).join("")}</div></td>
      <td><div class="pill-group">${Pi(e.mfa)}</div></td>
      <td>${Gt(e.risk)}</td>
  ...
  `}function ve(e,t,i){const s={add:"ti-user-plus",remove:"ti-user-minus",risk:"ti-alert-triangle",mfa:"ti-shield",tag:"ti-tag",review:"ti-clipboard-check"},a={add:"var(--clr-info-text)",remove:"var(--clr-warning-text)",risk:"var(--clr-danger-text)",mfa:"var(--clr-success-text)",tag:"var(--clr-info-text)",review:"var(--clr-success-text)"},n={add:"var(--clr-info-bg)",remove:"var(--clr-warning-bg)",risk:"var(--clr-danger-bg)",mfa:"var(--clr-success-bg)",tag:"var(--clr-info-bg)",review:"var(--clr-success-bg)"};Ei.unshift({id:Date.now(),type:e,icls:s[e]||"ti-info-circle",ic:a[e]||"var(--clr-info-text)",bg:n[e]||"var(--clr-info-bg)",title:t,detail:t,by:i,time:"Just now"});const r=document.querySelector("#pa-tab-log");r&&Li(r)}let N=[],xe={total:0,consumed:0,available:0,utilizationPct:0},we=[],ut=[],je={},Ue="summary";const Ua=[{id:"summary",label:"Executive Summary",icon:"ti-layout-dashboard"},{id:"inventory",label:"License Inventory",icon:"ti-box"},{id:"services",label:"Service Plans",icon:"ti-list-check"},{id:"assignments",label:"User Assignments",icon:"ti-users"},{id:"groups",label:"Group Licensing",icon:"ti-users-group"},{id:"compliance",label:"Compliance",icon:"ti-shield-check"}];async function Ii(){const e=document.getElementById("page-licenses");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading comprehensive license data...</p></div>';try{console.log("📡 Fetching comprehensive license data...");const[t,i,s,a]=await Promise.all([$("/licenses"),$("/licenses/assignments"),$("/licenses/groups"),$("/licenses/compliance")]);t.success&&t.data&&(N=t.data,xe=t.summary||{total:0,consumed:0,available:0,utilizationPct:0}),i.success&&i.data&&(we=i.data),s.success&&s.data&&(ut=s.data),a.success&&a.data&&(je=a.data),console.log("✅ Loaded all license data")}catch(t){console.error("❌ Error loading license data:",t)}Ri(e)}}function Ri(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,e.querySelectorAll(".license-tab-btn").forEach(s=>{s.addEventListener("click",()=>{Ue=s.dataset.tab,Ri(e)})}),(t=e.querySelector("#license-refresh"))==null||t.addEventListener("click",()=>{Ii()}),(i=e.querySelector("#license-export"))==null||i.addEventListener("click",()=>{alert("Export functionality coming soon")})}function Fa(e){switch(e){case"summary":return ja();case"inventory":return Ba();case"services":return Ha();case"assignments":return _a();case"groups":return Va();case"compliance":return Wa();default:return""}}function ja(){return`
  ...
  `}function Wa(){const e=je.scores||{utilization:0,costOptimization:0,securityCoverage:0,compliance:0};return`
  ...
  `,e&&e.querySelectorAll&&["PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].forEach(t=>{const i=e.querySelector(`#filter-${t}`);i&&i.addEventListener("click",()=>{vt=t,Y(e),qi(e)})}),e&&e.querySelectorAll){e.querySelectorAll(".btn-sm-approve").forEach(i=>{i.addEventListener("click",s=>{s.stopPropagation();const a=i.dataset.id;Re=ce.find(n=>n.id===a),Z="details",Y(e)})});const t=e.querySelector("#view-audit-btn");t&&t.addEventListener("click",()=>{Z="audit",Y(e)}),e.querySelectorAll("tr[data-id]").forEach(i=>{i.addEventListener("click",()=>{const s=i.dataset.id;Re=ce.find(a=>a.id===s),Z="details",Y(e)})})}}function Xa(e){var s,a,n,r,o;if(!e||!Re)return;const t=Re,i=tn(t);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `;const a=e.querySelector("#portal-service-grid");Ve.forEach(n=>{var l,c;const r=We(Vt(n.id)),o=Te(n.id)?ye.reduce((p,b)=>{var x,g;return p+(((g=(x=fe(b.id))==null?void 0:x.operations)==null?void 0:g.length)||0)},0):((c=(l=fe(n.id))==null?void 0:l.operations)==null?void 0:c.length)||0,d=document.createElement("div");d.className=`portal-svc-card ${r?"":"disabled"}`,d.innerHTML=`
    ...
    `,r||(d.title="This service has been disabled by your administrator."),a.appendChild(d)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(n=>{n.addEventListener("click",()=>{B=n.dataset.gid,Te(B)&&(_=ln()),z=null,ee={},R="service",V(e)})})}function cn(e){const t=At(B);if(!t){R="landing",V(e);return}const i=Ze(),s=fe(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{R="landing",V(e)}),Te(B)&&e.querySelectorAll(".ex-sub-tab").forEach(a=>{a.addEventListener("click",()=>{_=a.dataset.sub,z=null,Wt(e,fe(_)),e.querySelectorAll(".ex-sub-tab").forEach(n=>n.classList.toggle("active",n.dataset.sub===_))})}),Wt(e,s)}function pn(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
  ...
  `,s.querySelector("#svc-start-form").addEventListener("click",()=>{R="form",ee={};const o=document.getElementById("page-portal");V(o)})}function un(e){var n;const t=At(B),i=Ze(),s=Oi(i,z);if(!s||!t){R="service",V(e);return}const a=qe(s);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#form-back").addEventListener("click",()=>{R="service",V(e)}),e.querySelector("#form-submit").addEventListener("click",()=>gn(e,s))}function vn(e){const t=e.required?" *":"",i=e.hint?`<div style="font-size:10px;color:var(--color-text-tertiary);margin-top:3px">${e.hint}</div>`:"";return e.type==="text"||e.type==="email"?`<div class="form-group" data-field="${e.id}">
  ...
  `,x.appendChild(g),document.body.appendChild(x),document.getElementById("val-cancel").addEventListener("click",()=>{x.remove()}),document.getElementById("val-submit").addEventListener("click",()=>{x.remove(),Gi(e,t,i)})}async function Gi(e,t,i){Ni++;try{const s=e.querySelector("#val-submit");s&&(s.disabled=!0,s.innerHTML='<span class="spinner"></span> Submitting...');const n=await(await fetch(`${A}/requests/submit`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operationId:t.id,fields:ee,userEmail:window.userEmail,validation:i||{}})})).json();n.success?(console.log("✓ Request submitted:",n.data.id),u("Request submitted successfully","success"),R="submitted",V(e)):(u("Failed to submit request: "+n.error,"error"),s&&(s.disabled=!1,s.innerHTML='<i class="ti ti-send"></i> Confirm & Submit'))}catch(s){console.error("Submission error:",s),u("Error submitting request. Please try again.","error")}}function fn(e){var r,o;const t=At(B),i=Ze(),s=Oi(i,z);if(!s||!t){R="landing",V(e);return}const a=qe(s),n=`REQ-${String(Ni).padStart(4,"0")}`;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{R="landing",B=null,_=null,z=null,ee={},V(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{nn(()=>Promise.resolve().then(()=>Nr),void 0).then(d=>d.go("myreqs"))})}function hn(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
...
Full details available in **Graph API** page (super admin only).`}],xn=`I'm your **M365 AgentOps AI Copilot**. I can help you with:
...
- "What are the M365 Config failures?"`;let Je=[],Zt=!1;function wn(){const e=document.getElementById("page-chat");if(!e)return;const t=y.currentUser,i=Yt[t==null?void 0:t.role]||Yt.user;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#chat-messages"),a=e.querySelector("#chat-input");!Zt||Je.length===0?(Je=[],yt("ai",xn),Zt=!0):ft(s),e.querySelector("#chat-send").addEventListener("click",()=>at(e)),a.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),at(e))}),a.addEventListener("input",()=>{a.style.height="auto",a.style.height=Math.min(a.scrollHeight,120)+"px"}),e.querySelectorAll(".suggestion-pill").forEach(n=>{n.addEventListener("click",()=>{a.value=n.dataset.text,at(e)})})}function yt(e,t){Je.push({role:e,text:t,ts:new Date().toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"})})}function ft(e){e.innerHTML=Je.map(t=>{var a;const i=t.role==="ai",s=An(t.text);return`
...
Try rephrasing your question or ask about a specific service name.`}function Sn(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(d=>d.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(d=>d.classList.remove("active")),o.classList.add("active"),e.querySelector(`#graph-tab-${o.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",()=>{navigator.clipboard.writeText(o.dataset.val),u("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const o=e.querySelector("#graph-secret");o.type=o.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>u("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>u("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>u("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>u("Throttling configuration saved.","success"))}}function $n(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,(i=e.querySelector("#sso-save"))==null||i.addEventListener("click",()=>u("SSO configuration saved.","success")),(s=e.querySelector("#sso-test"))==null||s.addEventListener("click",()=>{u("SSO test initiated — check your browser for the Entra ID sign-in prompt.","info")})}}function En(){const e=document.getElementById("page-audit");if(!e)return;const t=[{time:"Today 08:47",event:"Config Agent scan completed",user:"M365 Config Agent",category:"Compliance",severity:"info",sevCls:"info"},{time:"Today 08:15",event:"High-risk sign-in detected",user:"kevin.osei@contoso.com",category:"Security",severity:"high",sevCls:"danger"},{time:"Yesterday 16:30",event:"Access request approved (REQ-005)",user:"Sanjay Kumar",category:"Access",severity:"low",sevCls:"success"},{time:"Yesterday 14:12",event:"PIM role activated — Compliance Admin",user:"sam.torres@contoso.com",category:"Identity",severity:"medium",sevCls:"warning"}];e.innerHTML=`
    <div class="page-header">
  ...
  `;const r=n.querySelector("input");return r.addEventListener("change",()=>a(r.checked)),n}const Pn=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",kt=Pn?"http://localhost:3000/api/tenantguard":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api/tenantguard";async function Cn(){try{return(await(await fetch(`${kt}/settings/claude-status`)).json()).data}catch(e){return console.error("Error getting Claude status:",e),null}}async function Mn(e){try{return await(await fetch(`${kt}/settings/claude-api-key`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:e})})).json()}catch(t){return console.error("Error setting Claude API key:",t),{success:!1,error:t.message}}}async function Dn(){try{return await(await fetch(`${kt}/settings/claude-api-key`,{method:"DELETE"})).json()}catch(e){return console.error("Error removing Claude API key:",e),{success:!1,error:e.message}}}function Ln(){const e=document.getElementById("page-settings");e&&Ui(e)}function Ui(e){const t=y.settings;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,u(`Synced ${be.length} messages`,"success")},2e3)})}function Tn(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `,e.querySelectorAll(".app-tab-btn").forEach(r=>{r.addEventListener("click",()=>{ze=r.dataset.appSection,ne(e)})}),(a=e.querySelector("#app-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#app-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u(`Application inventory updated — ${D.length} app registrations, ${Q.length} service principals scanned.`,"success")},2200)}),(n=e.querySelector("#app-audit"))==null||n.addEventListener("click",()=>u("Application audit exported as CSV.","success")),Kn(e)}function Nn(){return({executive:ei,appregistrations:On,enterprise:Gn,secrets:Un,permissions:Fn,auditconsents:jn,owners:Bn,usage:Hn,risk:_n,lifecycle:Vn,recommendations:Wn,copilot:Jn}[ze]||ei)()}function ei(){console.log(`📊 Executive: Apps=${D.length}, SPs=${Q.length}, Secrets=${O.length}`);const e=O.filter(a=>a.status==="expiring").length,t=O.filter(a=>a.status==="expired").length,i=oe.filter(a=>a.severity==="critical").length,s=re.filter(a=>a.status==="unused").length;return`
    <div class="grid-2 mb-3" style="gap:16px">
      ...
      <div class="card">
        ...
        ${ti([{label:"Expired Secrets",val:t,cls:"danger"},{label:"Expiring (30 days)",val:e,cls:"warning"},{label:"Expiring (60 days)",val:O.filter(a=>a.daysRemaining<=60&&a.daysRemaining>30).length,cls:"warning"},{label:"Apps Requiring Admin Consent",val:ht.length,cls:"warning"}])}
      </div>
    </div>
  ...
  `}function On(){const e=D.length>0?D:[],t=e.filter(s=>!(L.type!=="all"&&s.category!==L.type||L.status!=="all"&&s.status!==L.status||L.search&&!s.name.toLowerCase().includes(L.search.toLowerCase()))),i=[...new Set(e.map(s=>s.category))];return`
    <div class="filter-bar mb-3">
  ...
  `}function Gn(){const e=Q.length>0?Q:[];return`
    <div class="filter-bar mb-3">
  ...
  `}function Un(){const e=O.filter(s=>s.status==="expired"),t=O.filter(s=>s.status==="expiring"),i=O.filter(s=>s.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Fn(){const e=Ne.filter(i=>i.riskLevel==="critical"),t=Ne.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Bn(){const e=D.length>0?D:[],t=e.filter(a=>!a.owners||a.owners.length===0),i=e.filter(a=>a.owners&&a.owners.length===1),s=e.filter(a=>a.owners&&a.owners.length>1);return`
    ${t.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Hn(){const e=re.filter(s=>s.status==="active"),t=re.filter(s=>s.status==="lowuse"),i=re.filter(s=>s.status==="unused");return`
    ...
    `).join("")}
  `}function _n(){const e=oe.filter(i=>i.severity==="critical"),t=oe.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function Vn(){const e=D.length>0?D:[],t=e.filter(a=>{const n=a.createdDateTime?new Date(a.createdDateTime):null;if(!n)return!1;const r=new Date(Date.now()-30*24*60*60*1e3);return n>r}),i=e.filter(a=>!a.owners||a.owners.length===0),s=re.filter(a=>a.status==="unused");return`
  ...
  `}function Jn(){(!Qt||Se.length===0)&&(Se=[{role:"ai",text:`**Applications & App Registrations Copilot** — Ask me about app security, secrets, permissions, risks, and more.
...
Current state: **87 app registrations**, **124 enterprise apps**, **5 expiring secrets (30d)**, **2 critical risk apps**`}],Qt=!0);const e=["Show expiring secrets","Which apps have Directory.ReadWrite.All?","List apps without owners","Show high-risk applications","Unused apps (90+ days)","Multi-tenant applications"];return`
  ...
  `}function ti(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
...
Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;Se.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function Bi(e){var a,n;const t=h.summary,i=h.riskAssessment.criticalRiskCount||0,s=h.riskAssessment.highRiskCount||0;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-device-laptop"></i> Microsoft Intune Insights</div>
  ...
  `}function ar(){const e=h.summary,t=h.deviceHealth||[];return t.length>0&&Math.round(t.reduce((i,s)=>i+s.healthScore,0)/t.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function nr(){const e=h.summary,t=Math.max(0,(e.totalManagedDevices||0)-(e.nonCompliant||0));return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function or(){var t,i,s,a,n,r,o,d;const e=h.endpointSecurity;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function lr(){const e=h.patchManagement;return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
  ...
  `}function cr(){const e=h.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function pr(){const e=h.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
  ...
  `}function ur(){const e=h.recommendations||[];return`
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        <thead><tr>
          <th style="width:11%">Priority</th>
  ...
  `}function vr(){if(!ii){const t=h.summary||{},i=h.riskAssessment||{};Ke=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.

**Current state:** ${t.totalManagedDevices||0} managed devices, ${t.compliancePercentage||0}% compliant, ${t.deviceHealthScore||0}/100 health score, ${i.criticalRiskCount||0} critical risks`}],ii=!0}const e=["Show device health summary","Patch management status","Encryption coverage","Firewall & protection status","Critical risk devices","Compliance policies"];return`
    <div style="display:flex;flex-direction:column;height:calc(100vh - 340px);min-height:450px">
  ...
  `}function Hi(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
      <div style="padding:8px 10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md)">
        <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:3px;text-transform:uppercase;font-weight:600">${t.label}</div>
        <div style="font-size:16px;font-weight:700;color:${t.cls==="success"?"var(--clr-success-text)":t.cls==="danger"?"var(--clr-danger-text)":t.cls==="warning"?"var(--clr-warning-text)":"var(--clr-info-text)"}">${t.val}</div>
...
Ask me about device health, compliance, security, patches, or recommendations!`;Ke.push({role:"ai",text:l}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
        ...
        <div class="chat-bubble">${_i(l)}</div>
      </div>`,s.scrollTop=s.scrollHeight)},600)}function _i(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}const Vi={displayName:"Rajkumar Duraisami",upn:"rajkumar.duraisami@contoso.com",email:"rajkumar.duraisami@contoso.com",employeeId:"EMP-2024-001",jobTitle:"Cloud Solutions Architect",department:"Cloud Engineering",manager:"Sarah Johnson",lastSignIn:"Today 08:45",accountStatus:"Enabled",phone:"+1 (555) 123-4567",office:"Seattle, WA",mobilePhone:"+1 (555) 987-6543"},Wi={mfaStatus:"Enabled",mfaDefaultMethod:"Microsoft Authenticator",passwordLastChanged:"45 days ago",passwordExpiryDate:"15 days remaining",ssfrRegistration:"Completed",riskLevel:"Low",securityScore:92,authenticationMethods:[{type:"Password",status:"Enabled"},{type:"Microsoft Authenticator",status:"Enabled",registered:!0},{type:"FIDO2 Security Key",status:"Not registered"},{type:"Phone Authentication",status:"Enabled"},{type:"Email OTP",status:"Not registered"}],riskDetections:[{type:"Impossible Travel",status:"No",lastDetected:null},{type:"Anonymous IP",status:"No",lastDetected:null},{type:"Malware-linked IP",status:"No",lastDetected:null},{type:"Unfamiliar Sign-in",status:"No",lastDetected:null}]},Ji=[{date:"Today 08:45",app:"Microsoft 365 Portal",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 17:30",app:"Teams",device:"iPhone",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"Yesterday 09:15",app:"Exchange Online",device:"Windows-Laptop",browser:"Edge",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"2 days ago 14:20",app:"SharePoint",device:"iPad",browser:"Safari",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"},{date:"3 days ago 10:00",app:"OneDrive",device:"Windows-Laptop",browser:"Chrome",location:"Seattle, WA",ip:"203.0.113.45",result:"Success"}],Ki=[{name:"Microsoft 365 E5",sku:"ENTERPRISEPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Enterprise Mobility + Security E5",sku:"EMSPREMIUM",assignmentType:"Direct",assignmentSource:"Admin"},{name:"Power BI Premium",sku:"POWER_BI_PREMIUM_P1",assignmentType:"Group",assignmentSource:"Group License"},{name:"Teams Phone Standard",sku:"TEAMS_PHONE_STANDARD",assignmentType:"Direct",assignmentSource:"Admin"}],Ce={securityGroups:[{name:"Cloud Architects",type:"Security",membershipType:"Member"},{name:"M365-Admins",type:"Security",membershipType:"Member"},{name:"Security Review Board",type:"Security",membershipType:"Member"},{name:"Global Readers",type:"Security",membershipType:"Member"}],microsoft365Groups:[{name:"Engineering Team",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!1},{name:"Cloud Solutions Architects",type:"Microsoft 365",teamConnected:!0,dynamicMembership:!0},{name:"Product Innovation",type:"Microsoft 365",teamConnected:!1,dynamicMembership:!1}],distributionLists:[{name:"Cloud-Engineering@contoso.com",type:"Distribution List",membershipType:"Member"},{name:"Security-Team@contoso.com",type:"Distribution List",membershipType:"Owner"}]},Yi={totalStorage:"1 TB",usedStorage:"420 GB",availableStorage:"580 GB",percentageUsed:42,lastActivity:"Today 08:45",fileCount:2847,sharedItems:156,externalShares:12,anonymousLinks:3},Zi={teamsMembership:12,teamsOwned:3,guestAccessTeams:2,teamsPhoneLicense:!0,assignedNumber:"+1 (555) 123-7890",callingPlan:"Domestic and International",teams:[{name:"Engineering Team",role:"Member",owner:"Sarah Johnson"},{name:"Cloud Architects",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Security Review Board",role:"Member",owner:"Chen Wei"},{name:"Product Innovation",role:"Owner",owner:"Rajkumar Duraisami"},{name:"Global Company",role:"Member",owner:"System"}]},Qi=[{name:"LAPTOP-RAJ-001",type:"Windows",osVersion:"22H2",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"BitLocker Enabled",defender:"Active"},{name:"IPHONE-RAJ-001",type:"iOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"Corporate",lastCheckIn:"Today",encryption:"Device Encrypted",defender:"Enabled"},{name:"IPAD-RAJ-001",type:"iPadOS",osVersion:"17.5",complianceStatus:"Compliant",ownership:"BYOD",lastCheckIn:"Yesterday",encryption:"Device Encrypted",defender:"Enabled"}],mr=[{name:"Microsoft Teams",lastAccessed:"Today 08:45",permissionScope:"Full",riskLevel:"Low"},{name:"SharePoint Online",lastAccessed:"Yesterday 14:20",permissionScope:"Read/Write",riskLevel:"Low"},{name:"OneDrive for Business",lastAccessed:"Today 10:15",permissionScope:"Full",riskLevel:"Low"},{name:"Exchange Online",lastAccessed:"Today 09:30",permissionScope:"Full",riskLevel:"Low"},{name:"Power BI",lastAccessed:"2 days ago",permissionScope:"Admin",riskLevel:"Medium"},{name:"Dynamics 365",lastAccessed:"5 days ago",permissionScope:"Read/Write",riskLevel:"Low"}],Me=[{type:"Group Membership Request",group:"Data Governance Board",status:"Pending",submittedDate:"2 days ago",description:"Waiting for manager approval"},{type:"Distribution List Request",list:"Customer Success@contoso.com",status:"Pending",submittedDate:"1 day ago",description:"Awaiting IT approval"}],yr={personalAIReadinessScore:85,recommendations:[{title:"Enable Microsoft Authenticator",impact:"Improves security by 15%",priority:"High",status:"Recommended"},{title:"Complete Security Awareness Training",impact:"Unlocks advanced features",priority:"High",status:"Recommended"},{title:"Review OneDrive Sharing Settings",impact:"Improves data governance by 8%",priority:"Medium",status:"Recommended"},{title:"Register FIDO2 Security Key",impact:"Improves security by 20%",priority:"Medium",status:"Optional"}],exchangeUsage:78,teamsUsage:92,oneDriveUsage:42,sharePointUsage:65};let Ae="executive",f={profile:Vi,security:Wi,signin:Ji,licenses:Ki,groups:Ce,onedrive:Yi,teams:Zi,devices:Qi};const fr=[{id:"executive",label:"Executive Summary",icon:"ti-dashboard"},{id:"profile",label:"Profile",icon:"ti-user"},{id:"security",label:"Security",icon:"ti-shield-check"},{id:"signin",label:"Sign-in Activity",icon:"ti-login"},{id:"licenses",label:"Licenses",icon:"ti-license"},{id:"groups",label:"Groups",icon:"ti-users"},{id:"devices",label:"Devices",icon:"ti-device-laptop"},{id:"apps",label:"Apps & Access",icon:"ti-app-window"},{id:"onedrive",label:"OneDrive",icon:"ti-cloud"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"approvals",label:"Pending Approvals",icon:"ti-check"},{id:"copilot",label:"Copilot Insights",icon:"ti-robot"}];async function hr(){const e=document.getElementById("page-myaccount");if(e){try{console.log("📡 Fetching My Account data from backend...");const t=window.userEmail;if(!t){console.error("❌ User email not found. Make sure you are logged in."),u("Error: User not authenticated. Please log in again.","error");return}console.log(`Fetching data for user: ${t}`);const[i,s,a,n,r,o,d,l,c]=await Promise.allSettled([fetch(`${A}/me/profile?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/security?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/signin-activity?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/licenses?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/groups?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/onedrive?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/teams?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/devices?email=${encodeURIComponent(t)}`).then(p=>p.json()),fetch(`${A}/me/mailbox?email=${encodeURIComponent(t)}`).then(p=>p.json())]);f.profile=i.status==="fulfilled"&&i.value.success?i.value.data:Vi,f.security=s.status==="fulfilled"&&s.value.success?s.value.data:Wi,f.signin=a.status==="fulfilled"&&a.value.success?a.value.data.recentSignins:Ji,f.licenses=n.status==="fulfilled"&&n.value.success?n.value.data:Ki,f.groups=r.status==="fulfilled"&&r.value.success?r.value.data:Ce,f.onedrive=o.status==="fulfilled"&&o.value.success?o.value.data:Yi,f.teams=d.status==="fulfilled"&&d.value.success?d.value.data:Zi,f.devices=l.status==="fulfilled"&&l.value.success?l.value.data:Qi,f.mailbox=c.status==="fulfilled"&&c.value.success?c.value.data:{mailboxUsage:65},console.log("✓ My Account data loaded")}catch(t){console.warn("⚠️ Using simulated data:",t.message)}br(e)}}function br(e){var t;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <!-- Content -->
    <div id="myacc-content" style="margin-top:16px">${ni()}</div>
  `,e.querySelectorAll(".intune-tab-btn").forEach(i=>{i.addEventListener("click",()=>{Ae=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=ni(),Ae==="signin"&&setTimeout(()=>ri(e),100)})}),Ae==="signin"&&setTimeout(()=>ri(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,u("Your profile has been refreshed.","success")},1500)})}function ni(){const t={executive:xr,profile:wr,security:Ar,signin:kr,licenses:Sr,groups:$r,devices:Er,apps:Pr,onedrive:Cr,teams:Mr,approvals:Dr,copilot:Lr}[Ae];return t?t():""}function xr(){var c,p,b,x,g,m,v,w;const e=((c=f.security)==null?void 0:c.securityScore)||85,t=((p=f.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((b=f.security)==null?void 0:b.riskLevel)||"Low",s=(f.licenses&&Array.isArray(f.licenses)?f.licenses.length:0)||((x=f.licenses)==null?void 0:x.count)||0,a=(f.devices&&Array.isArray(f.devices)?f.devices.length:0)||((g=f.devices)==null?void 0:g.count)||0,n=(f.groups&&f.groups.securityGroups?f.groups.securityGroups.length:0)||0,r=((m=f.teams)==null?void 0:m.teamsMembership)||0,o=0,d=((v=f.onedrive)==null?void 0:v.percentageUsed)||0,l=((w=f.mailbox)==null?void 0:w.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function wr(){const e=f.profile;return`
    <div class="card">
  ...
  `}function Ar(){const e=f.security;return`
    <div class="card">
  ...
  `}function kr(){const e=f.signin.filter(i=>i.result==="Success"),t=f.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function Cr(){const e=f.onedrive;return`
    <div class="card">
  ...
  `}function Mr(){const e=f.teams;return`
    <div class="card">
  ...
  `}function Dr(){return!Me||Me.length===0?`
      <div class="card">
  ...
  `,ds(),cs()}function zr(){return["dashboard","requests","security","tenantguard","user-investigation","zerotrust","privaccts","m365config","msgcenter","applications","intune","licenses","agents","approvals","portal","myreqs","myaccount","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}Rr();di().catch(e=>{console.error("Login render error:",e),di()});const Nr=Object.freeze(Object.defineProperty({__proto__:null,go:C,hasAccess:es,isRole:Tr,resetSettings:Xi,saveState:T,state:y},Symbol.toStringTag,{value:"Module"}));
