...
**Graph API:** GET /beta/identity/conditionalAccess/policies`}];let wt=null,F=[],N=z,Ne="executive",O={priority:"all",category:"all",status:"all"},bt="7d",Qe=[],hi=!1;const An=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"},{id:"apiref",label:"API Reference",icon:"ti-api"}];async function $n(){const e=document.getElementById("page-security");if(e){if(ee()){console.log("🎭 Demo account detected - showing demo security data"),Bn(e);return}try{console.log("📡 Fetching real security data from backend...");const t=await ds();t.success&&t.data?(wt=t.data,console.log("✅ Loaded real secure score from API")):(console.warn("⚠️ No secure score data available from API"),wt=null);let i=[];try{const n=await ai();n.success&&n.data&&(i=n.data,console.log(`✅ Loaded ${i.length} real devices from Intune`))}catch(n){console.warn("⚠️ Could not fetch device data:",n.message)}const s=n=>n.map(o=>{var c,d,p,g,u,m;const l=o.deviceName||((d=(c=o.description)==null?void 0:c.match(/Device ([A-Z0-9-]+)/))==null?void 0:d[1])||((g=(p=o.title)==null?void 0:p.match(/([A-Z0-9-]+)/))==null?void 0:g[1])||((m=(u=o.description)==null?void 0:u.match(/([A-Z0-9]{3,})/))==null?void 0:m[1]);if(l&&i.length>0){const y=i.find(b=>{var x,T;return((x=b.deviceName)==null?void 0:x.toUpperCase().includes(l.toUpperCase()))||((T=b.deviceName)==null?void 0:T.includes(l))||b.id===l});if(y)return{...o,deviceId:y.id,deviceName:y.deviceName,deviceOS:y.operatingSystem,compliant:y.complianceState==="Compliant",managed:!0,owner:y.userDisplayName}}return o}),a=await ba();a.success&&Array.isArray(a.data)&&a.data.length>0?(F=s(a.data),console.log(`✅ Loaded ${F.length} real incidents from alerts (enriched with device data)`)):(console.warn("⚠️ No active incidents found"),F=[]);const r=await ha();r.success&&r.data&&(N={totalUsers:r.data.totalUsers||z.totalUsers,privAccounts:r.data.privilegedAccounts||z.privAccounts,globalAdmins:r.data.globalAdmins||z.globalAdmins,serviceAccounts:r.data.serviceAccounts||z.serviceAccounts,breakGlass:r.data.breakGlassAccounts||z.breakGlass,identitySecureScore:r.data.identitySecureScore||z.identitySecureScore,mfaEnabled:r.data.mfaEnabled||z.mfaEnabled,mfaExcluded:r.data.mfaExcluded||z.mfaExcluded,passwordlessAdoption:r.data.passwordlessAdoption||z.passwordlessAdoption,fido2Adoption:r.data.fido2Adoption||z.fido2Adoption,legacyAuthConnections:r.data.legacyAuthConnections||z.legacyAuthConnections,highRiskUsers:r.data.highRiskUsers||z.highRiskUsers,riskySignIns30d:r.data.riskySignIns30d||z.riskySignIns30d,impossibleTravel30d:z.impossibleTravel30d,anonymousIP30d:z.anonymousIP30d,passwordSpray30d:z.passwordSpray30d,caPoliciesEnabled:r.data.caPoliciesEnabled||z.caPoliciesEnabled,caPoliciesDisabled:r.data.caPoliciesDisabled||z.caPoliciesDisabled,caPoliciesReportOnly:r.data.caPoliciesReportOnly||z.caPoliciesReportOnly,caUsersExcluded:r.data.caUsersExcluded||z.caUsersExcluded},console.log("✅ Loaded real identity posture data from Azure AD"))}catch(t){console.error("❌ Error loading security data:",t.message)}ge(e)}}function ge(e){var a,r;const t=Array.isArray(F)?F:[],i=t.filter(n=>n.severity==="critical").length;t.filter(n=>n.severity==="high"&&n.status!=="resolved").length;const s=Ee.filter(n=>n.priority==="critical"||n.priority==="high").length;e.innerHTML=`
  ...
  </div>`}function Pn(e,t){return e==="pass"||e===!0?`<span style="color:var(--clr-success-text)"><i class="ti ti-circle-check"></i> ${t}</span>`:e==="partial"||e==="warn"?`<span style="color:var(--clr-warning-text)"><i class="ti ti-alert-triangle"></i> ${t}</span>`:`<span style="color:var(--clr-danger-text)"><i class="ti ti-circle-x"></i> ${t}</span>`}function Tn(){return({executive:xi,securescore:Dn,identity:Mn,email:Ln,endpoint:In,teams:Rn,sharepoint:qn,dataprotection:zn,privaccess:Nn,guests:Gn,incidents:Un,recommendations:jn,copilot:On,apiref:Fn}[Ne]||xi)()}function xi(){const e=wt||ri,t=Array.isArray(F)?F:[];return`
...
Current status: Secure Score 64/95 · ${F.filter(o=>o.status!=="resolved").length} active incidents · ${z.highRiskUsers} high-risk users.`;Qe.push({role:"ai",text:n}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `).join("")}function Ai(){return'<div style="padding:20px;text-align:center"><div class="spinner"></div><p style="color:var(--color-text-secondary)">Loading patterns...</p></div>'}function lr(){return Ie?bs():`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function bs(){return`
    <div class="card mb-3">
      <div class="card-header">
        <span class="card-title"><i class="ti ti-robot"></i> ${Y(Ie.title)}</span>
  ...
  `;const r=ce==="all"?pe.filter(n=>n.id!==e):pe.filter(n=>n.severity===ce&&n.id!==e);if(r.length>0){const n=`
    ...
    `,o=i.querySelector("#other-alerts");o&&(o.innerHTML=n)}else{const n=i.querySelector("#other-alerts");n&&(n.style.display="none")}}window.dismissAndRefreshDetail=async function(e){try{await fs(e),v("Alert dismissed","success"),await nt()}catch{v("Failed to dismiss alert","error")}};window.showAlertDetailsFromDetail=function(e){xs(e)};window.startCorrInvestigation=async function(e,t){try{ie="investigation",Ie=await Qn(null,e,t);const i=document.getElementById("page-tenantguard");if(i){const s=i.querySelector("#tg-content");s&&(s.innerHTML=bs(),dr(i),cr())}}catch(i){v("Failed to start investigation: "+i.message,"error")}};window.closeInvestigation=function(){Ie=null,ie="alerts";const e=document.getElementById("page-tenantguard");if(e){const t=e.querySelector("#tg-content");t&&(t.innerHTML=Bt(),_t(e))}};async function dr(e){const t=e.querySelector("#investigation-send"),i=e.querySelector("#investigation-input"),s=e.querySelector("#investigation-report");t&&i&&(t.addEventListener("click",Ei),i.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),Ei())})),s&&s.addEventListener("click",async()=>{try{s.disabled=!0,s.innerHTML='<span class="spinner dark"></span>';const a=await er(Ie.id);v("Report generated! Downloading...","success"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}catch(a){v("Failed to generate report: "+a.message,"error"),s.disabled=!1,s.innerHTML='<i class="ti ti-file-text"></i> Report'}})}async function Ei(){const e=document.getElementById("page-tenantguard"),t=e==null?void 0:e.querySelector("#investigation-input");if(!t)return;const i=t.value.trim();if(i)try{t.value="",t.disabled=!0;const s=e.querySelector("#investigation-messages");s&&(s.innerHTML+=`
      ...
      `,s.scrollTop=s.scrollHeight);const a=await Zn(Ie.id,i);s&&(s.innerHTML+=`
  ...
  `}function Ir(e,t){const i=e.querySelector("#pa-tab-log");i.innerHTML=`
    <div class="card" style="padding:0;overflow:hidden">
      <table style="width:100%">
        <thead style="background:var(--color-background-secondary)">
          <tr>
  ...
  `}function Rr(e){var a,r;const t=e.querySelector("#pa-tab-accounts"),i="pa-acct-search";let s=`
  ...
  `;t.innerHTML=s,Ds(t),(a=t.querySelector(`#${i}`))==null||a.addEventListener("input",n=>{var c;const o=n.target.value.toLowerCase(),l=((c=t.querySelector("#pa-risk-filter"))==null?void 0:c.value)||"all";Li(t,o,l)}),(r=t.querySelector("#pa-risk-filter"))==null||r.addEventListener("change",n=>{var l;const o=((l=t.querySelector(`#${i}`))==null?void 0:l.value.toLowerCase())||"";Li(t,o,n.target.value)})}function Li(e,t,i){const s=e.querySelector("#pa-acct-tbody");s&&(s.innerHTML=Re.filter(a=>{const r=!t||a.upn.toLowerCase().includes(t)||a.name.toLowerCase().includes(t),n=i==="all"||a.risk===i;return r&&n}).map(a=>Ts(a)).join(""),Ds(e))}function Ts(e){return`
  ...
  `,Ri(t),t.querySelector("#pa-grp-search").addEventListener("input",i=>{const s=i.target.value.toLowerCase();t.querySelector("#pa-grp-tbody").innerHTML=Vt.filter(a=>!s||a.name.toLowerCase().includes(s)).map(a=>Ii(a)).join(""),Ri(t)})}function Ii(e){return`
  ...
  `}function Rs(e){var t,i;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-license"></i> License Management Dashboard</div>
        <div class="page-subtitle">Enterprise-wide licensing health, utilization, and compliance</div>
...
<!-- Self-Service Portal Management -->
  ...
  `;const i=le({id:"toggle-ps",checked:t.showPSCommands,label:"Show PowerShell validation commands",sublabel:"Displays the PowerShell command used for each control in the M365 Config topic view.",onChange:h=>{f.settings.showPSCommands=h,j()}});e.querySelector("#settings-ps-wrap").appendChild(i);const s=le({id:"toggle-result",checked:t.showTenantResult,label:"Show simulated tenant result",sublabel:"Displays the simulated tenant scan result for each control.",onChange:h=>{f.settings.showTenantResult=h,j()}});e.querySelector("#settings-result-wrap").appendChild(s);const a=le({id:"toggle-expand",checked:t.autoExpandFailed,label:"Auto-expand failed controls",sublabel:"Automatically opens the details panel for failed controls on topic load.",onChange:h=>{f.settings.autoExpandFailed=h,j()}});e.querySelector("#settings-expand-wrap").appendChild(a);const r=le({id:"toggle-alert-fail",checked:t.agentAlertOnFail,label:"Alert on new failures",sublabel:"Send email notification when agent detects new failed controls.",onChange:h=>{f.settings.agentAlertOnFail=h,j()}});e.querySelector("#settings-alert-fail-wrap").appendChild(r);const n=le({id:"toggle-graph-health",checked:t.showGraphHealth,label:"Show Graph API health on dashboard",onChange:h=>{f.settings.showGraphHealth=h,j()}});e.querySelector("#settings-graph-health-wrap").appendChild(n);const o=le({id:"toggle-zt-score",checked:t.showZeroTrustScore,label:"Show Zero Trust score on dashboard",onChange:h=>{f.settings.showZeroTrustScore=h,j()}});e.querySelector("#settings-zt-score-wrap").appendChild(o);const l=le({id:"toggle-cfg-score",checked:t.showM365ConfigScore,label:"Show M365 Config score on dashboard",onChange:h=>{f.settings.showM365ConfigScore=h,j()}});e.querySelector("#settings-cfg-score-wrap").appendChild(l);const c=e.querySelector("#settings-sync-days");c&&(c.value=t.announcementSyncDays||7,c.addEventListener("change",h=>{f.settings.announcementSyncDays=parseInt(h.target.value),j(),v(`Sync period set to last ${h.target.value} days`,"success")}));const d=e.querySelector("#settings-sharepoint-site"),p=e.querySelector("#settings-sharepoint-test"),g=e.querySelector("#settings-sharepoint-status");d.value=t.sharepointSiteUrl||"root",p.addEventListener("click",async()=>{const h=d.value.trim()||"root";p.disabled=!0,p.innerHTML='<span class="spinner dark" style="width:14px;height:14px"></span> Testing...',g.style.display="block",g.textContent="Testing connection...";try{const k=await fetch(`${$}/msgcenter/validate-sharepoint`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteUrl:h})}),M=await k.json();k.ok&&M.success?(g.style.background="#e8f5e9",g.style.color="#2e7d32",g.textContent=`✓ Connected! Site: ${M.siteName||h}`,f.settings.sharepointSiteUrl=h,f.settings.sharepointSiteId=M.siteId,j(),v("SharePoint site configured successfully","success")):(g.style.background="#ffebee",g.style.color="#c62828",g.textContent=`✗ Error: ${M.error||"Could not connect to site"}`,v("SharePoint connection failed","error"))}catch(k){g.style.background="#ffebee",g.style.color="#c62828",g.textContent=`✗ Error: ${k.message}`,v("SharePoint connection error","error")}finally{p.disabled=!1,p.innerHTML='<i class="ti ti-check"></i> Test'}});const u=e.querySelector("#settings-selfservice-site"),m=e.querySelector("#settings-selfservice-test"),y=e.querySelector("#settings-selfservice-status");u.value=t.selfServiceSiteUrl||"root",m.addEventListener("click",async()=>{const h=u.value.trim()||"root";m.disabled=!0,m.innerHTML='<span class="spinner dark" style="width:14px;height:14px"></span> Testing...',y.style.display="block",y.textContent="Testing connection...";try{const k=await fetch(`${$}/self-service/validate-sharepoint`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteUrl:h})}),M=await k.json();k.ok&&M.success?(y.style.background="#e8f5e9",y.style.color="#2e7d32",y.textContent=`✓ Connected! Site: ${M.siteName||h}`,f.settings.selfServiceSiteUrl=h,f.settings.selfServiceSiteId=M.siteId,j(),v("Self Service Portal SharePoint site configured successfully","success")):(y.style.background="#ffebee",y.style.color="#c62828",y.textContent=`✗ Error: ${M.error||"Could not connect to site"}`,v("SharePoint connection failed","error"))}catch(k){y.style.background="#ffebee",y.style.color="#c62828",y.textContent=`✗ Error: ${k.message}`,v("SharePoint connection error","error")}finally{m.disabled=!1,m.innerHTML='<i class="ti ti-check"></i> Test'}});const b=e.querySelector("#settings-primary-approver"),x=e.querySelector("#settings-secondary-approver");b&&b.addEventListener("change",h=>{const k=h.target.value.trim();if(k&&!k.includes("@")){v("Please enter a valid email address","warning");return}f.settings.primaryApprover=k||null,j(),v(k?`Primary approver set to ${k}`:"Primary approver cleared","success")}),x&&x.addEventListener("change",h=>{const k=h.target.value.trim();if(k&&!k.includes("@")){v("Please enter a valid email address","warning");return}f.settings.secondaryApprover=k||null,j(),v(k?`Secondary approver set to ${k}`:"Secondary approver cleared","success")});const T=le({id:"toggle-portal-master",checked:t.portalEnabled!==!1,label:"Self-Service Portal — Master Switch",sublabel:"Disable to prevent all users from accessing the portal globally.",onChange:h=>{f.settings.portalEnabled=h,j();const k=e.querySelector("#portal-services-section");k&&(k.style.opacity=h?"1":"0.4"),v(h?"Self-Service Portal enabled.":"Self-Service Portal disabled globally.",h?"success":"warning")}});e.querySelector("#settings-portal-master-wrap").appendChild(T);const S=e.querySelector("#portal-services-section");S&&(S.style.opacity=t.portalEnabled!==!1?"1":"0.4");const L=e.querySelector("#portal-main-toggles");Ge.forEach(h=>{const k="portal_"+h.id.replace(/-/g,"_"),M=document.createElement("div");M.style.cssText="padding:12px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:1px solid var(--color-border-primary);display:flex;align-items:center;gap:10px",M.innerHTML=`
    ...
    `,L.appendChild(M);const fe=le({id:`chk-${k}`,checked:t[k]!==!1,label:"",onChange:mt=>{f.settings[k]=mt,j()}});M.querySelector(`#portal-toggle-${k}`).appendChild(fe)});const w=e.querySelector("#portal-exchange-toggles"),A={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};Ue.forEach(h=>{const k=A[h.id],M=document.createElement("div");M.style.cssText="padding:12px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:1px solid var(--color-border-primary);display:flex;align-items:center;gap:10px",M.innerHTML=`
      ...
      <span style="flex:1;font-size:11px;font-weight:600">${h.name}</span>
      <div id="portal-toggle-${k}"></div>
    `,w.appendChild(M);const fe=le({id:`chk-${k}`,checked:t[k]!==!1,label:"",onChange:mt=>{f.settings[k]=mt,j()}});M.querySelector(`#portal-toggle-${k}`).appendChild(fe)});const H=e.querySelector("#svc-availability-toggle"),I=e.querySelector("#svc-availability-content"),R=H.querySelector(".ti-chevron-down");H.addEventListener("click",()=>{const h=I.style.display==="none";I.style.display=h?"block":"none",R.style.transform=h?"rotate(180deg)":"rotate(0deg)"});const W=e.querySelector("#workflow-config");Ge.forEach(h=>{const k="workflow_"+h.id.replace(/-/g,"_"),M=t[k]||"admin-only",fe=document.createElement("div");fe.style.cssText="padding:12px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);border:1px solid var(--color-border-primary)",fe.innerHTML=`
    ...
    `}return t+="</div>",t}function ei(e){return{"Not Reviewed":"info",Reviewed:"success","In Progress":"warning",Resolved:"success","Not Started":"neutral"}[e]||"neutral"}function _i(e){return{"Not Started":"neutral","In Progress":"warning",Review:"info",Resolved:"success",Pending:"warning",Approved:"success",Rejected:"danger"}[e]||"neutral"}function Uo(e){if(!e)return"";try{const t=new Date(e),i=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${i}-${s}-${a}`}catch{return e}}function Me(e,t=[]){var m,y,b,x,T,S,L;const i=document.getElementById("admin-actions-tbody"),s=document.getElementById("admin-actions-count"),a=document.getElementById("my-tasks-tbody"),r=document.getElementById("my-tasks-count");if(!i||!s){console.warn("Admin actions table elements not found");return}const n=((y=(m=f.currentUser)==null?void 0:m.email)==null?void 0:y.toLowerCase())||"",o=t.filter(w=>{var A;return((A=w.assignedTo)==null?void 0:A.toLowerCase())===n});if(a&&r&&(r.textContent=`${o.length} tasks`,o.length===0?a.innerHTML='<tr><td colspan="5" style="padding:20px;text-align:center;color:#999">No tasks assigned to you</td></tr>':(a.innerHTML=o.map(w=>{var A;return`
      ...
      `}).join(""),a.querySelectorAll(".update-assignee-task").forEach(w=>{w.addEventListener("click",async A=>{const H=A.target.closest("button").dataset.taskId,I=o.find(R=>R.id===H);I&&Bo(I)})}))),!e||e.length===0){s.textContent="0 tasks created",i.innerHTML='<tr><td colspan="7" style="padding:20px;text-align:center;color:#999">No tasks created yet</td></tr>';return}new Map(t.map(w=>[w.announcementId,w]));const l=t.length>0?t:e.filter(w=>{const A=w.reviewStatus&&w.reviewStatus!=="Not Reviewed",H=w.taskStatus&&w.taskStatus!=="Not Started",I=!!w.actionDeadline,R=!!w.notes;return A||H||I||R});if(console.log(`📊 Tasks Tracking: ${l.length} tasks`),s.textContent=`${l.length} tasks`,l.length===0){i.innerHTML='<tr><td colspan="7" style="padding:20px;text-align:center;color:#999">No tasks created yet</td></tr>';return}const c=((x=(b=f.currentUser)==null?void 0:b.email)==null?void 0:x.toLowerCase())||"",d=((T=f.currentUser)==null?void 0:T.role)||"user",p=((S=f.settings.primaryApprover)==null?void 0:S.toLowerCase())||"",g=((L=f.settings.secondaryApprover)==null?void 0:L.toLowerCase())||"",u=["super","admin"].includes(d)||c===p||c===g;i.innerHTML=l.map(w=>{const A=w.announcementId&&w.announcementId!==w.id?w.announcementId:w.id||"N/A",H=w.taskStatus==="Resolved"&&w.approvalStatus==="Pending"&&u,I=w.assignedTo?`Assigned: ${w.assignedTo}`:"",R=w.dueDate?`Due: ${w.dueDate.split("T")[0]}`:"",W=[I,R].filter(Boolean).join(" | ")||"—";return`
      <tr style="border-bottom:0.5px solid #ddd">
  ...
  `,document.body.appendChild(s),s.querySelector(".cancel-resolution").addEventListener("click",()=>s.remove()),l&&s.querySelector(".confirm-resolution").addEventListener("click",async S=>{const L=S.target,w=L.dataset.progress,A=L.dataset.assignedTo,H=L.dataset.adminOverride==="true",I=s.querySelector("#approval-notes").value;L.disabled=!0,L.innerHTML='<span class="spinner dark"></span> Approving...';try{const R=await fetch(`${$}/msgcenter/tasks/${e}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({taskStatus:"Resolved",approvalStatus:"Approved",progress:w,assignedTo:A,notes:I?`[Admin: ${I}]`:H?"[Admin Override]":"",siteUrl:f.settings.sharepointSiteUrl||"root"})}),W=await R.json();if(R.ok&&W.success){v("✓ Task resolved and approved successfully","success"),s.remove();const h=document.getElementById("page-tasks");h&&await Fe(h)}else v(`Error: ${W.error}`,"error")}catch(R){v(`Error: ${R.message}`,"error")}finally{L.disabled=!1,L.innerHTML="✓ Approve & Resolve Task"}})}function Ko(e,t){const i=document.createElement("div");i.style.cssText=`
    position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);
    display:flex;align-items:center;justify-content:center;z-index:1000
  `,i.innerHTML=`
...
Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;Xe.push({role:"ai",text:n}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function Il(){const e=C.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function Rl(){const e=C.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
