(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function i(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=i(n);fetch(n.href,s)}})();const Ot=[{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["approvals","portal","myreqs","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","zerotrust","privaccts","m365config","licenses","agents","msgcenter","applications","intune","portal","myreqs","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","zerotrust","privaccts","m365config","licenses","agents","msgcenter","applications","intune","portal","myreqs","chat","audit","settings","graphapi","sso"]}],li="modulepreload",ci=function(e){return"/"+e},tt={},Gt=function(t,i,a){let n=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),o=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));n=Promise.allSettled(i.map(l=>{if(l=ci(l),l in tt)return;tt[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const y=document.createElement("link");if(y.rel=c?"stylesheet":li,c||(y.as="script"),y.crossOrigin="",y.href=l,o&&y.setAttribute("nonce",o),document.head.appendChild(y),c)return new Promise((Z,G)=>{y.addEventListener("load",Z),y.addEventListener("error",()=>G(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(r){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r}return n.then(r=>{for(const o of r||[])o.status==="rejected"&&s(o.reason);return t().catch(s)})};function di(){const e=document.getElementById("app-header"),t=d.currentUser;t&&(e.innerHTML=`
  ...
  `;const n=c=>c.filter(u=>i.includes(u.id)).map(u=>`
    ...
    <div class="dash-cards-row">
      ...
      <div class="card">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ${[{dot:"var(--clr-danger-text)",msg:"High-risk user sign-in detected — kevin.osei@contoso.com",time:"14 min ago"},{dot:"var(--clr-warning-text)",msg:"MFA registration incomplete — 3 users below policy threshold",time:"1 hour ago"},{dot:"var(--clr-info-text)",msg:"Config scan completed — 4 new failures found",time:"08:45 today"}].map(l=>`
            <div style="display:flex;align-items:flex-start;gap:10px;padding-bottom:10px;border-bottom:0.5px solid var(--color-border-tertiary)">
              <div class="dash-event-dot" style="background:${l.dot};margin-top:5px"></div>
              <div style="flex:1">
                <div style="font-size:11px;color:var(--color-text-primary);line-height:1.4">${l.msg}</div>
                <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:2px">${l.time}</div>
              </div>
            </div>
          `).join("")}
        </div>
  ...
  `;const t=document.createElement("div");t.style.marginTop="16px",t.innerHTML=ki(),e.querySelector("#page-dashboard-inner")||e.appendChild(t),(i=e.querySelector("#dash-to-msgcenter-health"))==null||i.addEventListener("click",async()=>await h("msgcenter")),(a=e.querySelector("#dash-to-requests"))==null||a.addEventListener("click",async()=>await h("requests")),(n=e.querySelector("#dash-to-m365"))==null||n.addEventListener("click",async()=>await h("m365config")),(s=e.querySelector("#dash-to-zt"))==null||s.addEventListener("click",async()=>await h("zerotrust")),(r=e.querySelector("#dash-to-audit"))==null||r.addEventListener("click",async()=>await h("audit")),(o=e.querySelector("#dash-to-msgcenter"))==null||o.addEventListener("click",async()=>await h("msgcenter"))}function ki(){const e=x.filter(n=>n.actionRequired&&n.severity==="high").slice(0,3),t=D.filter(n=>n.status!=="resolved"),i=x.filter(n=>n.actionRequired).length,a=Object.entries(k).map(([n,s])=>{const r=D.find(l=>l.service===n&&l.status!=="resolved"),o=r?r.severity==="high"?"fail":"warn":"pass";return`<span title="${n}: ${r?r.status:"Operational"}" style="display:inline-flex;align-items:center;gap:3px;font-size:9px;color:var(--color-text-tertiary);margin-right:6px">
    ...
    <div class="dash-cards-row">
      ...
      <div class="card">
        ...
        <div style="margin-bottom:10px">
          ${e.map(n=>{const s=k[n.service]||{icon:"ti-apps",color:"#185FA5",bg:"#E6F1FB"};return`<div style="display:flex;align-items:flex-start;gap:8px;padding:7px 0;border-bottom:0.5px solid var(--color-border-tertiary)">
              <div style="width:20px;height:20px;border-radius:4px;background:${s.bg};display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:10px;color:${s.color}">
                <i class="ti ${s.icon}"></i>
              </div>
      ...
      <div class="card">
        ...
        `).join(""):`
          <div style="font-size:11px;color:var(--clr-success-text);display:flex;align-items:center;gap:6px">
            <i class="ti ti-circle-check"></i> All ${Object.keys(k).length} monitored services operational.
          </div>
        `}
  ...
  `,Mi(e)}function Oe(e){return e==="approved"?'<span class="badge success dot">Approved</span>':e==="overdue"?'<span class="badge danger dot">Overdue</span>':e==="in-progress"?'<span class="badge info dot">In Progress</span>':e==="rejected"?'<span class="badge neutral dot">Rejected</span>':'<span class="badge warning dot">Pending</span>'}function $i(e){const t=e.status==="pending"||e.status==="overdue"||e.status==="in-progress";return`
    <tr data-id="${e.id}">
      <td class="monospace">${e.id}</td>
      <td>${e.type}</td>
      <td>${e.requestor}</td>
      <td ${e.sla==="Overdue"?'class="sla-overdue"':""}>${e.sla}</td>
      <td class="req-status-cell">${Oe(e.status)}</td>
      <td>
        ${t?`
  ...
  `}function Mi(e){e.querySelectorAll(".req-approve-btn").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,a=Ne.find(s=>s.id===i);a&&(a.status="approved");const n=e.querySelector(`tr[data-id="${i}"]`);n&&(n.querySelector(".req-status-cell").innerHTML=Oe("approved"),n.querySelector("td:last-child").innerHTML=""),p(`Request ${i} approved successfully.`,"success")})}),e.querySelectorAll(".req-reject-btn").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,a=Ne.find(s=>s.id===i);a&&(a.status="rejected");const n=e.querySelector(`tr[data-id="${i}"]`);n&&(n.querySelector(".req-status-cell").innerHTML=Oe("rejected"),n.querySelector("td:last-child").innerHTML=""),p(`Request ${i} rejected.`,"warning")})})}const fe={current:64,max:95,percentOf100:67.4,delta7d:2,delta30d:5,delta90d:-1,avgComparable:53,trend7d:[58,60,61,61,62,63,64],trend30d:[55,56,57,58,57,58,58,59,59,60,60,60,61,61,62,62,62,62,63,63,63,63,63,64,64,64,64,64,63,64],categories:[{name:"Identity",score:68,max:100,color:"#0C447C",icon:"ti-user-check"},{name:"Devices",score:58,max:100,color:"#3B6D11",icon:"ti-device-laptop"},{name:"Apps",score:72,max:100,color:"#854F0B",icon:"ti-apps"},{name:"Data",score:61,max:100,color:"#3C3489",icon:"ti-database"},{name:"Infrastructure",score:54,max:100,color:"#633806",icon:"ti-server"}]},W={globalAdmins:2,highRiskUsers:3},Ri={},te={},nt={publicTeams:8},rt={anonymousLinks:3},Ge={sensitivityLabelsApplied:34},ot={},Fe={totalGuests:87},we=[{id:"INC-2341",severity:"critical",title:"Ransomware Indicators — Device MBX-LAPTOP-047",category:"Malware",status:"active",assignee:"Aisha Raza",created:"3h ago",services:["Endpoint","Identity"]},{id:"INC-2338",severity:"high",title:"BEC Attempt — Invoice Fraud Pattern Detected",category:"Phishing",status:"active",assignee:"Chen Wei",created:"6h ago",services:["Exchange"]},{id:"INC-2335",severity:"high",title:"Risky Sign-in — kevin.osei@contoso.com (Unfamiliar Location)",category:"Identity Attack",status:"active",assignee:"Aisha Raza",created:"14h ago",services:["Identity"]},{id:"INC-2330",severity:"high",title:"Suspicious Inbox Rule — Auto-Forward to External",category:"Data Exposure",status:"investigating",assignee:"Chen Wei",created:"Yesterday",services:["Exchange"]},{id:"INC-2298",severity:"medium",title:"Multiple Failed Sign-ins — Brute Force Pattern",category:"Identity Attack",status:"monitoring",assignee:"Chen Wei",created:"2 days ago",services:["Identity"]},{id:"INC-2290",severity:"medium",title:"Sensitive File Shared Externally — Finance folder",category:"Data Exposure",status:"monitoring",assignee:"Aisha Raza",created:"3 days ago",services:["SharePoint","OneDrive"]},{id:"INC-2281",severity:"medium",title:"DLP Policy Violation — PII Data in Teams Chat",category:"Insider Threat",status:"resolved",assignee:"Chen Wei",created:"4 days ago",services:["Teams","Purview"]},{id:"INC-2267",severity:"low",title:"Guest Account — Excessive Resource Access",category:"Identity Attack",status:"resolved",assignee:"Aisha Raza",created:"5 days ago",services:["Identity"]}],Ue=[{id:"R01",priority:"critical",title:"Enable MFA for 130 unregistered users",category:"Identity",impact:"Identity",scoreGain:15,effort:"low",status:"open",apiHint:"GET /beta/reports/authenticationMethods/userRegistrationDetails"},{id:"R02",priority:"critical",title:"Block legacy authentication via Conditional Access",category:"Identity",impact:"Identity",scoreGain:8,effort:"low",status:"open",apiHint:"POST /beta/identity/conditionalAccess/policies"},{id:"R03",priority:"high",title:"Upgrade DMARC from quarantine to reject policy",category:"Email",impact:"Email",scoreGain:6,effort:"medium",status:"open",apiHint:"DNS: _dmarc.contoso.com TXT v=DMARC1;p=reject"},{id:"R04",priority:"high",title:"Enable Safe Attachments for all users",category:"Email",impact:"Email",scoreGain:4,effort:"low",status:"open",apiHint:"New-SafeAttachmentPolicy + New-SafeAttachmentRule"},{id:"R05",priority:"high",title:"Disable 2 active external mail forwarding rules",category:"Email",impact:"Email",scoreGain:5,effort:"low",status:"open",apiHint:"GET /beta/users/{id}/mailFolders/inbox/messageRules"},{id:"R06",priority:"high",title:"Remediate 8 vulnerable devices (critical patches missing)",category:"Endpoint",impact:"Devices",scoreGain:6,effort:"medium",status:"open",apiHint:"GET /beta/deviceManagement/managedDevices?$filter=complianceState ne 'compliant'"},{id:"R07",priority:"high",title:"Enable BitLocker on 36 unencrypted devices",category:"Endpoint",impact:"Devices",scoreGain:4,effort:"medium",status:"in-progress",apiHint:"GET /beta/deviceManagement/managedDevices?$select=isEncrypted"},{id:"R08",priority:"medium",title:"Convert 4 permanent admin assignments to PIM eligible",category:"Identity",impact:"Identity",scoreGain:5,effort:"medium",status:"open",apiHint:"GET /beta/roleManagement/directory/roleAssignmentSchedules"},{id:"R09",priority:"medium",title:"Remove or review 12 dormant guest accounts",category:"Guests",impact:"Collaboration",scoreGain:3,effort:"low",status:"open",apiHint:"GET /beta/users?$filter=userType eq 'Guest'&$select=signInActivity"},{id:"R10",priority:"medium",title:"Enable sensitivity auto-labeling for Office files",category:"Data",impact:"Data",scoreGain:4,effort:"high",status:"open",apiHint:"Microsoft Purview → Sensitivity Labels → Auto-labeling"},{id:"R11",priority:"medium",title:"Resolve DLP policy gap — Teams messages not covered",category:"Data",impact:"Data",scoreGain:3,effort:"low",status:"open",apiHint:"GET /beta/compliance/ediscovery/cases or Purview DLP console"},{id:"R12",priority:"medium",title:"Enable phishing-resistant MFA for all admins (FIDO2/CBA)",category:"Identity",impact:"Identity",scoreGain:7,effort:"medium",status:"open",apiHint:"GET /beta/policies/authenticationMethodsPolicy"},{id:"R13",priority:"low",title:"Archive 23 inactive Teams (90d+)",category:"Teams",impact:"Collaboration",scoreGain:2,effort:"low",status:"open",apiHint:"GET /v1.0/groups?$filter=resourceProvisioningOptions/Any(x:x eq 'Team')"},{id:"R14",priority:"low",title:"Conduct overdue quarterly access review for 14 guests",category:"Guests",impact:"Collaboration",scoreGain:2,effort:"low",status:"open",apiHint:"GET /v1.0/identityGovernance/accessReviews/definitions"},{id:"R15",priority:"low",title:"Restrict anonymous sharing links in SharePoint",category:"SharePoint",impact:"Data",scoreGain:3,effort:"low",status:"open",apiHint:"Set-SPOTenant -SharingCapability ExistingExternalUserSharingOnly"}];`${new Date().toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"})}`;let Be="executive",he=null;const Ii=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"}];async function Di(){const e=document.getElementById("page-security");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading security data...</p></div>';try{console.log("📡 Fetching real security data from backend...");const t=await Ut();t.success?(he=t.data||fe,console.log("✅ Loaded real secure score from API")):(he=fe,console.warn("⚠️ Using simulated secure score data")),lt(e)}catch(t){console.error("❌ Error loading security data:",t),he=fe,lt(e)}}}function lt(e){var a;const t=he||fe,i=we.filter(n=>n.severity==="critical").length;we.filter(n=>n.severity==="high").length,e.innerHTML=`
    ...
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
        <div class="kpi-value success">${t.currentScore}/${t.maxScore}</div>
        <div class="kpi-label">Secure Score</div>
        <div style="font-size:10px;margin-top:3px;color:var(--color-text-tertiary)">${Math.round(t.currentScore/t.maxScore*100)}% coverage</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value ${i>0?"danger":"success"}">${i}</div>
        <div class="kpi-label">Critical Risks</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value warning">${W.highRiskUsers}</div>
        <div class="kpi-label">High-Risk Users</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value info">${te.nonCompliantDevices}</div>
        <div class="kpi-label">Non-Compliant Devices</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value warning">${Ue.length}</div>
    ...
    <div class="intune-subnav" id="sec-subnav">
      ${Ii.map(n=>`
        <button class="intune-tab-btn ${Be===n.id?"active":""}" data-sec-section="${n.id}">
    ...
    <!-- Content -->
    <div id="sec-content" style="margin-top:16px">${ct(t)}</div>
  `,e.querySelectorAll(".intune-tab-btn").forEach(n=>{n.addEventListener("click",()=>{Be=n.dataset.secSection;const s=e.querySelector("#sec-content");s&&(s.innerHTML=ct(t))})}),(a=e.querySelector("#sec-refresh"))==null||a.addEventListener("click",()=>{const n=e.querySelector("#sec-refresh");n.innerHTML='<span class="spinner dark"></span> Scanning...',n.disabled=!0,setTimeout(()=>{n.innerHTML='<i class="ti ti-refresh"></i> Refresh',n.disabled=!1},2e3)})}function ct(e){const i={executive:()=>qi(e),securescore:()=>Ti(e),identity:()=>Li(),email:()=>Ni(),endpoint:()=>Oi(),teams:()=>Gi(),sharepoint:()=>Fi(),dataprotection:()=>Ui(),privaccess:()=>Bi(),guests:()=>zi(),incidents:()=>ji(),recommendations:()=>Hi(),copilot:()=>Wi()}[Be];return i?i():'<div class="alert info">Select a section above</div>'}function qi(e){return`
    <div class="card">
      <div class="card-header">
      ...
      <div style="padding:16px">
        <div style="margin-bottom:16px">
          <div style="font-weight:600;margin-bottom:8px">Microsoft Secure Score: ${e.currentScore}/${e.maxScore}</div>
          <div style="background:var(--color-bg-secondary);border-radius:4px;height:20px;overflow:hidden">
            <div style="background:#10b981;height:100%;width:${e.currentScore/e.maxScore*100}%"></div>
          </div>
        </div>
        <div class="grid-2" style="gap:16px;margin-top:16px">
          <div><strong>Critical Incidents</strong><div style="font-size:20px;font-weight:700;color:#dc2626">${we.filter(t=>t.severity==="critical").length}</div></div>
          <div><strong>High-Risk Users</strong><div style="font-size:20px;font-weight:700;color:#f97316">${W.highRiskUsers}</div></div>
          <div><strong>MFA Adoption</strong><div style="font-size:20px;font-weight:700;color:#0084ff">${W.mfaAdoption}%</div></div>
          <div><strong>Device Compliance</strong><div style="font-size:20px;font-weight:700;color:#10b981">${te.compliancePercentage}%</div></div>
          <div><strong>External Guests</strong><div style="font-size:20px;font-weight:700;color:#f59e0b">${Fe.totalGuests}</div></div>
          <div><strong>DLP Violations</strong><div style="font-size:20px;font-weight:700;color:#6366f1">${Ge.dlpViolations}</div></div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div style="padding:16px">
        <div style="margin-bottom:20px">
          <div style="font-size:14px;font-weight:600;margin-bottom:8px">Score: ${e.currentScore}/${e.maxScore} (${Math.round(e.currentScore/e.maxScore*100)}%)</div>
        ...
        <div style="font-size:12px;color:var(--color-text-secondary);margin-bottom:16px">
          Your tenant is performing better than ${e.percentile||50}% of similar organizations.
        </div>
  ...
  `}function Li(){return`<div class="card"><div class="card-header"><span class="card-title">Identity Security (Entra ID)</span></div><div style="padding:16px"><strong>MFA Status:</strong> ${W.mfaAdoption}% adoption · ${W.highRiskUsers} high-risk users · ${W.globalAdmins} global admins</div></div>`}function Ni(){return`<div class="card"><div class="card-header"><span class="card-title">Email Security</span></div><div style="padding:16px"><strong>Protection:</strong> ${Ri.phishingBlocked} phishing attempts blocked · SPF/DKIM/DMARC: ✅</div></div>`}function Oi(){return`<div class="card"><div class="card-header"><span class="card-title">Endpoint Security</span></div><div style="padding:16px"><strong>Status:</strong> ${te.totalDevices} devices · ${te.compliancePercentage}% compliant · ${te.nonCompliantDevices} non-compliant</div></div>`}function Gi(){return`<div class="card"><div class="card-header"><span class="card-title">Teams Security</span></div><div style="padding:16px"><strong>Configuration:</strong> ${nt.publicTeams} public teams · ${nt.guestAccessTeams} with guest access</div></div>`}function Fi(){return`<div class="card"><div class="card-header"><span class="card-title">SharePoint Security</span></div><div style="padding:16px"><strong>Sharing:</strong> ${rt.externallySharedSites} externally shared sites · ${rt.anonymousLinks} anonymous links active</div></div>`}function Ui(){return`<div class="card"><div class="card-header"><span class="card-title">Data Protection</span></div><div style="padding:16px"><strong>DLP:</strong> ${Ge.dlpViolations} violations detected · ${Ge.sensitivityLabelsApplied}% files labeled</div></div>`}function Bi(){return`<div class="card"><div class="card-header"><span class="card-title">Privileged Access</span></div><div style="padding:16px"><strong>Admin Accounts:</strong> ${ot.globalAdmins} global admins · ${ot.securityAdmins} security admins</div></div>`}function zi(){return`<div class="card"><div class="card-header"><span class="card-title">Guest Governance</span></div><div style="padding:16px"><strong>Guests:</strong> ${Fe.totalGuests} total · ${Fe.dormantGuests} inactive (90+ days)</div></div>`}function ji(){const e=we.filter(t=>t.status==="open");return`
    <div class="card">
      <div class="card-header"><span class="card-title">Active Incidents</span><span class="badge danger">${e.length}</span></div>
      <div style="padding:16px">
        ${e.slice(0,5).map(t=>`
          <div style="padding:8px;border-bottom:1px solid var(--color-border)">
            <div style="font-weight:600">${t.title}</div>
            <div style="font-size:12px;color:var(--color-text-tertiary)">${t.severity.toUpperCase()}</div>
          </div>
        `).join("")}
      </div>
    </div>
  `}function Hi(){return`
    <div class="card">
      <div class="card-header"><span class="card-title">Top Recommendations</span><span class="badge blue">${Ue.length}</span></div>
      <div style="padding:16px">
        ${Ue.slice(0,8).map(e=>`
          <div style="padding:8px;border-bottom:1px solid var(--color-border);display:flex;gap:8px">
            <div>${e.priority==="critical"?"🔴":e.priority==="high"?"🟠":"🟡"}</div>
            <div style="flex:1"><div style="font-weight:600;font-size:12px">${e.title}</div><div style="font-size:10px;color:var(--color-text-tertiary)">+${e.scoreGain} pts</div></div>
          </div>
        `).join("")}
      </div>
    </div>
  ...
  `}const Bt=[{id:"identity",name:"Identity & Authentication",icon:"ti-user-shield",controls:[{id:"mfa-reg",name:"MFA Registration Coverage",desc:"Percentage of users registered for MFA across the tenant.",status:"warn",value:"87% of users have MFA registered (target: 100%)",remediation:"Enforce MFA registration via Conditional Access policy targeting all users. Set registration deadline and monitor via Entra ID MFA reporting."},{id:"ca-mfa",name:"MFA Conditional Access Policy",desc:"Conditional Access policy enforcing MFA for all sign-ins.",status:"pass",value:'Policy "Require MFA — All Users" is enabled and targeting all cloud apps.',remediation:"No action required. Policy is active and enforcing MFA."},{id:"ca-legacy",name:"Legacy Authentication Blocked",desc:"Conditional Access policy blocking all legacy authentication protocols.",status:"fail",value:"No Conditional Access policy blocking legacy authentication found.",remediation:'Create a Conditional Access policy with condition "Client apps: Other clients (legacy auth)" and grant control "Block access". Test in report-only mode first.'},{id:"ca-compliant",name:"Device Compliance Required",desc:"Conditional Access policy requiring compliant or Hybrid Azure AD joined devices.",status:"warn",value:"Policy exists but excludes 3 admin accounts and 2 service accounts.",remediation:"Review and reduce exclusions in the device compliance CA policy. Create named locations for legitimate breakglass exclusions only."}]},{id:"device",name:"Device Compliance & App Protection",icon:"ti-device-laptop",controls:[{id:"dev-comp",name:"Intune Device Compliance Policies",desc:"Compliance policies configured for Windows, iOS and Android platforms.",status:"warn",value:"Windows and iOS policies exist; Android policy missing.",remediation:"Create an Android device compliance policy in Intune covering OS version, device encryption, and screen lock requirements."},{id:"app-prot",name:"App Protection Policies",desc:"Intune MAM policies protecting corporate data on managed apps.",status:"pass",value:"iOS and Android APP policies configured and assigned.",remediation:"No action required."},{id:"workload",name:"Defender for Endpoint Integration",desc:"Microsoft Defender for Endpoint integrated with Intune for device risk signals.",status:"pass",value:"Connector enabled. Device risk level used in compliance policy.",remediation:"No action required."},{id:"risk-ca",name:"Device Risk-Based Access",desc:"Conditional Access blocking access from high-risk devices.",status:"fail",value:"No Conditional Access policy found using Defender device risk signal.",remediation:"Create a CA policy using the Defender for Endpoint device risk connector. Block or require password change for High risk device sign-ins."}]},{id:"priv",name:"Privileged Access & Entitlements",icon:"ti-crown",controls:[{id:"entitlement",name:"Entitlement Management (PIM)",desc:"Azure AD PIM deployed for privileged role activation.",status:"pass",value:"PIM is activated. Global Admin and Security Admin roles are managed.",remediation:"No action required."},{id:"pim",name:"Permanent Privileged Role Assignments",desc:"No users should hold permanent (non-PIM) privileged role assignments.",status:"warn",value:"4 accounts have permanent Global Admin assignment (recommend < 2).",remediation:"Convert permanent role assignments to PIM eligible assignments. Require justification and approval for activation. Target ≤ 2 break-glass Global Admin accounts."},{id:"reviews",name:"Access Reviews Configured",desc:"Regular access reviews scheduled for privileged roles.",status:"pass",value:"Quarterly access reviews configured for all directory roles.",remediation:"No action required."}]},{id:"guest",name:"Guest & External Governance",icon:"ti-users",controls:[{id:"guest",name:"Guest Access Governance",desc:"Guest user invitations restricted and access reviewed regularly.",status:"pass",value:"Guest invite policy: Admins and guest inviters only. Annual reviews configured.",remediation:"No action required."}]}];function _i(){const e=document.getElementById("page-zerotrust");if(!e)return;let t=Bt.flatMap(c=>c.controls),i=t.filter(c=>c.status==="pass").length,a=t.filter(c=>c.status==="warn").length,n=t.filter(c=>c.status==="fail").length;const s=t.length,r=(i/s*100).toFixed(0),o=(a/s*100).toFixed(0),l=(n/s*100).toFixed(0);e.innerHTML=`
    ...
    <div class="kpi-row">
      <div class="kpi-tile">
        <div class="kpi-value warning">${i}/${s}</div>
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <span class="badge warning">${i}/${s} controls passed</span>
      </div>
      <div class="seg-bar" style="height:10px;border-radius:5px">
  ...
  `,Vi(e),e.querySelector("#zt-rescan").addEventListener("click",()=>{const c=e.querySelector("#zt-rescan");c.innerHTML='<span class="spinner dark"></span> Scanning...',c.disabled=!0,setTimeout(()=>{c.innerHTML='<i class="ti ti-refresh"></i> Re-scan',c.disabled=!1,p("Zero Trust scan complete — 12 controls assessed.","success")},2e3)})}function Vi(e){const t=e.querySelector("#zt-pillars");t&&(t.innerHTML=Bt.map((i,a)=>{const n=i.controls.filter(c=>c.status==="pass").length,s=i.controls.filter(c=>c.status==="warn").length,r=i.controls.filter(c=>c.status==="fail").length,o=i.controls.length,l=r>0?"danger":s>0?"warning":"success";return`
      <div class="card mb-3" style="padding:0;overflow:hidden">
        <div class="collapsible-header" id="zt-pillar-hdr-${a}" style="border-radius:0;background:var(--color-background-secondary)">
          ...
          <div style="display:flex;gap:6px;align-items:center;margin-right:8px">
            ...
            ${s>0?`<span class="badge warning">${s} warn</span>`:""}
            ${n>0?`<span class="badge success">${n} pass</span>`:""}
          </div>
          <div style="width:80px;margin-right:8px">
            <div class="score-bar"><div class="score-bar-fill ${l}" style="width:${(n/o*100).toFixed(0)}%"></div></div>
          </div>
        ...
        <div class="collapsible-body open" id="zt-pillar-body-${a}">
          ${i.controls.map((c,u)=>`
            <div>
              ...
              <div class="zt-expand-panel ${c.status}-border" data-pi="${a}" data-ci="${u}">
  ...
  `;const a=e.querySelector("#cfg-topic-grid");me.forEach(n=>{const s=Ye(n),r=ze(s.score),o=document.createElement("div");o.className="cfg-topic-card";const l=Ae[n.id]||{bg:"#f0f0f0",color:"#555"};o.innerHTML=`
      ...
      <div class="cfg-topic-bar">
        <div class="score-bar">
          <div class="score-bar-fill ${r}" style="width:${s.score}%"></div>
        </div>
      </div>
      <div class="cfg-topic-pct">${s.score}% · ${s.total} controls</div>
    `,o.addEventListener("click",()=>jt(e,n)),a.appendChild(o)}),e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const n=e.querySelector("#cfg-scan-now");n.innerHTML='<span class="spinner dark"></span> Scanning...',n.disabled=!0,setTimeout(()=>{n.innerHTML='<i class="ti ti-refresh"></i> Run scan now',n.disabled=!1,p("Scan complete — 96 controls validated.","success")},2200)}),e.querySelector("#cfg-agent-btn").addEventListener("click",()=>ea(e))}let f={search:"",status:"all",profile:"all"};function jt(e,t){J="topic",xe=t,f={search:"",status:"all",profile:"all"};const i=Ye(t),a=ze(i.score),n=Ae[t.id]||{bg:"#f0f0f0",color:"#555"};e.innerHTML=`
    <div class="page-header">
    ...
    <div class="kpi-row">
      <div class="kpi-tile">
        <div class="kpi-value ${a}">${i.score}%</div>
  ...
  `,e.querySelector("#cfg-back").addEventListener("click",()=>Pe(e)),e.querySelector("#cfg-topic-settings-btn").addEventListener("click",async()=>await h("settings"));const s=e.querySelector("#cfg-topic-settings-link");s&&s.addEventListener("click",async r=>{r.preventDefault(),await h("settings")}),e.querySelector("#cfg-topic-scan").addEventListener("click",()=>{const r=e.querySelector("#cfg-topic-scan");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Scan topic',r.disabled=!1,p(`Topic ${t.num} scan complete.`,"success")},1800)}),e.querySelector("#cfg-filter-search").addEventListener("input",r=>{f.search=r.target.value,B(e,t)}),e.querySelector("#cfg-filter-status").addEventListener("change",r=>{f.status=r.target.value,B(e,t)}),e.querySelector("#cfg-filter-profile").addEventListener("change",r=>{f.profile=r.target.value,B(e,t)}),B(e,t)}function B(e,t){const i=e.querySelector("#cfg-controls-area");i&&(i.innerHTML=t.subsections.map(a=>{const n=a.controls.filter(s=>{const r=le(s);if(f.status!=="all"&&r!==f.status||f.profile!=="all"&&s.profile!==f.profile)return!1;if(f.search){const o=f.search.toLowerCase();if(!s.id.toLowerCase().includes(o)&&!s.title.toLowerCase().includes(o))return!1}return!0});return n.length===0?"":`
      <div class="card mb-3" style="padding:0;overflow:hidden">
    ...
    `}).join(""),i.querySelectorAll(".cfg-control-row").forEach(a=>{a.addEventListener("click",n=>{if(n.target.closest("button"))return;const s=a.dataset.id,r=i.querySelector(`.cfg-expand-panel[data-id="${s}"]`),o=a.querySelector(".chevron-btn");r&&(r.classList.toggle("open"),o&&o.classList.toggle("open",r.classList.contains("open")))})}),i.querySelectorAll(".cfg-copy-btn").forEach(a=>{a.addEventListener("click",n=>{n.stopPropagation();const s=a.dataset.code;navigator.clipboard.writeText(s).then(()=>{a.classList.add("copy-flash"),a.innerHTML='<i class="ti ti-check"></i>',setTimeout(()=>{a.classList.remove("copy-flash"),a.innerHTML='<i class="ti ti-copy"></i>'},1500)})})}),i.querySelectorAll(".cfg-attest-btn").forEach(a=>{a.addEventListener("click",n=>{n.stopPropagation();const s=a.dataset.id,r=new Date().toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"numeric"});d.cfgAttested[s]=r,m(),B(e,t),p(`Control ${s} marked as compliant.`,"success")})}),i.querySelectorAll(".cfg-revoke-btn").forEach(a=>{a.addEventListener("click",n=>{n.stopPropagation();const s=a.dataset.id;delete d.cfgAttested[s],m(),B(e,t),p(`Attestation for ${s} revoked.`,"warning")})}),d.settings.autoExpandFailed&&i.querySelectorAll(".cfg-expand-panel").forEach(a=>{const n=a.dataset.id,s=t.subsections.flatMap(r=>r.controls).find(r=>r.id===n);if(s&&le(s)==="fail"){a.classList.add("open");const r=i.querySelector(`.cfg-control-row[data-id="${n}"] .chevron-btn`);r&&r.classList.add("open")}}))}function Xi(e){const t=le(e),i=d.cfgAttested[e.id];let a="";i?a=`
    ...
    `);let n="";return d.settings.showPSCommands&&e.ps&&(n+=`
      <div class="code-block-header">
        ...
        <button class="btn btn-xs cfg-copy-btn" data-code="${ia(e.ps)}"><i class="ti ti-copy"></i> Copy</button>
      </div>
      <div class="cfg-ps-block">${ut(e.ps)}</div>
    `),d.settings.showTenantResult&&e.value&&(n+=`
      <div class="code-block-header"><span>Tenant Result</span></div>
      <div class="cfg-result-block" style="color:${t==="fail"?"var(--clr-danger-text)":"var(--clr-success-text)"}">${ut(e.value)}</div>
    `),!e.ps&&e.type==="manual"&&(n+='<div style="font-size:11px;color:var(--color-text-secondary);margin-bottom:10px;font-style:italic">Manual validation required — verify in admin portal.</div>'),n+=a,`
  ...
  `}const dt=Object.fromEntries(me.map(e=>[e.id,!0]));function ea(e){J="agent";const t=d.cfgAgentLog;e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
    ...
    <div class="grid-2" style="gap:16px;margin-bottom:16px">
      ...
      <div class="card">
        ...
        ${me.map(i=>{var a,n;return`
          <div class="topic-toggle-row">
            <div class="cfg-topic-icon" style="background:${((a=Ae[i.id])==null?void 0:a.bg)||"#f0f0f0"};color:${((n=Ae[i.id])==null?void 0:n.color)||"#555"};width:24px;height:24px;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0">
              <i class="ti ${i.icon}"></i>
            </div>
            <span style="flex:1;font-size:11px">${i.name}</span>
            <label class="toggle-switch">
              <input type="checkbox" class="topic-enabled-toggle" data-tid="${i.id}" ${dt[i.id]?"checked":""}>
    ...
    <div class="card">
      ...
      <div id="agent-scan-log" style="max-height:300px;overflow-y:auto">
        ${t.length===0?'<div class="empty-state">No scan log entries yet. Run a scan to generate log entries.</div>':t.map(Ht).join("")}
      </div>
    </div>
  `,e.querySelector("#cfg-agent-back").addEventListener("click",()=>Pe(e)),e.querySelector("#agent-save-cfg").addEventListener("click",()=>{d.settings.agentSchedule=e.querySelector("#agent-schedule").value,d.settings.agentAlertEmail=e.querySelector("#agent-email").value,d.settings.agentAlertOnFail=e.querySelector("#agent-alert-fail").checked,d.settings.agentDailyDigest=e.querySelector("#agent-daily-digest").checked,m(),p("Agent configuration saved.","success")}),e.querySelector("#agent-clear-log").addEventListener("click",()=>{d.cfgAgentLog=[],m(),e.querySelector("#agent-scan-log").innerHTML='<div class="empty-state">Log cleared.</div>'}),e.querySelector("#cfg-agent-run-now").addEventListener("click",()=>{ta(e)}),e.querySelectorAll(".topic-enabled-toggle").forEach(i=>{i.addEventListener("change",a=>{dt[a.target.dataset.tid]=a.target.checked})})}function Ht(e){const t={scan:"ti-scan",pass:"ti-circle-check",fail:"ti-circle-x",warn:"ti-alert-triangle",info:"ti-info-circle",done:"ti-check"},i={scan:"var(--clr-info-text)",pass:"var(--clr-success-text)",fail:"var(--clr-danger-text)",warn:"var(--clr-warning-text)",info:"var(--clr-info-text)",done:"var(--clr-success-text)"};return`
  ...
  `,oa(e),la(e),ca(e),e.querySelectorAll("#pa-tabs .tab-btn").forEach(t=>{t.addEventListener("click",()=>{e.querySelectorAll("#pa-tabs .tab-btn").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(i=>i.classList.remove("active")),t.classList.add("active"),e.querySelector(`#pa-tab-${t.dataset.tab}`).classList.add("active")})}),e.querySelector("#pa-sync").addEventListener("click",()=>{const t=e.querySelector("#pa-sync");t.innerHTML='<span class="spinner dark"></span> Syncing...',t.disabled=!0,setTimeout(()=>{t.innerHTML='<i class="ti ti-refresh"></i> Sync tenant',t.disabled=!1,p("Tenant sync complete — 14 accounts updated.","success")},2e3)}),e.querySelector("#pa-tag-account").addEventListener("click",()=>{p("Tag account: select an account from the table below.","info")}))}function gt(e){return e==="High"?'<span class="badge danger dot">High</span>':e==="Medium"?'<span class="badge warning dot">Medium</span>':'<span class="badge neutral dot">None</span>'}function na(e){return!e||e.length===0?'<span class="pa-mfa-pill none">No MFA</span>':e.map(t=>t==="SMS"?'<span class="pa-mfa-pill sms">SMS</span>':`<span class="pa-mfa-pill">${t}</span>`).join("")}function ra(e){return`<span class="pa-role-chip ${e.toLowerCase().includes("global")?"global":""}">${e}</span>`}function oa(e){var n,s;const t=e.querySelector("#pa-tab-accounts"),i="pa-acct-search";let a=`
  ...
  `;t.innerHTML=a,Vt(t),(n=t.querySelector(`#${i}`))==null||n.addEventListener("input",r=>{var c;const o=r.target.value.toLowerCase(),l=((c=t.querySelector("#pa-risk-filter"))==null?void 0:c.value)||"all";vt(t,o,l)}),(s=t.querySelector("#pa-risk-filter"))==null||s.addEventListener("change",r=>{var l;const o=((l=t.querySelector(`#${i}`))==null?void 0:l.value.toLowerCase())||"";vt(t,o,r.target.value)})}function vt(e,t,i){const a=e.querySelector("#pa-acct-tbody");a&&(a.innerHTML=Qe.filter(n=>{const s=!t||n.upn.toLowerCase().includes(t)||n.name.toLowerCase().includes(t),r=i==="all"||n.risk===i;return s&&r}).map(n=>_t(n)).join(""),Vt(e))}function _t(e){return`
    <tr class="pa-acct-row" data-id="${e.id}">
      ...
      <td><div class="pill-group">${e.roles.map(ra).join("")}</div></td>
      <td><div class="pill-group">${na(e.mfa)}</div></td>
      <td>${gt(e.risk)}</td>
  ...
  `}function Vt(e){e.querySelectorAll(".pa-acct-expand").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const n=t.closest(".pa-acct-row").dataset.id,s=e.querySelector(`.pa-acct-expand-row[data-id="${n}"]`),r=s.style.display!=="none";s.style.display=r?"none":"table-row",t.classList.toggle("open",!r)})}),e.querySelectorAll(".pa-action").forEach(t=>{t.addEventListener("click",i=>{i.stopPropagation();const{action:a,id:n}=t.dataset,s=Qe.find(r=>r.id===n);a==="pwd-reset"?(p(`Password reset initiated for ${s==null?void 0:s.name}.`,"warning"),z("risk",`Password reset forced for ${s==null?void 0:s.upn}`,"Admin")):a==="convert-pim"?(p(`${s==null?void 0:s.name} converted to PIM eligible assignment.`,"success"),z("add",`${s==null?void 0:s.upn} converted to PIM eligible`,"Admin")):a==="mfa-enroll"?(p(`MFA enrollment triggered for ${s==null?void 0:s.name}.`,"info"),z("mfa",`MFA enrollment triggered for ${s==null?void 0:s.upn}`,"Admin")):a==="remove"&&(p(`${s==null?void 0:s.name} removed from privileged role.`,"danger"),z("remove",`${s==null?void 0:s.upn} removed from privileged role`,"Admin"))})})}function la(e){const t=e.querySelector("#pa-tab-groups");t.innerHTML=`
    <div class="filter-bar" style="margin-bottom:12px">
  ...
  `,yt(t),t.querySelector("#pa-grp-search").addEventListener("input",i=>{const a=i.target.value.toLowerCase();t.querySelector("#pa-grp-tbody").innerHTML=je.filter(n=>!a||n.name.toLowerCase().includes(a)).map(n=>mt(n)).join(""),yt(t)})}function mt(e){return`
  ...
  `}function yt(e){e.querySelectorAll(".pa-grp-expand").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,a=e.querySelector(`.pa-grp-expand-row[data-id="${i}"]`);a.style.display=a.style.display==="none"?"table-row":"none"})}),e.querySelectorAll(".pa-grp-untag").forEach(t=>{t.addEventListener("click",()=>{const i=je.find(a=>a.id===t.dataset.id);p(`${i==null?void 0:i.name} untagged as privileged group.`,"warning"),z("remove",`Group "${i==null?void 0:i.name}" untagged`,"Admin")})}),e.querySelectorAll(".pa-grp-remove-member").forEach(t=>{t.addEventListener("click",()=>{p(`${t.dataset.upn} removed from group.`,"success"),z("remove",`${t.dataset.upn} removed from group`,"Admin")})})}function ca(e){const t=e.querySelector("#pa-tab-log");Jt(t)}function Jt(e){e.innerHTML=`
  ...
  `}function z(e,t,i){const a={add:"ti-user-plus",remove:"ti-user-minus",risk:"ti-alert-triangle",mfa:"ti-shield",tag:"ti-tag",review:"ti-clipboard-check"},n={add:"var(--clr-info-text)",remove:"var(--clr-warning-text)",risk:"var(--clr-danger-text)",mfa:"var(--clr-success-text)",tag:"var(--clr-info-text)",review:"var(--clr-success-text)"},s={add:"var(--clr-info-bg)",remove:"var(--clr-warning-bg)",risk:"var(--clr-danger-bg)",mfa:"var(--clr-success-bg)",tag:"var(--clr-info-bg)",review:"var(--clr-success-bg)"};Wt.unshift({id:Date.now(),type:e,icls:a[e]||"ti-info-circle",ic:n[e]||"var(--clr-info-text)",bg:s[e]||"var(--clr-info-bg)",title:t,detail:t,by:i,time:"Just now"});const r=document.querySelector("#pa-tab-log");r&&Jt(r)}function da(){const e=document.getElementById("page-licenses");if(!e)return;const t=[{name:"Microsoft 365 E3",total:600,consumed:581,available:19,status:"monitor",statusCls:"warning"},{name:"Microsoft 365 E5",total:150,consumed:148,available:2,status:"critical",statusCls:"danger"},{name:"Exchange Online P1",total:100,consumed:72,available:28,status:"healthy",statusCls:"success"},{name:"Power BI Pro",total:100,consumed:38,available:62,status:"healthy",statusCls:"success"}];e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        ...
        <tbody>
          ${t.map(i=>{const a=Math.round(i.consumed/i.total*100);return`
              <tr>
                ...
                <td>
                  <div style="display:flex;align-items:center;gap:8px">
                    <div class="score-bar" style="flex:1">
                      <div class="score-bar-fill ${i.statusCls}" style="width:${a}%"></div>
                    </div>
                    <span style="font-size:10px;font-weight:600;min-width:30px">${a}%</span>
                  </div>
                </td>
  ...
  `;const t=e.querySelector("#agents-grid");ft.forEach(i=>{const a=i.status==="active"?"active pulse":i.status==="alert"?"alert pulse":"idle",n=i.status==="active"?"var(--clr-success-text)":i.status==="alert"?"var(--clr-danger-text)":"var(--color-text-tertiary)",s=document.createElement("div");s.className="agent-card",s.innerHTML=`
    ...
    `,t.appendChild(s)}),e.querySelectorAll(".agent-configure").forEach(i=>{i.addEventListener("click",async()=>{var n;const a=i.dataset.id;a==="config"?await h("m365config"):p(`Opening configuration for ${(n=ft.find(s=>s.id===a))==null?void 0:n.name}...`,"info")})}),e.querySelectorAll(".agent-pause").forEach(i=>{i.addEventListener("click",()=>p("Agent paused.","warning"))}),e.querySelectorAll(".agent-start").forEach(i=>{i.addEventListener("click",()=>p("Agent started.","success"))})}const ua=[{id:"REQ-001",type:"Distribution Group",requestor:"Priya Kumar",submitted:"2h ago",sla:"2h left",status:"pending",detail:"Create DG: marketing-emea@contoso.com"},{id:"REQ-003",type:"MFA Reset",requestor:"James Liu",submitted:"3h ago",sla:"Overdue",status:"overdue",detail:"MFA reset requested — lost device"},{id:"REQ-006",type:"SharePoint Access",requestor:"Sara Ogden",submitted:"1h ago",sla:"3h left",status:"pending",detail:"SharePoint site: HR Documents — Read access"}];let ie=ua.map(e=>({...e}));function ga(){const e=document.getElementById("page-approvals");e&&va(e)}function va(e){const t=ie.filter(a=>a.status==="pending"||a.status==="overdue").length,i=ie.filter(a=>a.status==="overdue").length;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,ya(e)}function ma(e){const t=e.status==="pending"||e.status==="overdue";return`
    <tr data-id="${e.id}">
      <td class="monospace">${e.id}</td>
      <td>${e.type}</td>
      <td>${e.requestor}</td>
  ...
  `}function ya(e){e.querySelectorAll(".approval-approve").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,a=ie.find(r=>r.id===i);a&&(a.status="approved");const n=e.querySelector(`tr[data-id="${i}"] .approval-action-cell`);n&&(n.innerHTML='<span class="badge success">Approved</span>');const s=document.querySelector("#n-approvals .nav-badge");if(s){const r=parseInt(s.textContent)-1;s.textContent=Math.max(0,r),r<=1&&(s.style.display="none")}p(`Request ${i} approved.`,"success")})}),e.querySelectorAll(".approval-reject").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.id,a=ie.find(s=>s.id===i);a&&(a.status="rejected");const n=e.querySelector(`tr[data-id="${i}"] .approval-action-cell`);n&&(n.innerHTML='<span class="badge neutral">Rejected</span>'),p(`Request ${i} rejected.`,"warning")})})}const He=[{id:"submit",label:"Request Submitted",icon:"ti-send",color:"info"},{id:"manager",label:"Manager Approval",icon:"ti-user-check",color:"warning"},{id:"dataowner",label:"Data Owner Approval",icon:"ti-shield-check",color:"purple"},{id:"it",label:"IT Review",icon:"ti-settings",color:"warning"},{id:"agent",label:"AI Agent Validation",icon:"ti-robot",color:"teal"},{id:"action",label:"System Provisioning",icon:"ti-api",color:"info"},{id:"done",label:"Completion",icon:"ti-circle-check",color:"success"}],Se=[{id:"exchange",name:"Exchange Online",icon:"ti-mail",color:"#854F0B",bg:"#FAEEDA",desc:"Groups, shared mailboxes, room resources, and email settings",badge:"4 services"},{id:"teams",name:"Microsoft Teams",icon:"ti-brand-teams",color:"#3C3489",bg:"#EEEDFE",desc:"Create teams, manage members, channels, and guest access",badge:"5 actions"},{id:"sharepoint",name:"SharePoint Services",icon:"ti-brand-sharepoint",color:"#3B6D11",bg:"#EAF3DE",desc:"Sites, permissions, external sharing, and storage management",badge:"6 actions"},{id:"onedrive",name:"OneDrive Administration",icon:"ti-cloud",color:"#0C447C",bg:"#E6F1FB",desc:"Storage increases and former employee OneDrive access",badge:"2 actions"},{id:"ext-sharing",name:"External Sharing",icon:"ti-world",color:"#791F1F",bg:"#FCEBEB",desc:"Invite, extend, or remove external guest access",badge:"4 actions"},{id:"user-access",name:"User Access Management",icon:"ti-lock-access",color:"#185FA5",bg:"#E6F1FB",desc:"Request access to mailboxes, Teams, SharePoint and groups",badge:"5 actions"},{id:"licenses",name:"License Management",icon:"ti-license",color:"#854F0B",bg:"#FAEEDA",desc:"Request Microsoft 365, Power BI, Visio, Project licenses",badge:"6 licenses"},{id:"copilot",name:"Microsoft Copilot",icon:"ti-sparkles",color:"#3C3489",bg:"#EEEDFE",desc:"Request or remove Microsoft 365 Copilot licenses",badge:"2 actions"},{id:"power-platform",name:"Power Platform",icon:"ti-bolt",color:"#3B6D11",bg:"#EAF3DE",desc:"Environments, premium connectors, DLP exceptions",badge:"4 actions"},{id:"intune",name:"Intune Services",icon:"ti-device-laptop",color:"#0C447C",bg:"#E6F1FB",desc:"Device retirement, wipe, and compliance exceptions",badge:"3 actions"},{id:"guest-lifecycle",name:"Guest User Lifecycle",icon:"ti-user-plus",color:"#633806",bg:"#FAEEDA",desc:"Invite guests, extend or remove access, quarterly reviews",badge:"4 actions"}],K=[{id:"exchange-groups",name:"Distribution & Security Groups",icon:"ti-users-group",desc:"M365 Groups, Distribution Groups, Security Groups"},{id:"shared-mailbox",name:"Shared Mailboxes",icon:"ti-mailbox",desc:"Create, delete, and manage shared mailbox permissions"},{id:"room-equipment",name:"Room & Equipment Mailboxes",icon:"ti-building",desc:"Meeting rooms, equipment resources, booking policies"},{id:"email-services",name:"Email Services",icon:"ti-mail-forward",desc:"SMTP addresses, mail forwarding, auto-reply configuration"}],fa={"exchange-groups":{parentGroup:"exchange",operations:[{id:"create-m365-group",group:"Microsoft 365 Groups",label:"Create M365 Group",approvalPath:["manager","it"],agentChecks:["Check for duplicate group names","Suggest existing groups with similar purpose","Validate naming convention","Verify requestor eligibility"],systemAction:"POST /v1.0/groups (groupTypes: Unified)",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. Marketing EMEA"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"marketing-emea",hint:"@contoso.com appended automatically"},{id:"privacy",label:"Privacy",type:"select",required:!0,options:["Private","Public"]},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"user1@contoso.com, user2@contoso.com",hint:"Comma-separated UPNs"},{id:"description",label:"Group Description",type:"textarea",required:!1,placeholder:"Purpose of this group..."},{id:"justification",label:"Business Justification",type:"textarea",required:!0,placeholder:"Why is this group needed?"}]},{id:"add-m365-members",group:"Microsoft 365 Groups",label:"Add Members to M365 Group",approvalPath:["manager"],agentChecks:["Verify group exists","Check member licensing","Validate UPNs"],systemAction:"POST /v1.0/groups/{id}/members/$ref",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0,placeholder:"marketing-emea@contoso.com"},{id:"members",label:"Members to Add",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0,placeholder:"Why do these users need to join?"}]},{id:"remove-m365-members",group:"Microsoft 365 Groups",label:"Remove Members from M365 Group",approvalPath:["manager"],agentChecks:["Verify group membership","Check if member is owner"],systemAction:"DELETE /v1.0/groups/{id}/members/{userId}/$ref",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0,placeholder:"marketing-emea@contoso.com"},{id:"members",label:"Members to Remove",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"archive-m365-group",group:"Microsoft 365 Groups",label:"Archive M365 Group",approvalPath:["manager","it"],agentChecks:["Check last activity date","Identify active owners","Verify no active workflows depend on group"],systemAction:"PATCH /v1.0/groups/{id} (visibility: archived)",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0},{id:"archiveDate",label:"Archive By Date",type:"date",required:!1},{id:"dataRetention",label:"Data Retention Period",type:"select",required:!0,options:["30 days","90 days","180 days","1 year","Indefinite"]},{id:"justification",label:"Reason for Archiving",type:"textarea",required:!0}]},{id:"create-dg",group:"Distribution Groups",label:"Create Distribution Group",approvalPath:["manager"],agentChecks:["Duplicate DG check","Naming convention validation","Suggest existing DGs"],systemAction:"New-DistributionGroup via Exchange PowerShell",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. All Staff UK"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"all-staff-uk"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"managedBy",label:"Managed By (Owner)",type:"text",required:!1,placeholder:"UPN of owner"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"modify-dg",group:"Distribution Groups",label:"Rename / Modify Distribution Group",approvalPath:["manager"],agentChecks:["Verify group ownership","Check for email references to current name"],systemAction:"Set-DistributionGroup via Exchange PowerShell",fields:[{id:"currentName",label:"Current Group Name",type:"text",required:!0},{id:"newName",label:"New Display Name",type:"text",required:!1,placeholder:"Leave blank if not changing"},{id:"newAlias",label:"New Email Alias",type:"text",required:!1,placeholder:"Leave blank if not changing"},{id:"changeOwner",label:"New Owner UPN",type:"text",required:!1},{id:"justification",label:"Reason for Change",type:"textarea",required:!0}]},{id:"delete-dg",group:"Distribution Groups",label:"Delete Distribution Group",approvalPath:["manager","it"],agentChecks:["Check group usage in mail flow rules","Identify group members","Check email references in other systems"],systemAction:"Remove-DistributionGroup via Exchange PowerShell",fields:[{id:"groupName",label:"Group Name / Email",type:"text",required:!0},{id:"confirmation",label:"Type group name to confirm deletion",type:"text",required:!0,placeholder:"Must match exactly"},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]},{id:"create-sg",group:"Security Groups",label:"Create Security Group",approvalPath:["manager","it"],agentChecks:["Duplicate check","Naming convention","Suggest existing groups","Review intended resource access"],systemAction:"POST /v1.0/groups (securityEnabled: true)",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. SG-Finance-ReadOnly"},{id:"purpose",label:"Purpose / Resource",type:"text",required:!0,placeholder:"What resource will this secure?"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"manage-sg-members",group:"Security Groups",label:"Add / Remove Security Group Members",approvalPath:["manager","it"],agentChecks:["Verify requester is group owner","Check member eligibility","Validate access to secured resource"],systemAction:"POST/DELETE /v1.0/groups/{id}/members/$ref",fields:[{id:"groupName",label:"Security Group Name",type:"text",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Add members","Remove members"]},{id:"members",label:"Members (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"shared-mailbox":{parentGroup:"exchange",operations:[{id:"create-shared-mb",group:"Create / Delete",label:"Create Shared Mailbox",approvalPath:["manager","it"],agentChecks:["Duplicate mailbox check","License availability","Naming convention","Verify owner details"],systemAction:"New-Mailbox -Shared via Exchange PowerShell",fields:[{id:"displayName",label:"Display Name",type:"text",required:!0,placeholder:"e.g. HR Department"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"hr@contoso.com"},{id:"fullAccess",label:"Full Access Users",type:"text",required:!1,placeholder:"UPNs comma-separated"},{id:"sendAs",label:"Send As Users",type:"text",required:!1,placeholder:"UPNs comma-separated"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-shared-mb",group:"Create / Delete",label:"Delete Shared Mailbox",approvalPath:["manager","it"],agentChecks:["Check mailbox usage in last 90 days","Identify users with permissions","Check mail flow dependencies"],systemAction:"Remove-Mailbox via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Mailbox Email Address",type:"email",required:!0},{id:"dataAction",label:"Data Disposition",type:"select",required:!0,options:["Export then delete","Retain for 90 days","Immediate deletion"]},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]},{id:"mb-permissions",group:"Permissions",label:"Modify Mailbox Permissions",approvalPath:["manager"],agentChecks:["Verify mailbox exists","Validate user licensing","Check current permission state"],systemAction:"Add/Remove-MailboxPermission via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Mailbox Email Address",type:"email",required:!0},{id:"permType",label:"Permission Type",type:"select",required:!0,options:["Full Access","Send As","Send on Behalf"]},{id:"action",label:"Action",type:"select",required:!0,options:["Add permission","Remove permission"]},{id:"users",label:"Users (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"room-equipment":{parentGroup:"exchange",operations:[{id:"create-room",group:"Create",label:"Create Room Mailbox",approvalPath:["manager","it"],agentChecks:["Check for duplicate room names","Validate capacity settings","Verify location exists in directory"],systemAction:"New-Mailbox -Room via Exchange PowerShell",fields:[{id:"displayName",label:"Room Name",type:"text",required:!0,placeholder:"e.g. London — Boardroom A"},{id:"alias",label:"Email Alias",type:"text",required:!0,placeholder:"london-boardroom-a"},{id:"capacity",label:"Capacity (persons)",type:"text",required:!0,placeholder:"12"},{id:"location",label:"Building / Floor",type:"text",required:!1,placeholder:"e.g. 1 Canada Square, Floor 4"},{id:"autoAccept",label:"Auto-accept bookings",type:"select",required:!0,options:["Auto-accept all","Require approval","Manual only"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"create-equipment",group:"Create",label:"Create Equipment Mailbox",approvalPath:["manager","it"],agentChecks:["Duplicate equipment name check","Validate equipment type"],systemAction:"New-Mailbox -Equipment via Exchange PowerShell",fields:[{id:"displayName",label:"Equipment Name",type:"text",required:!0,placeholder:"e.g. Projector — Floor 3"},{id:"alias",label:"Email Alias",type:"text",required:!0},{id:"equipType",label:"Equipment Type",type:"select",required:!0,options:["Projector","Video conferencing unit","Laptop pool","Car/Fleet","Other"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"modify-booking",group:"Modify",label:"Modify Booking Policy",approvalPath:["manager"],agentChecks:["Verify resource exists","Check current booking conflicts"],systemAction:"Set-CalendarProcessing via Exchange PowerShell",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"autoAccept",label:"Auto-accept policy",type:"select",required:!1,options:["Auto-accept all","Require approval","Manual only"]},{id:"maxDuration",label:"Max booking duration",type:"select",required:!1,options:["1 hour","2 hours","4 hours","8 hours","1 day","Unlimited"]},{id:"bookingWindow",label:"Advance booking window",type:"select",required:!1,options:["1 week","2 weeks","1 month","3 months","6 months"]},{id:"justification",label:"Reason for Change",type:"textarea",required:!0}]},{id:"add-delegate",group:"Modify",label:"Add Room/Equipment Delegate",approvalPath:["manager"],agentChecks:["Verify resource exists","Verify delegate licensing"],systemAction:"Set-CalendarProcessing -ResourceDelegates",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"delegates",label:"Delegate UPNs",type:"text",required:!0,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-resource",group:"Delete",label:"Remove Room / Equipment Mailbox",approvalPath:["manager","it"],agentChecks:["Check for future bookings","Identify delegates","Cancel existing calendar entries"],systemAction:"Remove-Mailbox via Exchange PowerShell",fields:[{id:"resourceEmail",label:"Resource Email",type:"email",required:!0},{id:"deleteDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"justification",label:"Reason for Removal",type:"textarea",required:!0}]}]},"email-services":{parentGroup:"exchange",operations:[{id:"smtp-change",group:"Email Configuration",label:"SMTP Address Change",approvalPath:["manager","it"],agentChecks:["Verify mailbox ownership","Check SMTP address availability","Check for email references in other systems"],systemAction:"Set-Mailbox -EmailAddresses via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"newSmtp",label:"New Primary SMTP",type:"email",required:!0,hint:"New primary email address"},{id:"keepOld",label:"Retain old address as alias",type:"select",required:!0,options:["Yes — keep as alias","No — remove old address"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"mail-forwarding",group:"Email Configuration",label:"Configure Mail Forwarding",approvalPath:["manager","it"],agentChecks:["Check for external forwarding policy","Verify destination address","Flag if forwarding to external domain"],systemAction:"Set-Mailbox -ForwardingSmtpAddress via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"forwardTo",label:"Forward To",type:"email",required:!0},{id:"keepCopy",label:"Keep a copy in mailbox",type:"select",required:!0,options:["Yes","No"]},{id:"duration",label:"Forwarding Duration",type:"select",required:!1,options:["Indefinite","30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"auto-reply",group:"Email Configuration",label:"Auto Reply Configuration",approvalPath:["manager"],agentChecks:["Validate mailbox ownership","Check message content for compliance"],systemAction:"Set-MailboxAutoReplyConfiguration via Exchange PowerShell",fields:[{id:"mailboxUpn",label:"Mailbox UPN",type:"email",required:!0},{id:"scope",label:"Reply Scope",type:"select",required:!0,options:["Internal only","Internal and external"]},{id:"startDate",label:"Start Date",type:"date",required:!1},{id:"endDate",label:"End Date",type:"date",required:!1},{id:"message",label:"Auto Reply Message",type:"textarea",required:!0,placeholder:"Out of office message..."}]}]},teams:{parentGroup:null,operations:[{id:"create-team",group:"Team Management",label:"Create Team",approvalPath:["manager"],agentChecks:["Duplicate team name check","Suggest existing teams","Validate naming convention","Check M365 group quota"],systemAction:"POST /v1.0/teams",fields:[{id:"displayName",label:"Team Name",type:"text",required:!0,placeholder:"e.g. Project Phoenix"},{id:"description",label:"Description",type:"textarea",required:!1},{id:"privacy",label:"Privacy",type:"select",required:!0,options:["Private (invite only)","Public (open to all)"]},{id:"template",label:"Team Template",type:"select",required:!1,options:["Standard","Project","Retail","Healthcare","Education"]},{id:"owners",label:"Team Owners",type:"text",required:!0,placeholder:"Comma-separated UPNs (at least 1)"},{id:"members",label:"Initial Members",type:"text",required:!1,placeholder:"Comma-separated UPNs"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"add-team-members",group:"Team Management",label:"Add / Remove Team Members",approvalPath:["manager"],agentChecks:["Verify team exists","Check user licensing","Validate requester is owner"],systemAction:"POST/DELETE /v1.0/teams/{id}/members",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Add members","Remove members","Promote to owner","Demote from owner"]},{id:"users",label:"Users (UPNs)",type:"textarea",required:!0,placeholder:"One UPN per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"create-channel",group:"Channel Management",label:"Create Channel",approvalPath:["manager"],agentChecks:["Verify team exists","Check for duplicate channel names","Validate channel type eligibility"],systemAction:"POST /v1.0/teams/{id}/channels",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"channelName",label:"Channel Name",type:"text",required:!0,placeholder:"e.g. Project Updates"},{id:"channelType",label:"Channel Type",type:"select",required:!0,options:["Standard","Private","Shared"]},{id:"description",label:"Description",type:"textarea",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"team-guest-access",group:"Guest Access",label:"Request Guest Access to Team",approvalPath:["manager","it"],agentChecks:["Verify guest policy allows external access","Check guest domain restrictions","Validate team guest access setting"],systemAction:"POST /v1.0/teams/{id}/members (guest)",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"guestEmails",label:"Guest Email Addresses",type:"textarea",required:!0,placeholder:"One email per line (external addresses)"},{id:"guestOrg",label:"Guest Organisation",type:"text",required:!0,placeholder:"External company name"},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},sharepoint:{parentGroup:null,operations:[{id:"new-site",group:"Site Management",label:"Request New SharePoint Site",approvalPath:["manager","it"],agentChecks:["Check for similar existing sites","Validate site URL availability","Check storage quota","Verify naming convention"],systemAction:"POST /v1.0/sites — Invoke-RestMethod SharePoint REST API",fields:[{id:"siteTitle",label:"Site Title",type:"text",required:!0,placeholder:"e.g. Finance Department Hub"},{id:"siteUrl",label:"Site URL",type:"text",required:!0,placeholder:"finance-hub",hint:"contoso.sharepoint.com/sites/ prefix appended"},{id:"siteTemplate",label:"Template",type:"select",required:!0,options:["Team site","Communication site","Hub site","Document center"]},{id:"owners",label:"Site Owners",type:"text",required:!0,placeholder:"Comma-separated UPNs"},{id:"storageQuota",label:"Initial Storage Quota",type:"select",required:!1,options:["1 GB (default)","5 GB","10 GB","25 GB","100 GB"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"add-site-members",group:"Site Permissions",label:"Add Site Members / Owners",approvalPath:["manager"],agentChecks:["Verify site exists","Check user eligibility","Validate permission level request"],systemAction:"SharePoint REST API — /_api/web/roleassignments",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0,placeholder:"contoso.sharepoint.com/sites/..."},{id:"role",label:"Permission Level",type:"select",required:!0,options:["Read","Contribute","Edit","Full Control","Site Owner"]},{id:"users",label:"Users / Groups (UPNs)",type:"textarea",required:!0,placeholder:"One UPN or group name per line"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"external-sharing",group:"External Sharing",label:"Request External Sharing",approvalPath:["manager","dataowner","it"],agentChecks:["Check tenant external sharing policy","Verify domain not blocked","Classify data sensitivity","Check DLP policy applicability"],systemAction:"Set-SPOSite -SharingCapability via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"sharingLevel",label:"Sharing Level",type:"select",required:!0,options:["Specific people (authenticated)","Anyone with link (no sign-in)","Existing guests only"]},{id:"externalOrg",label:"External Organisation",type:"text",required:!0},{id:"duration",label:"Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year","Ongoing (reviewed annually)"]},{id:"dataSensitivity",label:"Data Sensitivity",type:"select",required:!0,options:["Public","Internal","Confidential","Highly Confidential"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"storage-increase",group:"Site Management",label:"Request Storage Increase",approvalPath:["manager","it"],agentChecks:["Check current usage vs quota","Validate increase request is proportionate","Check tenant storage pool"],systemAction:"Set-SPOSite -StorageQuota via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"currentSize",label:"Current Storage Used",type:"text",required:!1,placeholder:"Approx. current usage (e.g. 4.5 GB)"},{id:"requestedGB",label:"Additional Storage (GB)",type:"text",required:!0,placeholder:"e.g. 10"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"delete-site",group:"Site Management",label:"Request Site Deletion",approvalPath:["manager","it"],agentChecks:["Check last site activity","Identify site owners","Check for active flows or apps referencing site","Verify data retention requirements"],systemAction:"Remove-SPOSite via PnP PowerShell",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"contentAction",label:"Content Action",type:"select",required:!0,options:["Export content then delete","Move to archive library","Immediate deletion"]},{id:"confirmation",label:"Type site name to confirm",type:"text",required:!0},{id:"justification",label:"Reason for Deletion",type:"textarea",required:!0}]}]},onedrive:{parentGroup:null,operations:[{id:"onedrive-storage",group:"Storage",label:"Request OneDrive Storage Increase",approvalPath:["manager","it"],agentChecks:["Check current OneDrive usage","Verify user licensing tier","Check tenant storage pool"],systemAction:"Set-SPOSite (OneDrive) -StorageQuota via PnP PowerShell",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0,placeholder:"user@contoso.com"},{id:"currentUsage",label:"Current Usage (approx)",type:"text",required:!1,placeholder:"e.g. 800 GB"},{id:"requestedQuota",label:"Requested Quota (GB)",type:"select",required:!0,options:["1 TB (default)","2 TB","5 TB","10 TB","25 TB (requires approval)"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"former-employee-od",group:"Access",label:"Access Former Employee OneDrive",approvalPath:["manager","it"],agentChecks:["Verify employee account status","Check data retention policy","Validate manager relationship","Check GDPR/legal hold status"],systemAction:"Set-SPOUser -Site (OneDrive URL) -LoginName via PnP PowerShell",fields:[{id:"formerEmployee",label:"Former Employee UPN",type:"email",required:!0},{id:"requestorUpn",label:"Requestor UPN",type:"email",required:!0,hint:"Your UPN — will be granted access"},{id:"reason",label:"Reason for Access",type:"select",required:!0,options:["Business continuity","Legal / compliance","Data recovery","Project handover","GDPR subject access request"]},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["7 days","30 days","90 days"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"ext-sharing":{parentGroup:null,operations:[{id:"invite-guest",group:"Guest Invitations",label:"Invite External Guest",approvalPath:["manager","it"],agentChecks:["Check domain against block list","Verify guest invitation policy","Check existing guest account","Validate business relationship"],systemAction:"POST /v1.0/invitations",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"guestName",label:"Guest Full Name",type:"text",required:!0},{id:"guestOrg",label:"Guest Organisation",type:"text",required:!0},{id:"accessNeeded",label:"Access Required",type:"text",required:!0,placeholder:"Teams, SharePoint site, etc."},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"extend-guest",group:"Guest Lifecycle",label:"Extend Guest Access",approvalPath:["manager","dataowner"],agentChecks:["Verify current expiry date","Check if guest is still active","Validate business relationship still active"],systemAction:"PATCH /v1.0/users/{guestId} — update account expiry",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"extension",label:"Extend By",type:"select",required:!0,options:["30 days","60 days","90 days","6 months","1 year"]},{id:"reviewDate",label:"Next Review Date",type:"date",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-guest",group:"Guest Lifecycle",label:"Remove Guest Access",approvalPath:["manager"],agentChecks:["Enumerate all resources guest has access to","Check for owned content","Schedule account removal"],systemAction:"DELETE /v1.0/users/{guestId}",fields:[{id:"guestEmail",label:"Guest Email Address",type:"email",required:!0},{id:"removeDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"reassignContent",label:"Reassign owned content to",type:"text",required:!1,placeholder:"UPN of new owner (optional)"},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"enable-ext-sharing",group:"Sharing Policy",label:"Request External Sharing Enablement",approvalPath:["manager","dataowner","it"],agentChecks:["Verify DLP policies cover new sharing scope","Check Conditional Access for guest sign-in","Review tenant sharing policy settings"],systemAction:"Set-SPOTenant -SharingCapability via PnP PowerShell",fields:[{id:"scope",label:"Sharing Scope",type:"select",required:!0,options:["Specific SharePoint sites","All SharePoint sites","OneDrive","All workloads"]},{id:"sharingLevel",label:"Sharing Level",type:"select",required:!0,options:["New and existing guests","Existing guests only","Anyone (anonymous links)"]},{id:"domains",label:"Allowed External Domains",type:"text",required:!1,placeholder:"partner1.com, partner2.com"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"user-access":{parentGroup:null,operations:[{id:"access-mailbox",group:"Access Requests",label:"Access to Shared Mailbox",approvalPath:["manager"],agentChecks:["Verify mailbox exists","Check existing permissions","Validate requester eligibility"],systemAction:"Add-MailboxPermission via Exchange PowerShell",fields:[{id:"mailboxEmail",label:"Shared Mailbox Email",type:"email",required:!0},{id:"permLevel",label:"Permission Level",type:"select",required:!0,options:["Full Access","Send As","Send on Behalf"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-teams",group:"Access Requests",label:"Access to Teams Team or Channel",approvalPath:["manager"],agentChecks:["Verify team exists","Check if team is private/public","Check channel accessibility"],systemAction:"POST /v1.0/teams/{id}/members",fields:[{id:"teamName",label:"Team Name",type:"text",required:!0},{id:"channelName",label:"Channel Name",type:"text",required:!1,placeholder:"Leave blank for general access"},{id:"role",label:"Role",type:"select",required:!0,options:["Member","Owner"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-sharepoint",group:"Access Requests",label:"Access to SharePoint Site",approvalPath:["manager"],agentChecks:["Verify site exists","Check current permissions","Classify data sensitivity"],systemAction:"SharePoint REST API — /_api/web/roleassignments",fields:[{id:"siteUrl",label:"Site URL",type:"text",required:!0},{id:"permLevel",label:"Permission Level",type:"select",required:!0,options:["Read","Contribute","Edit"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-dl",group:"Access Requests",label:"Access to Distribution List",approvalPath:["manager"],agentChecks:["Verify DL exists","Check for closed membership","Check for similar groups"],systemAction:"Add-DistributionGroupMember via Exchange PowerShell",fields:[{id:"dlEmail",label:"Distribution List Email",type:"email",required:!0},{id:"action",label:"Action",type:"select",required:!0,options:["Subscribe (add)","Unsubscribe (remove)"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"access-sg",group:"Access Requests",label:"Access to Security Group",approvalPath:["manager","it"],agentChecks:["Verify SG exists","Identify what resources are secured","Validate eligibility based on role/department"],systemAction:"POST /v1.0/groups/{id}/members/$ref",fields:[{id:"sgName",label:"Security Group Name",type:"text",required:!0},{id:"resourceAccess",label:"Resource you need to access",type:"text",required:!0,placeholder:"What will this SG membership unlock?"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},licenses:{parentGroup:null,operations:[{id:"req-e3",group:"Microsoft 365",label:"Request Microsoft 365 E3 License",approvalPath:["manager","it"],agentChecks:["Check E3 license availability","Verify current license assignment","Validate user eligibility"],systemAction:"POST /v1.0/users/{id}/assignLicense",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"startDate",label:"Required From Date",type:"date",required:!1},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-e5",group:"Microsoft 365",label:"Request Microsoft 365 E5 License",approvalPath:["manager","it"],agentChecks:["Check E5 license availability (CRITICAL — low stock)","Verify E5 features needed vs E3","Validate cost center approval"],systemAction:"POST /v1.0/users/{id}/assignLicense",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"featuresNeeded",label:"E5 Features Required",type:"select",required:!0,options:["Defender for Endpoint P2","Purview compliance","Advanced analytics","All E5 features"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"startDate",label:"Required From Date",type:"date",required:!1},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-powerbi",group:"Add-on Licenses",label:"Request Power BI Pro License",approvalPath:["manager"],agentChecks:["Check Power BI Pro availability","Verify user not already licensed","Check for Power BI Free upgrade path"],systemAction:"POST /v1.0/users/{id}/assignLicense (PBIPREMIUM)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"useCase",label:"Use Case",type:"textarea",required:!0,placeholder:"How will Power BI Pro be used?"},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-visio",group:"Add-on Licenses",label:"Request Visio Plan License",approvalPath:["manager"],agentChecks:["Check Visio license availability","Verify Visio Plan 1 vs Plan 2 need"],systemAction:"POST /v1.0/users/{id}/assignLicense (VISIO_PLAN2)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"visioTier",label:"Visio Plan",type:"select",required:!0,options:["Visio Plan 1 (web only)","Visio Plan 2 (desktop + web)"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"req-project",group:"Add-on Licenses",label:"Request Project Plan License",approvalPath:["manager"],agentChecks:["Check Project Plan availability","Validate PM role or equivalent"],systemAction:"POST /v1.0/users/{id}/assignLicense (PROJECT_PLAN3)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"projectTier",label:"Project Plan",type:"select",required:!0,options:["Project Plan 1 (web only)","Project Plan 3 (full)","Project Plan 5 (enterprise)"]},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},copilot:{parentGroup:null,operations:[{id:"req-copilot",group:"Copilot License",label:"Request Microsoft 365 Copilot License",approvalPath:["manager","it"],agentChecks:["Check Copilot license availability","Verify M365 E3/E5 prerequisite","Validate cost center budget"],systemAction:"POST /v1.0/users/{id}/assignLicense (COPILOT_M365)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"useCase",label:"Intended Use Case",type:"textarea",required:!0,placeholder:"How will Copilot improve your productivity?"},{id:"pilotGroup",label:"Pilot / rollout group",type:"text",required:!1,placeholder:"Team or department (optional)"},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-copilot",group:"Copilot License",label:"Remove Microsoft 365 Copilot License",approvalPath:["manager"],agentChecks:["Verify current Copilot assignment","Check active Copilot usage metrics"],systemAction:"POST /v1.0/users/{id}/assignLicense (removeLicenses)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"reason",label:"Reason for Removal",type:"select",required:!0,options:["User departure","Cost reduction","Low utilisation","Role change","Other"]},{id:"justification",label:"Additional Details",type:"textarea",required:!1}]}]},"power-platform":{parentGroup:null,operations:[{id:"create-env",group:"Environments",label:"Create Power Platform Environment",approvalPath:["manager","it"],agentChecks:["Check environment quota","Validate environment type eligibility","Check DLP policy coverage for new environment"],systemAction:"Power Platform Admin API — POST /environments",fields:[{id:"envName",label:"Environment Name",type:"text",required:!0,placeholder:"e.g. Finance-Production"},{id:"envType",label:"Environment Type",type:"select",required:!0,options:["Sandbox","Production","Developer","Trial"]},{id:"region",label:"Region",type:"select",required:!0,options:["United Kingdom","Europe","United States","Australia"]},{id:"purpose",label:"Purpose",type:"textarea",required:!0},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"premium-connector",group:"Connectors",label:"Request Premium Connector Access",approvalPath:["manager","it"],agentChecks:["Check DLP policy for requested connector","Verify Power Automate license","Assess data exposure risk"],systemAction:"Power Platform DLP API — update connector classification",fields:[{id:"connector",label:"Premium Connector",type:"text",required:!0,placeholder:"e.g. Salesforce, SAP, ServiceNow"},{id:"environment",label:"Environment Name",type:"text",required:!0},{id:"useCase",label:"Use Case",type:"textarea",required:!0},{id:"dataFlow",label:"Data Flow Description",type:"textarea",required:!0,placeholder:"What data will flow through this connector?"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"dlp-exception",group:"Policies",label:"Request DLP Policy Exception",approvalPath:["manager","dataowner","it"],agentChecks:["Validate exception scope","Assess compliance risk","Check for alternative compliant approach","Flag sensitive connectors"],systemAction:"Power Platform DLP API — environment-level policy override",fields:[{id:"environment",label:"Environment",type:"text",required:!0},{id:"dlpPolicy",label:"DLP Policy Name",type:"text",required:!0},{id:"connector",label:"Connector(s) Affected",type:"text",required:!0},{id:"riskMitigation",label:"Risk Mitigation Plan",type:"textarea",required:!0},{id:"duration",label:"Exception Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"pa-license",group:"Licensing",label:"Request Power Automate License",approvalPath:["manager"],agentChecks:["Check Power Automate license availability","Verify M365 base license","Determine if Premium or per-flow license needed"],systemAction:"POST /v1.0/users/{id}/assignLicense (FLOW_PER_USER)",fields:[{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"licenseType",label:"License Type",type:"select",required:!0,options:["Power Automate Premium (per user)","Power Automate per flow","Power Automate Process"]},{id:"useCase",label:"Use Case",type:"textarea",required:!0},{id:"costCenter",label:"Cost Center",type:"text",required:!0},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},intune:{parentGroup:null,operations:[{id:"retire-device",group:"Device Actions",label:"Retire Device",approvalPath:["manager","it"],agentChecks:["Verify device ownership","Check for company data on device","Confirm MFA device registration","Check for pending updates"],systemAction:"POST /beta/deviceManagement/managedDevices/{id}/retire",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0,placeholder:"Device display name from Intune"},{id:"userUpn",label:"Device User UPN",type:"email",required:!0},{id:"reason",label:"Reason for Retirement",type:"select",required:!0,options:["Device being replaced","User departure","Device lost/stolen","End of lifecycle","Other"]},{id:"returnDate",label:"Device Return / Disposal Date",type:"date",required:!1},{id:"justification",label:"Additional Details",type:"textarea",required:!1}]},{id:"wipe-device",group:"Device Actions",label:"Wipe Device",approvalPath:["it"],agentChecks:["Verify device ownership","Check for unsynced data","CRITICAL: Confirm user awareness — device wipe is irreversible"],systemAction:"POST /beta/deviceManagement/managedDevices/{id}/wipe",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0},{id:"userUpn",label:"Device User UPN",type:"email",required:!0},{id:"wipeType",label:"Wipe Type",type:"select",required:!0,options:["Full wipe (factory reset)","Selective wipe (remove corporate data only)"]},{id:"reason",label:"Reason",type:"select",required:!0,options:["Device lost","Device stolen","Security incident","User departure","Other"]},{id:"confirmation",label:"Type CONFIRM to proceed",type:"text",required:!0,hint:"This action is irreversible"},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"compliance-exception",group:"Compliance",label:"Request Compliance Exception",approvalPath:["manager","it"],agentChecks:["Assess compliance gap","Check for compensating controls","Review exception policy limits","Flag if exception creates Zero Trust gap"],systemAction:"Update device compliance policy exclusion group via Intune API",fields:[{id:"deviceName",label:"Device Name",type:"text",required:!0},{id:"userUpn",label:"User UPN",type:"email",required:!0},{id:"nonCompliantItem",label:"Non-Compliant Item",type:"select",required:!0,options:["OS version","Encryption","Screen lock","Jailbreak/Root detection","Threat level","Other"]},{id:"compensatingControls",label:"Compensating Controls",type:"textarea",required:!0,placeholder:"What security controls mitigate the compliance gap?"},{id:"duration",label:"Exception Duration",type:"select",required:!0,options:["7 days","30 days","90 days"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]}]},"guest-lifecycle":{parentGroup:null,operations:[{id:"invite-guest-user",group:"Guest Management",label:"Invite Guest User",approvalPath:["manager","it"],agentChecks:["Check domain against block list","Check for existing guest account","Verify guest invitation policy","Check Conditional Access guest policy"],systemAction:"POST /v1.0/invitations",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"guestName",label:"Guest Full Name",type:"text",required:!0},{id:"guestOrg",label:"Organisation",type:"text",required:!0},{id:"accessScope",label:"Access Scope",type:"text",required:!0,placeholder:"Teams, SharePoint sites, etc."},{id:"sponsor",label:"Internal Sponsor UPN",type:"email",required:!0,hint:"Accountable internal contact for this guest"},{id:"duration",label:"Access Duration",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"extend-guest-access",group:"Guest Management",label:"Extend Guest Access",approvalPath:["manager","dataowner"],agentChecks:["Verify guest activity (last 30 days)","Check access scope still appropriate","Validate sponsor still in organisation"],systemAction:"PATCH /v1.0/users/{guestId} — update account expiry",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"extension",label:"Extend Access By",type:"select",required:!0,options:["30 days","90 days","6 months","1 year"]},{id:"accessReview",label:"Access Still Required For",type:"textarea",required:!0,placeholder:"Confirm ongoing business need..."},{id:"justification",label:"Business Justification",type:"textarea",required:!0}]},{id:"remove-guest-user",group:"Guest Management",label:"Remove Guest User",approvalPath:["manager"],agentChecks:["Enumerate guest resource access","Check for owned content","Check active collaborations","Flag any open items"],systemAction:"DELETE /v1.0/users/{guestId}",fields:[{id:"guestEmail",label:"Guest Email",type:"email",required:!0},{id:"removeDate",label:"Removal Date",type:"date",required:!1,hint:"Leave blank for immediate removal"},{id:"contentAction",label:"Owned Content Action",type:"select",required:!0,options:["Reassign to sponsor","Export then delete","No action needed"]},{id:"justification",label:"Reason",type:"textarea",required:!0}]},{id:"quarterly-review",group:"Access Review",label:"Request Quarterly Access Review",approvalPath:["it"],agentChecks:["Enumerate all active guest accounts","Identify guests inactive >60 days","Check expiry dates","Identify guests without sponsors"],systemAction:'GET /v1.0/users?$filter=userType eq "Guest" — generate review report',fields:[{id:"scope",label:"Review Scope",type:"select",required:!0,options:["All guest users","Specific department guests","Guests expiring in 30 days","Inactive guests only"]},{id:"reviewerUpn",label:"Reviewer UPN",type:"email",required:!0,hint:"Who should receive the review report"},{id:"justification",label:"Additional Notes",type:"textarea",required:!1}]}]}};let A="landing",E=null,P=null,S=null,ye={},Kt=100;function ha(){const e=document.getElementById("page-portal");e&&(A="landing",E=null,P=null,S=null,ye={},$(e))}function $(e){A==="landing"?wa(e):A==="service"?xa(e):A==="form"?Sa(e):A==="submitted"&&Ca(e)}function ke(e){const t=d.settings;return t.portalEnabled?t[e]!==!1:!1}function ht(e){return"portal_"+e.replace(/-/g,"_")}function Y(e){return fa[e]||null}function Ze(e){return Se.find(t=>t.id===e)}function Yt(e,t){const i=Y(e);return i?i.operations.find(a=>a.id===t):null}function ce(e){return e==="exchange"}function ba(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};for(const t of K)if(ke(e[t.id]))return t.id;return K[0].id}function $e(){return ce(E)?P:E}function de(e){if(!e)return[];const t=["submit",...e.approvalPath,"agent","action","done"];return He.filter(i=>t.includes(i.id))}function wa(e){const t=d.currentUser;if(!d.settings.portalEnabled){e.innerHTML=`
      ...
      </div>`;return}const i={user:"Standard user",manager:"Manager",admin:"Administrator",super:"Super Admin"},a=Se.filter(s=>ke(ht(s.id)));e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="portal-workflow-banner mb-3">
      ${He.map((s,r)=>`
        ...
        ${r<He.length-1?'<div class="pwf-arrow"><i class="ti ti-arrow-right"></i></div>':""}
      `).join("")}
    </div>
    ...
    <div style="font-size:11px;font-weight:600;color:var(--color-text-secondary);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:12px">
      ${a.length} services available
    </div>

    <div class="portal-service-grid" id="portal-service-grid"></div>
  `;const n=e.querySelector("#portal-service-grid");Se.forEach(s=>{var c,u;const r=ke(ht(s.id)),o=ce(s.id)?K.reduce((y,Z)=>{var G,g;return y+(((g=(G=Y(Z.id))==null?void 0:G.operations)==null?void 0:g.length)||0)},0):((u=(c=Y(s.id))==null?void 0:c.operations)==null?void 0:u.length)||0,l=document.createElement("div");l.className=`portal-svc-card ${r?"":"disabled"}`,l.innerHTML=`
      <div class="psc-icon" style="background:${s.bg};color:${s.color}"><i class="ti ${s.icon}"></i></div>
      ...
      <div class="psc-footer">
        ...
        <button class="btn btn-xs btn-primary psc-open-btn" data-gid="${s.id}" ${r?"":"disabled"}>
          <i class="ti ti-arrow-right"></i> Open
        </button>
      </div>
    `,r||(l.title="This service has been disabled by your administrator."),n.appendChild(l)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(s=>{s.addEventListener("click",()=>{E=s.dataset.gid,ce(E)&&(P=ba()),S=null,ye={},A="service",$(e)})})}function xa(e){const t=Ze(E);if(!t){A="landing",$(e);return}const i=$e(),a=Y(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{A="landing",$(e)}),ce(E)&&e.querySelectorAll(".ex-sub-tab").forEach(n=>{n.addEventListener("click",()=>{P=n.dataset.sub,S=null,bt(e,Y(P)),e.querySelectorAll(".ex-sub-tab").forEach(s=>s.classList.toggle("active",s.dataset.sub===P))})}),bt(e,a)}function Aa(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
    <div class="tabs mb-3" style="margin-bottom:16px">
      ${K.map(t=>{const i=ke(e[t.id]);return`<button class="tab-btn ex-sub-tab ${t.id===P?"active":""} ${i?"":"disabled-tab"}"
  ...
  `}function bt(e,t){const i=e.querySelector("#svc-ops-area");if(!i)return;if(!t){i.innerHTML='<div class="empty-state">No operations available for this service.</div>';return}const a={};if(t.operations.forEach(n=>{a[n.group]||(a[n.group]=[]),a[n.group].push(n)}),i.innerHTML=`
    <div class="card">
      <div class="card-title mb-3"><i class="ti ti-list-check"></i> Select an action</div>
      ${Object.entries(a).map(([n,s])=>`
        <div style="margin-bottom:16px">
          <div class="section-heading">${n}</div>
          <div class="op-cards-grid">
            ${s.map(r=>`
              <div class="op-card ${S===r.id?"selected":""}" data-op="${r.id}">
                <div class="op-card-title">${r.label}</div>
                <div class="op-card-steps">
                  ${de(r).map(o=>`<span class="op-step-dot op-step-${o.color}" title="${o.label}"></span>`).join("")}
                </div>
                <div class="op-card-approval">
                  <i class="ti ti-route" style="font-size:10px"></i>
                  ${de(r).map(o=>o.label).join(" → ")}
                </div>
              </div>
            `).join("")}
          </div>
  ...
  `,i.querySelectorAll(".op-card").forEach(n=>{n.addEventListener("click",()=>{i.querySelectorAll(".op-card").forEach(s=>s.classList.remove("selected")),n.classList.add("selected"),S=n.dataset.op,wt(i,Y($e()),S)})}),S){const n=i.querySelector(`.op-card[data-op="${S}"]`);n&&n.classList.add("selected"),wt(i,t,S)}}function wt(e,t,i){var r;const a=e.querySelector("#svc-form-preview");if(!a)return;const n=(r=t==null?void 0:t.operations)==null?void 0:r.find(o=>o.id===i);if(!n)return;const s=de(n);a.innerHTML=`
    <div class="card mt-3">
      <div class="card-header">
        ...
        <div>
          ...
          <div class="workflow-timeline-h">
            ${s.map((o,l)=>`
              ...
              ${l<s.length-1?'<div class="wfh-arrow"></div>':""}
            `).join("")}
          </div>
        </div>
        <div>
  ...
  `,a.querySelector("#svc-start-form").addEventListener("click",()=>{A="form",ye={};const o=document.getElementById("page-portal");$(o)})}function Sa(e){var s;const t=Ze(E),i=$e(),a=Yt(i,S);if(!a||!t){A="service",$(e);return}const n=de(a);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
        <button class="btn" id="form-back"><i class="ti ti-arrow-left"></i> Back</button>
        <div class="psc-icon sm" style="background:${t.bg};color:${t.color}"><i class="ti ${t.icon}"></i></div>
        <div>
          <div class="page-title">${a.label}</div>
          <div class="page-subtitle">${t.name}${P?" — "+(((s=K.find(r=>r.id===P))==null?void 0:s.name)||""):""}</div>
        </div>
      </div>
    </div>
    ...
    <div class="grid-2" style="gap:16px">
        ...
        <div class="card" style="background:var(--clr-info-bg);border-color:var(--clr-info-border)">
          <div style="display:flex;align-items:flex-start;gap:10px">
            ...
            <div>
              ...
              ${a.agentChecks.map(r=>`<div style="font-size:11px;color:var(--color-text-secondary);padding:2px 0;display:flex;align-items:flex-start;gap:5px"><i class="ti ti-check" style="color:var(--clr-teal-text);font-size:10px;flex-shrink:0;margin-top:2px"></i>${r}</div>`).join("")}
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
            ...
            ${n.map((r,o)=>`
              <div class="wfv-step">
                ...
                <div class="wfv-content">
                  ...
                  ${xt(r.id,a)?`<div class="wfv-desc">${xt(r.id,a)}</div>`:""}
                </div>
              </div>
            `).join("")}
          </div>
        ...
        <div class="card">
          ...
          <code style="font-size:10px;font-family:var(--font-mono);color:var(--clr-info-text);word-break:break-all;line-height:1.6">${a.systemAction}</code>
        </div>
  ...
  `,e.querySelector("#form-back").addEventListener("click",()=>{A="service",$(e)}),e.querySelector("#form-submit").addEventListener("click",()=>Ea(e,a))}function ka(e){const t=e.required?" *":"",i=e.hint?`<div style="font-size:10px;color:var(--color-text-tertiary);margin-top:3px">${e.hint}</div>`:"";return e.type==="text"||e.type==="email"?`<div class="form-group" data-field="${e.id}">
      ...
      ${i}
    </div>`:""}function xt(e,t){return t.approvalPath,e==="submit"?"Request submitted with required details":e==="manager"?"Your direct manager reviews and approves":e==="it"?"IT team validates technical feasibility and security":e==="dataowner"?"Data/resource owner confirms access appropriateness":e==="agent"?`AI Agent validates: ${t.agentChecks[0]}, and ${t.agentChecks.length-1} more checks`:e==="action"?`Provisioning via: ${t.systemAction}`:e==="done"?"Email notification sent. Request available in My Requests.":""}function Ea(e,t){const i=e.querySelector("#dynamic-form");let a=!0;const n=[];if(t.fields.filter(r=>r.required).forEach(r=>{const o=i.querySelector(`#ff-${r.id}`);if(!o)return;(o.type==="checkbox"?o.checked:o.value.trim())||(a=!1,n.push(r.label),o.style.borderColor="var(--clr-danger-text)",o.addEventListener("input",()=>{o.style.borderColor=""},{once:!0}))}),t.fields.find(r=>r.id==="confirmation")){const r=i.querySelector("#ff-confirmation"),o=i.querySelector("#ff-groupName, #ff-siteUrl, #ff-currentName");if(r&&r.value.toUpperCase()!=="CONFIRM"&&!o&&r.value!=="CONFIRM"){a=!1,p("Type CONFIRM in the confirmation field to proceed.","error");return}}if(!a){p(`Please fill in required fields: ${n.slice(0,3).join(", ")}`,"error");return}t.fields.forEach(r=>{const o=i.querySelector(`#ff-${r.id}`);o&&(ye[r.id]=o.type==="checkbox"?o.checked:o.value)}),Kt++,A="submitted",$(e)}function Ca(e){var r,o;const t=Ze(E),i=$e(),a=Yt(i,S);if(!a||!t){A="landing",$(e);return}const n=de(a),s=`REQ-${String(Kt).padStart(4,"0")}`;e.innerHTML=`
    <div class="page-header">
    ...
    <div class="alert-banner success mb-3">
      ...
      <strong>${s}</strong> — ${a.label} request submitted successfully. You will be notified at each approval stage.
    </div>
    ...
    <div class="grid-2" style="gap:16px;margin-bottom:16px">
      <div class="card">
        ...
        <div style="display:grid;grid-template-columns:auto 1fr;gap:5px 16px;font-size:11px">
          ...
          <span class="monospace" style="font-weight:600;color:var(--clr-info-text)">${s}</span>
          ...
          ${n.map((l,c)=>`
            <div class="wfv-step">
              <div class="wfv-left">
                ...
                ${c<n.length-1?'<div class="wfv-line"></div>':""}
              </div>
              <div class="wfv-content">
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{A="landing",E=null,P=null,S=null,ye={},$(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{Gt(()=>Promise.resolve().then(()=>oi),void 0).then(l=>l.go("myreqs"))})}function Pa(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
  ...
  `)}const At={user:["What can I request?","How to create a Team?","Request SharePoint access","Request Copilot license"],manager:["Approve pending requests","Guest access policy","How to request a shared mailbox?","License request process"],admin:["M365 Config failures","Risky users summary","Zero Trust gaps","Portal service status"],super:["Graph API status","All service workflows","Failed CIS controls","Guest lifecycle policy"]},$a=[{keywords:["m365 config","cis","benchmark","compliance score"],response:`**M365 Config — CIS Benchmark v7.0.0**
...
Full details available in **Graph API** page (super admin only).`}],Ma=`I'm your **M365 AgentOps AI Copilot**. I can help you with:
...
- "What are the M365 Config failures?"`;let Ee=[],St=!1;function Ra(){const e=document.getElementById("page-chat");if(!e)return;const t=d.currentUser,i=At[t==null?void 0:t.role]||At.user;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="card" style="padding:0;overflow:hidden;display:flex;flex-direction:column;height:calc(100vh - 200px);min-height:400px">
      ...
      <div class="chat-suggestions" id="chat-suggestions">
        ${i.map(s=>`<button class="suggestion-pill" data-text="${s}">${s}</button>`).join("")}
      </div>
  ...
  `;const a=e.querySelector("#chat-messages"),n=e.querySelector("#chat-input");!St||Ee.length===0?(Ee=[],We("ai",Ma),St=!0):_e(a),e.querySelector("#chat-send").addEventListener("click",()=>De(e)),n.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),De(e))}),n.addEventListener("input",()=>{n.style.height="auto",n.style.height=Math.min(n.scrollHeight,120)+"px"}),e.querySelectorAll(".suggestion-pill").forEach(s=>{s.addEventListener("click",()=>{n.value=s.dataset.text,De(e)})})}function We(e,t){Ee.push({role:e,text:t,ts:new Date().toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"})})}function _e(e){e.innerHTML=Ee.map(t=>{var n;const i=t.role==="ai",a=Ia(t.text);return`
    ...
    `}).join(""),e.scrollTop=e.scrollHeight}function Ia(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/^#{1,3} (.+)$/gm,'<strong style="font-size:12px">$1</strong>').replace(/\|(.+)\|\n\|[-| ]+\|\n/g,t=>`<table style="width:100%;border-collapse:collapse;font-size:11px;margin:6px 0"><thead><tr>${t.split(`
`)[0].split("|").filter(a=>a.trim()).map(a=>`<th style="padding:4px 8px;font-size:10px">${a.trim()}</th>`).join("")}</tr></thead><tbody>`).replace(/\|(.+)\|(?!\n\|[-|])/g,t=>`<tr>${t.split("|").filter(a=>a.trim()).map(a=>`<td style="padding:3px 8px;border-top:1px solid var(--color-border-tertiary)">${a.trim()}</td>`).join("")}</tr>`).replace(/<\/tbody>(?![\s\S]*<\/tbody>)/g,"</tbody></table>").replace(/\n/g,"<br>").replace(/❌/g,'<span style="color:var(--clr-danger-text)">❌</span>').replace(/✅/g,'<span style="color:var(--clr-success-text)">✅</span>').replace(/⚠️/g,'<span style="color:var(--clr-warning-text)">⚠️</span>').replace(/🟢/g,'<span style="color:var(--clr-success-text)">●</span>')}function De(e){const t=e.querySelector("#chat-input"),i=t.value.trim();if(!i)return;We("user",i),t.value="",t.style.height="auto";const a=e.querySelector("#chat-messages");_e(a),setTimeout(()=>{const n=i.toLowerCase(),s=$a.find(o=>o.keywords.some(l=>n.includes(l))),r=(s==null?void 0:s.response)||Da(n);We("ai",r),_e(a)},500)}function Da(e){return e.includes("help")||e.includes("what")||e.includes("how")?`I'm here to help! I can answer questions about:
...
Try rephrasing your question or ask about a specific service name.`}function qa(){var t,i,a,n,s,r;const e=document.getElementById("page-graphapi");if(e){if(((t=d.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `}function C({id:e,checked:t,label:i,sublabel:a,onChange:n}){const s=document.createElement("div");s.className="toggle-wrap",s.innerHTML=`
    <label class="toggle-switch">
    ...
    <label for="${e}" class="toggle-label">
      ${i}
      ${a?`<div class="toggle-sublabel">${a}</div>`:""}
    </label>
  `;const r=s.querySelector("input");return r.addEventListener("change",()=>n(r.checked)),s}function Na(){const e=document.getElementById("page-settings");e&&Qt(e)}function Qt(e){const t=d.settings;e.innerHTML=`
    <div class="page-header">
  ...
  `;const i=C({id:"toggle-ps",checked:t.showPSCommands,label:"Show PowerShell validation commands",sublabel:"Displays the PowerShell command used for each control in the M365 Config topic view.",onChange:g=>{d.settings.showPSCommands=g,m(),Ie()}});e.querySelector("#settings-ps-wrap").appendChild(i);const a=C({id:"toggle-result",checked:t.showTenantResult,label:"Show simulated tenant result",sublabel:"Displays the simulated tenant scan result for each control.",onChange:g=>{d.settings.showTenantResult=g,m(),Ie()}});e.querySelector("#settings-result-wrap").appendChild(a);const n=C({id:"toggle-expand",checked:t.autoExpandFailed,label:"Auto-expand failed controls",sublabel:"Automatically opens the details panel for failed controls on topic load.",onChange:g=>{d.settings.autoExpandFailed=g,m()}});e.querySelector("#settings-expand-wrap").appendChild(n);const s=C({id:"toggle-alert-fail",checked:t.agentAlertOnFail,label:"Alert on new failures",sublabel:"Send email notification when agent detects new failed controls.",onChange:g=>{d.settings.agentAlertOnFail=g,m()}});e.querySelector("#settings-alert-fail-wrap").appendChild(s);const r=C({id:"toggle-graph-health",checked:t.showGraphHealth,label:"Show Graph API health on dashboard",onChange:g=>{d.settings.showGraphHealth=g,m()}});e.querySelector("#settings-graph-health-wrap").appendChild(r);const o=C({id:"toggle-zt-score",checked:t.showZeroTrustScore,label:"Show Zero Trust score on dashboard",onChange:g=>{d.settings.showZeroTrustScore=g,m()}});e.querySelector("#settings-zt-score-wrap").appendChild(o);const l=C({id:"toggle-cfg-score",checked:t.showM365ConfigScore,label:"Show M365 Config score on dashboard",onChange:g=>{d.settings.showM365ConfigScore=g,m()}});e.querySelector("#settings-cfg-score-wrap").appendChild(l);const c=C({id:"toggle-portal-master",checked:t.portalEnabled!==!1,label:"Self-Service Portal — Master Switch",sublabel:"Disable to prevent all users from accessing the portal globally.",onChange:g=>{d.settings.portalEnabled=g,m();const b=e.querySelector("#portal-services-section");b&&(b.style.opacity=g?"1":"0.4"),p(g?"Self-Service Portal enabled.":"Self-Service Portal disabled globally.",g?"success":"warning")}});e.querySelector("#settings-portal-master-wrap").appendChild(c);const u=e.querySelector("#portal-services-section");u&&(u.style.opacity=t.portalEnabled!==!1?"1":"0.4");const y=e.querySelector("#portal-main-toggles");Se.forEach(g=>{const b="portal_"+g.id.replace(/-/g,"_"),M=document.createElement("div");M.className="portal-svc-setting-row",M.innerHTML=`
      ...
      <div id="portal-toggle-${b}"></div>
    `,y.appendChild(M);const Me=C({id:`chk-${b}`,checked:t[b]!==!1,label:"",onChange:Re=>{d.settings[b]=Re,m()}});M.querySelector(`#portal-toggle-${b}`).appendChild(Me)});const Z=e.querySelector("#portal-exchange-toggles"),G={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};K.forEach(g=>{const b=G[g.id],M=document.createElement("div");M.className="portal-svc-setting-row",M.innerHTML=`
      <i class="ti ${g.icon}" style="color:var(--color-text-secondary)"></i>
      <span style="flex:1;font-size:11px;font-weight:500">${g.name}</span>
      <div id="portal-toggle-${b}"></div>
    `,Z.appendChild(M);const Me=C({id:`chk-${b}`,checked:t[b]!==!1,label:"",onChange:Re=>{d.settings[b]=Re,m()}});M.querySelector(`#portal-toggle-${b}`).appendChild(Me)}),e.querySelector("#settings-save").addEventListener("click",()=>{d.settings.agentSchedule=e.querySelector("#settings-schedule").value,d.settings.agentAlertEmail=e.querySelector("#settings-alert-email").value,m(),p("Settings saved successfully.","success")}),e.querySelector("#settings-reset").addEventListener("click",()=>{si(),Qt(e),p("Settings reset to defaults.","info"),Ie()})}function pe(){return d.mcMessages||(d.mcMessages=x.map(e=>({id:e.id,status:e.status,tasksCreated:!1}))),d.mcMessages}function I(e){var t;return((t=pe().find(i=>i.id===e))==null?void 0:t.status)||"new"}function kt(e,t){const i=pe().find(a=>a.id===e);i?i.status=t:pe().push({id:e,status:t,tasksCreated:!1}),m()}function Zt(e){var t;return((t=pe().find(i=>i.id===e))==null?void 0:t.tasksCreated)||!1}function Xt(e){const t=pe().find(i=>i.id===e);t&&(t.tasksCreated=!0),m()}let T="all",v={search:"",service:"all",category:"all",actionRequired:"all",status:"all"},_=new Set,F=!1;const Oa=[{id:"all",label:"All Messages",icon:"ti-inbox"},{id:"health",label:"Service Health",icon:"ti-heartbeat"},{id:"required",label:"Action Required",icon:"ti-alert-circle",badgeKey:"actionRequired"},{id:"upcoming",label:"Upcoming Changes",icon:"ti-calendar-event"},{id:"copilot",label:"Copilot",icon:"ti-sparkles"},{id:"licenses",label:"License Alerts",icon:"ti-license"},{id:"security",label:"Security",icon:"ti-shield-exclamation"}],Ga=["All Services","Exchange Online","Microsoft Teams","SharePoint Online","OneDrive","Microsoft Entra ID","Microsoft Intune","Microsoft Copilot","Power Platform","Microsoft Defender","Microsoft 365"],Fa=[{val:"all",label:"All Categories"},{val:"planForChange",label:"Plan for Change"},{val:"preventOrFixIssue",label:"Prevent or Fix Issue"},{val:"stayInformed",label:"Stay Informed"}];function Ua(){const e=document.getElementById("page-msgcenter");e&&(_=new Set,F=!1,ae(e))}function ae(e){var n;const t=x.filter(s=>s.actionRequired&&I(s.id)!=="actioned").length,i=x.filter(s=>I(s.id)==="new").length,a=D.filter(s=>s.status!=="resolved").length;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
        <div class="page-subtitle">
          Graph: /admin/serviceAnnouncement/messages · Last sync: Today at 08:45 · ${x.length} messages
        </div>
      </div>
      <div class="page-actions">
    ...
    <div class="kpi-row">
      ...
      <div class="kpi-tile">
        <div class="kpi-value warning">${x.filter(s=>s.severity==="high").length}</div>
        <div class="kpi-label">High Severity</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value info">${x.filter(s=>s.targetRelease).length}</div>
      ...
      <div class="kpi-tile">
        <div class="kpi-value success">${x.filter(s=>I(s.id)==="actioned").length}</div>
    ...
    <div class="tabs mc-tabs" id="mc-tabs">
      ${Oa.map(s=>{let r="";return s.id==="required"&&(r=`<span class="nav-badge red" style="margin-left:5px">${t}</span>`),s.id==="health"&&(r=a>0?`<span class="nav-badge red" style="margin-left:5px">${a}</span>`:'<span class="nav-badge green" style="margin-left:5px">All clear</span>'),s.id==="all"&&i>0&&(r=`<span class="nav-badge blue" style="margin-left:5px">${i} new</span>`),`<button class="tab-btn ${T===s.id?"active":""}" data-tab="${s.id}">
          <i class="ti ${s.icon}" style="margin-right:4px"></i>${s.label}${r}
        </button>`}).join("")}
    </div>
    ...
    <!-- Digest overlay -->
    ${F?_a():""}
  `,e.querySelectorAll("#mc-tabs .tab-btn").forEach(s=>{s.addEventListener("click",()=>{T=s.dataset.tab,_=new Set,ae(e)})}),e.querySelector("#mc-sync").addEventListener("click",()=>Va(e)),e.querySelector("#mc-digest").addEventListener("click",()=>{F=!F,ae(e)}),e.querySelector("#mc-create-tasks").addEventListener("click",()=>{x.filter(r=>r.actionRequired&&I(r.id)!=="actioned").forEach(r=>{Zt(r.id)||Xt(r.id)}),p(`${t} task groups created from action-required messages.`,"success")}),T==="health"?Wa(e):L(e),F&&((n=e.querySelector("#mc-digest-close"))==null||n.addEventListener("click",()=>{F=!1,ae(e)}))}function Ba(){let e=[...x];if(T==="required"&&(e=e.filter(t=>t.actionRequired&&I(t.id)!=="actioned")),T==="upcoming"&&(e=e.filter(t=>t.targetRelease)),T==="copilot"&&(e=e.filter(t=>t.service==="Microsoft Copilot"||t.tags.some(i=>i.toLowerCase().includes("copilot")||i.toLowerCase().includes("ai")))),T==="licenses"&&(e=e.filter(t=>t.tags.some(i=>i.toLowerCase().includes("licens")))),T==="security"&&(e=e.filter(t=>t.tags.some(i=>["security","mfa","authentication","defender","conditional access","zero trust"].includes(i.toLowerCase())))),v.search){const t=v.search.toLowerCase();e=e.filter(i=>i.id.toLowerCase().includes(t)||i.title.toLowerCase().includes(t)||i.aiSummary.toLowerCase().includes(t))}return v.service!=="all"&&(e=e.filter(t=>t.service===v.service)),v.category!=="all"&&(e=e.filter(t=>t.category===v.category)),v.actionRequired==="yes"&&(e=e.filter(t=>t.actionRequired)),v.actionRequired==="no"&&(e=e.filter(t=>!t.actionRequired)),v.status!=="all"&&(e=e.filter(t=>I(t.id)===v.status)),e}function L(e){const t=e.querySelector("#mc-content");if(!t)return;const i=Ba();t.innerHTML=`
    <!-- Filter bar -->
    <div class="filter-bar mc-filter-bar">
      <input type="text" class="form-input search" id="mc-search" placeholder="Search message ID, title, summary..." value="${v.search}" style="min-width:220px">
      <select class="form-select" id="mc-svc-filter">
        ${Ga.map(a=>`<option value="${a==="All Services"?"all":a}" ${v.service===(a==="All Services"?"all":a)?"selected":""}>${a}</option>`).join("")}
      </select>
      <select class="form-select" id="mc-cat-filter">
        ${Fa.map(a=>`<option value="${a.val}" ${v.category===a.val?"selected":""}>${a.label}</option>`).join("")}
      </select>
      <select class="form-select" id="mc-req-filter" style="min-width:140px">
        <option value="all" ${v.actionRequired==="all"?"selected":""}>All Messages</option>
        <option value="yes" ${v.actionRequired==="yes"?"selected":""}>Action Required</option>
        <option value="no" ${v.actionRequired==="no"?"selected":""}>No Action Needed</option>
      </select>
      <select class="form-select" id="mc-status-filter">
        ...
        <option value="read" ${v.status==="read"?"selected":""}>Read</option>
        <option value="actioned" ${v.status==="actioned"?"selected":""}>Actioned</option>
    ...
    <div style="font-size:10px;color:var(--color-text-tertiary);margin-bottom:10px">
      Showing ${i.length} of ${x.length} messages
    </div>

    <div id="mc-msg-list">
      ${i.length===0?'<div class="empty-state"><i class="ti ti-inbox-off" style="font-size:32px;margin-bottom:8px"></i><p>No messages match your filters.</p></div>':i.map(a=>za(a)).join("")}
    </div>
  `,t.querySelector("#mc-search").addEventListener("input",a=>{v.search=a.target.value,L(e)}),t.querySelector("#mc-svc-filter").addEventListener("change",a=>{v.service=a.target.value,L(e)}),t.querySelector("#mc-cat-filter").addEventListener("change",a=>{v.category=a.target.value,L(e)}),t.querySelector("#mc-req-filter").addEventListener("change",a=>{v.actionRequired=a.target.value,L(e)}),t.querySelector("#mc-status-filter").addEventListener("change",a=>{v.status=a.target.value,L(e)}),Ha(t,e)}function za(e){const t=k[e.service]||{icon:"ti-apps",color:"#185FA5",bg:"#E6F1FB"},i=I(e.id),a=_.has(e.id),n=Zt(e.id),s={high:'<span class="badge danger">High</span>',medium:'<span class="badge warning">Medium</span>',low:'<span class="badge neutral">Low</span>'}[e.severity]||"",r={planForChange:'<span class="badge info">Plan for Change</span>',preventOrFixIssue:'<span class="badge danger">Prevent / Fix Issue</span>',stayInformed:'<span class="badge neutral">Stay Informed</span>'}[e.category]||"",o={new:'<span class="mc-status-dot new"></span>',read:"",actioned:'<span class="badge success" style="font-size:9px">✓ Actioned</span>',dismissed:'<span class="badge neutral" style="font-size:9px">Dismissed</span>'}[i]||"";return`
    <div class="mc-card ${i}" data-id="${e.id}">
      ...
      <div class="mc-action-bar">
        <button class="btn btn-xs mc-expand-rec" data-id="${e.id}">
          <i class="ti ti-brain"></i> AI Recommendations ${a?'<i class="ti ti-chevron-up"></i>':'<i class="ti ti-chevron-down"></i>'}
        </button>
  ...
  `}function ja(e){const t=e.aiRec;return`
          ...
          <div style="display:flex;flex-direction:column;gap:5px;margin-bottom:12px">
            ${t.tasks.map((i,a)=>`
              <div style="display:flex;align-items:flex-start;gap:8px;font-size:11px;padding:5px 8px;background:var(--color-background-secondary);border-radius:var(--border-radius-sm);border:0.5px solid var(--color-border-tertiary)">
                <span style="width:16px;height:16px;border-radius:50%;background:var(--clr-info-bg);color:var(--clr-info-text);font-size:9px;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0">${a+1}</span>
  ...
  `}function Ha(e,t){e.querySelectorAll(".mc-expand-rec").forEach(i=>{i.addEventListener("click",()=>{const a=i.dataset.id;_.has(a)?_.delete(a):(_.add(a),kt(a,I(a)==="new"?"read":I(a))),L(t)})}),e.querySelectorAll(".mc-action-btn").forEach(i=>{i.addEventListener("click",a=>{a.stopPropagation();const{action:n,id:s}=i.dataset;kt(s,n),p({read:"Marked as read.",actioned:"Marked as actioned.",dismissed:"Message dismissed."}[n]||"Updated.",n==="actioned"?"success":"info"),ae(t)})}),e.querySelectorAll(".mc-create-task-btn").forEach(i=>{i.addEventListener("click",a=>{a.stopPropagation();const n=i.dataset.id;Xt(n),p(`Tasks created for ${n}. Check task tracker.`,"success"),L(t)})})}function Wa(e){const t=e.querySelector("#mc-content");if(!t)return;const i=D.filter(o=>o.status!=="resolved"),a=D.filter(o=>o.status==="resolved"),n=Object.keys(k).map(o=>{const l=D.find(y=>y.service===o&&y.status!=="resolved"),c=l?l.severity==="high"?"var(--clr-danger-text)":"var(--clr-warning-text)":"var(--clr-success-text)";l&&l.severity;const u=l?l.severity==="high"?"fail":"warn":"pass";return`
      <div class="mc-health-svc-tile" style="border-color:${l?"var(--color-border-secondary)":"var(--clr-success-border)"}">
        <div class="psc-icon" style="background:${k[o].bg};color:${k[o].color};width:28px;height:28px;font-size:13px;border-radius:6px">
          <i class="ti ${k[o].icon}"></i>
        </div>
        <div style="flex:1;min-width:0">
    ...
    `}).join(""),s={investigating:"Investigating",serviceDegradation:"Service degradation",serviceAdvisory:"Advisory",serviceInterruption:"Interrupted",resolved:"Resolved"},r={investigating:"danger",serviceDegradation:"warning",serviceAdvisory:"info",serviceInterruption:"danger",resolved:"success"};t.innerHTML=`
    <!-- Service health grid -->
    <div class="card mb-3">
      <div class="card-header">
    ...
    ${a.map(o=>Et(o,s,r)).join("")}
  `}function Et(e,t,i){const a=k[e.service]||{icon:"ti-apps",color:"#185FA5",bg:"#E6F1FB"};return`
    <div class="card mb-3" style="border-left:3px solid ${e.status==="resolved"?"var(--clr-success-text)":e.severity==="high"?"var(--clr-danger-text)":"var(--clr-warning-text)"}">
      <div class="mc-card-header" style="margin-bottom:8px">
        <div class="mc-svc-chip" style="background:${a.bg};color:${a.color}">
          <i class="ti ${a.icon}"></i> ${e.service}
        </div>
      ...
      ${e.updates.length>0?`
        ...
        ${e.updates.map(s=>`
          <div style="display:flex;gap:10px;padding:5px 0;border-bottom:0.5px solid var(--color-border-tertiary);font-size:11px">
            <span class="monospace" style="color:var(--color-text-tertiary);flex-shrink:0;min-width:52px">${s.time}</span>
            <span style="color:var(--color-text-secondary);line-height:1.4">${s.text}</span>
          </div>
        `).join("")}
      `:""}
    </div>
  `}function _a(){const e=xi;return`
    <div class="digest-overlay" id="mc-digest-overlay">
      <div class="digest-panel">
        ...
        <div class="digest-body">
          ...
          ${e.highlights.map(i=>{var a,n,s;return`
            <div style="display:flex;gap:10px;padding:8px 10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);margin-bottom:6px;border-left:3px solid ${i.severity==="high"?"var(--clr-danger-text)":"var(--clr-warning-text)"}">
              <div class="mc-svc-chip" style="background:${((a=k[i.service])==null?void 0:a.bg)||"#f0f0f0"};color:${((n=k[i.service])==null?void 0:n.color)||"#555"};flex-shrink:0">
                <i class="ti ${((s=k[i.service])==null?void 0:s.icon)||"ti-apps"}"></i> ${i.service}
              </div>
          ...
          ${x.filter(i=>i.actionRequired).slice(0,5).map(i=>`
          ...
          <div style="font-size:11px;color:var(--color-text-secondary);line-height:1.7">
            ${D.filter(i=>i.status!=="resolved").length===0?"✅ All Microsoft 365 services are operating normally.":D.filter(i=>i.status!=="resolved").map(i=>`⚠️ <strong>${i.service}</strong>: ${i.title}`).join("<br>")}
            <br>✅ ${D.filter(i=>i.status==="resolved").length} incidents resolved since last digest.
          </div>
...
→ **Applications → Secret & Certificate Expiry** for rotation roadmap.`}];let ge="executive",w={type:"all",status:"all",search:""},ne=[],$t=!1,j=[],H=[];const Ka=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"appregistrations",label:"App Registrations",icon:"ti-app-window"},{id:"enterprise",label:"Enterprise Apps",icon:"ti-grid-dots"},{id:"secrets",label:"Secrets & Certs",icon:"ti-lock"},{id:"permissions",label:"Permissions",icon:"ti-shield-check"},{id:"consents",label:"Admin Consents",icon:"ti-user-check"},{id:"owners",label:"Owners",icon:"ti-users"},{id:"usage",label:"Usage Analytics",icon:"ti-chart-line"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"lifecycle",label:"Lifecycle",icon:"ti-timeline"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"App Copilot",icon:"ti-robot"}];async function Ya(){const e=document.getElementById("page-applications");if(e){e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading real M365 application data...</p></div>';try{console.log("📡 Fetching real application data from backend...");const t=await bi(),i=await wi();t.success?(j=t.data||q,console.log(`✅ Loaded ${j.length} real applications from API`)):(console.warn("⚠️ Failed to fetch applications, using simulated data:",t.error),j=q),i.success?(H=i.data||be,console.log(`✅ Loaded ${H.length} real service principals from API`)):(console.warn("⚠️ Failed to fetch service principals, using simulated data"),H=be)}catch(t){console.error("❌ Error loading application data:",t),j=q,H=be}N(e)}}function N(e){var n,s;const t=O.filter(r=>r.status==="expiring").length,i=O.filter(r=>r.status==="expired").length,a=ue.filter(r=>r.severity==="critical").length;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-app-window"></i> Entra Applications</div>
        <div class="page-subtitle">Application Registrations & Enterprise Apps · ${ee.totalAppRegistrations} app registrations · Last sync: Today 08:45</div>
      </div>
      <div class="page-actions">
    ...
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
        <div class="kpi-value info">${ee.totalAppRegistrations}</div>
        <div class="kpi-label">App Registrations</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value info">${ee.totalEnterpriseApplications}</div>
      ...
      <div class="kpi-tile">
        <div class="kpi-value ${a>0?"danger":"warning"}">${a}</div>
        <div class="kpi-label">Critical Risk Apps</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value warning">${ee.highPrivilegeApps}</div>
    ...
    <div class="app-subnav" id="app-subnav">
      ${Ka.map(r=>`
        <button class="app-tab-btn ${ge===r.id?"active":""}" data-app-section="${r.id}">
          <i class="ti ${r.icon}"></i><span>${r.label}</span>
          ${r.id==="secrets"&&i+t>0?`<span class="app-tab-badge red">${i+t}</span>`:""}
          ${r.id==="risk"&&a>0?`<span class="app-tab-badge red">${a}</span>`:""}
  ...
  `,e.querySelectorAll(".app-tab-btn").forEach(r=>{r.addEventListener("click",()=>{ge=r.dataset.appSection,N(e)})}),(n=e.querySelector("#app-refresh"))==null||n.addEventListener("click",()=>{const r=e.querySelector("#app-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,p("Application inventory updated — 87 app registrations, 124 service principals scanned.","success")},2200)}),(s=e.querySelector("#app-audit"))==null||s.addEventListener("click",()=>p("Application audit exported as CSV.","success")),cs(e)}function Qa(){return({executive:Mt,appregistrations:Za,enterprise:Xa,secrets:es,permissions:ts,consents:is,owners:as,usage:ss,risk:ns,lifecycle:rs,recommendations:os,copilot:ls}[ge]||Mt)()}function Mt(){const e=ee,t=O.filter(s=>s.status==="expiring").length,i=O.filter(s=>s.status==="expired").length,a=ue.filter(s=>s.severity==="critical").length,n=se.filter(s=>s.status==="unused").length;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-header">
          <span class="card-title"><i class="ti ti-app-window"></i> Application Inventory</span>
        </div>
        ${Rt([{label:"Total App Registrations",val:e.totalAppRegistrations,cls:"info"},{label:"Enterprise Applications",val:e.totalEnterpriseApplications,cls:"info"},{label:"Multi-Tenant Apps",val:e.multiTenantApps,cls:"warning"},{label:"High Privilege Apps",val:e.highPrivilegeApps,cls:"danger"},{label:"Certificate-Based",val:e.certificateBasedApps,cls:"success"},{label:"Unused (90+ days)",val:n,cls:"warning"}])}
      </div>
      ...
      <div class="card">
        ...
        ${Rt([{label:"Expired Secrets",val:i,cls:"danger"},{label:"Expiring (30 days)",val:t,cls:"warning"},{label:"Expiring (60 days)",val:e.expiringSecrets60d,cls:"warning"},{label:"Apps Requiring Admin Consent",val:e.appsRequiringConsent,cls:"warning"}])}
      </div>
    </div>
    ...
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-header">
          ...
          <span class="badge danger dot">${a} critical</span>
        </div>
        ${ue.slice(0,5).map(s=>`
          <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:0.5px solid var(--color-border-tertiary)">
            <span class="badge ${s.severity==="critical"?"danger":s.severity==="high"?"warning":"info"}" style="min-width:72px">${s.riskScore}/100</span>
            <div style="flex:1;min-width:0">
              <div style="font-size:11px;font-weight:600;overflow:hidden;text-overflow:ellipsis">${s.appName}</div>
              <div style="font-size:10px;color:var(--color-text-tertiary)">${s.risks.slice(0,2).join(" · ")}</div>
            </div>
            <span class="badge ${s.severity==="critical"?"danger":"warning"}" style="flex-shrink:0">${s.severity}</span>
          </div>
        `).join("")}
      ...
      <div class="card">
        ...
        ${Xe.filter(s=>s.priority==="critical").slice(0,4).map(s=>`
          <div style="display:flex;align-items:flex-start;gap:8px;padding:6px 0;border-bottom:0.5px solid var(--color-border-tertiary)">
            <span class="badge danger" style="flex-shrink:0;font-size:9px;min-width:56px;justify-content:center">${s.priority}</span>
            <div style="flex:1">
              <div style="font-size:11px;font-weight:600;line-height:1.3">${s.title}</div>
              <div style="font-size:10px;color:var(--color-text-tertiary)">${s.app}</div>
            </div>
          </div>
        `).join("")}
  ...
  `}function Za(){const e=j.length>0?j:q,t=e.filter(a=>!(w.type!=="all"&&a.category!==w.type||w.status!=="all"&&a.status!==w.status||w.search&&!a.name.toLowerCase().includes(w.search.toLowerCase()))),i=[...new Set(e.map(a=>a.category))];return`
    <div class="filter-bar mb-3">
      <input type="text" class="form-input" id="app-search" placeholder="Search app name..." value="${w.search}" style="min-width:200px">
      <select class="form-select" id="app-type-filter">
        <option value="all">All Categories</option>
        ${i.map(a=>`<option value="${a}" ${w.type===a?"selected":""}>${a}</option>`).join("")}
      </select>
      <select class="form-select" id="app-status-filter">
        <option value="all" ${w.status==="all"?"selected":""}>All Status</option>
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        ...
        <tbody>
          ${t.map(a=>`
            <tr>
              <td style="font-weight:600">${a.name}${a.risk?` <span class="badge danger" style="font-size:8px">${a.risk}</span>`:""}</td>
              <td><code style="font-size:10px;color:var(--clr-info-text)">${a.appId.substring(0,8)}...</code></td>
              <td style="font-size:11px">${a.created}</td>
              <td style="font-size:10px">${a.owners.length===0?'<span class="badge danger">No owner</span>':a.owners.join(", ")}</td>
              <td><span class="pill">${a.type}</span></td>
              <td><span class="badge ${a.status==="active"?"success":"warning"}">${a.status}</span></td>
              <td style="text-align:center;font-size:16px">${a.risk==="critical"?"🔴":a.risk==="high"?"🟠":"🟢"}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    </div>
  `}function Xa(){const e=H.length>0?H:be;return`
    <div class="filter-bar mb-3">
  ...
  `}function es(){const e=O.filter(a=>a.status==="expired"),t=O.filter(a=>a.status==="expiring"),i=O.filter(a=>a.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
        ...
        <div class="card" style="padding:0;overflow:hidden">
          <table style="width:100%;font-size:11px">
            ...
            <tbody>
              ${e.map(a=>`
                <tr>
                  <td style="font-weight:600">${a.appName}</td>
                  <td><span class="pill">${a.type}</span></td>
                  <td style="color:var(--clr-danger-text);font-weight:600">${a.expiryDate}</td>
                  <td style="color:var(--clr-danger-text);font-weight:700">${Math.abs(a.daysRemaining)} days overdue</td>
                  <td><span class="badge warning">${a.rotation}</span></td>
    ...
    <div style="margin-bottom:16px">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <table style="width:100%;font-size:11px">
          ...
          <tbody>
            ${t.map(a=>{const n=a.daysRemaining<30?"danger":a.daysRemaining<60?"warning":"success";return`
                <tr>
                  <td style="font-weight:600">${a.appName}</td>
                  <td><span class="pill">${a.type}</span></td>
                  <td>${a.expiryDate}</td>
                  <td style="color:var(--clr-${n}-text);font-weight:700">${a.daysRemaining} days</td>
                  <td><span class="badge ${n}">${a.rotation}</span></td>
    ...
    <div>
      ...
      ${i.map(a=>`
        <div style="display:flex;align-items:center;gap:10px;padding:8px 10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);margin-bottom:5px;font-size:11px">
          ...
          <span style="flex:1">${a.appName}</span>
          <span style="color:var(--color-text-tertiary)">${a.type}</span>
          <span style="color:var(--clr-success-text);font-weight:600">${a.daysRemaining} days</span>
        </div>
      `).join("")}
    </div>
  `}function ts(){const e=Ct.filter(i=>i.riskLevel==="critical"),t=Ct.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
    ...
    ${e.map(i=>`
      <div class="card mb-2">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:4px">
          ${i.permissions.map(a=>`<code style="background:var(--clr-danger-bg);color:var(--clr-danger-text);padding:3px 6px;border-radius:4px;font-size:10px;font-family:monospace">${a}</code>`).join("")}
        </div>
    ...
    ${t.map(i=>`
      <div class="card mb-2">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:4px;font-size:10px">
          ${i.permissions.map(a=>`<code style="background:var(--clr-warning-bg);color:var(--clr-warning-text);padding:2px 5px;border-radius:3px;font-family:monospace">${a}</code>`).join("")}
        </div>
      </div>
    `).join("")}
  `}function is(){const e=Pt.filter(i=>i.scope==="Tenant-wide"),t=Pt.filter(i=>i.scope==="User");return`
    <div class="alert-banner warning mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    ${e.map(i=>`
      <div class="card mb-2" style="border-left:3px solid ${i.riskAlert?"var(--clr-danger-text)":"var(--color-border-secondary)"}">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:8px">
          ${i.permissions.split(", ").map(a=>`<code style="background:var(--color-background-secondary);padding:2px 6px;border-radius:3px;font-size:10px">${a}</code>`).join("")}
        </div>
      </div>
    `).join("")}
    ...
    `).join("")}
  `}function as(){const e=q.filter(a=>a.owners.length===0),t=q.filter(a=>a.owners.length===1),i=q.filter(a=>a.owners.length>1);return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <table style="width:100%;font-size:11px">
          ...
          <tbody>
            ${e.map(a=>`
              <tr>
                <td style="font-weight:700;color:var(--clr-danger-text)">${a.name}</td>
                <td>${a.created}</td>
                <td><span class="badge warning">${a.status}</span></td>
    ...
    ${t.slice(0,5).map(a=>`
      <div style="display:flex;align-items:center;justify-content:space-between;padding:8px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);margin-bottom:4px;font-size:11px">
        <div>
          ...
          <div style="color:var(--color-text-tertiary)">Owner: ${a.owners[0]}</div>
        </div>
    ...
    ${i.map(a=>`
      <div style="display:flex;align-items:center;justify-content:space-between;padding:8px;background:var(--clr-success-bg);border-radius:var(--border-radius-md);margin-bottom:4px;font-size:11px">
        <div>
          <div style="font-weight:600">${a.name}</div>
          <div style="color:var(--color-text-tertiary)">${a.owners.join(", ")}</div>
        </div>
      </div>
    `).join("")}
  `}function ss(){const e=se.filter(a=>a.status==="active"),t=se.filter(a=>a.status==="lowuse"),i=se.filter(a=>a.status==="unused");return`
    ...
    ${e.map(a=>`
      <div class="card mb-2">
        ...
        <div class="grid-2" style="gap:12px;font-size:10px;margin-top:8px">
          <div>
            <div style="color:var(--color-text-tertiary)">Last Sign-in</div>
            <div style="font-weight:600">${a.lastSignIn}</div>
          </div>
          <div>
            <div style="color:var(--color-text-tertiary)">Sign-ins (30d)</div>
            <div style="font-weight:600">${a.signInCount30d.toLocaleString()}</div>
          </div>
          <div>
            <div style="color:var(--color-text-tertiary)">Active Users</div>
            <div style="font-weight:600">${a.activeUsers30d}</div>
          </div>
          <div>
            <div style="color:var(--color-text-tertiary)">Failed Sign-ins</div>
            <div style="color:var(--clr-warning-text);font-weight:600">${a.failedSignins}</div>
          </div>
        </div>
      </div>
    `).join("")}
    ...
    ${i.map(a=>`
      <div class="alert-banner warning mb-2">
        ...
        <div>
          <div style="font-weight:700">${a.appName}</div>
          <div style="font-size:10px">Last sign-in: ${a.lastSignIn}</div>
        </div>
      </div>
    `).join("")}
  `}function ns(){const e=ue.filter(i=>i.severity==="critical"),t=ue.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    ${e.map(i=>`
      <div class="card mb-2" style="border-left:3px solid var(--clr-danger-text)">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:4px">
          ${i.risks.map(a=>`<span class="badge danger" style="font-size:9px">${a}</span>`).join("")}
        </div>
      </div>
    `).join("")}
    ...
    `).join("")}
  `}function rs(){const e=q.filter(a=>{const n=new Date(a.created),s=new Date(Date.now()-30*24*60*60*1e3);return n>s}),t=q.filter(a=>a.owners.length===0||a.status==="inactive"&&a.risk==="critical"),i=se.filter(a=>a.status==="unused");return`
    ...
    ${e.length===0?'<p style="font-size:11px;color:var(--color-text-tertiary)">No new applications created.</p>':`
      ${e.map(a=>`
        <div style="padding:10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);margin-bottom:8px">
          ...
          <div style="font-size:10px;color:var(--color-text-tertiary)">Created ${a.created} · Owners: ${a.owners.length>0?a.owners.join(", "):"NONE"}</div>
        </div>
      `).join("")}
    `}
    ...
    ${t.map(a=>`
      <div class="alert-banner danger mb-2">
        <i class="ti ti-alert-triangle"></i>
        <span><strong>${a.name}</strong> — no owner, unused, or expired credentials</span>
      </div>
    `).join("")}
  ...
  `}function ls(){(!$t||ne.length===0)&&(ne=[{role:"ai",text:`**Applications & App Registrations Copilot** — Ask me about app security, secrets, permissions, risks, and more.

Current state: **87 app registrations**, **124 enterprise apps**, **5 expiring secrets (30d)**, **2 critical risk apps**`}],$t=!0);const e=["Show expiring secrets","Which apps have Directory.ReadWrite.All?","List apps without owners","Show high-risk applications","Unused apps (90+ days)","Multi-tenant applications"];return`
  ...
  `}function Rt(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ${e.map(t=>`
    ...
    `).join("")}
  </div>`}function cs(e){var n,s,r,o,l;const t=e.querySelector("#app-content");if(!t)return;(n=t.querySelector("#app-search"))==null||n.addEventListener("input",c=>{w.search=c.target.value,N(e)}),(s=t.querySelector("#app-type-filter"))==null||s.addEventListener("change",c=>{w.type=c.target.value,N(e)}),(r=t.querySelector("#app-status-filter"))==null||r.addEventListener("change",c=>{w.status=c.target.value,N(e)}),(o=t.querySelector("#exec-view-risk"))==null||o.addEventListener("click",()=>{ge="risk",N(e)}),(l=t.querySelector("#exec-view-recs"))==null||l.addEventListener("click",()=>{ge="recommendations",N(e)});const i=t.querySelector("#app-cop-send"),a=t.querySelector("#app-cop-input");i&&a&&(i.addEventListener("click",()=>qe(e,a)),a.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),qe(e,a))})),t.querySelectorAll(".app-cop-pill").forEach(c=>{c.addEventListener("click",()=>{const u=t.querySelector("#app-cop-input");u&&(u.value=c.dataset.q,qe(e,u))})})}function qe(e,t){const i=t.value.trim();if(!i)return;ne.push({role:"user",text:i}),t.value="";const a=e.querySelector("#app-cop-msgs");a&&(a.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,a.scrollTop=a.scrollHeight),setTimeout(()=>{const n=i.toLowerCase(),s=Ja.find(o=>o.keywords.some(l=>n.includes(l))),r=(s==null?void 0:s.response)||`Searching application data for **"${i}"**...

Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;ne.push({role:"ai",text:r}),a&&(a.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
      ...
      </div>`,a.scrollTop=a.scrollHeight)},600)}function ei(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}const V={totalManagedDevices:847,activeDevices:821,inactiveDevices:26,nonCompliant:15,unmanaged:34,corporateDevices:620,byodDevices:227,deviceHealthScore:74,compliancePercentage:98.2,encryptionCoverage:95.7,patchCompliance:87.4,endpointProtection:94.2},ds={windows:{count:512,percentage:60.4,compliant:498,nonCompliant:14},macos:{count:187,percentage:22.1,compliant:186,nonCompliant:1},ios:{count:92,percentage:10.9,compliant:91,nonCompliant:1},android:{count:42,percentage:5,compliant:40,nonCompliant:2},linux:{count:14,percentage:1.6,compliant:14,nonCompliant:0}},Ve=[{id:"policy-001",name:"Windows 11 Standard",assignedDevices:512,compliant:498,nonCompliant:14,pending:0,coverage:100},{id:"policy-002",name:"macOS Security Policy",assignedDevices:187,compliant:186,nonCompliant:1,pending:0,coverage:100},{id:"policy-003",name:"iOS Device Policy",assignedDevices:92,compliant:91,nonCompliant:1,pending:0,coverage:100},{id:"policy-004",name:"Android Security Policy",assignedDevices:42,compliant:40,nonCompliant:2,pending:0,coverage:100}],Je=[{id:"DEV-001",name:"LAPTOP-CHEN-001",type:"Windows",manufacturer:"Dell",model:"XPS 13",osVersion:"23H2",lastSync:"2 hours ago",owner:"Chen Wei",compliance:"compliant",encryption:!0,patched:!0,riskLevel:"low"},{id:"DEV-002",name:"LAPTOP-AISHA-001",type:"macOS",manufacturer:"Apple",model:"MacBook Pro 16",osVersion:"14.5",lastSync:"1 hour ago",owner:"Aisha Raza",compliance:"compliant",encryption:!0,patched:!0,riskLevel:"low"},{id:"DEV-003",name:"SURFACE-PRIYA-001",type:"Windows",manufacturer:"Microsoft",model:"Surface Laptop 5",osVersion:"22H2",lastSync:"45 min ago",owner:"Priya Kumar",compliance:"non-compliant",encryption:!1,patched:!1,riskLevel:"high"},{id:"DEV-004",name:"IPHONE-USER-045",type:"iOS",manufacturer:"Apple",model:"iPhone 15 Pro",osVersion:"17.5",lastSync:"Today",owner:"BYOD User",compliance:"compliant",encryption:!0,patched:!0,riskLevel:"low"},{id:"DEV-005",name:"ANDROID-USER-023",type:"Android",manufacturer:"Samsung",model:"Galaxy S24",osVersion:"14",lastSync:"3 days ago",owner:"BYOD User",compliance:"non-compliant",encryption:!0,patched:!1,riskLevel:"medium"},{id:"DEV-006",name:"LAPTOP-UNUSED-001",type:"Windows",manufacturer:"HP",model:"EliteBook 850",osVersion:"21H2",lastSync:"45 days ago",owner:"Former Employee",compliance:"non-compliant",encryption:!1,patched:!1,riskLevel:"critical"},{id:"DEV-007",name:"MAC-CONTRACTOR-001",type:"macOS",manufacturer:"Apple",model:"MacBook Air M2",osVersion:"13.4",lastSync:"120 days ago",owner:"Contractor",compliance:"non-compliant",encryption:!0,patched:!1,riskLevel:"critical"},{id:"DEV-008",name:"SURFACE-GO-LAB-001",type:"Windows",manufacturer:"Microsoft",model:"Surface Go 3",osVersion:"22H2",lastSync:"6 hours ago",owner:"Lab",compliance:"compliant",encryption:!0,patched:!0,riskLevel:"low"}],ps={antivirus:{defenderEnabled:821,realTimeProtection:819,cloudProtection:815,coverage:96.9},firewall:{enabled:812,coverage:95.9},asr:{coverage:69.3},smartscreen:{coverage:82.8}},R={criticalUpdatesMissing:23,securityUpdatesMissing:58,compliancePercentage:87.4,avgDaysBehind:8,devices:[{name:"LAPTOP-UNUSED-001",missingUpdates:47,daysBehind:92,severity:"critical"},{name:"MAC-CONTRACTOR-001",missingUpdates:23,daysBehind:120,severity:"critical"},{name:"SURFACE-PRIYA-001",missingUpdates:12,daysBehind:15,severity:"high"},{name:"ANDROID-USER-023",missingUpdates:5,daysBehind:60,severity:"high"}]},us=[{id:"app-001",name:"Microsoft Office 365",deployedDevices:847,outdated:0,unauthorized:0,status:"compliant"},{id:"app-002",name:"Microsoft Teams",deployedDevices:821,outdated:8,unauthorized:0,status:"warning"},{id:"app-003",name:"Microsoft Defender",deployedDevices:821,outdated:0,unauthorized:0,status:"compliant"},{id:"app-004",name:"Adobe Creative Cloud",deployedDevices:234,outdated:12,unauthorized:3,status:"warning"},{id:"app-005",name:"VLC Media Player",deployedDevices:15,outdated:0,unauthorized:15,status:"risk"},{id:"app-006",name:"Slack",deployedDevices:412,outdated:0,unauthorized:12,status:"warning"}],ve=[{deviceId:"DEV-003",deviceName:"SURFACE-PRIYA-001",riskScore:78,severity:"high",risks:["Missing encryption","Unpatched OS","Non-compliant"],owner:"Priya Kumar"},{deviceId:"DEV-006",deviceName:"LAPTOP-UNUSED-001",riskScore:95,severity:"critical",risks:["Not synced 45 days","Missing 47 updates","No BitLocker","Non-compliant"],owner:"Former Employee"},{deviceId:"DEV-007",deviceName:"MAC-CONTRACTOR-001",riskScore:92,severity:"critical",risks:["Not synced 120 days","Missing 23 updates","Non-compliant"],owner:"Contractor"},{deviceId:"DEV-005",deviceName:"ANDROID-USER-023",riskScore:62,severity:"medium",risks:["Missing 5 updates","Non-compliant","60 days inactive"],owner:"BYOD User"}],gs=[{id:"ca-001",name:"Require Compliant Device - All Users",enabled:!0,enforcedDevices:821,nonCompliantBlocked:26,coverage:96.9},{id:"ca-002",name:"Block Unmanaged Devices",enabled:!0,blockedDevices:34,coverage:100},{id:"ca-003",name:"Require MFA + Compliant Device",enabled:!0,enforcedDevices:621,coverage:73.3},{id:"ca-004",name:"Require Hybrid Joined Devices",enabled:!1,coverage:0}],It=[{id:"config-001",name:"Windows 11 Security Baseline",assigned:512,compliant:498,nonCompliant:14,conflicts:0},{id:"config-002",name:"Microsoft Defender Configuration",assigned:821,compliant:815,nonCompliant:6,conflicts:2},{id:"config-003",name:"Password Policy - 14 Characters",assigned:847,compliant:789,nonCompliant:58,conflicts:1},{id:"config-004",name:"Browser Security Policy",assigned:621,compliant:601,nonCompliant:20,conflicts:0}],vs={windowsBaseline:{compliant:498,partiallyCompliant:12,nonCompliant:2,score:96},defenderBaseline:{compliant:815,partiallyCompliant:4,nonCompliant:2,score:99},edgeBaseline:{compliant:456,partiallyCompliant:45,nonCompliant:34,score:87},msAppsBaseline:{compliant:821,partiallyCompliant:18,nonCompliant:8,score:98}},Te=[{deviceId:"DEV-001",name:"LAPTOP-CHEN-001",encryptionScore:100,complianceScore:100,patchScore:95,epScore:98,healthScore:98,riskLevel:"low"},{deviceId:"DEV-002",name:"LAPTOP-AISHA-001",encryptionScore:100,complianceScore:100,patchScore:98,epScore:96,healthScore:98,riskLevel:"low"},{deviceId:"DEV-003",name:"SURFACE-PRIYA-001",encryptionScore:0,complianceScore:45,patchScore:32,epScore:78,healthScore:39,riskLevel:"high"},{deviceId:"DEV-006",name:"LAPTOP-UNUSED-001",encryptionScore:0,complianceScore:20,patchScore:5,epScore:45,healthScore:17,riskLevel:"critical"}],et=[{id:"rec-001",priority:"critical",title:"Enable BitLocker on SURFACE-PRIYA-001",category:"Encryption",impact:"Security",effort:"low",status:"open"},{id:"rec-002",priority:"critical",title:"Decommission LAPTOP-UNUSED-001 (45 days inactive)",category:"Lifecycle",impact:"Risk",effort:"low",status:"open"},{id:"rec-003",priority:"critical",title:"Patch 23 devices with critical updates",category:"Patching",impact:"Security",effort:"medium",status:"open"},{id:"rec-004",priority:"high",title:"Deploy ASR rules to 260 devices",category:"Endpoint Protection",impact:"Security",effort:"high",status:"open"},{id:"rec-005",priority:"high",title:"Enable SmartScreen on 146 devices",category:"Endpoint Protection",impact:"Security",effort:"low",status:"open"},{id:"rec-006",priority:"high",title:"Assign compliance policy to 34 unmanaged devices",category:"Compliance",impact:"Governance",effort:"low",status:"open"},{id:"rec-007",priority:"medium",title:"Update Teams app on 8 devices",category:"App Management",impact:"Stability",effort:"low",status:"open"},{id:"rec-008",priority:"medium",title:"Review and remove 15 unauthorized applications",category:"App Management",impact:"Security",effort:"medium",status:"open"},{id:"rec-009",priority:"medium",title:"Create Fast update ring for 200 pilot devices",category:"Patching",impact:"Testing",effort:"high",status:"open"},{id:"rec-010",priority:"medium",title:"Enforce Hybrid Join for corporate devices",category:"Device Management",impact:"Security",effort:"high",status:"open"}],ms=[{keywords:["device health","health score","device posture"],response:`**Device Health Assessment — Tenant Overview**
...
→ **Intune → Endpoint Security → Windows Firewall** to configure policy.`}];let Ke="executive",Ce=[],Dt=!1,re=[],oe=[];const ys=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"health",label:"Device Health",icon:"ti-heartbeat"},{id:"compliance",label:"Compliance",icon:"ti-check-circle"},{id:"inventory",label:"Device Inventory",icon:"ti-device-laptop"},{id:"security",label:"Endpoint Security",icon:"ti-shield-check"},{id:"patches",label:"Patch Management",icon:"ti-refresh"},{id:"apps",label:"Applications",icon:"ti-app-window"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"policies",label:"Policies",icon:"ti-settings-2"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Intune Copilot",icon:"ti-robot"}];async function fs(){const e=document.getElementById("page-intune");if(!e)return;e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading real M365 device data...</p></div>',console.log("📡 Fetching real device data from backend...");const t=await Ft(),i=await fi();t.success?(re=t.data||Je,console.log(`✅ Loaded ${re.length} real devices from API`)):(console.warn("⚠️ Failed to fetch devices, using simulated data:",t.error),p(`Device data unavailable: ${t.error}. Using demo data.`,"warning"),re=Je),i.success?(oe=i.data||Ve,console.log(`✅ Loaded ${oe.length} real policies from API`)):(console.warn("⚠️ Failed to fetch policies, using simulated data"),oe=Ve),ti(e)}function ti(e){var n,s;const t=V,i=ve.filter(r=>r.severity==="critical").length,a=ve.filter(r=>r.severity==="high").length;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="kpi-row mb-3">
      ...
      <div class="kpi-tile">
        ...
        <div style="font-size:10px;margin-top:3px;color:var(--color-text-tertiary)">${R.criticalUpdatesMissing} critical</div>
      </div>
      <div class="kpi-tile">
      ...
      <div class="kpi-tile">
        <div class="kpi-value ${i>0?"danger":"warning"}">${i+a}</div>
    ...
    <div class="intune-subnav" id="intune-subnav">
      ${ys.map(r=>`
        <button class="intune-tab-btn ${Ke===r.id?"active":""}" data-intune-section="${r.id}">
          <i class="ti ${r.icon}"></i><span>${r.label}</span>
          ...
          ${r.id==="patches"&&R.criticalUpdatesMissing>0?`<span class="intune-tab-badge red">${R.criticalUpdatesMissing}</span>`:""}
          ${r.id==="recommendations"?`<span class="intune-tab-badge amber">${et.length}</span>`:""}
        </button>
      `).join("")}
    </div>

    <!-- Content -->
    <div id="intune-content" style="margin-top:16px">${hs()}</div>
  `,e.querySelectorAll(".intune-tab-btn").forEach(r=>{r.addEventListener("click",()=>{Ke=r.dataset.intuneSection,ti(e)})}),(n=e.querySelector("#intune-refresh"))==null||n.addEventListener("click",()=>{const r=e.querySelector("#intune-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,p("Intune inventory updated — 847 devices scanned, 4 compliance policies evaluated.","success")},2200)}),(s=e.querySelector("#intune-remediate"))==null||s.addEventListener("click",()=>p("Remediation workflow initiated — ${criticalRisks} critical devices tagged for action.","info")),Ms(e)}function hs(){return({executive:qt,health:bs,compliance:ws,inventory:xs,security:As,patches:Ss,apps:ks,risk:Es,policies:Cs,recommendations:Ps,copilot:$s}[Ke]||qt)()}function qt(){const e=V,t=ds;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-header">
          <span class="card-title"><i class="ti ti-layout-dashboard"></i> Device Overview</span>
        </div>
        ${ii([{label:"Total Managed",val:e.totalManagedDevices,cls:"info"},{label:"Active",val:e.activeDevices,cls:"success"},{label:"Inactive",val:e.inactiveDevices,cls:"warning"},{label:"Non-Compliant",val:e.nonCompliant,cls:"danger"},{label:"Unmanaged",val:e.unmanaged,cls:"warning"},{label:"Corporate / BYOD",val:`${e.corporateDevices} / ${e.byodDevices}`,cls:"info"}])}
      </div>
      ...
      <div class="card">
        ...
        ${["windows","macos","ios","android","linux"].map(i=>{const a=t[i];return`
            <div style="margin-bottom:10px">
              ...
              <div class="score-bar" style="height:8px">
                <div class="score-bar-fill" style="width:${a.percentage}%"></div>
              </div>
              <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:2px">${a.compliant} compliant · ${a.nonCompliant} non-compliant</div>
            </div>
          `}).join("")}
      </div>
    </div>
    ...
    <div class="card mb-3">
      ...
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
        <span><strong>${ve.filter(i=>i.severity==="critical").length} critical risk devices</strong> require immediate attention</span>
      </div>
      ${ve.filter(i=>i.severity==="critical").map(i=>`
    ...
    <div class="grid-2" style="gap:16px">
      <div class="card">
        ...
        ${["windowsBaseline","defenderBaseline","edgeBaseline","msAppsBaseline"].map((i,a)=>{const n=vs[i];return`
            <div style="margin-bottom:10px">
              <div style="display:flex;justify-content:space-between;margin-bottom:4px;font-size:11px;font-weight:600">
                <span>${["Windows","Defender","Edge","M365 Apps"][a]}</span>
      ...
      <div class="card">
        ...
        ${et.filter(i=>i.priority==="critical").slice(0,4).map(i=>`
  ...
  `}function bs(){const e=V;return Math.round(Te.reduce((t,i)=>t+i.healthScore,0)/Te.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function ws(){return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
        <div class="kpi-value success">${V.compliancePercentage}%</div>
      ...
      <div class="kpi-tile">
        <div class="kpi-value danger">${V.nonCompliant}</div>
      ...
      <div class="kpi-tile">
        <div class="kpi-value warning">${V.unmanaged}</div>
  ...
  `}function xs(){return`
    ...
    <div class="card" style="padding:0;overflow:hidden">
      <table style="font-size:11px">
        ...
        <tbody>
          ${(re.length>0?re:Je).slice(0,50).map(e=>`
            <tr>
  ...
  `}function As(){const e=ps;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-title mb-3"><i class="ti ti-shield-check"></i> Antivirus & Firewall</div>
        ${ii([{label:"Defender Enabled",val:e.antivirus.defenderEnabled,cls:"success"},{label:"Real-Time Protection",val:e.antivirus.realTimeProtection,cls:"success"},{label:"Cloud Protection",val:e.antivirus.cloudProtection,cls:"success"},{label:"Firewall Enabled",val:e.firewall.enabled,cls:"success"}])}
      </div>
  ...
  `}function Ss(){return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
      <span><strong>${R.criticalUpdatesMissing} devices missing critical updates</strong> — schedule patching immediately</span>
    </div>

    <div class="kpi-row mb-3">
      <div class="kpi-tile">
        <div class="kpi-value warning">${R.compliancePercentage}%</div>
        <div class="kpi-label">Patch Compliance</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value danger">${R.criticalUpdatesMissing}</div>
        <div class="kpi-label">Critical Updates</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value warning">${R.securityUpdatesMissing}</div>
        <div class="kpi-label">Security Updates</div>
      </div>
      <div class="kpi-tile">
        <div class="kpi-value info">${R.avgDaysBehind}</div>
  ...
  `}function Es(){return`
    ...
    `).join("")}
  `}function Cs(){return`
    <div class="section-heading">Configuration Policies (${It.length})</div>
    ${It.map(e=>`
      <div style="padding:10px;background:var(--color-background-secondary);border-radius:var(--border-radius-md);margin-bottom:8px">
  ...
  `}function $s(){Dt||(Ce=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.

**Current state:** 847 managed devices, 98.2% compliant, 74/100 health score, 2 critical risks`}],Dt=!0);const e=["Show device health summary","Patch management status","Encryption coverage","Firewall & protection status","Critical risk devices","Compliance policies"];return`
    <div style="display:flex;flex-direction:column;height:calc(100vh - 340px);min-height:450px">
  ...
  `}function ii(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
  </div>`}function Ms(e){const t=e.querySelector("#intune-content");if(!t)return;const i=t.querySelector("#intune-cop-send"),a=t.querySelector("#intune-cop-input");i&&a&&(i.addEventListener("click",()=>Le(e,a)),a.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),Le(e,a))})),t.querySelectorAll(".intune-cop-pill").forEach(n=>{n.addEventListener("click",()=>{const s=t.querySelector("#intune-cop-input");s&&(s.value=n.dataset.q,Le(e,s))})})}function Le(e,t){const i=t.value.trim();if(!i)return;Ce.push({role:"user",text:i}),t.value="";const a=e.querySelector("#intune-cop-msgs");a&&(a.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,a.scrollTop=a.scrollHeight),setTimeout(()=>{const n=i.toLowerCase(),s=ms.find(o=>o.keywords.some(l=>n.includes(l))),r=(s==null?void 0:s.response)||`Searching Intune data for **"${i}"**...

Based on your question, navigate to the relevant section above. Current status: 847 devices, 98.2% compliant, 2 critical risks.`;Ce.push({role:"ai",text:r}),a&&(a.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
      ...
      </div>`,a.scrollTop=a.scrollHeight)},600)}function ai(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>")}const d={currentUser:null,currentPage:"dashboard",settings:{showPSCommands:!0,showTenantResult:!0,autoExpandFailed:!0,showGraphHealth:!0,showZeroTrustScore:!0,showM365ConfigScore:!0,agentSchedule:"daily-0800",agentAlertEmail:"security@contoso.com",agentAlertOnFail:!0,agentDailyDigest:!0,portalEnabled:!0,portal_exchange:!0,portal_teams:!0,portal_sharepoint:!0,portal_onedrive:!0,portal_ext_sharing:!0,portal_user_access:!0,portal_licenses:!0,portal_copilot:!0,portal_power_platform:!0,portal_intune:!0,portal_guest_lifecycle:!0,portal_exchange_groups:!0,portal_shared_mailbox:!0,portal_room_equipment:!0,portal_email_services:!0},cfgAttested:{},cfgAgentLog:[],mcMessages:null},Rs={showPSCommands:!0,showTenantResult:!0,autoExpandFailed:!0,showGraphHealth:!0,showZeroTrustScore:!0,showM365ConfigScore:!0,portalEnabled:!0,portal_exchange:!0,portal_teams:!0,portal_sharepoint:!0,portal_onedrive:!0,portal_ext_sharing:!0,portal_user_access:!0,portal_licenses:!0,portal_copilot:!0,portal_power_platform:!0,portal_intune:!0,portal_guest_lifecycle:!0,portal_exchange_groups:!0,portal_shared_mailbox:!0,portal_room_equipment:!0,portal_email_services:!0,agentSchedule:"daily-0800",agentAlertEmail:"security@contoso.com",agentAlertOnFail:!0,agentDailyDigest:!0};function m(){localStorage.setItem("m365ops_settings",JSON.stringify(d.settings)),localStorage.setItem("m365ops_attested",JSON.stringify(d.cfgAttested)),localStorage.setItem("m365ops_agentlog",JSON.stringify(d.cfgAgentLog))}function Is(){try{const e=localStorage.getItem("m365ops_settings");e&&Object.assign(d.settings,JSON.parse(e));const t=localStorage.getItem("m365ops_attested");t&&(d.cfgAttested=JSON.parse(t));const i=localStorage.getItem("m365ops_agentlog");i&&(d.cfgAgentLog=JSON.parse(i))}catch{}}function si(){Object.assign(d.settings,Rs),m()}function ni(e){return d.currentUser?d.currentUser.navAccess.includes(e):!1}function Ds(...e){return d.currentUser&&e.includes(d.currentUser.role)}const Tt={dashboard:Si,msgcenter:Ua,applications:Ya,intune:fs,requests:Ci,security:Di,zerotrust:_i,m365config:Zi,privaccts:sa,licenses:da,agents:pa,approvals:ga,portal:ha,myreqs:Pa,chat:Ra,graphapi:qa,sso:Ta,audit:La,settings:Na};async function h(e){if(!ni(e)){p("You do not have access to that page.","error");return}d.currentPage=e,document.querySelectorAll(".page").forEach(a=>a.classList.remove("active"));const t=document.getElementById("page-"+e);t&&t.classList.add("active"),document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const i=document.getElementById("n-"+e);i&&i.classList.add("active"),Tt[e]&&await Tt[e]()}async function Lt(){const e=document.getElementById("app"),t=await vi();if(t){await Nt(t);return}e.innerHTML=`
    <div id="login-screen">
  ...
  `,document.getElementById("entra-login-btn").addEventListener("click",async()=>{const i=document.getElementById("entra-login-btn");i.innerHTML='<span class="spinner" style="margin-right:8px"></span> Signing in...',i.disabled=!0;const a=await mi();a?await Nt(a):(i.innerHTML=`
        <svg width="16" height="16" viewBox="0 0 21 21" fill="none"><rect width="10" height="10" fill="#F25022"/><rect x="11" width="10" height="10" fill="#7FBA00"/><rect y="11" width="10" height="10" fill="#00A4EF"/><rect x="11" y="11" width="10" height="10" fill="#FFB900"/></svg>
        Sign in with Microsoft Entra ID
      `,i.disabled=!1,p("Login cancelled or failed. Try again or use demo account.","warning"))}),document.querySelectorAll(".user-tile").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".user-tile").forEach(a=>a.classList.remove("selected")),i.classList.add("selected"),i.dataset.user}),i.addEventListener("dblclick",async()=>{await qs(i.dataset.user)})})}async function qs(e){const t=Ot.find(a=>a.id===e);if(!t)return;d.currentUser=t,ri();const i=t.navAccess[0];await h(i),p(`Welcome back, ${t.name}!`,"success")}async function Nt(e){const t=(e.name||e.username).split(" "),i={id:e.localAccountId,name:e.name||e.username,email:e.username,role:"admin",initials:t.map(n=>n[0]).join("").toUpperCase(),color:"#0C447C",isEntraID:!0,account:e,navAccess:["dashboard","requests","security","zerotrust","privaccts","m365config","licenses","agents","msgcenter","applications","intune","portal","myreqs","chat","audit","settings"]};d.currentUser=i,ri();const a=i.navAccess[0];await h(a),p(`Welcome, ${i.name}! Authenticated with Entra ID.`,"success")}function ri(){var t,i;const e=document.getElementById("app");if(e.innerHTML=`
    <div id="app-shell">
      <nav id="sidebar"></nav>
      <div id="main-content">
  ...
  `,di(),pi(),((i=d.currentUser)==null?void 0:i.role)==="manager"){const a=document.getElementById("alert-approvals-link");a&&a.addEventListener("click",async n=>{n.preventDefault(),await h("approvals")})}}function Ts(){return["dashboard","requests","security","zerotrust","privaccts","m365config","msgcenter","applications","intune","licenses","agents","approvals","portal","myreqs","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}Is();Lt().catch(e=>{console.error("Login render error:",e),Lt()});const oi=Object.freeze(Object.defineProperty({__proto__:null,go:h,hasAccess:ni,isRole:Ds,resetSettings:si,saveState:m,state:d},Symbol.toStringTag,{value:"Module"}));
