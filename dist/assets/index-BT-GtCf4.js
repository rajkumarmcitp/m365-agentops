    ...
    <div class="grid-2" style="gap:16px">
      ...
      <div>
        ...
        <div class="card mb-3">
          ...
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            ${(((r=t.validation)==null?void 0:r.approvalPath)||[]).map((o,d)=>{const c=t.approvals.find(h=>h.step===o),p=!c&&o!=="agent"&&o!=="action",v=(c==null?void 0:c.status)==="APPROVED"||(c==null?void 0:c.status)==="COMPLETED";return`
    ...
    <div class="grid-2" style="gap:16px">
      ...
      <div>
        ...
        <div class="card mb-3">
          <div class="card-header"><span class="card-title">Approval Workflow</span></div>
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            ${(((o=t.validation)==null?void 0:o.approvalPath)||[]).map((d,c)=>{const p=t.approvals.find(m=>m.step===d),v=!p&&d!=="agent"&&d!=="action",h=(p==null?void 0:p.status)==="APPROVED";return`
                <div style="display:flex;gap:10px;margin-bottom:12px;align-items:flex-start">
                  <div style="flex-shrink:0;width:24px;height:24px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;${h?"background:var(--clr-success-bg);color:var(--clr-success-text)":v?"background:var(--clr-warning-bg);color:var(--clr-warning-text)":"background:var(--color-background-tertiary);color:var(--color-text-secondary)"}">
                    ${h?"✓":v?"◯":"—"}
                  </div>
                  <div style="flex:1;font-size:11px">
...
**Graph API:** GET /beta/identity/conditionalAccess/policies`}];let Ye=null,R=[],C=P,Ae="executive",D={priority:"all",category:"all",status:"all"},Je="7d",Re=[],_t=!1;const ga=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"securescore",label:"Secure Score",icon:"ti-shield-check"},{id:"identity",label:"Identity",icon:"ti-user-check"},{id:"email",label:"Email",icon:"ti-mail"},{id:"endpoint",label:"Endpoint",icon:"ti-device-laptop"},{id:"teams",label:"Teams",icon:"ti-brand-teams"},{id:"sharepoint",label:"SharePoint",icon:"ti-brand-sharepoint"},{id:"dataprotection",label:"Data Protection",icon:"ti-lock"},{id:"privaccess",label:"Priv. Access",icon:"ti-crown"},{id:"guests",label:"Guests",icon:"ti-user-plus"},{id:"incidents",label:"Incidents",icon:"ti-alert-triangle"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"Security Copilot",icon:"ti-robot"},{id:"apiref",label:"API Reference",icon:"ti-api"}];async function ma(){const e=document.getElementById("page-security");if(e){if(G()){console.log("🎭 Demo account detected - showing demo security data"),Ia(e);return}try{console.log("📡 Fetching real security data from backend...");const t=await qi();t.success&&t.data?(Ye=t.data,console.log("✅ Loaded real secure score from API")):(console.warn("⚠️ No secure score data available from API"),Ye=null);let i=[];try{const r=await Lt();r.success&&r.data&&(i=r.data,console.log(`✅ Loaded ${i.length} real devices from Intune`))}catch(r){console.warn("⚠️ Could not fetch device data:",r.message)}const s=r=>r.map(l=>{var d,c,p,v,h,m;const o=l.deviceName||((c=(d=l.description)==null?void 0:d.match(/Device ([A-Z0-9-]+)/))==null?void 0:c[1])||((v=(p=l.title)==null?void 0:p.match(/([A-Z0-9-]+)/))==null?void 0:v[1])||((m=(h=l.description)==null?void 0:h.match(/([A-Z0-9]{3,})/))==null?void 0:m[1]);if(o&&i.length>0){const y=i.find(g=>{var A,V;return((A=g.deviceName)==null?void 0:A.toUpperCase().includes(o.toUpperCase()))||((V=g.deviceName)==null?void 0:V.includes(o))||g.id===o});if(y)return{...l,deviceId:y.id,deviceName:y.deviceName,deviceOS:y.operatingSystem,compliant:y.complianceState==="Compliant",managed:!0,owner:y.userDisplayName}}return l}),a=await Hs();a.success&&Array.isArray(a.data)&&a.data.length>0?(R=s(a.data),console.log(`✅ Loaded ${R.length} real incidents from alerts (enriched with device data)`)):(console.warn("⚠️ No active incidents found"),R=[]);const n=await Vs();n.success&&n.data&&(C={totalUsers:n.data.totalUsers||P.totalUsers,privAccounts:n.data.privilegedAccounts||P.privAccounts,globalAdmins:n.data.globalAdmins||P.globalAdmins,serviceAccounts:n.data.serviceAccounts||P.serviceAccounts,breakGlass:n.data.breakGlassAccounts||P.breakGlass,identitySecureScore:n.data.identitySecureScore||P.identitySecureScore,mfaEnabled:n.data.mfaEnabled||P.mfaEnabled,mfaExcluded:n.data.mfaExcluded||P.mfaExcluded,passwordlessAdoption:n.data.passwordlessAdoption||P.passwordlessAdoption,fido2Adoption:n.data.fido2Adoption||P.fido2Adoption,legacyAuthConnections:n.data.legacyAuthConnections||P.legacyAuthConnections,highRiskUsers:n.data.highRiskUsers||P.highRiskUsers,riskySignIns30d:n.data.riskySignIns30d||P.riskySignIns30d,impossibleTravel30d:P.impossibleTravel30d,anonymousIP30d:P.anonymousIP30d,passwordSpray30d:P.passwordSpray30d,caPoliciesEnabled:n.data.caPoliciesEnabled||P.caPoliciesEnabled,caPoliciesDisabled:n.data.caPoliciesDisabled||P.caPoliciesDisabled,caPoliciesReportOnly:n.data.caPoliciesReportOnly||P.caPoliciesReportOnly,caUsersExcluded:n.data.caUsersExcluded||P.caUsersExcluded},console.log("✅ Loaded real identity posture data from Azure AD"))}catch(t){console.error("❌ Error loading security data:",t.message)}ie(e)}}function ie(e){var a,n;const t=Array.isArray(R)?R:[],i=t.filter(r=>r.severity==="critical").length;t.filter(r=>r.severity==="high"&&r.status!=="resolved").length;const s=ve.filter(r=>r.priority==="critical"||r.priority==="high").length;e.innerHTML=`
  ...
  `}function Ma(){const e=R.filter(r=>r.status!=="resolved"),t=R.filter(r=>r.status==="resolved"),i=R.filter(r=>r.severity==="critical").length,s=R.filter(r=>r.severity==="high").length,a=R.filter(r=>r.severity==="medium").length,n=R.filter(r=>r.severity==="low").length;return`
    ...
    ${t.length>0?`
      ...
      `).join("")}
    `:""}
  `}function Da(){const e=ve.filter(s=>!(D.priority!=="all"&&s.priority!==D.priority||D.category!=="all"&&s.category!==D.category||D.status!=="all"&&s.status!==D.status)),t=e.reduce((s,a)=>s+a.scoreGain,0),i=[...new Set(ve.map(s=>s.category))];return`
...
Ask me anything about your security posture, specific risks, or recommended actions.`}],_t=!0);const e=["Show me all high-risk users","Why did Secure Score drop this week?","Which Teams have external guests?","Top 10 security improvements","Which devices are vulnerable to ransomware?","Summarize today's security posture","Email security status","MFA coverage and gaps","Conditional Access coverage","Guest user governance"];return`
  ...
  `}function Ta(e){var a,n,r,l,o;const t=e.querySelector("#sec-content");if(!t)return;t.querySelectorAll("[data-trend]").forEach(d=>{d.addEventListener("click",()=>{Je=d.dataset.trend,ie(e)})}),t.querySelectorAll("[data-goto]").forEach(d=>{d.addEventListener("click",()=>{const p={identity:"identity",email:"email",endpoint:"endpoint",teams:"teams",sharepoint:"sharepoint",data:"dataprotection",privaccess:"privaccess",guests:"guests"}[d.dataset.goto];p&&(Ae=p,ie(e))})}),(a=t.querySelector("#exec-view-incidents"))==null||a.addEventListener("click",()=>{Ae="incidents",ie(e)}),(n=t.querySelector("#exec-view-recs"))==null||n.addEventListener("click",()=>{Ae="recommendations",ie(e)}),(r=t.querySelector("#rec-priority"))==null||r.addEventListener("change",d=>{D.priority=d.target.value,ie(e)}),(l=t.querySelector("#rec-category"))==null||l.addEventListener("change",d=>{D.category=d.target.value,ie(e)}),(o=t.querySelector("#rec-status"))==null||o.addEventListener("change",d=>{D.status=d.target.value,ie(e)});const i=t.querySelector("#sec-cop-send"),s=t.querySelector("#sec-cop-input");i&&s&&(i.addEventListener("click",()=>vt(e,s)),s.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),vt(e,s))})),t.querySelectorAll(".sec-cop-pill").forEach(d=>{d.addEventListener("click",()=>{const c=t.querySelector("#sec-cop-input");c&&(c.value=d.dataset.q,vt(e,c))})}),t.querySelectorAll(".api-copy").forEach(d=>{d.addEventListener("click",()=>{navigator.clipboard.writeText(d.dataset.code),u("Endpoint copied to clipboard.","success")})})}function vt(e,t){const i=t.value.trim();if(!i)return;Re.push({role:"user",text:i}),t.value="";const s=e.querySelector("#sec-copilot-msgs");s&&(s.innerHTML+=`<div class="chat-msg user-msg" style="max-width:85%;margin-bottom:12px">
    ...
    </div>`,s.scrollTop=s.scrollHeight),setTimeout(()=>{const a=i.toLowerCase(),n=va.find(l=>l.keywords.some(o=>a.includes(o))),r=(n==null?void 0:n.response)||`Analysing your query across all 15 security data sources...
...
Current status: Secure Score 64/95 · ${R.filter(l=>l.status!=="resolved").length} active incidents · ${P.highRiskUsers} high-risk users.`;Re.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
      ...
      </div>`,s.scrollTop=s.scrollHeight)},600)}function Ni(e){return e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"<br><br>").replace(/\n/g,"<br>").replace(/\|(.+)\|\n\|[-|: ]+\|\n/g,"").replace(/\|(.+)\|/g,t=>`<span style="display:flex;gap:16px;font-size:11px;padding:2px 0">${t.split("|").filter(s=>s.trim()).map(s=>`<span>${s.trim()}</span>`).join("")}</span>`)}function Ia(e){const t={overallScore:78,categoryScores:{identity:82,data:75,devices:72,apps:76,infrastructure:79}},i=ua.slice(0,5);e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;let t=[],i=null;const s=e.querySelector("#user-search"),a=e.querySelector("#user-dropdown"),n=e.querySelector("#days-back");e.querySelector("#custom-date");const r=e.querySelector("#investigate-btn");l();async function l(){try{t=(await nn()).data||[]}catch(o){console.error("Failed to load users:",o),u("Failed to load user list","error")}}s.addEventListener("input",o=>{const d=o.target.value.toLowerCase();if(!d){a.style.display="none";return}const c=t.filter(p=>p.displayName.toLowerCase().includes(d)||p.mail.toLowerCase().includes(d));a.innerHTML=c.map(p=>`
    ...
    `).join(""),c.forEach(p=>{const v=a.querySelector(`[data-id="${p.id}"]`);v==null||v.addEventListener("click",()=>{i=p.id,s.value=p.displayName,a.style.display="none",r.disabled=!1})}),a.style.display=c.length>0?"block":"none"}),r.addEventListener("click",async()=>{if(!i){u("Please select a user","warning");return}const o=parseInt(n.value),d=new Date,c=new Date(d);c.setDate(c.getDate()-o),mt(e,!0);try{const p=await rn(i,c.toISOString().split("T")[0],d.toISOString().split("T")[0]);cn(e,p.data),mt(e,!1)}catch(p){console.error("Investigation error:",p),u("Failed to load investigation data","error"),mt(e,!1)}}),document.addEventListener("click",o=>{!s.contains(o.target)&&!a.contains(o.target)&&(a.style.display="none")})}function mt(e,t){e.querySelector("#loading-state").style.display=t?"block":"none",e.querySelector("#investigation-results").style.display=t?"none":"block",e.querySelector("#empty-state").style.display="none"}function cn(e,t){const{user:i,applicationAccess:s,signInLogs:a,auditLogs:n,actionsOnOtherAccounts:r,timeline:l,summary:o}=t,d=`
    <div class="info-card">
        ...
        <tbody>
          ${s.map(g=>`
            <tr>
              ...
              <td>
                <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${ti(g.status).bg};color:${ti(g.status).text}">
                  ${g.status}
                </span>
              </td>
  ...
  `;e.querySelector("#applications-section").innerHTML=c;const p={};a.forEach(g=>{p[g.application]||(p[g.application]=[]),p[g.application].push(g)});const v=`
    <div style="display:grid;gap:16px">
      ${Object.entries(p).slice(0,10).map(([g,A])=>{const V=A.filter(k=>k.status==="success").length,$e=A.filter(k=>k.status==="failure").length,E=A.filter(k=>k.compliant==="No").length,K=A.filter(k=>k.managed==="No").length;return`
  ...
  `;e.querySelector("#signin-logs-section").innerHTML=v;const h=`
    <div style="overflow-x:auto">
      <table class="data-table">
        <thead>
          <tr>
        ...
        <tbody>
          ${n.map(g=>`
            <tr>
              ...
              <td>
                <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${te(g.severity).bg};color:${te(g.severity).text}">
                  ${g.severity}
                </span>
              </td>
            </tr>
  ...
  `;e.querySelector("#audit-logs-section").innerHTML=h;const m=`
    <div style="display:flex;flex-direction:column;gap:8px">
      ${r.map(g=>`
        <div style="padding:12px;background:var(--color-background-secondary);border-radius:6px;border-left:3px solid ${te(g.severity).border}">
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <div style="text-align:right">
              ...
              <div style="font-size:10px;color:var(--color-text-tertiary);margin-top:2px">${ce(g.timestamp)}</div>
            </div>
            <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${te(g.severity).bg};color:${te(g.severity).text};margin-left:12px">
              ${g.severity}
            </span>
          </div>
        </div>
      ...
      ${l.map((g,A)=>`
        <div style="display:flex;gap:16px;margin-bottom:24px;position:relative">
          <div style="display:flex;flex-direction:column;align-items:center;width:40px;flex-shrink:0">
            <div style="width:12px;height:12px;border-radius:50%;background:${te(g.severity).bg};border:2px solid ${te(g.severity).border}"></div>
          ...
          <div style="flex:1;padding-top:2px">
            <div style="display:flex;justify-content:space-between;align-items:start;gap:12px">
              <div>
                ...
                <div style="font-size:10px;color:var(--color-text-secondary);margin-top:4px">${ce(g.timestamp)}</div>
              </div>
              <span style="padding:2px 6px;border-radius:3px;font-size:9px;font-weight:600;background:${te(g.severity).bg};color:${te(g.severity).text};white-space:nowrap">
                ${g.severity}
              </span>
            </div>
          </div>
  ...
  `;const s=e.querySelector("#cfg-topic-grid");zt.forEach(a=>{const n=qt(a),r=Ue(n.score),l=document.createElement("div");l.className="cfg-topic-card";const o=Vi[a.id]||{bg:"#f0f0f0",color:"#555"};l.innerHTML=`
    ...
    `,l.addEventListener("click",()=>{rt=a,nt="topic",Ji(e,a)}),s.appendChild(l)}),e.querySelector("#cfg-scan-now").addEventListener("click",()=>{const a=e.querySelector("#cfg-scan-now");a.innerHTML='<span class="spinner dark"></span> Scanning...',a.disabled=!0,setTimeout(()=>{a.innerHTML='<i class="ti ti-refresh"></i> Run scan now',a.disabled=!1,u("CIS Benchmark scan complete — see results above","success")},2e3)})}function Ji(e,t){const i=qt(t),s=Ue(i.score);e.innerHTML=`
    <div class="page-header">
      <div>
        ...
        <tbody>
          ${n.controls.map(l=>`
            <tr style="border-bottom:0.5px solid var(--color-border-tertiary)">
              ...
              <td style="padding:10px 12px;font-size:10px">${fn(Gt(l))}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
  ...
  `;try{const s=await Bs();if(!s.success||!s.data||s.data.length===0){ii(e);return}const a=_i(),n=Ue(a.score);e.innerHTML=`
      ...
      <div style="font-size:11px;font-weight:600;color:var(--color-text-secondary);margin-bottom:10px;text-transform:uppercase;letter-spacing:0.5px">Topics</div>
      <div class="cfg-topic-grid" id="cfg-topic-grid"></div>
    `;const r=e.querySelector("#cfg-topic-grid");zt.forEach(l=>{const o=qt(l),d=Ue(o.score),c=document.createElement("div");c.className="cfg-topic-card";const p=Vi[l.id]||{bg:"#f0f0f0",color:"#555"};c.innerHTML=`
    ...
    <div class="grid-2" style="gap:16px">
      ...
      <div>
        ...
        <div class="card mb-3">
          <div class="card-header"><span class="card-title">Approval Workflow</span></div>
          <div style="padding:16px;border-top:0.5px solid var(--color-border-secondary)">
            ${(((l=t.validation)==null?void 0:l.approvalPath)||[]).map((o,d)=>{const c=t.approvals.find(h=>h.step===o),p=!c&&o!=="agent"&&o!=="action",v=(c==null?void 0:c.status)==="APPROVED";return`
                <div style="display:flex;gap:10px;margin-bottom:12px;align-items:flex-start">
                  <div style="flex-shrink:0;width:24px;height:24px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;${v?"background:var(--clr-success-bg);color:var(--clr-success-text)":p?"background:var(--clr-warning-bg);color:var(--clr-warning-text)":"background:var(--color-background-tertiary);color:var(--color-text-secondary)"}">
                    ${v?"✓":p?"◯":"—"}
                  </div>
  ...
  `;const a=e.querySelector("#portal-service-grid");Qe.forEach(n=>{var d,c;const r=Xe(pi(n.id)),l=je(n.id)?ke.reduce((p,v)=>{var h,m;return p+(((m=(h=Se(v.id))==null?void 0:h.operations)==null?void 0:m.length)||0)},0):((c=(d=Se(n.id))==null?void 0:d.operations)==null?void 0:c.length)||0,o=document.createElement("div");o.className=`portal-svc-card ${r?"":"disabled"}`,o.innerHTML=`
    ...
    `,r||(o.title="This service has been disabled by your administrator."),a.appendChild(o)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(n=>{n.addEventListener("click",()=>{J=n.dataset.gid,je(J)&&(X=Xn()),F=null,oe={},q="service",ee(e)})})}function tr(e){const t=Ot(J);if(!t){q="landing",ee(e);return}const i=ot(),s=Se(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{q="landing",ee(e)}),je(J)&&e.querySelectorAll(".ex-sub-tab").forEach(a=>{a.addEventListener("click",()=>{X=a.dataset.sub,F=null,ui(e,Se(X)),e.querySelectorAll(".ex-sub-tab").forEach(n=>n.classList.toggle("active",n.dataset.sub===X))})}),ui(e,s)}function ir(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
  ...
  `,s.querySelector("#svc-start-form").addEventListener("click",()=>{q="form",oe={};const l=document.getElementById("page-portal");ee(l)})}function sr(e){var n;const t=Ot(J),i=ot(),s=ls(i,F);if(!s||!t){q="service",ee(e);return}const a=Be(s);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
    ...
    ${l&&l.length>0?`
      <div style="margin-bottom:20px;padding:12px;background:var(--clr-info-bg);border-left:3px solid var(--clr-info-text);border-radius:4px">
        ...
        <ul style="margin:0;padding-left:20px;font-size:11px;color:var(--clr-info-text)">
          ${l.map(y=>`<li style="margin-bottom:4px">${y.message}</li>`).join("")}
        </ul>
      </div>
    `:""}
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{q="landing",J=null,X=null,F=null,oe={},ee(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{Yn(()=>Promise.resolve().then(()=>qo),void 0).then(o=>o.go("myreqs"))})}function dr(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
...
- "What are the M365 Config failures?"`;let et=[],yi=!1;function ur(){const e=document.getElementById("page-chat");if(!e)return;const t=f.currentUser,i=mi[t==null?void 0:t.role]||mi.user;e.innerHTML=`
    <div class="page-header">
      <div>
...
Try rephrasing your question or ask about a specific service name.`}function mr(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=f.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>o.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(o=>o.classList.remove("active")),l.classList.add("active"),e.querySelector(`#graph-tab-${l.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(l=>{l.addEventListener("click",()=>{navigator.clipboard.writeText(l.dataset.val),u("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const l=e.querySelector("#graph-secret");l.type=l.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>u("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>u("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>u("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>u("Throttling configuration saved.","success"))}}function yr(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=f.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `;const i=Y({id:"toggle-ps",checked:t.showPSCommands,label:"Show PowerShell validation commands",sublabel:"Displays the PowerShell command used for each control in the M365 Config topic view.",onChange:m=>{f.settings.showPSCommands=m,N()}});e.querySelector("#settings-ps-wrap").appendChild(i);const s=Y({id:"toggle-result",checked:t.showTenantResult,label:"Show simulated tenant result",sublabel:"Displays the simulated tenant scan result for each control.",onChange:m=>{f.settings.showTenantResult=m,N()}});e.querySelector("#settings-result-wrap").appendChild(s);const a=Y({id:"toggle-expand",checked:t.autoExpandFailed,label:"Auto-expand failed controls",sublabel:"Automatically opens the details panel for failed controls on topic load.",onChange:m=>{f.settings.autoExpandFailed=m,N()}});e.querySelector("#settings-expand-wrap").appendChild(a);const n=Y({id:"toggle-alert-fail",checked:t.agentAlertOnFail,label:"Alert on new failures",sublabel:"Send email notification when agent detects new failed controls.",onChange:m=>{f.settings.agentAlertOnFail=m,N()}});e.querySelector("#settings-alert-fail-wrap").appendChild(n);const r=Y({id:"toggle-graph-health",checked:t.showGraphHealth,label:"Show Graph API health on dashboard",onChange:m=>{f.settings.showGraphHealth=m,N()}});e.querySelector("#settings-graph-health-wrap").appendChild(r);const l=Y({id:"toggle-zt-score",checked:t.showZeroTrustScore,label:"Show Zero Trust score on dashboard",onChange:m=>{f.settings.showZeroTrustScore=m,N()}});e.querySelector("#settings-zt-score-wrap").appendChild(l);const o=Y({id:"toggle-cfg-score",checked:t.showM365ConfigScore,label:"Show M365 Config score on dashboard",onChange:m=>{f.settings.showM365ConfigScore=m,N()}});e.querySelector("#settings-cfg-score-wrap").appendChild(o);const d=Y({id:"toggle-portal-master",checked:t.portalEnabled!==!1,label:"Self-Service Portal — Master Switch",sublabel:"Disable to prevent all users from accessing the portal globally.",onChange:m=>{f.settings.portalEnabled=m,N();const y=e.querySelector("#portal-services-section");y&&(y.style.opacity=m?"1":"0.4"),u(m?"Self-Service Portal enabled.":"Self-Service Portal disabled globally.",m?"success":"warning")}});e.querySelector("#settings-portal-master-wrap").appendChild(d);const c=e.querySelector("#portal-services-section");c&&(c.style.opacity=t.portalEnabled!==!1?"1":"0.4");const p=e.querySelector("#portal-main-toggles");Qe.forEach(m=>{const y="portal_"+m.id.replace(/-/g,"_"),g=document.createElement("div");g.className="portal-svc-setting-row",g.innerHTML=`
    ...
    `,p.appendChild(g);const A=Y({id:`chk-${y}`,checked:t[y]!==!1,label:"",onChange:V=>{f.settings[y]=V,N()}});g.querySelector(`#portal-toggle-${y}`).appendChild(A)});const v=e.querySelector("#portal-exchange-toggles"),h={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};ke.forEach(m=>{const y=h[m.id],g=document.createElement("div");g.className="portal-svc-setting-row",g.innerHTML=`
      <i class="ti ${m.icon}" style="color:var(--color-text-secondary)"></i>
      <span style="flex:1;font-size:11px;font-weight:500">${m.name}</span>
      <div id="portal-toggle-${y}"></div>
    `,v.appendChild(g);const A=Y({id:`chk-${y}`,checked:t[y]!==!1,label:"",onChange:V=>{f.settings[y]=V,N()}});g.querySelector(`#portal-toggle-${y}`).appendChild(A)}),e.querySelector("#settings-save").addEventListener("click",()=>{f.settings.agentSchedule=e.querySelector("#settings-schedule").value,f.settings.agentAlertEmail=e.querySelector("#settings-alert-email").value,N(),u("Settings saved successfully.","success")}),e.querySelector("#settings-reset").addEventListener("click",()=>{$s(),cs(e),u("Settings reset to defaults.","info")}),ft(e),e.querySelector("#claude-save-btn").addEventListener("click",async()=>{const m=e.querySelector("#settings-claude-key").value;if(!m||m.trim()===""){u("Please enter a Claude API key","warning");return}const y=e.querySelector("#claude-save-btn");y.disabled=!0,y.innerHTML='<span class="spinner dark"></span> Saving...';try{const g=await xr(m);g.success?(u("Claude API key configured successfully!","success"),e.querySelector("#settings-claude-key").value="",ft(e)):u("Failed to save: "+g.error,"error")}catch(g){u("Error saving API key: "+g.message,"error")}y.disabled=!1,y.innerHTML='<i class="ti ti-device-floppy"></i> Save API Key'}),e.querySelector("#claude-remove-btn").addEventListener("click",async()=>{const m=e.querySelector("#claude-remove-btn");m.disabled=!0,m.innerHTML='<span class="spinner dark"></span> Removing...';try{const y=await wr();y.success?(u("Claude API key removed","success"),ft(e)):u("Failed to remove: "+y.error,"error")}catch(y){u("Error removing API key: "+y.message,"error")}m.disabled=!1,m.innerHTML='<i class="ti ti-trash"></i> Remove API Key'})}async function ft(e){try{const t=await br();if(t){const i=e.querySelector("#claude-status-badge"),s=e.querySelector("#claude-mode-text"),a=e.querySelector("#claude-remove-btn");t.available?(i.innerHTML='<span style="background:var(--clr-success-bg);color:var(--clr-success-text);padding:2px 8px;border-radius:3px;font-size:9px;font-weight:600">ACTIVE</span>',s.innerHTML='<strong style="color:var(--clr-success-text)">✓ Claude API Active</strong> - Real AI investigations enabled',a.style.display="inline-flex"):(i.innerHTML='<span style="background:var(--clr-info-bg);color:var(--clr-info-text);padding:2px 8px;border-radius:3px;font-size:9px;font-weight:600">MOCK MODE</span>',s.innerHTML='<strong style="color:var(--clr-info-text)">✓ Mock Mode</strong> - Using intelligent fallback responses (fully functional for testing)',a.style.display="none")}}catch(t){console.error("Failed to load Claude status:",t)}}async function kr(){const e=document.getElementById("page-msgcenter");e&&(G()?Sr(e):await ps(e))}function Sr(e){const t=pe.filter(i=>i.actionRequired).length;pe.length,e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,u(`Synced ${pe.length} messages`,"success")},2e3)})}async function ps(e){var t,i,s;e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `;try{const a=await Ii(),n=await zi();if(!a.success||!a.data||a.data.length===0){fi(e);return}const r=new Date,l=new Date(r.getTime()-7*24*60*60*1e3),o=new Date(r.getTime()-30*24*60*60*1e3);let d=a.data.filter(v=>new Date(v.publishedDate)>=l&&v.actionRequired);d.length===0&&(d=a.data.filter(v=>new Date(v.publishedDate)>=o&&v.actionRequired)),d.length===0&&(d=a.data.filter(v=>v.actionRequired)),d.sort((v,h)=>new Date(h.publishedDate)-new Date(v.publishedDate));const c=d.length,p=d.filter(v=>v.severity==="high").length;e.innerHTML=`
      <div class="page-header">
        <div>
          <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
          <div class="page-subtitle">Last 7 days · Action required only · ${d.length} announcements · <span style="color:var(--clr-success-text)">● Real data</span></div>
        </div>
        <div class="page-actions">
          <button class="btn" id="mc-sync"><i class="ti ti-refresh"></i> Sync now</button>
          <button class="btn" id="mc-analyze"><i class="ti ti-sparkles"></i> Analyze with AI</button>
          <button class="btn btn-primary" id="mc-create-tasks"><i class="ti ti-circle-plus"></i> Create tasks (${c})</button>
        </div>
      </div>
      ...
      <div class="kpi-row">
        ...
        <div class="kpi-tile">
          <div class="kpi-value danger">${c}</div>
          <div class="kpi-label">Action Required</div>
        </div>
        <div class="kpi-tile">
          <div class="kpi-value warning">${p}</div>
          <div class="kpi-label">High Severity</div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <span class="badge danger">${d.length} announcements</span>
        </div>
          ...
          ${d.slice(0,50).map(v=>`
            <div style="padding:12px;border-bottom:0.5px solid var(--color-border-tertiary)">
              <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:6px">
                <div style="flex:1">
                  <div style="font-weight:600;font-size:12px;color:var(--color-text-primary)">${v.title||v.id}</div>
                  <div style="font-size:10px;color:var(--color-text-secondary);margin-top:4px">
                    Service: <strong>${v.service||"Unknown"}</strong> · ID: <code style="font-family:monospace;font-size:9px">${v.id}</code>
                  </div>
                </div>
                <span class="badge ${v.severity==="high"?"danger":v.severity==="medium"?"warning":"success"}" style="flex-shrink:0;font-size:9px">
                  ${v.severity||"normal"}
                </span>
              </div>
              ${v.actionByDate?`<div style="font-size:10px;color:var(--clr-danger-text);margin-top:6px">⚠️ Action required by: <strong>${v.actionByDate}</strong></div>`:""}
              ${v.body&&typeof v.body=="string"?`<div style="font-size:10px;color:var(--color-text-secondary);margin-top:6px;line-height:1.4">${v.body.substring(0,150)}...</div>`:""}
            </div>
          `).join("")}
        </div>
      </div>
    `,(t=e.querySelector("#mc-sync"))==null||t.addEventListener("click",async()=>{const v=e.querySelector("#mc-sync");v.innerHTML='<span class="spinner dark"></span> Syncing...',v.disabled=!0,setTimeout(async()=>{v.innerHTML='<i class="ti ti-refresh"></i> Sync now',v.disabled=!1,await ps(e),u("Synced announcements","success")},2e3)}),(i=e.querySelector("#mc-analyze"))==null||i.addEventListener("click",()=>{if(c===0){u("No recent action-required announcements to analyze","info");return}u(`Analyzing ${c} announcements with AI...`,"info"),setTimeout(()=>{u("AI analysis complete - see insights panel below","success")},2e3)}),(s=e.querySelector("#mc-create-tasks"))==null||s.addEventListener("click",()=>{c===0?u("No action-required announcements to create tasks for","info"):u(`Creating ${c} tasks from recent announcements...`,"success")})}catch(a){console.error("Error loading Message Center:",a),fi(e)}}function fi(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
...
**Current state:** ${t.totalManagedDevices||0} managed devices, ${t.compliancePercentage||0}% compliant, ${t.deviceHealthScore||0}/100 health score, ${i.criticalRiskCount||0} critical risks`}],ki=!0}const e=["Show device health summary","Patch management status","Encryption coverage","Firewall & protection status","Critical risk devices","Compliance policies"];return`
  ...
  `}function ys(e){return`<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:4px">
    ...
    `).join("")}
      ...
      <div class="chat-sender" style="justify-content:flex-end">You</div>
      <div class="chat-bubble">${i}</div>
    </div>`,s.scrollTop=s.scrollHeight),setTimeout(()=>{var c,p,v,h,m;const a=i.toLowerCase(),n=x.summary||{},r=x.riskAssessment||{},l=x.patchManagement||{},o=x.endpointSecurity||{};let d=`Based on your question about Intune, here's the current tenant status:
...
• SmartScreen Coverage: ${((v=o.smartscreen)==null?void 0:v.coverage)||0}%
...
• Non-Compliant: ${((m=r.deviceRisks)==null?void 0:m.length)||0}`;else if(a.includes("recommendation")||a.includes("suggest")){const g=(x.recommendations||[]).filter(A=>A.priority==="critical");d+=`**Top Recommendations:**
...
Ask me about device health, compliance, security, patches, or recommendations!`;tt.push({role:"ai",text:d}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function bo(){const e=b.profile;return`
    <div class="card">
  ...
  `}function xo(){const e=b.security;return`
    <div class="card">
  ...
  `}function wo(){const e=b.signin.filter(i=>i.result==="Success"),t=b.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function Eo(){const e=b.onedrive;return`
    <div class="card">
  ...
  `}function Po(){const e=b.teams;return`
    <div class="card">
