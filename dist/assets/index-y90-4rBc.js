...
- "What are the M365 Config failures?"`;let et=[],yi=!1;function ur(){const e=document.getElementById("page-chat");if(!e)return;const t=y.currentUser,i=mi[t==null?void 0:t.role]||mi.user;e.innerHTML=`
    <div class="page-header">
      <div>
...
Try rephrasing your question or ask about a specific service name.`}function mr(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>o.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(o=>o.classList.remove("active")),l.classList.add("active"),e.querySelector(`#graph-tab-${l.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(l=>{l.addEventListener("click",()=>{navigator.clipboard.writeText(l.dataset.val),u("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const l=e.querySelector("#graph-secret");l.type=l.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>u("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>u("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>u("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>u("Throttling configuration saved.","success"))}}function yr(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,u(`Synced ${pe.length} messages`,"success")},2e3)})}async function ps(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
  ...
  `;try{const t=await Ii(),i=await zi();if(!t.success||!t.data||t.data.length===0){fi(e);return}const s=t.data,a=s.filter(r=>r.actionRequired).length,n=s.filter(r=>r.severity==="high").length;e.innerHTML=`
      <div class="page-header">
        <div>
          <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
          <div class="page-subtitle">Graph: /admin/serviceAnnouncement/messages · ${s.length} messages · <span style="color:var(--clr-success-text)">● Real data</span></div>
        </div>
        <div class="page-actions">
          <button class="btn" id="mc-sync"><i class="ti ti-refresh"></i> Sync now</button>
          <button class="btn" id="mc-digest"><i class="ti ti-file-text"></i> Weekly digest</button>
          <button class="btn btn-primary" id="mc-create-tasks"><i class="ti ti-circle-plus"></i> Create tasks (${a})</button>
        </div>
      </div>
      ...
      <div class="kpi-row">
        ...
        <div class="kpi-tile">
          <div class="kpi-value warning">${n}</div>
          <div class="kpi-label">High Severity</div>
        </div>
      </div>
      ...
      <div style="padding:20px;text-align:center;color:var(--color-text-secondary)">
        <p>Displaying ${s.length} real Message Center announcements for your Nas-Tech tenant</p>
      </div>
    `,e.querySelector("#mc-sync").addEventListener("click",async()=>{const r=e.querySelector("#mc-sync");r.innerHTML='<span class="spinner dark"></span> Syncing...',r.disabled=!0,setTimeout(async()=>{r.innerHTML='<i class="ti ti-refresh"></i> Sync now',r.disabled=!1,await ps(e),u(`Synced ${s.length} messages`,"success")},2e3)})}catch(t){console.error("Error loading Message Center:",t),fi(e)}}function fi(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
