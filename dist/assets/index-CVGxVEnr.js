(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const Ei=[{id:"demo",name:"Demo Account",email:"demo@contoso.com",role:"admin",initials:"DM",color:"#00C7B7",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"],isDemoAccount:!0},{id:"priya",name:"Priya Kumar",email:"priya@contoso.com",role:"user",initials:"PK",color:"#0C447C",navAccess:["portal","myreqs","myaccount","chat"]},{id:"sanjay",name:"Sanjay Kumar",email:"sanjay@contoso.com",role:"manager",initials:"SK",color:"#3C3489",navAccess:["requests","msgcenter","portal","myreqs","myaccount","chat"],pendingApprovals:3},{id:"chen",name:"Chen Wei",email:"chen@contoso.com",role:"admin",initials:"CW",color:"#633806",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings"]},{id:"aisha",name:"Aisha Raza",email:"aisha@contoso.com",role:"super",initials:"AR",color:"#791F1F",navAccess:["dashboard","requests","security","tenantguard","zerotrust","privaccts","m365config","licenses","agents","approvals","msgcenter","applications","intune","portal","myreqs","myaccount","chat","audit","settings","graphapi","sso"]}],ws={auth:{clientId:"04d3be8d-d433-4367-893e-eccc82190a11",authority:"https://login.microsoftonline.com/b9cc8284-05ed-452f-877a-970779430dcb",redirectUri:window.location.origin+"/callback"},cache:{cacheLocation:"sessionStorage",storeAuthStateInCookie:!1},system:{allowNativeBroker:!1}},As={scopes:["openid","profile","email","User.Read"]};let I=null;async function ks(){try{if(!window.msal)return console.warn("MSAL not loaded yet"),null;I=new window.msal.PublicClientApplication(ws),await I.initialize();const e=await I.handleRedirectPromise();if(e)return console.log("✓ Authenticated from redirect:",e.account.name),e.account;const t=I.getAllAccounts();return t.length>0?(console.log("✓ Already authenticated as:",t[0].name),t[0]):null}catch(e){return console.error("MSAL init error:",e.message),null}}async function Ss(){try{if(!I)return console.error("MSAL not initialized"),null;const e=await I.loginPopup(As);return console.log("✓ Login successful:",e.account.name),e.account}catch(e){return e.errorCode==="user_cancelled"?console.log("User cancelled login"):console.error("Login error:",e.errorCode,e.errorMessage),null}}async function $s(){try{if(!I)return null;const e=I.getAllAccounts();if(e.length===0)return null;const t={scopes:["https://graph.microsoft.com/.default"],account:e[0]};return(await I.acquireTokenSilent(t)).accessToken}catch(e){return console.error("Token error:",e.message),null}}async function Es(){try{if(!I)return;const e={account:I.getAllAccounts()[0]};await I.logout(e),console.log("✓ Logged out")}catch(e){console.error("Logout error:",e)}}function Ps(){if(!I)return null;const e=I.getAllAccounts();return e.length>0?e[0]:null}function Cs(){if(window.userEmail)return console.log("📧 getUserEmail from window.userEmail:",window.userEmail),window.userEmail;const e=Ps();if(!e)return null;const t=e.username||e.mail||e.email;return console.log("📧 getUserEmail from MSAL:",t),t}function Ms(){const e=document.getElementById("app-header"),t=y.currentUser;t&&(e.innerHTML=`
  ...
  `,e.querySelectorAll(".demo-filter-btn").forEach(s=>{s.addEventListener("click",()=>{_=s.dataset.status,Rt(e)})}),e.querySelectorAll(".demo-req-row").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;B=C.find(n=>n.id===a),B&&(me="details",Nt(e))})}),e.querySelectorAll(".demo-req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;B=C.find(r=>r.id===n),B&&(me="details",Nt(e))})})}function Nt(e){var i,s,a,n,r,l;if(!e||!e.querySelector||!B)return;const t=B;e.innerHTML=`
    <div class="page-header">
  ...
  `,e&&e.querySelector&&["ALL","PENDING_APPROVAL","APPROVED","REJECTED","COMPLETED"].forEach(s=>{const a=e.querySelector(`#filter-${s}`);a&&a.addEventListener("click",()=>{_=s,tt(e)})}),e&&e.querySelectorAll&&(e.querySelectorAll("tr[data-id]").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.id;B=C.find(n=>n.id===a),B&&(me="details",Ot(e))})}),e.querySelectorAll(".req-review-btn").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.id;B=C.find(r=>r.id===n),B&&(me="details",Ot(e))})}))}function Ot(e){var a,n,r,l,o;if(!e||!e.querySelector||!B)return;const t=B,i=_s(t);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
...
Current status: Secure Score 64/95 · ${R.filter(l=>l.status!=="resolved").length} active incidents · ${$.highRiskUsers} high-risk users.`;Re.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function Oa(e){var r;const t=document.getElementById("page-tenantguard");if(!t)return;const i=e.critical||0,s=e.high||0;e.medium;const a=e.total||0,n=re.length;t.innerHTML=`
    ...
    <div id="tg-content" style="margin-top:16px">
      ${O==="alerts"?ft():O==="correlations"?_t():O==="patterns"?Wt():Ua()}
    </div>
  `,t.querySelectorAll("[data-section]").forEach(l=>{l.addEventListener("click",()=>{O=l.dataset.section,Z="all";const o=t.querySelector("#tg-content");o&&(o.innerHTML=O==="alerts"?ft():O==="correlations"?_t():Wt(),O==="alerts"&&ht(t)),t.querySelectorAll("[data-section]").forEach(d=>d.classList.remove("active")),l.classList.add("active")})}),(r=t.querySelector("#tg-refresh"))==null||r.addEventListener("click",async()=>{const l=t.querySelector("#tg-refresh"),o=l.innerHTML;l.innerHTML='<span class="spinner dark"></span> Scanning...',l.disabled=!0,await Ne(),l.innerHTML=o,l.disabled=!1}),O==="alerts"&&ht(t)}function ft(){return`
    <!-- Severity Tabs -->
  ...
  `}function gn(e,t){const i=e.querySelector("#pa-tab-log");i.innerHTML=`
    <div class="card" style="padding:0;overflow:hidden">
      <table style="width:100%">
        <thead style="background:var(--color-background-secondary)">
          <tr>
  ...
  `,e.querySelectorAll(".license-tab-btn").forEach(s=>{s.addEventListener("click",()=>{_e=s.dataset.tab,Ji(e)})}),(t=e.querySelector("#license-refresh"))==null||t.addEventListener("click",()=>{Wi()}),(i=e.querySelector("#license-export"))==null||i.addEventListener("click",()=>{alert("Export functionality coming soon")})}function Sn(e){switch(e){case"summary":return $n();case"inventory":return En();case"services":return Pn();case"assignments":return Cn();case"groups":return Mn();case"compliance":return Dn();default:return""}}function $n(){return`
  ...
  `}function Dn(){const e=Je.scores||{utilization:0,costOptimization:0,securityCoverage:0,compliance:0};return`
  ...
  `}let ae="dashboard",Ue=null,be=[],Ki=[],kt="PENDING_APPROVAL";async function In(){const e=document.getElementById("page-approvals");e&&(se(e),await Yi(e))}async function Yi(e){var t;try{const s=await(await fetch(`${S}/requests?status=${kt}&limit=50`)).json();be=Array.isArray(s.data)?s.data:[];const n=await(await fetch(`${S}/audit-logs?limit=20`)).json();Ki=Array.isArray((t=n.data)==null?void 0:t.data)?n.data.data:Array.isArray(n.data)?n.data:[],se(e)}catch(i){console.error("Error loading approvals data:",i),u("Failed to load approvals data","error")}}function se(e){ae==="dashboard"?zn(e):ae==="details"?qn(e):ae==="audit"&&Gn(e)}function zn(e){if(!e){console.error("❌ Page element not found");return}if(e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const a=e.querySelector("#portal-service-grid");Ze.forEach(n=>{var d,c;const r=Qe(ri(n.id)),l=Fe(n.id)?ke.reduce((p,f)=>{var x,g;return p+(((g=(x=Se(f.id))==null?void 0:x.operations)==null?void 0:g.length)||0)},0):((c=(d=Se(n.id))==null?void 0:d.operations)==null?void 0:c.length)||0,o=document.createElement("div");o.className=`portal-svc-card ${r?"":"disabled"}`,o.innerHTML=`
    ...
    `,r||(o.title="This service has been disabled by your administrator."),a.appendChild(o)}),e.querySelectorAll(".psc-open-btn:not([disabled])").forEach(n=>{n.addEventListener("click",()=>{J=n.dataset.gid,Fe(J)&&(X=Hn()),U=null,oe={},q="service",ee(e)})})}function _n(e){const t=It(J);if(!t){q="landing",ee(e);return}const i=at(),s=Se(i);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#svc-back").addEventListener("click",()=>{q="landing",ee(e)}),Fe(J)&&e.querySelectorAll(".ex-sub-tab").forEach(a=>{a.addEventListener("click",()=>{X=a.dataset.sub,U=null,oi(e,Se(X)),e.querySelectorAll(".ex-sub-tab").forEach(n=>n.classList.toggle("active",n.dataset.sub===X))})}),oi(e,s)}function Wn(){const e={"exchange-groups":"portal_exchange_groups","shared-mailbox":"portal_shared_mailbox","room-equipment":"portal_room_equipment","email-services":"portal_email_services"};return`
  ...
  `,s.querySelector("#svc-start-form").addEventListener("click",()=>{q="form",oe={};const l=document.getElementById("page-portal");ee(l)})}function Jn(e){var n;const t=It(J),i=at(),s=Xi(i,U);if(!s||!t){q="service",ee(e);return}const a=je(s);e.innerHTML=`
    <div class="page-header">
      <div style="display:flex;align-items:center;gap:10px">
  ...
  `,e.querySelector("#form-back").addEventListener("click",()=>{q="service",ee(e)}),e.querySelector("#form-submit").addEventListener("click",()=>Yn(e,s))}function Kn(e){const t=e.required?" *":"",i=e.hint?`<div style="font-size:10px;color:var(--color-text-tertiary);margin-top:3px">${e.hint}</div>`:"";return e.type==="text"||e.type==="email"?`<div class="form-group" data-field="${e.id}">
  ...
  `,e.querySelector("#submit-new").addEventListener("click",()=>{q="landing",J=null,X=null,U=null,oe={},ee(e)}),e.querySelector("#submit-myreqs").addEventListener("click",()=>{Fn(()=>Promise.resolve().then(()=>Co),void 0).then(o=>o.go("myreqs"))})}function er(){const e=document.getElementById("page-myreqs");e&&(e.innerHTML=`
    <div class="page-header">
...
- "What are the M365 Config failures?"`;let Xe=[],pi=!1;function sr(){const e=document.getElementById("page-chat");if(!e)return;const t=y.currentUser,i=ci[t==null?void 0:t.role]||ci.user;e.innerHTML=`
    <div class="page-header">
      <div>
  ...
  `;const s=e.querySelector("#chat-messages"),a=e.querySelector("#chat-input");!pi||Xe.length===0?(Xe=[],Et("ai",ir),pi=!0):Pt(s),e.querySelector("#chat-send").addEventListener("click",()=>vt(e)),a.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),vt(e))}),a.addEventListener("input",()=>{a.style.height="auto",a.style.height=Math.min(a.scrollHeight,120)+"px"}),e.querySelectorAll(".suggestion-pill").forEach(n=>{n.addEventListener("click",()=>{a.value=n.dataset.text,vt(e)})})}function Et(e,t){Xe.push({role:e,text:t,ts:new Date().toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit"})})}function Pt(e){e.innerHTML=Xe.map(t=>{var a;const i=t.role==="ai",s=ar(t.text);return`
...
Try rephrasing your question or ask about a specific service name.`}function rr(){var t,i,s,a,n,r;const e=document.getElementById("page-graphapi");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,e.querySelectorAll("#graph-tabs .tab-btn").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll("#graph-tabs .tab-btn").forEach(o=>o.classList.remove("active")),e.querySelectorAll(".tab-panel").forEach(o=>o.classList.remove("active")),l.classList.add("active"),e.querySelector(`#graph-tab-${l.dataset.tab}`).classList.add("active")})}),e.querySelectorAll(".copy-val").forEach(l=>{l.addEventListener("click",()=>{navigator.clipboard.writeText(l.dataset.val),u("Copied to clipboard.","success")})}),(i=e.querySelector("#graph-secret-toggle"))==null||i.addEventListener("click",()=>{const l=e.querySelector("#graph-secret");l.type=l.type==="password"?"text":"password"}),(s=e.querySelector("#graph-save"))==null||s.addEventListener("click",()=>u("Configuration saved.","success")),(a=e.querySelector("#graph-refresh-token"))==null||a.addEventListener("click",()=>u("Token refreshed successfully.","success")),(n=e.querySelector("#graph-grant-consent"))==null||n.addEventListener("click",()=>u("Admin consent granted for all permissions.","success")),(r=e.querySelector("#throttle-save"))==null||r.addEventListener("click",()=>u("Throttling configuration saved.","success"))}}function or(){var t,i,s;const e=document.getElementById("page-sso");if(e){if(((t=y.currentUser)==null?void 0:t.role)!=="super"){e.innerHTML=`
  ...
  `,(i=e.querySelector("#sso-save"))==null||i.addEventListener("click",()=>u("SSO configuration saved.","success")),(s=e.querySelector("#sso-test"))==null||s.addEventListener("click",()=>{u("SSO test initiated — check your browser for the Entra ID sign-in prompt.","info")})}}function lr(){const e=document.getElementById("page-audit");if(!e)return;const t=[{time:"Today 08:47",event:"Config Agent scan completed",user:"M365 Config Agent",category:"Compliance",severity:"info",sevCls:"info"},{time:"Today 08:15",event:"High-risk sign-in detected",user:"kevin.osei@contoso.com",category:"Security",severity:"high",sevCls:"danger"},{time:"Yesterday 16:30",event:"Access request approved (REQ-005)",user:"Sanjay Kumar",category:"Access",severity:"low",sevCls:"success"},{time:"Yesterday 14:12",event:"PIM role activated — Compliance Admin",user:"sam.torres@contoso.com",category:"Identity",severity:"medium",sevCls:"warning"}];e.innerHTML=`
    <div class="page-header">
  ...
  `;const r=n.querySelector("input");return r.addEventListener("change",()=>a(r.checked)),n}const dr=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",zt=dr?"http://localhost:3000/api/tenantguard":"https://m365ops-api-gtbgezb9c7bgata7.centralus-01.azurewebsites.net/api/tenantguard";async function cr(){try{return(await(await fetch(`${zt}/settings/claude-status`)).json()).data}catch(e){return console.error("Error getting Claude status:",e),null}}async function pr(e){try{return await(await fetch(`${zt}/settings/claude-api-key`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:e})})).json()}catch(t){return console.error("Error setting Claude API key:",t),{success:!1,error:t.message}}}async function ur(){try{return await(await fetch(`${zt}/settings/claude-api-key`,{method:"DELETE"})).json()}catch(e){return console.error("Error removing Claude API key:",e),{success:!1,error:e.message}}}function vr(){const e=document.getElementById("page-settings");e&&ts(e)}function ts(e){const t=y.settings;e.innerHTML=`
    <div class="page-header">
  ...
  `,e.querySelector("#mc-sync").addEventListener("click",()=>{const i=e.querySelector("#mc-sync");i.innerHTML='<span class="spinner dark"></span> Syncing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Sync now',i.disabled=!1,u(`Synced ${pe.length} messages`,"success")},2e3)})}function yr(e){e.innerHTML=`
    <div class="page-header">
      <div>
        <div class="page-title"><i class="ti ti-antenna"></i> Change Intelligence</div>
...
→ **Applications → Secret & Certificate Expiry** for rotation roadmap.`}];let Be="executive",T={type:"all",status:"all",search:""},Le=[],ui=!1,L=[],ne=[],j=[],He=[],Ct=[],Te=[],vi=[],ge=[],ye=[],Ve=[];const is=[{id:"executive",label:"Executive",icon:"ti-layout-dashboard"},{id:"appregistrations",label:"App Registrations",icon:"ti-app-window"},{id:"enterprise",label:"Enterprise Apps",icon:"ti-grid-dots"},{id:"secrets",label:"Secrets & Certs",icon:"ti-lock"},{id:"permissions",label:"Permissions",icon:"ti-shield-check"},{id:"auditconsents",label:"Audit Consents",icon:"ti-history"},{id:"owners",label:"Owners",icon:"ti-users"},{id:"usage",label:"Usage Analytics",icon:"ti-chart-line"},{id:"risk",label:"Risk Assessment",icon:"ti-alert-triangle"},{id:"lifecycle",label:"Lifecycle",icon:"ti-timeline"},{id:"recommendations",label:"Recommendations",icon:"ti-checklist"},{id:"copilot",label:"App Copilot",icon:"ti-robot"}];async function br(){const e=document.getElementById("page-applications");if(!e)return;if(H()){console.log("🎭 Demo account detected - showing demo applications data"),xr(e);return}e.innerHTML='<div style="padding:20px;text-align:center"><div class="spinner"></div><p>Loading real M365 application data...</p></div>',console.log("📡 Fetching real application data from backend...");const t=await Gs();t!=null&&t.success&&t.data?(L=t.data,console.log(`✅ Apps: ${L.length}`)):(console.warn("⚠️ No application data available from API"),L=[]);const i=await Ns();i!=null&&i.success&&i.data?(ne=i.data,console.log(`✅ SPs: ${ne.length}`)):(console.warn("⚠️ No service principal data available from API"),ne=[]);try{const a=await(await fetch(`${S}/secrets-certificates`)).json();a!=null&&a.success&&(j=a.data||[],console.log(`✅ Secrets: ${j.length}`))}catch(s){console.warn("⚠️ Secrets error:",s.message)}try{console.log(`🔄 Fetching permissions from ${S}/permissions`);const s=await fetch(`${S}/permissions`);console.log(`📦 Permissions response status: ${s.status}`);const a=await s.json();console.log("📊 Permissions response:",a),a!=null&&a.success?(He=a.data||[],console.log(`✅ Permissions: ${He.length} items`)):console.warn("⚠️ Permissions endpoint returned success=false")}catch(s){console.warn("⚠️ Permissions error:",s.message,s.stack)}try{const a=await(await fetch(`${S}/admin-consents`)).json();a!=null&&a.success&&(Ct=a.data||[],console.log(`✅ Consents: ${Ct.length}`))}catch(s){console.warn("⚠️ Consents error:",s.message)}try{const a=await(await fetch(`${S}/recent-consents`)).json();a!=null&&a.success&&(vi=a.data||[],console.log(`✅ Recent Consents: ${vi.length}`))}catch(s){console.warn("⚠️ Recent Consents error:",s.message)}try{const a=await(await fetch(`${S}/audit-logs/consents`)).json();a!=null&&a.success&&(Te=a.data||[],console.log(`✅ Audit Consents: ${Te.length}`))}catch(s){console.warn("⚠️ Audit Consents error:",s.message)}try{const a=await(await fetch(`${S}/usage-analytics`)).json();a!=null&&a.success&&(ge=a.data||[],console.log(`✅ Usage: ${ge.length}`))}catch(s){console.warn("⚠️ Usage error:",s.message)}try{const a=await(await fetch(`${S}/risk-assessment`)).json();a!=null&&a.success&&(ye=a.data||[],console.log(`✅ Risks: ${ye.length}`))}catch(s){console.warn("⚠️ Risk error:",s.message)}try{const a=await(await fetch(`${S}/recommendations`)).json();a!=null&&a.success&&(Ve=a.data||[],console.log(`✅ Recs: ${Ve.length}`))}catch(s){console.warn("⚠️ Recs error:",s.message)}ue(e)}function xr(e){const t=[{id:"app-001",name:"Power BI Service",owners:["Chen Wei","Priya Kumar"],lastUsed:"2026-06-01",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-002",name:"Salesforce Integration",owners:["Aisha Raza"],lastUsed:"2026-06-01",status:"active",riskLevel:"medium",secretsExpiring:1},{id:"app-003",name:"ServiceNow Connector",owners:["Chen Wei","Sanjay Kumar"],lastUsed:"2026-05-31",status:"active",riskLevel:"low",secretsExpiring:0},{id:"app-004",name:"Slack Integration",owners:["Priya Kumar"],lastUsed:"2026-05-30",status:"inactive",riskLevel:"low",secretsExpiring:0},{id:"app-005",name:"Azure DevOps Extension",owners:["Chen Wei"],lastUsed:"2026-06-01",status:"active",riskLevel:"high",secretsExpiring:2}],i={totalApps:t.length,activeApps:4,appPermissions:12,delegatedPermissions:18,appRoles:8,secretsExpiring:3},s=[{appName:"Power BI Service",permissions:"Dataset.ReadWrite.All, Report.Read.All",grantedBy:"Chen Wei",grantedAt:"2026-06-01 14:32",status:"Approved"},{appName:"Salesforce Integration",permissions:"User.Read.All, Directory.Read.All",grantedBy:"Aisha Raza",grantedAt:"2026-06-01 11:15",status:"Approved"},{appName:"ServiceNow Connector",permissions:"Mail.Send, Mail.Read",grantedBy:"Admin",grantedAt:"2026-05-30 09:45",status:"Approved"}],a=[{appName:"Salesforce Integration",type:"Client Secret",expiresAt:"2026-06-15",status:"Expiring soon",daysLeft:14},{appName:"Azure DevOps Extension",type:"Client Secret",expiresAt:"2026-06-10",status:"Expiring soon",daysLeft:9},{appName:"Azure DevOps Extension",type:"Certificate",expiresAt:"2026-06-08",status:"Critical",daysLeft:7}];e.innerHTML=`
  ...
  `;const n=e.querySelector("#app-content");gi(n,i,t),e.querySelectorAll("#app-tabs .tab-btn").forEach(r=>{r.addEventListener("click",()=>{e.querySelectorAll("#app-tabs .tab-btn").forEach(o=>o.classList.remove("active")),r.classList.add("active");const l=r.dataset.tab;l==="executive"?gi(n,i,t):l==="appregistrations"?wr(n,t):l==="enterprise"?Ar(n,t):l==="secrets"?kr(n,a):l==="permissions"?Sr(n,i):l==="auditconsents"&&$r(n,s)})})}function gi(e,t,i){const s=i.filter(a=>a.riskLevel==="high");e.innerHTML=`
    <div class="card mb-3">
      <div class="card-header">
  ...
  `}function ue(e){var a,n;const t=(j||[]).filter(r=>r.status==="expiring").length,i=(j||[]).filter(r=>r.status==="expired").length,s=(ye||[]).filter(r=>r.severity==="critical").length;e.innerHTML=`
    <div class="page-header">
      <div>
    ...
    <div class="kpi-row mb-3">
      ...
      <div class="kpi-tile">
        <div class="kpi-value warning">${fr.highPrivilegeApps}</div>
    ...
    <!-- Content area -->
    <div id="app-content" style="margin-top:16px">${Er()}</div>
  `,e.querySelectorAll(".app-tab-btn").forEach(r=>{r.addEventListener("click",()=>{Be=r.dataset.appSection,ue(e)})}),(a=e.querySelector("#app-refresh"))==null||a.addEventListener("click",()=>{const r=e.querySelector("#app-refresh");r.innerHTML='<span class="spinner dark"></span> Scanning...',r.disabled=!0,setTimeout(()=>{r.innerHTML='<i class="ti ti-refresh"></i> Refresh',r.disabled=!1,u(`Application inventory updated — ${L.length} app registrations, ${ne.length} service principals scanned.`,"success")},2200)}),(n=e.querySelector("#app-audit"))==null||n.addEventListener("click",()=>u("Application audit exported as CSV.","success")),Nr(e)}function Er(){return({executive:mi,appregistrations:Pr,enterprise:Cr,secrets:Mr,permissions:Dr,auditconsents:Rr,owners:Lr,usage:Tr,risk:Ir,lifecycle:zr,recommendations:qr,copilot:Gr}[Be]||mi)()}function mi(){console.log(`📊 Executive: Apps=${L.length}, SPs=${ne.length}, Secrets=${j.length}`);const e=j.filter(a=>a.status==="expiring").length,t=j.filter(a=>a.status==="expired").length,i=ye.filter(a=>a.severity==="critical").length,s=ge.filter(a=>a.status==="unused").length;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
        <div class="card-header">
      ...
      <div class="card">
        ...
        ${yi([{label:"Expired Secrets",val:t,cls:"danger"},{label:"Expiring (30 days)",val:e,cls:"warning"},{label:"Expiring (60 days)",val:j.filter(a=>a.daysRemaining<=60&&a.daysRemaining>30).length,cls:"warning"},{label:"Apps Requiring Admin Consent",val:Ct.length,cls:"warning"}])}
      </div>
    </div>
  ...
  `}function Pr(){const e=L.length>0?L:[],t=e.filter(s=>!(T.type!=="all"&&s.category!==T.type||T.status!=="all"&&s.status!==T.status||T.search&&!s.name.toLowerCase().includes(T.search.toLowerCase()))),i=[...new Set(e.map(s=>s.category))];return`
    <div class="filter-bar mb-3">
  ...
  `}function Cr(){const e=ne.length>0?ne:[];return`
    <div class="filter-bar mb-3">
  ...
  `}function Mr(){const e=j.filter(s=>s.status==="expired"),t=j.filter(s=>s.status==="expiring"),i=j.filter(s=>s.status==="healthy");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Dr(){const e=He.filter(i=>i.riskLevel==="critical"),t=He.filter(i=>i.riskLevel==="high");return`
    ${e.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Lr(){const e=L.length>0?L:[],t=e.filter(a=>!a.owners||a.owners.length===0),i=e.filter(a=>a.owners&&a.owners.length===1),s=e.filter(a=>a.owners&&a.owners.length>1);return`
    ${t.length>0?`
      <div class="alert-banner danger mb-3">
        <i class="ti ti-alert-triangle"></i>
  ...
  `}function Tr(){const e=ge.filter(s=>s.status==="active"),t=ge.filter(s=>s.status==="lowuse"),i=ge.filter(s=>s.status==="unused");return`
    ...
    `).join("")}
  `}function Ir(){const e=ye.filter(i=>i.severity==="critical"),t=ye.filter(i=>i.severity==="high");return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
    ...
    `).join("")}
  `}function zr(){const e=L.length>0?L:[],t=e.filter(a=>{const n=a.createdDateTime?new Date(a.createdDateTime):null;if(!n)return!1;const r=new Date(Date.now()-30*24*60*60*1e3);return n>r}),i=e.filter(a=>!a.owners||a.owners.length===0),s=ge.filter(a=>a.status==="unused");return`
  ...
  `}function Gr(){(!ui||Le.length===0)&&(Le=[{role:"ai",text:`**Applications & App Registrations Copilot** — Ask me about app security, secrets, permissions, risks, and more.
...
Based on your question, navigate to the relevant section above. Current state: 87 app registrations, 2 expired secrets, 2 critical risk apps, 5 recommendations.`;Le.push({role:"ai",text:r}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `}function Wr(){const e=b.summary,t=b.deviceHealth||[];return t.length>0&&Math.round(t.reduce((i,s)=>i+s.healthScore,0)/t.length),`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function Yr(){var t,i,s,a,n,r,l,o;const e=b.endpointSecurity;return`
    <div class="grid-2 mb-3" style="gap:16px">
      <div class="card">
  ...
  `}function Zr(){const e=b.patchManagement;return`
    <div class="alert-banner danger mb-3">
      <i class="ti ti-alert-triangle"></i>
  ...
  `}function Xr(){const e=b.riskAssessment,t=e.deviceRisks||[];return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
    ...
    `).join("")}
  `}function eo(){const e=b.policies||{configurationPolicies:[],conditionalAccessPolicies:[]},t=e.configurationPolicies||[],i=e.conditionalAccessPolicies||[];return`
  ...
  `}function to(){const e=b.recommendations||[];return`
    <div class="card" style="padding:0;overflow:hidden">
      <table>
        <thead><tr>
          <th style="width:11%">Priority</th>
  ...
  `}function io(){if(!fi){const t=b.summary||{},i=b.riskAssessment||{};et=[{role:"ai",text:`**Intune Security Advisor** — Ask me about device health, compliance, security posture, patch status, or remediation recommendations.
...
Ask me about device health, compliance, security, patches, or recommendations!`;et.push({role:"ai",text:d}),s&&(s.innerHTML+=`<div class="chat-msg ai" style="max-width:85%;margin-bottom:12px">
  ...
  `,e.querySelectorAll(".intune-tab-btn").forEach(i=>{i.addEventListener("click",()=>{De=i.dataset.tab,e.querySelector("#myacc-content").innerHTML=xi(),De==="signin"&&setTimeout(()=>wi(e),100)})}),De==="signin"&&setTimeout(()=>wi(e),100),(t=e.querySelector("#myacc-refresh"))==null||t.addEventListener("click",()=>{const i=e.querySelector("#myacc-refresh");i.innerHTML='<span class="spinner dark"></span> Refreshing...',i.disabled=!0,setTimeout(()=>{i.innerHTML='<i class="ti ti-refresh"></i> Refresh',i.disabled=!1,u("Your profile has been refreshed.","success")},1500)})}function xi(){const t={executive:co,profile:po,security:uo,signin:vo,licenses:go,groups:mo,devices:yo,apps:fo,onedrive:ho,teams:bo,approvals:xo,copilot:wo}[De];return t?t():""}function co(){var c,p,f,x,g,m,v,A;const e=((c=h.security)==null?void 0:c.securityScore)||85,t=((p=h.security)==null?void 0:p.mfaStatus)||"Not Enabled",i=((f=h.security)==null?void 0:f.riskLevel)||"Low",s=(h.licenses&&Array.isArray(h.licenses)?h.licenses.length:0)||((x=h.licenses)==null?void 0:x.count)||0,a=(h.devices&&Array.isArray(h.devices)?h.devices.length:0)||((g=h.devices)==null?void 0:g.count)||0,n=(h.groups&&h.groups.securityGroups?h.groups.securityGroups.length:0)||0,r=((m=h.teams)==null?void 0:m.teamsMembership)||0,l=0,o=((v=h.onedrive)==null?void 0:v.percentageUsed)||0,d=((A=h.mailbox)==null?void 0:A.mailboxUsage)||65;return`
    <div class="kpi-row mb-3">
      <div class="kpi-tile">
  ...
  `}function po(){const e=h.profile;return`
    <div class="card">
  ...
  `}function uo(){const e=h.security;return`
    <div class="card">
  ...
  `}function vo(){const e=h.signin.filter(i=>i.result==="Success"),t=h.signin.filter(i=>i.result==="Failed");return`
  ...
  `}function ho(){const e=h.onedrive;return`
    <div class="card">
  ...
  `}function bo(){const e=h.teams;return`
    <div class="card">
  ...
  `}function xo(){return!Ge||Ge.length===0?`
      <div class="card">
  ...
  `,Ms(),Pi()}function Po(){return["dashboard","requests","security","tenantguard","user-investigation","zerotrust","privaccts","m365config","msgcenter","applications","intune","licenses","agents","approvals","portal","myreqs","myaccount","chat","graphapi","sso","audit","settings"].map(t=>`<div class="page" id="page-${t}"></div>`).join("")}ko();Si().catch(e=>{console.error("Login render error:",e),Si()});const Co=Object.freeze(Object.defineProperty({__proto__:null,go:w,hasAccess:ys,isRole:So,resetSettings:ms,saveState:G,state:y},Symbol.toStringTag,{value:"Module"}));
