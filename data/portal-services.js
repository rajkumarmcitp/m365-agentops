...
export const SERVICE_GROUPS = [
  ...
  { id: 'licenses',        name: 'License Management',       icon: 'ti-license',          color: '#854F0B', bg: '#FAEEDA', desc: 'Request Microsoft 365, Power BI, Visio, Project licenses', badge: '6 licenses' },
  { id: 'copilot',         name: 'Microsoft Copilot',        icon: 'ti-sparkles',         color: '#3C3489', bg: '#EEEDFE', desc: 'Request or remove Microsoft 365 Copilot licenses', badge: '2 actions' },
...
export const SERVICE_CATALOG = {
  ...
  'licenses': {
    ...
    operations: [
      ...
      {
        id: 'req-powerbi', group: 'Add-on Licenses', label: 'Request Power BI Pro License',
        approvalPath: ['manager'],
      ...
      {
        id: 'req-visio', group: 'Add-on Licenses', label: 'Request Visio Plan License',
        approvalPath: ['manager'],
      ...
      {
        id: 'req-project', group: 'Add-on Licenses', label: 'Request Project Plan License',
        approvalPath: ['manager'],
